...
class Emulator {
  ...
  constructor(pubsub) {
    ...
    this.self = this;
    // Send keep alives to emulator so our websocket doesn't close down
    // TODO(jansene): This should move to the server.
    setInterval((function(ps) { ps.publish('emulator', 'ping'); })(pubsub), 5000);
    this.resolvers = []
