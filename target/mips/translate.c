...
#define DEBUG_DISSAS(opc) do {                                                          \
    ...
    fprintf(stderr, "%s:%d\t CPU(%d) %s pc %u op 0x%x rs %d rt %d rd %d sa %d imm 0x%x\n",       \
                    __func__, __LINE__, cs->cpu_index, opc, env->CPU.pc, op, rs, rt, rd, sa, (uint32_t)imm);\
    for (i = 0; i < 32; i++) {                                                          \
        fprintf(stderr, "$%d = 0x" TARGET_FMT_lx " ", i, env->CPU.gpr_reg[i]);               \
...
#define DEBUG_ERROR(msg) do {                                                           \
    fprintf(stderr, "%s:%d\t CPU(%d) %s pc %u op 0x%x rs %d rt %d rd %d sa %d imm 0x%x\n",       \
                    __func__, __LINE__, cs->cpu_index, msg, env->CPU.pc, op, rs, rt, rd, sa, (uint32_t)imm);\
    exit(1);                                                                            \
} while(0)
...
int tlb_exception_interpreter(CPUMIPSState *env, uint32_t *code, uint32_t size)
{
    ...
    env->CPU.branch_addr = 0;

    env->CPU.CP0_EntryLo0 = env->CP0_EntryLo0;
    env->CPU.CP0_EntryLo1 = env->CP0_EntryLo1;
    env->CPU.CP0_BadVAddr = env->CP0_BadVAddr;
    env->CPU.CP0_EntryHi = env->CP0_EntryHi;
    env->CPU.CP0_Context = env->CP0_Context;
    env->CPU.CP0_XContext = env->CP0_XContext;
    env->CPU.CP0_PageMask = env->CP0_PageMask;
    env->CPU.CP0_PageGrain = env->CP0_PageGrain;
    env->CPU.CP0_PageGrain_rw_bitmask = env->CP0_PageGrain_rw_bitmask;
    env->CPU.CP0_Index = env->CP0_Index;

    for (i = 0; i < MIPS_KSCRATCH_NUM; i++) {
        env->CPU.CP0_KScratch[i] = env->CP0_KScratch[i];
    }

    while (1) {

        op = MASK_OP_MAJOR(code[env->CPU.pc]);
        rs = (code[env->CPU.pc] >> 21) & 0x1f;
        rt = (code[env->CPU.pc] >> 16) & 0x1f;
        rd = (code[env->CPU.pc] >> 11) & 0x1f;
        sa = (code[env->CPU.pc] >> 6) & 0x1f;
        imm = (int16_t)code[env->CPU.pc];
        opcode = code[env->CPU.pc];
        ...
        case OPC_SPECIAL:
            ...
            case OPC_JALR:
                ...
                return -2;
            case OPC_SLL:
                env->CPU.gpr_reg[rt] = (int32_t)(env->CPU.gpr_reg[rt] << sa);
                DEBUG_DISSAS("sll");
                break;
            case OPC_SRA:
                env->CPU.gpr_reg[rt] = (int32_t)((int32_t)env->CPU.gpr_reg[rt] >> sa);
                DEBUG_DISSAS("sra");
                break;
            case OPC_SRL:
                switch ((opcode >> 21) & 0x1f) {
                    ...
                    {
                        uint32_t mask = ~(-1 << sa);
                        env->CPU.gpr_reg[rd] = (int32_t)((((uint32_t)env->CPU.gpr_reg[rt] & mask) << (32 - sa)) |
                                                   (((uint32_t)env->CPU.gpr_reg[rt]) >> sa));
                        DEBUG_DISSAS("ror");
                        break;
                    }
                    case 0:
                        env->CPU.gpr_reg[rt] = (int32_t)((uint32_t)env->CPU.gpr_reg[rt] >> sa);
                        DEBUG_DISSAS("srl");
                        break;
                    default:
            ...
            case OPC_ROTR:
            {
                ...
                env->CPU.gpr_reg[rd] = (int32_t)(((env->CPU.gpr_reg[rt] & mask) << (32 - sa)) |
                                           (((target_ulong)env->CPU.gpr_reg[rt]) >> sa));
                DEBUG_DISSAS("rotr");
                break;
            }
            case OPC_ADDU:
                env->CPU.gpr_reg[rd] = (int32_t)(env->CPU.gpr_reg[rs] + env->CPU.gpr_reg[rt]);
                DEBUG_DISSAS("addu");
                break;
            case OPC_SUBU:
                env->CPU.gpr_reg[rd] = (int32_t)(env->CPU.gpr_reg[rs] - env->CPU.gpr_reg[rt]);
                ...
                break;
            case OPC_AND:          /* Logic*/
                env->CPU.gpr_reg[rd] = env->CPU.gpr_reg[rs] & env->CPU.gpr_reg[rt];
                DEBUG_DISSAS("and");
                break;
            case OPC_OR:
                env->CPU.gpr_reg[rd] = env->CPU.gpr_reg[rs] | env->CPU.gpr_reg[rt];
            ...
            case OPC_DSLL:
                env->CPU.gpr_reg[rd] = env->CPU.gpr_reg[rt] << sa;
                DEBUG_DISSAS("dsll");
                break;
            case OPC_DSRA:
                env->CPU.gpr_reg[rd] = env->CPU.gpr_reg[rt] >> sa;
                ...
                break;
            case OPC_DSLL32:
                env->CPU.gpr_reg[rd] = env->CPU.gpr_reg[rt] << (sa + 32);
                DEBUG_DISSAS("dsll32");
                break;
            case OPC_DSRA32:
                env->CPU.gpr_reg[rd] = env->CPU.gpr_reg[rt] >> (sa + 32);
            ...
            case OPC_DSRL:
                switch ((opcode >> 21) & 0x1f) {
                    ...
                    {
                        target_ulong mask = ~(-1 << sa);
                        env->CPU.gpr_reg[rd] = (((target_ulong)env->CPU.gpr_reg[rt] & mask) << (64 - sa)) |
                                          (((target_ulong)env->CPU.gpr_reg[rt]) >> sa);
                        DEBUG_DISSAS("dror");
                        break;
                    }
                    case 0:
                        env->CPU.gpr_reg[rt] = ((target_ulong)env->CPU.gpr_reg[rt] >> sa);
                        DEBUG_DISSAS("dsrl");
                        break;
                    default:
            ...
            case OPC_DROTR32:
            {
                ...
                env->CPU.gpr_reg[rd] = (((target_ulong)env->CPU.gpr_reg[rt] & mask) << (32 - sa)) |
                                  (((target_ulong)env->CPU.gpr_reg[rt]) >> (sa + 32));
                DEBUG_DISSAS("drotr32");
                break;
            }
            case OPC_DSRL32:
                env->CPU.gpr_reg[rd] = ((target_ulong)env->CPU.gpr_reg[rt]) >> (sa + 32);
                DEBUG_DISSAS("dsrl32");
                break;
            case OPC_DADDU:
                env->CPU.gpr_reg[rd] = env->CPU.gpr_reg[rs] + env->CPU.gpr_reg[rt];
        ...
        case OPC_SPECIAL3:
        {
            ...
            case OPC_EXT:
                mask = (~(-1 << (rd + 1))) << sa;
                env->CPU.gpr_reg[rt] = (int32_t)(((target_ulong)(env->CPU.gpr_reg[rs] & mask)) >> sa);
                DEBUG_DISSAS("ext");
                break;
            case OPC_INS:
                mask = ~(-1 << (rd - sa + 1));
                env->CPU.gpr_reg[rt] = (int32_t)((env->CPU.gpr_reg[rt] & ~(mask << sa)) |
                                            ((env->CPU.gpr_reg[rs] & mask) << sa));
                DEBUG_DISSAS("ins");
                break;
#if defined(TARGET_MIPS64)
            case OPC_DEXT:
                mask = (~(-1 << (rd + 1))) << sa;
                env->CPU.gpr_reg[rt] = ((target_ulong)(env->CPU.gpr_reg[rs] & mask)) >> sa |
                                  (env->CPU.gpr_reg[rt] & ~((target_ulong)mask >> sa));
                DEBUG_DISSAS("dext");
                break;
            case OPC_DINSM:
                mask = ~(-1 << ((rd + 32) - sa + 1));
                env->CPU.gpr_reg[rt] = (env->CPU.gpr_reg[rt] & ~(mask << sa)) |
                                  ((env->CPU.gpr_reg[rs] & mask) << sa);
                DEBUG_DISSAS("dinsm");
                break;
            case OPC_DINS:
        ...
        case OPC_REGIMM:
            ...
            case OPC_BLTZL: /* REGIMM branches */
                if (env->CPU.gpr_reg[rs] < 0) {
                    env->CPU.branch_addr = env->CPU.pc + (int32_t)imm;
                    DEBUG_DISSAS("bltzl");
                    continue;
                } else {
                    env->CPU.pc++;
        ...
        case OPC_CP0:
            ...
            case OPC_MFC0:
                ...
                case 4:
                    ...
                    case 0:
                        // Context
                        env->CPU.gpr_reg[rt] = (int32_t)env->CPU.CP0_Context;
                ...
                case 5:
                    switch (opcode & 0x7) {
                    case 0:
                        env->CPU.gpr_reg[rt] = env->CPU.CP0_PageMask;
                        DEBUG_DISSAS("mfc0 PageMask");
                        break;
                    case 1:
                        env->CPU.gpr_reg[rt] = env->CPU.CP0_PageGrain;
                ...
                case 8:
                    ...
                    case 0:
                        // BadVAddr
                        env->CPU.gpr_reg[rt] = env->CPU.CP0_BadVAddr;
                ...
                case 13:
                    switch (opcode & 0x7) {
                    case 0:
                        env->CPU.gpr_reg[rt] = env->CPU.CP0_Cause;
                ...
                case 20:
                    ...
                    case 0:
                        // XContext
                        env->CPU.gpr_reg[rt] = env->CPU.CP0_XContext;
                ...
                case 31:
                    switch(opcode & 0x7) {
                        case 2 ... 7:
                            env->CPU.gpr_reg[rt] = (int32_t)env->CPU.CP0_KScratch[(opcode & 0x7) - 2];
            ...
            case OPC_MTC0:
                ...
                case 2:
                    ...
                    {
                        // EntryLo0
                        target_ulong rxi = env->CPU.gpr_reg[rt] & (env->CPU.CP0_PageGrain & (3u << CP0PG_XIE));
                        env->CPU.CP0_EntryLo0 = (env->CPU.gpr_reg[rt] & ((env->PAMask >> 6) & 0x3FFFFFFF)) |
                                           (rxi << (CP0EnLo_XI - 30));
                ...
                case 3:
                    ...
                    case 0:
                    {
                        // EntryLo1
                        target_ulong rxi = env->CPU.gpr_reg[rt] & (env->CPU.CP0_PageGrain & (3u << CP0PG_XIE));
                        env->CPU.CP0_EntryLo1 = (env->CPU.gpr_reg[rt] & ((env->PAMask >> 6) & 0x3FFFFFFF)) |
                                           (rxi << (CP0EnLo_XI - 30));
                ...
                case 5:
                    ...
                    case 0:
                    {
                        uint64_t mask = env->CPU.gpr_reg[rt] >> (TARGET_PAGE_BITS + 1);
                        if (!(env->insn_flags & ISA_MIPS32R6) || (env->CPU.gpr_reg[rt] == ~0) ||
                            (mask == 0x0000 || mask == 0x0003 || mask == 0x000F ||
                             mask == 0x003F || mask == 0x00FF || mask == 0x03FF ||
                             mask == 0x0FFF || mask == 0x3FFF || mask == 0xFFFF)) {
                            env->CPU.CP0_PageMask = env->CPU.gpr_reg[rt] & (0x1FFFFFFF & (TARGET_PAGE_MASK << 1));
                        }
                        DEBUG_DISSAS("mtc0 PageMask");
                        break;
                    }
                    case 1:
                        env->CPU.CP0_PageGrain = (env->CPU.gpr_reg[rt] & env->CPU.CP0_PageGrain_rw_bitmask) |
                                             (env->CPU.CP0_PageGrain & ~env->CPU.CP0_PageGrain_rw_bitmask);
                ...
                case 31:
                    switch(opcode & 0x7) {
                        case 2 ... 7:
                            env->CPU.CP0_KScratch[(opcode & 0x7) - 2] = env->CPU.gpr_reg[rt];
            ...
            case OPC_DMFC0:
                ...
                case 4:
                    ...
                    case 0:
                        // Context
                        env->CPU.gpr_reg[rt] = env->CPU.CP0_Context;
                ...
                case 31:
                    switch(opcode & 0x7) {
                        case 2 ... 7:
                            env->CPU.gpr_reg[rt] = env->CPU.CP0_KScratch[(opcode & 0x7) - 2];
            ...
            case OPC_DMTC0:
                ...
                case 2:
                    ...
                    {
                        // EntryLo0
                        target_ulong rxi = env->CPU.gpr_reg[rt] & ((env->CPU.CP0_PageGrain & (3ull << CP0PG_XIE)) << 32);
                        env->CPU.CP0_EntryLo0 = (env->CPU.gpr_reg[rt] & (env->PAMask >> 6)) | rxi;
                ...
                case 3:
                    ...
                    case 0:
                    {
                        // EntryLo1
                        target_ulong rxi = env->CPU.gpr_reg[rt] & ((env->CPU.CP0_PageGrain & (3ull << CP0PG_XIE)) << 32);
                        env->CPU.CP0_EntryLo1 = (env->CPU.gpr_reg[rt] & (env->PAMask >> 6)) | rxi;
            ...
            case OPC_C0_FIRST ... OPC_C0_LAST:
                switch (MASK_C0(opcode)) {
                    case OPC_ERET:
                        ...
                        return 0;
                    case OPC_TLBWR:
                        if (likely(env->CPU.do_tlbwr)) {
                            env->CP0_EntryLo0 = env->CPU.CP0_EntryLo0;
                            env->CP0_EntryLo1 = env->CPU.CP0_EntryLo1;
            ...
            break;
        case OPC_ADDIU:
            env->CPU.gpr_reg[rt] = env->CPU.gpr_reg[rs] + imm;
            DEBUG_DISSAS("addiu");
            break;
        case OPC_ANDI: /* Arithmetic with immediate opcode */
            env->CPU.gpr_reg[rt] = env->CPU.gpr_reg[rs] & (uint32_t)imm;
            DEBUG_DISSAS("andi");
            break;
        case OPC_LUI: /* OPC_AUI */
            env->CPU.gpr_reg[rt] = ((int32_t)imm) << 16;
            DEBUG_DISSAS("lui");
            break;
        case OPC_ORI:
            env->CPU.gpr_reg[rt] = env->CPU.gpr_reg[rs] | ((uint32_t)imm);
        ...
        /* Branch */
        case OPC_BEQ:
            if (env->CPU.gpr_reg[rs] == env->CPU.gpr_reg[rt]) {
                env->CPU.branch_addr = env->CPU.pc + (int32_t)imm;
                DEBUG_DISSAS("beq");
                continue;
            }
        ...
        case OPC_LW:
        {
            env->CPU.gpr_reg[rt] = (int32_t)ldl_phys(cs->as, translate_address(env, env->CPU.gpr_reg[rs] + imm));
            DEBUG_DISSAS("lw");
            break;
        }
        case OPC_SW:
            stl_phys(cs->as, translate_address(env, env->CPU.gpr_reg[rs] + imm), env->CPU.gpr_reg[rt]);
            DEBUG_DISSAS("sw");
            break;
    #if defined(TARGET_MIPS64)
        /* MIPS64 opcodes */
        case OPC_LD:
            env->CPU.gpr_reg[rt] = ldq_phys(cs->as, translate_address(env, env->CPU.gpr_reg[rs] + imm));
            DEBUG_DISSAS("ld");
            break;
        case OPC_SD:
            stq_phys(cs->as, translate_address(env, env->CPU.gpr_reg[rs] + imm), env->CPU.gpr_reg[rt]);
            DEBUG_DISSAS("sd");
            break;
        case OPC_DADDIU:
            env->CPU.gpr_reg[rt] = env->CPU.gpr_reg[rs] + imm;
        ...
        if (env->CPU.branch_addr) {
            env->CPU.pc = env->CPU.branch_addr;
            env->CPU.branch_addr = 0;
        }
