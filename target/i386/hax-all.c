...
//#endif
    ...
    //hax_getput_reg(&regs.)
    hax_getput_reg(&regs._dr0, &env->dr0, set);
    hax_getput_reg(&regs._dr1, &env->dr1, set);
    hax_getput_reg(&regs._dr2, &env->dr2, set);
    hax_getput_reg(&regs._dr3, &env->dr3, set);
    hax_getput_reg(&regs._dr6, &env->dr6, set);
    hax_getput_reg(&regs._dr7, &env->dr7, set);
