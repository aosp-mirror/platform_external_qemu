...
$(call start-emulator-program,google_benchmark$(BUILD_TARGET_SUFFIX)_basic_test)

LOCAL_SRC_FILES := \
    test/basic_test.cc \

LOCAL_C_INCLUDES += $(GOOGLE_BENCHMARK_INCLUDES)
LOCAL_WHOLE_STATIC_LIBRARIES += $(GOOGLE_BENCHMARK_STATIC_LIBRARIES)
LOCAL_LDLIBS += $(GOOGLE_BENCHMARK_LDLIBS)
