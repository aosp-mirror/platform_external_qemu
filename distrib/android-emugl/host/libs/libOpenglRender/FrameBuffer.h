...
public:
    ...
    HandleType createColorBufferPid(
        int p_width, int p_height, GLenum p_internalFormat, int pid);
    ...
    int openColorBufferPid(HandleType p_colorbuffer, int pid);
    ...
    void closeColorBufferPid(HandleType p_colorbuffer, int pid);

    void onProcKilled(int pid);
