...
//
//   2) Each time you want to draw a texture, call draw(texture), where
//      |texture| is the name of a GLES 2.x texture object, which fill the
//      current framebuffer with its content.
//
// NOTE: There is no scaling or rotation support at the moment.
//
class TextureDraw {
public:
