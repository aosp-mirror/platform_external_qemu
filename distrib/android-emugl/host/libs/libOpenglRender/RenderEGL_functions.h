// Auto-generated with: android/scripts/gen-entries.py --mode=functions distrib/android-emugl/host/libs/libOpenglRender/render_egl.entries --output=distrib/android-emugl/host/libs/libOpenglRender/RenderEGL_functions.h
