...
// to finish. 1 sceond seems to cover most cases.
// If we set this to 16ms or something close to a frame time,
// we can get out of order frames.
static const uint64_t kFenceSyncWaitTime = 1000000000;
...
bool ColorBuffer::blitFromCurrentReadBuffer()
{
    ...
    if (tInfo->currContext->isGL2()) {
        ...
        // No glFinish or any sync needed provided
        // we use the fence sync commands issued from the guest properly
    }
    else {
