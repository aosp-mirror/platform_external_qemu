...
RenderWindow::RenderWindow(int width, int height) :
    ...
    mValid = mChannel->sendMessageAndGetResult(msg);
}
...
RenderWindow::~RenderWindow() {
    ...
    (void) mChannel->sendMessageAndGetResult(msg);
...
bool RenderWindow::setupSubWindow(FBNativeWindowType window,
    ...
    mHasSubWindow = mChannel->sendMessageAndGetResult(msg);
...
bool RenderWindow::removeSubWindow() {
    ...
    bool result = mChannel->sendMessageAndGetResult(msg);
    D("Exiting result=%s\n", result ? "success" : "failure");
    return result;
}
