...
public:
    ...
    // Read data from the guest, this call is blocking. On success,
    // move item into |*buffer| and return true. On failure, return false
    // (meaning the channel was closed). TODO(digit): Update doc.
...
private:
    ...
    SyncBufferQueue mFromGuest;
    SyncBufferQueue mToGuest;
};
