...
#define LIST_RENDER_API_FUNCTIONS(X) \
  ...
  X(bool, createOpenGLSubwindow, (FBNativeWindowType window, int x, int y, int windowWidth, int windowHeight, int framebufferWidth, int framebufferHeight, float zRot)) \
