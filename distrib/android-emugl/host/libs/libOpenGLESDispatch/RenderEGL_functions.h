// Auto-generated with: android/scripts/gen-entries.py --mode=functions distrib/android-emugl/host/libs/openGLESDispatch/render_egl.entries --output=distrib/android-emugl/host/libs/openGLESDispatch/RenderEGL_functions.h
