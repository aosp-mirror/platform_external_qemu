// Auto-generated with: android/scripts/gen-entries.py --mode=functions distrib/android-emugl/host/libs/EGLDispatch/render_egl_extensions.entries --output=distrib/android-emugl/host/libs/EGLDispatch/RenderEGL_extensions_functions.h
