...
public:
    ...
    bool validatePointer(const void* ptr) const { return m_pointerValidate.isValid(ptr); }
    bool validateBuffer(const void* buffer, size_t size) const {return m_pointerValidate.isValid(buffer, size);}
protected:
...
private:
    ...
    PointerValidator       m_pointerValidate;
};
