...
//
// GenNameInfo contains the type of an GL object to be generated. It also
// contains shader type when generating shader object. It is used by
// NameSpace::genName. When generating non-shader object, a NamedObjectType
// parameter should be passed to the constructor. When generating shader object,
// the shader type should be passed to the constructor.
//
// Example:
//          NameSpace nameSpace;
//          GenNameInfo genTexture(NamedObjectType::TEXTURE);
//          unsigned int texID = nameSpace.genName(genTexture);
//          GenNameInfo genShader(GL_FRAGMENT_SHADER);
//          unsigned int shaderID = nameSpace.genName(genShader);
