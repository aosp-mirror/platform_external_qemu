// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs distrib/android-emugl/host/libs/Translator/GLcommon/gles_common.entries --output=distrib/android-emugl/host/libs/Translator/include/GLcommon/gles_common_functions.h
