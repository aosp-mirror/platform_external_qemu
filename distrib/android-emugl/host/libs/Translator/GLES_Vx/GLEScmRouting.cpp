...
bool                  s_gles_v1tov2_routing_enabled;
...
void init_gles_v1tov2_routing() {
  ...
  // init es1x
  struct gl2_server_base_t *gles_v2_base = static_cast<struct gl2_server_base_t *>(&gles_v2);
