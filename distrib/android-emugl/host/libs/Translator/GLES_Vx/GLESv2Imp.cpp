...
static void initGLESx() {
  fprintf(stdout, "Initializing GLES_V2 to GL routing from within GLES_CM\n");
  // instantiate a GLESv2 context to initialize static library components
  GLESv2Context *tmp_ctx = new GLESv2Context();
  tmp_ctx->initGLESx();
  delete tmp_ctx;
  fprintf(stdout, "Initializing GLES_V2 to GL routing from within GLES_CM ______________COMPLETE_____________\n");
}
