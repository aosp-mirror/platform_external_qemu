...
TEST_F(Etc2Test, ETC2T) {
    const unsigned char encoded[8] = {21, 101, 186, 135, 166, 238, 74, 106};
    const unsigned char expectedDecoded[48] = {
...
TEST_F(Etc2Test, ETC2H) {
    const unsigned char encoded[8] = {110, 13, 228, 186, 119, 119, 255, 117};
    const unsigned char expectedDecoded[48] = {
...
TEST_F(Etc2Test, ETC2P) {
    const unsigned char encoded[8] = {89, 138, 250, 79, 120, 181, 146, 29};
    const unsigned char expectedDecoded[48] = {
