...
#include "DummyGLfuncs.h"
    ...
    GLboolean dummy_glIsBuffer(GLuint){ return false;}
    GLboolean dummy_glIsEnabled(GLenum cap){ return false;}
    GLboolean dummy_glIsTexture(GLuint texture){return false;}
    ...
    GLboolean dummy_glIsRenderbufferEXT(GLuint renderbuffer){ return false;}
    ...
    GLboolean dummy_glIsFramebufferEXT(GLuint framebuffer){ return false;}
    ...
    GLenum dummy_glCheckFramebufferStatusEXT(GLenum target){ return 0;}
    ...
    void dummy_glTexGenf(GLenum coord, GLenum pname, const GLfloat *params ){}
    ...
    GLboolean dummy_glIsProgram(GLuint program){ return false;}
    GLboolean dummy_glIsShader(GLuint shader){ return false;}
    ...
    GLboolean dummy_glIsFramebuffer(GLuint framebuffer){ return false;}
    GLboolean dummy_glIsRenderbuffer(GLuint renderbuffer){ return false;}
    GLenum dummy_glCheckFramebufferStatus(GLenum target){ return 0;}
    ...
    GLuint dummy_glCreateProgram(void){ return 0;}
    GLuint dummy_glCreateShader(GLenum type){ return 0;}
    ...
    int  dummy_glGetAttribLocation(GLuint program, const GLchar* name){ return 0;}
    ...
    int  dummy_glGetUniformLocation(GLuint program, const GLchar* name){ return 0;}
