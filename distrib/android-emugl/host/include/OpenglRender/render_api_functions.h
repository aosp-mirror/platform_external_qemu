...
#define LIST_RENDER_API_FUNCTIONS(X) \
  ...
  X(int, initOpenGLRenderer, (int width, int height, bool useSubWindow, char* addr, size_t addrLen, void** logfuncs), (width, height, useSubWindow, addr, addrLen, logfuncs)) \
