...
#define LIST_RENDER_API_FUNCTIONS(X) \
  ...
  X(int, initOpenGLRenderer, (int width, int height, bool useSubWindow, char* addr, size_t addrLen, void* logger, void* cxt_logger), (width, height, useSubWindow, addr, addrLen, logger, cxt_logger)) \
