...
// GLProtocol adds checksum to GL pipe communication. Each pipe should use one
// GLProtocol.
// It can:
...
public:
    ...
    // Get and set current protocol version
    ...
    // Size of checksum string in the current version
