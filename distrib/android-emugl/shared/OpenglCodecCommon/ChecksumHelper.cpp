...
namespace {
    ...
    const char* kMaxVersionStrPrefix = CHECKSUMHELPER_VERSION_STR_PREFIX;
    const char* kMaxVersionStr = CHECKSUMHELPER_VERSION_STR_PREFIX CHECKSUMHELPER_MACRO_VAL_TO_STR(CHECKSUMHELPER_MAX_VERSION);
}
...
uint32_t ChecksumHelper::getMaxVersion() {return kMaxVersion;}
const char* ChecksumHelper::getMaxVersionStr() {return kMaxVersionStr;}
const char* ChecksumHelper::getMaxVersionStrPrefix() {return kMaxVersionStrPrefix;}
