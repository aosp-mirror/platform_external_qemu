...
public:
    ...
    // Also setting version > kMaxVersion returns false.
    bool setVersion(uint32_t version);

    // Maximum supported checksum version
    static const uint32_t kMaxVersion;
    static const char* kMaxVersionStrPrefix;
    static const char* kMaxVersionStr;
    ...
    // from the host
    static const char* getMaxVersionString() { return kMaxVersionStr; }
