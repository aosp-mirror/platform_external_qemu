...
$(foreach prebuilt_dll,$(LOCAL_PREBUILT_DLLS),$(eval $(call install-stripped-binary,$(PREBUILT_DLLS_DIR)/$(prebuilt_dll),$(OBJS_DIR)/$(prebuilt_dll),--strip-unneeded)))
$(foreach prebuilt_dll,$(LOCAL_PREBUILT_DLLS_SYMLINKS),$(eval $(call install-symlink,$(PREBUILT_DLLS_DIR)/$(prebuilt_dll),$(OBJS_DIR)/$(prebuilt_dll))))
LOCAL_GENERATE_SYMBOLS := true
$(foreach prebuilt_dll,$(LOCAL_PREBUILT_DLLS),$(eval $(call install-symbol,$(PREBUILT_DLLS_DIR)/$(prebuilt_dll))))
