...
QEMU2_BUILD_DIR=$OUT_DIR/build-qemu2
echo "QEMU2_BUILD_DIR := $QEMU2_BUILD_DIR" >> $config_mk
...
log "Configuring QEMU2 building"
$PROGDIR/android/scripts/configure-qemu2.sh $QEMU2_BUILD_DIR
