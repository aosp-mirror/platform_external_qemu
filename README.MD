...
The emulator uses a [coding style](android/docs/ANDROID-CODING-STYLE.MD)  derived from [Chromium style](https://chromium.googlesource.com/chromium/src/+/master/styleguide/c++/c++.md).
...
Next you should try to build qemu standalone:
    ...
    ./android/scripts/build-qemu-android.sh  --verbose --verbose --build-dir=$HOME/qemu-build  &&
