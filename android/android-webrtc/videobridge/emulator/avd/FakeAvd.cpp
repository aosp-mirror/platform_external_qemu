...
#include "aemu/base/Log.h"                                 // for LogStre...
#include "aemu/base/StringFormat.h"                        // for StringF...

#include "aemu/base/files/PathUtils.h"                     // for pj, Pat...
...
bool FakeAvd::create() {
    ...
    std::ofstream iniFile(PathUtils::asUnicodePath(ini.data()).c_str());
    ...
    std::ofstream pidFile(PathUtils::asUnicodePath(pidFilename.data()).c_str());
