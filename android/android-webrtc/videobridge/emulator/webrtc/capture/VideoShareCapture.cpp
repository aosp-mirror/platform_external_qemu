...
bool VideoShareCapture::CaptureProcess() {
    ...
    // Sleep up to mMaxFrameDelayUs, as we don't want to
    // slam the encoder.
...
int32_t VideoShareCapture::StartCapture(
    ...
    // That is the underlying shared memory region gets updated
    // at least at the given framerate.
...
static size_t getBytesPerFrame(const VideoCaptureCapability& capability) {
    // A frame will be delivered in the I420 format.
