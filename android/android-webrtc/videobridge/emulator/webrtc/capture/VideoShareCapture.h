...
// This class is responsible for delivering frames at the right
// interval to the webrtc engine.
//
// The frames are obtained from a SharedMemory region that contains
// the current emulator "image" in the
// (I420)[https://wiki.videolan.org/YUV/#I420] format. The emulator should
// deliver frames at a rate equal to higher than the capture engine.
...
private:
    ...
    const int kI420BitsPerPixel = 12;
