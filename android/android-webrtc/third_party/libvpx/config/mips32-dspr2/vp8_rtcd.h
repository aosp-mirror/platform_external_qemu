...
void vp8_copy_mem16x16_dspr2(unsigned char *src, int src_stride, unsigned char *dst, int dst_stride);
...
void vp8_copy_mem8x4_dspr2(unsigned char *src, int src_stride, unsigned char *dst, int dst_stride);
...
void vp8_copy_mem8x8_dspr2(unsigned char *src, int src_stride, unsigned char *dst, int dst_stride);
...
void vp8_dequant_idct_add_dspr2(short *input, short *dq, unsigned char *dest, int stride);
...
void vp8_loop_filter_bh_dspr2(unsigned char *y_ptr, unsigned char *u_ptr, unsigned char *v_ptr, int y_stride, int uv_stride, struct loop_filter_info *lfi);
...
void vp8_loop_filter_bv_dspr2(unsigned char *y_ptr, unsigned char *u_ptr, unsigned char *v_ptr, int y_stride, int uv_stride, struct loop_filter_info *lfi);
...
void vp8_loop_filter_mbh_dspr2(unsigned char *y_ptr, unsigned char *u_ptr, unsigned char *v_ptr, int y_stride, int uv_stride, struct loop_filter_info *lfi);
...
void vp8_loop_filter_mbv_dspr2(unsigned char *y_ptr, unsigned char *u_ptr, unsigned char *v_ptr, int y_stride, int uv_stride, struct loop_filter_info *lfi);
...
void vp8_short_idct4x4llm_dspr2(short *input, unsigned char *pred_ptr, int pred_stride, unsigned char *dst_ptr, int dst_stride);
...
void vp8_sixtap_predict16x16_dspr2(unsigned char *src_ptr, int src_pixels_per_line, int xoffset, int yoffset, unsigned char *dst_ptr, int dst_pitch);
...
void vp8_sixtap_predict4x4_dspr2(unsigned char *src_ptr, int src_pixels_per_line, int xoffset, int yoffset, unsigned char *dst_ptr, int dst_pitch);
...
void vp8_sixtap_predict8x4_dspr2(unsigned char *src_ptr, int src_pixels_per_line, int xoffset, int yoffset, unsigned char *dst_ptr, int dst_pitch);
...
void vp8_sixtap_predict8x8_dspr2(unsigned char *src_ptr, int src_pixels_per_line, int xoffset, int yoffset, unsigned char *dst_ptr, int dst_pitch);
