...
// will pre-allocate a fixed amount of memory that cannot be changed once allocated
// and stores it in a circular buffer. The producer will write into the
// oldest slot, and the consumer will read the oldest data inserted into
// the queue.
//
