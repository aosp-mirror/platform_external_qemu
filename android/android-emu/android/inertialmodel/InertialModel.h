 ...
 *
 * An target position and rotation should be set via user input (such as
 * UI controls, mouse, keyboard, etc...) - using setTargetPosition and
 * setTargetRotation.  The various getXXXX() calls should be regularly polled
 * at the desired sensor rate, with the output values used as simulated
 * sensor values.
 */
class InertialModel {
public:
