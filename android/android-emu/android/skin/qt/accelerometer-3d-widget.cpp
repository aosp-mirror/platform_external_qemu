...
bool Accelerometer3DWidget::vecNearEqual(glm::vec3 lhs, glm::vec3 rhs) {
    return glm::all(glm::epsilonEqual(lhs, rhs, kEpsilon));
}

bool Accelerometer3DWidget::quaternionNearEqual(glm::quat lhs, glm::quat rhs) {
    return glm::all(glm::epsilonEqual(lhs, rhs, kEpsilon)) ||
           glm::all(glm::epsilonEqual(lhs, -rhs, kEpsilon));
}
