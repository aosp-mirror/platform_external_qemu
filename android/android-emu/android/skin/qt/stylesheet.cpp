...
struct StylesheetValues {
    ...
    QHash<QString, QString> studioLightValues = {
        ...
        {TAB_BKG_COLOR_VAR,                 "#FFFFFF"},  // Background of major tabs
        {TAB_SELECTED_COLOR_VAR,            "#DAE4ED"},  // Background of the selected major tab
        {"TAB_DARKENED_COLOR",              "#FFFFFF"},
...
private:
    bool initializeStylesheets() {
        ...
        //initialize extra themes only for embedded emulator.
