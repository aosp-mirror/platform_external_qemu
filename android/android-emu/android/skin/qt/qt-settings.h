...
enum SAVE_SNAPSHOT_ON_EXIT_PREFERENCE_VALUE {
    SAVE_SNAPSHOT_ON_EXIT_PREFERENCE_ASK = 0,
    SAVE_SNAPSHOT_ON_EXIT_PREFERENCE_ALWAYS = 1,
    SAVE_SNAPSHOT_ON_EXIT_PREFERENCE_NEVER = 2
};

enum SAVE_SNAPSHOT_ON_EXIT_VALUE {
    SAVE_SNAPSHOT_ON_EXIT_ALWAYS = 0,
    SAVE_SNAPSHOT_ON_EXIT_NEVER = 1,
    SAVE_SNAPSHOT_ON_EXIT_ASK = 2
};
