...
class Accelerometer3DWidget : public GLWidget {
    ...
    Q_PROPERTY(glm::mat4 targetRotation READ targetRotation WRITE setTargetRotation NOTIFY targetRotationChanged USER true);
...
public slots:
    ...
    void setTargetRotation(const glm::mat4& rotation) {
...
public:
    ...
    const glm::mat4& targetRotation() const { return mTargetRotation; }
...
private:
    ...
    glm::mat4 mTargetRotation = glm::mat4();
