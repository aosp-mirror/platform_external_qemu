...
VirtualSceneControlWindow::VirtualSceneControlWindow(
    ...
    : QFrame(emulatorWindow->containerWindow()), mEmulatorWindow(emulatorWindow),mToolWindow(toolWindow), mSizeTweaker(this),
