...
void GooglePlayPage::playStoreVersionDone(GooglePlayServices::Result result,
    ...
    switch (result) {
        ...
        case GooglePlayServices::Result::kAppNotInstalled:
            msg =
                    tr("It doesn't look like you have the play store<br/>"
                       "installed.");
            break;
        case GooglePlayServices::Result::kOperationInProgress:
            msg =
                    tr("Still waiting for play store version.<br/>"
                       "Please try again later.");
            break;
        default:
            msg =
    ...
    showErrorDialog(msg, tr("Play Store Version"));
}
...
void GooglePlayPage::playServicesVersionDone(GooglePlayServices::Result result,
    ...
    switch (result) {
        ...
        case GooglePlayServices::Result::kAppNotInstalled:
            msg =
                    tr("It doesn't look like you have play services<br/>"
                       "installed.");
            break;
        case GooglePlayServices::Result::kOperationInProgress:
            msg =
                    tr("Still waiting for play services version.<br/>"
                       "Please try again later.");
            break;
        default:
            msg =
    ...
    showErrorDialog(msg, tr("Play Services Version"));
}
