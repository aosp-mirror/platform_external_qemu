...
#define PAGE_TO_DESC(x, y) \
    { GooglePlayPage::PlayPages::x, qApp->translate("PlayPages", y) }
// static
const std::pair<GooglePlayPage::PlayPages, QString>
...
#define APP_TO_DESC(x, y) \
    { GooglePlayPage::PlayApps::x, qApp->translate("PlayApps", y) }
// static
const std::pair<GooglePlayPage::PlayApps, QString>
