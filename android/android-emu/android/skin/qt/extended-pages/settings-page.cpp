...
void SettingsPage::on_set_saveSnapNowButton_clicked() {
    ...
    android::base::async([]{
        fprintf(stderr, "%s: create looper\n", __func__);
        android::base::Looper* looper = (android::base::Looper*)(android_getMainLooper());
        auto timer = looper->createTimer([](void* opaque, android::base::Looper::Timer*)  {
                     fprintf(stderr, "%s: sav\n", __func__);
