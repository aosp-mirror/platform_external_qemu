...
#include "android/skin/qt/visual-metrics-widget.h"
#include "ui_visual-metrics-page.h"
...
void VisualMetricsPage::on_playStopButton_pressed() {
    if (mInFlight) {
        disableCollection();
    } else {
        enableCollection();
...
void VisualMetricsPage::enableCollection() {
    ...
    mUi->visualMetricsWidget->onCollectionEnabled(x, y);
}
