...
private:
    ...
    void playPageDone(android::emulation::GooglePlayServices::Result result,
                      PlayPages page);
    QString getPlayAppDescription(PlayApps app);
    QString getPlayPageDescription(PlayPages page);
...
private:
    static const std::pair<PlayApps, QString> PlayAppToDesc[];
    static const std::pair<PlayPages, QString> PlayPageToDesc[];
