    ...
    mUi(new Ui::LocationPage)
{
    ...
    if(!webChannelJsFile.open(QIODevice::ReadOnly)) {
        ...
        mWebPage.reset(new QWebEnginePage(QWebEngineProfile::defaultProfile(), mUi->webEngineView));
        mUi->webEngineView->setPage(mWebPage.get());
        mWebPage->scripts().insert(script);
	    ...
	    // setup the channel
	    mWebChannel.reset(new QWebChannel(mWebPage.get()));
	    ...
	    mUi->webEngineView->page()->load(QUrl("qrc:/html/index.html"));
    }
}
