    ...
    mUi(new Ui::SnapshotPage())
{
    ...
    // Queue the confirm signal so the base window is populated and raised
    // before the pop-up shows.
    QObject::connect(this, SIGNAL(confirmAutosaveChoiceAndRestart(Ui::Settings::SaveSnapshotOnExit, Ui::Settings::SaveSnapshotOnExit)),
                     this, SLOT(slot_confirmAutosaveChoiceAndRestart(Ui::Settings::SaveSnapshotOnExit, Ui::Settings::SaveSnapshotOnExit)),
                     Qt::QueuedConnection);
    sInstance = this;
}
