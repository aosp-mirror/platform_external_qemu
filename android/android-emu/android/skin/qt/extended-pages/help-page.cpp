...
static const char SEND_FEEDBACK_URL[] =
    "https://issuetracker.google.com/issues/new?component=192727&description=%s&&template=872501";
...
void HelpPage::on_help_sendFeedback_clicked() {
    std::string encodedArgs =
            Uri::FormatEncodeArguments(SEND_FEEDBACK_URL, mBugreportInfo.dump() + FEATURE_REQUEST_TEMPLATE);
