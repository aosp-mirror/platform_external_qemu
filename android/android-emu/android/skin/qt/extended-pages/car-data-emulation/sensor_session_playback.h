...
class SensorSessionPlayback {
    public:
        ...
        enum SensorSessionStatus { FAILED_PRECONDITION, OK, FAIL, PROTO_PARSE_OK, PROTO_PARSE_FAIL};
        ...
        // util::Clock here is used to track the start timeand sleep, let's replace with qtimer
        ...
        // playback is running.
        SensorSessionStatus LoadFrom(QString filename);
