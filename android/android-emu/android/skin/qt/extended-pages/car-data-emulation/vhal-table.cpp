...
void VhalTable::showPropertyDescription(VehiclePropValue val) {
    ...
    setLabel(mUi->property_name_value, label);
    setLabel(mUi->area_value, area);
    setLabel(mUi->property_id_value, id);
    setLabel(mUi->value_value, value);
    setLabel(mUi->editable_value, propDesc.writable
...
void VhalTable::setLabel(QLabel *label, QString text) {
