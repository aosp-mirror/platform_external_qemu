...
map<int32_t, PropertyDescription> carpropertyutils::propMap = {
        ...
        {289472775,
         {QObject::tr("Usable connectors (EV)"), true, &evConnectorTypeMap}},
        ...
        {356517121,
         {QObject::tr("Fan direction"), true, &fanDirectionMap,
        ...
        {356517131,
         {QObject::tr("Seat healing/cooling"), true, nullptr,
          heatingCoolingToString}},
        {339739916, {QObject::tr("Side mirror heat"), false}},
        {289408269,
         {QObject::tr("Steering wheel heating/cooling"), true, nullptr,
          heatingCoolingToString}},
        {289408270,
         {QObject::tr("User display temperature units"), true, &tempUnitsMap}},
        {356517135, {QObject::tr("Actual fan speed"), false}},
        {354419984, {QObject::tr("Global power state"), false}},
        {356582673,
         {QObject::tr("Available fan positions"), true, &fanDirectionMap,
          fanDirectionToString}},
        {354419986, {QObject::tr("Automatic recirculation on"), true}},
        {356517139,
         {QObject::tr("Seat ventilation"), true, nullptr,
          heatingCoolingToString}},
        {291505923, {QObject::tr("Outside temperature (°C)"), false}},
        {289475072,
         {QObject::tr("App processor power state control"), false, nullptr,
          nullptr, apPowerStateReqToString}},
        {289475073,
         {QObject::tr("App processor power state report"), false, nullptr,
        ...
        {289410561,
         {QObject::tr("High beam lights state"), true, &lightStateMap}},
        ...
        {289410577,
         {QObject::tr("High beam lights switch"), true, &lightSwitchMap}},
        {289410578, {QObject::tr("Fog lights switch"), true, &lightSwitchMap}},
        {289410579,
         {QObject::tr("Hazard lights switch"), true, &lightSwitchMap}}};
