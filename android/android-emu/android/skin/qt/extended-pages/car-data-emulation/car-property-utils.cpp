...
map<int32_t, PropertyDescription> carpropertyutils::propMap = {
    ...
    { 356517121, { QObject::tr("Fan direction"), nullptr, fanDirectionToString } },
    ...
    { 356517131, { QObject::tr("Seat healing/cooling"),
            nullptr, heatingCoolingToString } },
    { 339739916, { QObject::tr("Side mirror heat") } },
    { 289408269, { QObject::tr("Steering wheel heating/cooling"), nullptr, heatingCoolingToString } },
    ...
    { 356582673, { QObject::tr("Available fan positions"), nullptr, fanDirectionToString } },
...
QString carpropertyutils::getAreaString(VehiclePropValue val) {
    ...
    if (prop.lookupTable != nullptr) {
        QString details = carpropertyutils::multiDetailToString(*(prop.lookupTable), val.area_id());
        if (details != "") {
            area += ": " + details;
        }
    }
...
QString carpropertyutils::heatingCoolingToString(int val) {
    ...
    return behavior + " (" + QString::number(val) + ")";
}
