...
CheckboxDialog::CheckboxDialog(QWidget *parent, std::map<int32_t, QString> *lookupTable, QSet<QString> *checkedTitleSet, 
                        const QString &label)
    :QDialog (parent)
{
    ...
    checkboxDialogLayout->addWidget(mLabel, 0,0);
    int loc = 0;
