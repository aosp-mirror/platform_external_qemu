...
private:
    ...
    void sendDrivingStatusChangeMsg(const int status, const std::string& statusName);
    void sendIgnitionChangeMsg(const int ignition, const std::string& ignitionName);
