...
public:
    ...
    void setSendEmulatorMsg(const function<void(const EmulatorMessage msg, const string log)>&);
...
private:
    ...
    function<void(const EmulatorMessage msg, const string log)> sendEmulatorMsg = nullptr;
