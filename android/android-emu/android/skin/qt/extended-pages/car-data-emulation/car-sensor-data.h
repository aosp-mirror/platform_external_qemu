...
private:
    ...
    void sendGearChangeMsg(int gear, std::string& gearName);
    void sendDrivingStatusChangeMsg(int status, std::string& statusName);
    void sendIgnitionChangeMsg(int ignition, std::string& ignitionName);
