...
void SensorReplayPage::updatePanel(SensorSessionPlayback* sensorSessionPlayback,
    ...
    QString elidedText = metrics.elidedText(PreviewText, Qt::ElideRight,
    ...
    sensorSessionPlayback->getSensorRecordTimeLine(&recordCounts,
                                                   TIMELINE_INTERVAL);
...
// Set playback callback, then ask
