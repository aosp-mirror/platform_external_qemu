...
public:
    ...
    //
    // TODO(zyy): allow nonblocking calls to these signals by having the signal
    // take ownership of object pointers. This would allow QEMU to do things
    // like update the screen without blocking, which would make it run faster.
