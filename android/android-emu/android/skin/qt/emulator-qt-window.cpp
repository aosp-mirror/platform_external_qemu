...
EmulatorQtWindow::EmulatorQtWindow(QWidget* parent)
    ...
    QObject::connect(this, &EmulatorQtWindow::showMessageWithCustomDismiss, this,
                     &EmulatorQtWindow::slot_showMessageWithCustomDismiss);
...
void EmulatorQtWindow::slot_showMessageWithCustomDismiss(QString text,
                                                         Ui::OverlayMessageIcon icon,
                                                         QString dismissText,
                                                         RunOnUiThreadFunc func,
                                                         int timeoutMs) {
    auto msg = mContainer.messageCenter().addMessage(text, icon, timeoutMs);
    msg->setCustomDismiss(dismissText, std::move(func));
}
