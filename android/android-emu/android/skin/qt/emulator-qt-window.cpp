...
void EmulatorQtWindow::resizeAndChangeAspectRatio(int changeType) {
    ...
    switch (changeType) {
        default:
        case 0:  // Half width
            windowGeo.setWidth(windowGeo.width() / 2);
            backingSize.setWidth(backingSize.width() / 2);
            displayXOffset = -backingSize.width() / 2;
            break;
        case 1:  // Double width (restore)
            windowGeo.setWidth(windowGeo.width()  * 2);
            backingSize.setWidth(backingSize.width() * 2);
            break;
        case 2:  // 3/4 height
            ...
            displayYOffset = -backingSize.height() / 6;
            break;
        case 3:  // 4/3 height (restore)
