...
EmulatorQtWindow::EmulatorQtWindow(QWidget* parent)
    ...
    // initialize bug report after AdbInterface and ScreemCapturer is created
    void* adbOpaque = (void*)getAdbInterface();
    void* screencapOpaque = (void*)getScreenCapturer();
    bugReportInit(adbOpaque, screencapOpaque);
}
