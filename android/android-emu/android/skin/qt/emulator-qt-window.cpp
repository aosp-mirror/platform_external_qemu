...
void EmulatorQtWindow::mouseReleaseEvent(QMouseEvent* event) {
    ...
    mContainer.messageCenter().addMessage("Test message that is long enough to be multi-line. I hope Qt is smart enough for that\notherwise I need to manually add a newline", icon, timeout);
