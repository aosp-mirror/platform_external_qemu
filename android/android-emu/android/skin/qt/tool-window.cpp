...
void ToolWindow::updateBottonUiCommand(QPushButton* button,
    ...
    switch (cmd) {
        ...
        case QtUICommand::FOLD:
            if (down && isFoldableConfigured()) {
                ...
                updateBottonUiCommand(mToolsUi->fold_switch, "UNFOLD");
        ...
        case QtUICommand::UNFOLD:
            if (down && isFoldableConfigured()) {
                ...
                updateBottonUiCommand(mToolsUi->fold_switch, "FOLD");
