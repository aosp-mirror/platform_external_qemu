            ...
            if (ev->message == WM_KEYDOWN || ev->message == WM_SYSKEYDOWN) {
                ...
                if (android::featurecontrol::isEnabled(
                    ...
                    if (EmulatorQtWindow::getInstance()->isActiveWindow()) {
                        ...
                        // event. Then, translate the scancode to virtual
                        // keycode by assuming the keyboard layout is
                        // English-US. Therefore, emulated keyboard in Android
                        // system will receive consistent Linux keycode no
                        // matter what keyboard layout is used on host OS. Bug:
                        // 140523177
