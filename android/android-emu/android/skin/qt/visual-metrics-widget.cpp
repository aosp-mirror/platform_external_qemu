...
VisualMetricsWidget::VisualMetricsWidget(QWidget* parent) : GLWidget(parent) {
...
static void onFrameAvailableCallback(int frame, uint64_t timeStamp) {
    FrameDataPoint pt;
    pt.timeInterval = 0;
...
void VisualMetricsWidget::onCollectionEnabled(int x, int y) {
#ifdef __APPLE__
    startDisplayStream(x, y, &onFrameAvailableCallback);
#endif
