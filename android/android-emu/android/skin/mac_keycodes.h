#pragma once
// Copied from Carbon.framework/Versions/A/Frameworks/HIToolbox.framework/Versions/A/Headers/Event.h
...
enum {
  ...
  kMacOSRightShiftKeyBit              = 13,   /* right shift key down? Not supported on Mac OS X.*/
  kMacOSRightOptionKeyBit             = 14,   /* right Option key down? Not supported on Mac OS X.*/
  kMacOSRightControlKeyBit            = 15    /* right Control key down? Not supported on Mac OS X.*/
};
...
enum {
  ...
  kMacOSRightShiftKey                 = 1 << kMacOSRightShiftKeyBit, /* Not supported on Mac OS X.*/
  kMacOSRightOptionKey                = 1 << kMacOSRightOptionKeyBit, /* Not supported on Mac OS X.*/
  kMacOSRightControlKey               = 1 << kMacOSRightControlKeyBit /* Not supported on Mac OS X.*/
};
