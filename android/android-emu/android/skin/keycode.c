...
int32_t skin_native_to_linux_keycode(int32_t scancode) {
    ...
    // X11 scan code ranges from 8 to 255 with small gaps in between
    static const struct {
        int scancode;
        int linuxKeyCode;  
    } kTbl[] = {
    ...
        {  20, LINUX_KEY_MINUS }, //minus underscore equal percent backslash dead_diaeresis
        {  21, LINUX_KEY_EQUAL }, //equal plus dead_acute dead_caron dead_macron dead_cedilla
    ...
        {  34, LINUX_KEY_LEFTBRACE }, //bracketleft braceleft uacute slash bracketleft braceleft
        {  35, LINUX_KEY_RIGHTBRACE }, //bracketright braceright parenright parenleft bracketright braceright
    ...
        {  47, LINUX_KEY_SEMICOLON }, //semicolon colon uring quotedbl semicolon colon
        {  48, LINUX_KEY_APOSTROPHE }, //apostrophe quotedbl section exclam apostrophe ssharp
        {  49, LINUX_KEY_GREEN }, //grave asciitilde semicolon dead_abovering grave asciitilde 
    ...
        {  61, LINUX_KEY_SLASH }, //slash question minus underscore asterisk dead_abovedot
        {  62, LINUX_KEY_RIGHTSHIFT }, //Shift_R NoSymbol Shift_R
        {  63, LINUX_KEY_KPASTERISK }, //KP_Multiply KP_Multiply KP_Multiply KP_Multiply KP_Multiply KP_Multiply XF86ClearGrab KP_Multiply KP_Multiply XF86ClearGrab
        {  64, LINUX_KEY_LEFTALT }, //Alt_L Meta_L Alt_L Meta_L
        {  65, LINUX_KEY_SPACE }, //space NoSymbol space space space space
        {  66, LINUX_KEY_CAPSLOCK }, //Caps_Lock ISO_Next_Group Caps_Lock ISO_Next_Group
        {  67, LINUX_KEY_F1 }, //F1 F1 F1 F1 F1 F1 XF86Switch_VT_1 F1 F1 XF86Switch_VT_1
        {  68, LINUX_KEY_F2 }, //F2 F2 F2 F2 F2 F2 XF86Switch_VT_2 F2 F2 XF86Switch_VT_2
        {  69, LINUX_KEY_F3 }, //F3 F3 F3 F3 F3 F3 XF86Switch_VT_3 F3 F3 XF86Switch_VT_3
        {  70, LINUX_KEY_F4 }, //F4 F4 F4 F4 F4 F4 XF86Switch_VT_4 F4 F4 XF86Switch_VT_4
        {  71, LINUX_KEY_F5 }, //F5 F5 F5 F5 F5 F5 XF86Switch_VT_5 F5 F5 XF86Switch_VT_5
        {  72, LINUX_KEY_F6 }, //F6 F6 F6 F6 F6 F6 XF86Switch_VT_6 F6 F6 XF86Switch_VT_6
        {  73, LINUX_KEY_F7 }, //F7 F7 F7 F7 F7 F7 XF86Switch_VT_7 F7 F7 XF86Switch_VT_7
        {  74, LINUX_KEY_F8 }, //F8 F8 F8 F8 F8 F8 XF86Switch_VT_8 F8 F8 XF86Switch_VT_8
        {  75, LINUX_KEY_F9 }, //F9 F9 F9 F9 F9 F9 XF86Switch_VT_9 F9 F9 XF86Switch_VT_9
        {  76, LINUX_KEY_F10 }, //F10 F10 F10 F10 F10 F10 XF86Switch_VT_10 F10 F10 XF86Switch_VT_10
        {  77, LINUX_KEY_NUMLOCK }, //Num_Lock NoSymbol Num_Lock
        {  78, LINUX_KEY_SCROLLLOCK }, //Scroll_Lock NoSymbol Scroll_Lock
    ...
        {  82, LINUX_KEY_KPMINUS }, //KP_Subtract KP_Subtract KP_Subtract KP_Subtract KP_Subtract KP_Subtract XF86Prev_VMode KP_Subtract KP_Subtract XF86Prev_VMode
    ...
        {  86, LINUX_KEY_KPPLUS }, //KP_Add KP_Add KP_Add KP_Add KP_Add KP_Add XF86Next_VMode KP_Add KP_Add XF86Next_VMode
    ...
        {  92, LINUX_KEY_RIGHTALT }, //ISO_Level3_Shift NoSymbol ISO_Level3_Shift
        {  94, LINUX_KEY_KPPLUSMINUS }, //less greater backslash bar bar brokenbar slash
        {  95, LINUX_KEY_F11 }, //F11 F11 F11 F11 F11 F11 XF86Switch_VT_11 F11 F11 XF86Switch_VT_11
        {  96, LINUX_KEY_F12 }, //F12 F12 F12 F12 F12 F12 XF86Switch_VT_12 F12 F12 XF86Switch_VT_12
        {  98, LINUX_KEY_KATAKANA }, //Katakana NoSymbol Katakana
        {  99, LINUX_KEY_HIRAGANA }, //Hiragana NoSymbol Hiragana
        { 100, LINUX_KEY_HENKAN }, //Henkan_Mode NoSymbol Henkan_Mode
        { 101, LINUX_KEY_HIRAGANA }, //Hiragana_Katakana NoSymbol Hiragana_Katakana
    ...
        { 106, LINUX_KEY_KPSLASH }, //KP_Divide KP_Divide KP_Divide KP_Divide KP_Divide KP_Divide XF86Ungrab KP_Divide KP_Divide XF86Ungrab
        { 107, LINUX_KEY_PRINT }, //Print Sys_Req Print Sys_Req
        { 108, LINUX_KEY_RIGHTALT }, //Alt_R Meta_R ISO_Level3_Shift
        { 109, LINUX_KEY_LINEFEED }, //Linefeed NoSymbol Linefeed
        { 110, LINUX_KEY_HOME }, //Home NoSymbol Home
        { 111, LINUX_KEY_UP }, //Up NoSymbol Up
        { 112, LINUX_KEY_PAGEUP }, //Prior NoSymbol Prior
    ...
        { 117, LINUX_KEY_PAGEDOWN }, //Next NoSymbol Next
        { 118, LINUX_KEY_INSERT }, //Insert NoSymbol Insert
        { 119, LINUX_KEY_DELETE }, //Delete NoSymbol Delete
        { 121, LINUX_KEY_MUTE }, //XF86AudioMute NoSymbol XF86AudioMute
        { 122, LINUX_KEY_VOLUMEDOWN }, //XF86AudioLowerVolume NoSymbol XF86AudioLowerVolume
        { 123, LINUX_KEY_VOLUMEUP }, //XF86AudioRaiseVolume NoSymbol XF86AudioRaiseVolume
    ...
        { 127, LINUX_KEY_PAUSE }, //Pause Break Pause Break
        //  { 128, LINUX_KEY_ }, //XF86LaunchA NoSymbol XF86LaunchA
        { 129, LINUX_KEY_KPDOT }, //KP_Decimal KP_Decimal KP_Decimal KP_Decimal
        { 130, LINUX_KEY_HANGEUL }, //Hangul NoSymbol Hangul
        { 131, LINUX_KEY_HANJA }, //Hangul_Hanja NoSymbol Hangul_Hanja
        { 133, LINUX_KEY_LEFTMETA }, //Super_L NoSymbol Super_L
        { 134, LINUX_KEY_RIGHTMETA }, //Super_R NoSymbol Super_R
        { 135, LINUX_KEY_MENU }, //Menu NoSymbol Menu
        { 136, LINUX_KEY_CANCEL }, //Cancel NoSymbol Cancel
        { 137, LINUX_KEY_REDO }, //Redo NoSymbol Redo
        { 138, LINUX_KEY_PROPS }, //SunProps NoSymbol SunProps
        { 139, LINUX_KEY_UNDO }, //Undo NoSymbol Undo
        { 140, LINUX_KEY_FRONT }, //SunFront NoSymbol SunFront
        { 141, LINUX_KEY_COPY }, //XF86Copy NoSymbol XF86Copy
        { 142, LINUX_KEY_OPEN }, //XF86Open NoSymbol XF86Open
        { 143, LINUX_KEY_PASTE }, //XF86Paste NoSymbol XF86Paste
        { 144, LINUX_KEY_FIND }, //Find NoSymbol Find
        { 145, LINUX_KEY_CUT }, //XF86Cut NoSymbol XF86Cut
        { 146, LINUX_KEY_HELP }, //Help NoSymbol Help
        { 147, LINUX_KEY_MENU }, //XF86MenuKB NoSymbol XF86MenuKB
        { 148, LINUX_KEY_CALC }, //XF86Calculator NoSymbol XF86Calculator
        { 150, LINUX_KEY_SLEEP }, //XF86Sleep NoSymbol XF86Sleep
        { 151, LINUX_KEY_WAKEUP }, //XF86WakeUp NoSymbol XF86WakeUp
        //  { 152, LINUX_KEY_ }, //XF86Explorer NoSymbol XF86Explorer
        { 153, LINUX_KEY_SEND }, //XF86Send NoSymbol XF86Send
        { 155, LINUX_KEY_XFER }, //XF86Xfer NoSymbol XF86Xfer
        { 156, LINUX_KEY_PROG1 }, //XF86Launch1 NoSymbol XF86Launch1
        { 157, LINUX_KEY_PROG2 }, //XF86Launch2 NoSymbol XF86Launch2
        { 158, LINUX_KEY_WWW }, //XF86WWW NoSymbol XF86WWW
        { 159, LINUX_KEY_MSDOS }, //XF86DOS NoSymbol XF86DOS
        //  { 160, LINUX_KEY_ }, //XF86ScreenSaver NoSymbol XF86ScreenSaver
        //  { 161, LINUX_KEY_ }, //XF86RotateWindows NoSymbol XF86RotateWindows
        //  { 162, LINUX_KEY_ }, //XF86TaskPane NoSymbol XF86TaskPane
        { 163, LINUX_KEY_MAIL }, //XF86Mail NoSymbol XF86Mail
        { 164, LINUX_KEY_BOOKMARKS }, //XF86Favorites NoSymbol XF86Favorites
        { 165, LINUX_KEY_COMPUTER }, //XF86MyComputer NoSymbol XF86MyComputer
        { 166, LINUX_KEY_BACK }, //XF86Back NoSymbol XF86Back
        { 167, LINUX_KEY_FORWARD }, //XF86Forward NoSymbol XF86Forward
        { 169, LINUX_KEY_EJECTCD }, //XF86Eject NoSymbol XF86Eject
        { 170, LINUX_KEY_EJECTCLOSECD }, //XF86Eject XF86Eject XF86Eject XF86Eject
        { 171, LINUX_KEY_NEXTSONG }, //XF86AudioNext NoSymbol XF86AudioNext
        { 172, LINUX_KEY_PLAYPAUSE }, //XF86AudioPlay XF86AudioPause XF86AudioPlay XF86AudioPause
        { 173, LINUX_KEY_PREVIOUSSONG }, //XF86AudioPrev NoSymbol XF86AudioPrev
        { 174, LINUX_KEY_STOPCD }, //XF86AudioStop XF86Eject XF86AudioStop XF86Eject
    ...
        { 177, LINUX_KEY_PHONE }, //XF86Phone NoSymbol XF86Phone
        //  { 179, LINUX_KEY_ }, //XF86Tools NoSymbol XF86Tools
        { 180, LINUX_KEY_HOMEPAGE }, //XF86HomePage NoSymbol XF86HomePage
        { 181, LINUX_KEY_REFRESH }, //XF86Reload NoSymbol XF86Reload
        { 182, LINUX_KEY_EXIT }, //XF86Close NoSymbol XF86Close
        { 185, LINUX_KEY_SCROLLUP }, //XF86ScrollUp NoSymbol XF86ScrollUp
        { 186, LINUX_KEY_SCROLLDOWN }, //XF86ScrollDown NoSymbol XF86ScrollDown
        { 187, LINUX_KEY_KPLEFTPAREN }, //parenleft NoSymbol parenleft
        { 188, LINUX_KEY_KPRIGHTPAREN }, //parenright NoSymbol parenright
        { 189, LINUX_KEY_NEW }, //XF86New NoSymbol XF86New
        { 190, LINUX_KEY_REDO }, //Redo NoSymbol Redo
        //  { 191, LINUX_KEY_ }, //XF86Tools NoSymbol XF86Tools
        //  { 192, LINUX_KEY_ }, //XF86Launch5 NoSymbol XF86Launch5
        //  { 193, LINUX_KEY_ }, //XF86Launch6 NoSymbol XF86Launch6
        //  { 194, LINUX_KEY_ }, //XF86Launch7 NoSymbol XF86Launch7
        //  { 195, LINUX_KEY_ }, //XF86Launch8 NoSymbol XF86Launch8
        //  { 196, LINUX_KEY_ }, //XF86Launch9 NoSymbol XF86Launch9
        { 198, LINUX_KEY_MUTE }, //XF86AudioMicMute NoSymbol XF86AudioMicMute
        //  { 199, LINUX_KEY_ }, //XF86TouchpadToggle NoSymbol XF86TouchpadToggle
        //  { 200, LINUX_KEY_ }, //XF86TouchpadOn NoSymbol XF86TouchpadOn
        //  { 201, LINUX_KEY_ }, //XF86TouchpadOff NoSymbol XF86TouchpadOff
        //  { 203, LINUX_KEY_ }, //Mode_switch NoSymbol Mode_switch
        { 204, LINUX_KEY_LEFTALT }, //NoSymbol Alt_L NoSymbol Alt_L
        { 205, LINUX_KEY_LEFTMETA }, //NoSymbol Meta_L NoSymbol Meta_L
        //  { 206, LINUX_KEY_ }, //NoSymbol Super_L NoSymbol Super_L
        //  { 207, LINUX_KEY_ }, //NoSymbol Hyper_L NoSymbol Hyper_L
        { 208, LINUX_KEY_PLAYCD }, //XF86AudioPlay NoSymbol XF86AudioPlay
        { 209, LINUX_KEY_PAUSECD }, //XF86AudioPause NoSymbol XF86AudioPause
        { 210, LINUX_KEY_PROG3 }, //XF86Launch3 NoSymbol XF86Launch3
        { 211, LINUX_KEY_PROG4 }, //XF86Launch4 NoSymbol XF86Launch4
        //   { 212, LINUX_KEY_ }, //XF86LaunchB NoSymbol XF86LaunchB
        { 213, LINUX_KEY_SUSPEND }, //XF86Suspend NoSymbol XF86Suspend
        { 214, LINUX_KEY_CLOSE }, //XF86Close NoSymbol XF86Close
        { 215, LINUX_KEY_PLAY }, //XF86AudioPlay NoSymbol XF86AudioPlay
        { 216, LINUX_KEY_FASTFORWARD }, //XF86AudioForward NoSymbol XF86AudioForward
        { 218, LINUX_KEY_PRINT }, //Print NoSymbol Print
        { 220, LINUX_KEY_CAMERA }, //XF86WebCam NoSymbol XF86WebCam
        { 223, LINUX_KEY_EMAIL }, //XF86Mail NoSymbol XF86Mail
        { 224, LINUX_KEY_CHAT }, //XF86Messenger NoSymbol XF86Messenger
        { 225, LINUX_KEY_SEARCH }, //XF86Search NoSymbol XF86Search
        { 226, LINUX_KEY_CONNECT }, //XF86Go NoSymbol XF86Go
        { 227, LINUX_KEY_FINANCE }, //XF86Finance NoSymbol XF86Finance
        { 228, LINUX_KEY_SPORT }, //XF86Game NoSymbol XF86Game
        { 229, LINUX_KEY_SHOP }, //XF86Shop NoSymbol XF86Shop
        { 231, LINUX_KEY_CANCEL }, //Cancel NoSymbol Cancel
        { 232, LINUX_KEY_BRIGHTNESSDOWN }, //XF86MonBrightnessDown NoSymbol XF86MonBrightnessDown
        { 233, LINUX_KEY_BRIGHTNESSUP }, //XF86MonBrightnessUp NoSymbol XF86MonBrightnessUp
        { 234, LINUX_KEY_MEDIA }, //XF86AudioMedia NoSymbol XF86AudioMedia
        { 235, LINUX_KEY_SWITCHVIDEOMODE }, //XF86Display NoSymbol XF86Display
        { 236, LINUX_KEY_KBDILLUMTOGGLE }, //XF86KbdLightOnOff NoSymbol XF86KbdLightOnOff
        { 237, LINUX_KEY_KBDILLUMDOWN }, //XF86KbdBrightnessDown NoSymbol XF86KbdBrightnessDown
        { 238, LINUX_KEY_KBDILLUMUP }, //XF86KbdBrightnessUp NoSymbol XF86KbdBrightnessUp
        { 239, LINUX_KEY_SEND }, //XF86Send NoSymbol XF86Send
        { 240, LINUX_KEY_REPLY }, //XF86Reply NoSymbol XF86Reply
        { 241, LINUX_KEY_FORWARDMAIL }, //XF86MailForward NoSymbol XF86MailForward
        { 242, LINUX_KEY_SAVE }, //XF86Save NoSymbol XF86Save
        { 243, LINUX_KEY_DOCUMENTS }, //XF86Documents NoSymbol XF86Documents
        { 244, LINUX_KEY_BATTERY }, //XF86Battery NoSymbol XF86Battery
        //{ 245, LINUX_KEY_ }, //XF86Bluetooth NoSymbol XF86Bluetooth
        //{ 246, LINUX_KEY_ }, //XF86WLAN NoSymbol XF86WLAN
    };
    ...
    static const struct {
        ...
        { kMacOS_VK_F17, LINUX_KEY_F17 },
        { kMacOS_VK_VolumeUp, LINUX_KEY_VOLUMEUP },
        { kMacOS_VK_VolumeDown, LINUX_KEY_VOLUMEDOWN },
        { kMacOS_VK_Mute, LINUX_KEY_MUTE },
        { kMacOS_VK_F18, LINUX_KEY_F18 },
        { kMacOS_VK_F19, LINUX_KEY_F19 },
        { kMacOS_VK_F20, LINUX_KEY_F20 },
        { kMacOS_VK_F5, LINUX_KEY_F5 },
        { kMacOS_VK_F6, LINUX_KEY_F6 },
        { kMacOS_VK_F7, LINUX_KEY_F7 },
        { kMacOS_VK_F3, LINUX_KEY_F3 },
        { kMacOS_VK_F8, LINUX_KEY_F8 },
        { kMacOS_VK_F9, LINUX_KEY_F9 },
        { kMacOS_VK_F11, LINUX_KEY_F11 },
        { kMacOS_VK_F13, LINUX_KEY_F13 },
        { kMacOS_VK_F16, LINUX_KEY_F16 },
        { kMacOS_VK_F14, LINUX_KEY_F14 },
        { kMacOS_VK_F10, LINUX_KEY_F10 },
        { kMacOS_VK_F12, LINUX_KEY_F12 },
        { kMacOS_VK_F15, LINUX_KEY_F15 },
        { kMacOS_VK_Help, LINUX_KEY_HELP },
        { kMacOS_VK_Home, LINUX_KEY_HOME },
        { kMacOS_VK_PageUp, LINUX_KEY_PAGEUP },
//        { kMacOS_VK_ForwardDelete, LINUX_KEY_UNKNOWN },
        { kMacOS_VK_F4, LINUX_KEY_F4 },
        //{ kMacOS_VK_End          , LINUX_KEY_UNKNOWN },
        { kMacOS_VK_F2, LINUX_KEY_F2 },
        { kMacOS_VK_PageDown, LINUX_KEY_PAGEDOWN },
        { kMacOS_VK_F1, LINUX_KEY_F1 },
        ...
        { kMacOS_VK_JIS_Yen, LINUX_KEY_YEN },
        //{ kMacOS_VK_JIS_Underscore, LINUX_KEY_UNKNOWN},
        { kMacOS_VK_JIS_KeypadComma, LINUX_KEY_KPJPCOMMA },
        //{ kMacOS_VK_JIS_Eisu, LINUX_KEY_UNKNOWN},
        { kMacOS_VK_JIS_Kana, LINUX_KEY_KATAKANA },
    };
#else
    return -1;
#endif
