...
#include "android/recording/codecs/audio/VorbisCodecHelper.h"
...
VorbisCodecHelper::VorbisCodecHelper(CodecParams&& p,
                                     AVSampleFormat inSampleFmt)
    : CodecHelper(AV_CODEC_ID_VORBIS, std::move(p)),
...
bool VorbisCodecHelper::configAndOpenEncoder(const AVFormatContext* oc,
...
bool VorbisCodecHelper::initSwxContext(const AVCodecContext* c,
