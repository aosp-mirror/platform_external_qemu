...
// VorbisCodecHelper.h
//
// Helper to configure Vorbis encoder
//
...
class VorbisCodecHelper : public CodecHelper<SwrContext> {
public:
    explicit VorbisCodecHelper(CodecParams&& params,
                               AVSampleFormat inSampleFmt);
    virtual ~VorbisCodecHelper();
