...
//    recorder->addVideoTrack(std::move(videoProducer), myVideoCodecHelper);
//    // audio is optional
//    recorder->addAudioTrack(std::move(audioProducer), myAudioCodecHelper);
//
//    // Start the recording
//    recorder->start();
//
...
public:
    ...
    //              producer.
    //   codecHelper - The codec helper used to create the audio codec and
    //   resampling
    //                 contexts.
    // returns:
    //   true if the audio track was successfully added, false otherwise.
    virtual bool addAudioTrack(Producer* producer,
                               const CodecHelper<SwrContext>* codecHelper) = 0;
    ...
    //              producer.
    //   codecHelper - The codec helper used to create the video codec and
    //   rescaling
    //                 contexts.
    // returns:
    //   true if the video track was successfully added, false otherwise.
    virtual bool addVideoTrack(Producer* producer,
                               const CodecHelper<SwsContext*>* codecHelper) = 0;
