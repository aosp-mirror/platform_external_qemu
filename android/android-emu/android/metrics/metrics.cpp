...
bool android_metrics_start(const char* emulatorVersion,
    ...
    sGlobalData->emulatorName = android::base::StringFormat("emulator-%d", controlConsolePort);
...
{    
    android::emulation::AdbInterface *adb = (android::emulation::AdbInterface *)adbInterface;
