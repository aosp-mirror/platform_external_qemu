...
void PerfStatReporter::fillProto(
        android_studio::EmulatorPerformanceStats* perfStatProto) {
...
static void fillProtoMemUsage(
    ...
    D("MemoryReport: uptime: %" PRIu64
      ...
      stats_out->process_uptime_us(), rawMemUsage.resident,
      rawMemUsage.resident_max, rawMemUsage.virt, rawMemUsage.virt_max);
}
...
static void fillProtoCpuUsage(
    ...
    cpu->forEachUsage(CpuUsage::UsageArea::Vcpu,
