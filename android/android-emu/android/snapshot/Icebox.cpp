...
#define _RECV_PACKET(packet)           \
...

    {
        ...
        to_guest.mesg = {
                ...
                0,                                // arg0
                256 * 1024,                       // arg1
                (unsigned)strlen(kCnxnData) + 1,  // data_length
                0,                                // data_check
                ADB_CNXN ^ 0xffffffff,            // magic
        };
        ...
        while (pack_recv.mesg.command == ADB_AUTH) {
            ...
            pack_send.mesg = {
                    ADB_AUTH,               // command
                    ADB_AUTH_SIGNATURE,     // arg0
                    0,                      // arg1
                    (unsigned)sigLen,       // data_length
                    0,                      // data_check
                    ADB_AUTH ^ 0xffffffff,  // magic
            };
    ...
    {                                                  \
    ...
    }
        {
            ...
            connect.mesg = {
                    ...
                    local_id,                        // arg0
                    0,                               // arg1
                    (unsigned)cmd_str.length() + 1,  // data_length
                    0,                               // data_check
                    ADB_OPEN ^ 0xffffffff,           // magic
            };
