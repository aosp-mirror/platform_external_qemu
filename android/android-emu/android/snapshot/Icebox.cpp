...
#define _RECV_PACKET_OK(packet) \
    ...
    std::vector<uint64_t> exception_reference_type_ids(0);
    {
        ...
        jdwp_query.command_set = VirtualMachineCommand::IDSizes;
    ...
    while (1) {
        ...
        if (reply.mesg.data_length > 11 &&
            ...
            JdwpCommandHeader jdwp_command = {
                    11, jdwp_id++, 0, CommandSet::VirtualMachine, VirtualMachineCommand::Resume,
            };
            jdwp_command.length = 11;
            jdwp_command.flags = 0;
            jdwp_command.command_set = CommandSet::VirtualMachine;
            jdwp_command.command = VirtualMachineCommand::Resume;
