...
public:
    ...
    bool fillPage(bool loadedAlready,
        ...
        //
        // Here are the important access patterns arising from these 
        // and what happens to host memory protection:
        //
        // First , Second (and subsequent) -> host protect flags, guest protect flags, mark dirty?
        //
        // Guest (read), Guest (read) -> r/e, no
