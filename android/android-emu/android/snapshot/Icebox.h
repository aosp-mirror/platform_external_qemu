...
extern bool track(int pid, const std::string snapshot_name, bool skip_snapshot);
extern bool run_async(const std::string cmd);
extern bool track_async(int pid, const std::string snapshot_name, bool skip_snapshot);
