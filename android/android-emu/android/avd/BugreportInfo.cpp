...
BugreportInfo::BugreportInfo(){
    ...
    androidStduioVer = studioVersion.isValid() ? studioVersion.toString() : "Unknown";
...
AVD Details: %s
)", androidStduioVer, emulatorVer, hypervisorVer, sdkToolsVer, hostOsName, cpuModel, totalMem,
            gpuListInfo, buildFingerprint,
            avdDetails);
}
}
}
