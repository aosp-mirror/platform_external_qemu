...
void avdInfo_replaceMultiDisplayInConfigIni(AvdInfo* i, int index,
    ...
    char x_s[] = "hw_display0_xOffset";
    char y_s[] = "hw_display0_yOffset";
    char w_s[] = "hw_display0_width";
    char h_s[] = "hw_display0_height";
    char d_s[] = "hw_display0_density";
    char f_s[] = "hw_display0_flag";
    bool write = false;
