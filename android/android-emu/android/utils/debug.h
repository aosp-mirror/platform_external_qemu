...
#define VERBOSE_TAG_LIST                                                       \
    ...
    _VERBOSE_TAG(audio_producer, "audio producer for screen recording")        \
    _VERBOSE_TAG(video_producer, "video producer for screen recording")        \
    _VERBOSE_TAG(ffmpeg_audio, "ffmpeg audio encoding")                        \
    _VERBOSE_TAG(ffmpeg_video, "ffmpeg video encoding")
