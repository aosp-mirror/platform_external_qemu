...
typedef void (*address_space_device_register_deallocation_callback)(void* context, uint64_t gpa, address_space_device_deallocation_callback_t);
...
struct address_space_device_control_ops {
    ...
    address_space_device_register_deallocation_callback register_deallocation_callback;
