...
private:
    ...
    void saveVectorToStream(const DataBuffer & input, base::Stream* stream);

    void loadVectorFromStream(base::Stream* stream, DataBuffer* output);
    ...
    DataBuffer mSendLengthBuffer;
    DataBuffer mSendPayloadBuffer;
    DataBuffer mRecvLengthBuffer;
