...
//    android::AndroidPipe::Service::add(new android::AndroidMessagePipe::Service("MyXYZService",
...
public:
    ...
    AndroidMessagePipe(void* hwPipe, Service* service, DecodeAndExecuteFunction cb,
