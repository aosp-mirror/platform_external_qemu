...
void media_vtb_utils_nv12_updater(void* privData,
    ...
    int uv=0;
    typedef void* ai[3];
    void* (*array)[3] = (void*(*)[3])callerData;

    void* nscontext = array[0];
    auto nsConvertVideoFrameToNV12Textures = (nsConvertVideoFrameToNV12TexturesFun)array[1];
    auto nsCopyTexture = (nsCopyTextureFun)array[2];
