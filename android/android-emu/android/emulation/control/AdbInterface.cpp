...
// Compares two adb versions.
static bool versionCompare(const std::pair<std::string, Optional<int>> l,
                           const std::pair<std::string, Optional<int>> r) {
