...
public:
    ...
    void setAdbInterface(AdbInterface* adb);
    ...
    static bool parseOutputForVersion(std::ifstream& output,
                                      std::string* outErrorString);

private:
    static const android::base::System::Duration kTimeoutMs;
    static const std::string kPlayStorePkgName;
    static const std::string kPlayServicesPkgName;
