...
// Tests using AdbInterface with a dedicated thread with its own looper.
//
TEST_F(AdbInterfaceTest, AsyncThreadWithLooper) {
    android::base::AsyncThreadWithLooper asyncThread;
