...
// Adb authentication, this comes from Icebox.cpp
// TODO(jansene): Clean this up.
extern bool sign_auth_token(const char* token,
                            int token_size,
                            char* sig,
                            int& siglen);
...
private:
    ...
    uint32_t mProtocolVersion{A_VERSION};
};
