...
static_assert(QEMU_SHUTDOWN_CAUSE_NONE == SHUTDOWN_CAUSE_NONE, SHUTDOWN_CAUSE_STATIC_ASSERT_ERROR_MESSAGE); \
static_assert(QEMU_SHUTDOWN_CAUSE_HOST_ERROR == SHUTDOWN_CAUSE_HOST_ERROR, SHUTDOWN_CAUSE_STATIC_ASSERT_ERROR_MESSAGE); \
static_assert(QEMU_SHUTDOWN_CAUSE_HOST_QMP == SHUTDOWN_CAUSE_HOST_QMP, SHUTDOWN_CAUSE_STATIC_ASSERT_ERROR_MESSAGE); \
static_assert(QEMU_SHUTDOWN_CAUSE_HOST_SIGNAL == SHUTDOWN_CAUSE_HOST_SIGNAL, SHUTDOWN_CAUSE_STATIC_ASSERT_ERROR_MESSAGE); \
static_assert(QEMU_SHUTDOWN_CAUSE_HOST_UI == SHUTDOWN_CAUSE_HOST_UI, SHUTDOWN_CAUSE_STATIC_ASSERT_ERROR_MESSAGE); \
static_assert(QEMU_SHUTDOWN_CAUSE_GUEST_SHUTDOWN == SHUTDOWN_CAUSE_GUEST_SHUTDOWN, SHUTDOWN_CAUSE_STATIC_ASSERT_ERROR_MESSAGE); \
static_assert(QEMU_SHUTDOWN_CAUSE_GUEST_RESET == SHUTDOWN_CAUSE_GUEST_RESET, SHUTDOWN_CAUSE_STATIC_ASSERT_ERROR_MESSAGE); \
static_assert(QEMU_SHUTDOWN_CAUSE_GUEST_PANIC == SHUTDOWN_CAUSE_GUEST_PANIC, SHUTDOWN_CAUSE_STATIC_ASSERT_ERROR_MESSAGE); \
static_assert(QEMU_SHUTDOWN_CAUSE__MAX == SHUTDOWN_CAUSE__MAX, SHUTDOWN_CAUSE_STATIC_ASSERT_ERROR_MESSAGE); \
