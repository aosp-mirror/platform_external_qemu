...
#if MEDIA_H264_DEBUG
#define H264_DPRINT(fmt,...) fprintf(stderr, "h264-cuvid-dec: %s:%d " fmt "\n", __func__, __LINE__, ##__VA_ARGS__);
#else
...
void MediaH264DecoderCuvid::decodeFrame(void* ptr, const uint8_t* frame, size_t szBytes, uint64_t pts) {
...
int MediaH264DecoderCuvid::HandlePictureDisplay(CUVIDPARSERDISPINFO *pDispInfo) {
    ...
    mOutputPts = pDispInfo->timestamp;
