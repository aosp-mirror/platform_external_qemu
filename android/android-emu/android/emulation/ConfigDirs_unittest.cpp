...
TEST(ConfigDirs, getAvdRootDirectory) {
    ...
    sys.envSet("ANDROID_SDK_HOME", "Area_1");
    sys.envSet("USER_HOME", "Area_2");
    sys.envSet("ANDROID_EMULATOR_HOME", "Area_3/.android");
    EXPECT_STREQ("Area_1" SLASH ".android" SLASH "avd", ConfigDirs::getAvdRootDirectory().c_str());
    ...
    EXPECT_STREQ("Area_3/.android" SLASH "avd", ConfigDirs::getAvdRootDirectory().c_str());
}
