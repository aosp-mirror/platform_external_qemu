...
// A parser for Hevc ping info from guest. It will know where to extract
// the specified data.
...
public:
    explicit HevcPingInfoParser(void* ptr);
    HevcPingInfoParser(uint32_t version);
    ~HevcPingInfoParser() = default;
