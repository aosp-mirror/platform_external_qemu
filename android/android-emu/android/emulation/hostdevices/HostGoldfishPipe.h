...
public:
    ...
    InternalPipe* getHostPipe(const HostHwPipe* hwpipe) const;
...
//    void saveSnapshot1(base::Stream* stream, void* hwpipe);
...
private:
    ...
    void resetPipe(HostHwPipe* hwpipe, InternalPipe* internal_pipe);
