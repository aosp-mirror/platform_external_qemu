...
public:
    ...
    void pingWithData(uint32_t handle, AddressSpaceDevicePingWithDataInfo* pingInfo) {
        AutoLock lock(mLock);
        auto& entry = mEntries[handle];
        memcpy(entry.pingInfo, pingInfo, sizeof(AddressSpaceDevicePingWithDataInfo));
        memcpy(
            ((uint8_t*)entry.pingInfo) + offsetof(AddressSpaceDevicePingWithDataInfo, data),
            ((uint8_t*)pingInfo) + offsetof(AddressSpaceDevicePingWithDataInfo, data),
        ...
        lock.lock();
        memcpy(pingInfo, entry.pingInfo, sizeof(AddressSpaceDevicePingWithDataInfo));
    }
...
void HostAddressSpaceDevice::pingWithData(uint32_t handle, AddressSpaceDevicePingWithDataInfo* pingInfo) {
