...
private:
    ...
    uint64_t createId();
    void addDecoder(uint64_t key, MediaH264DecoderDefaultImpl* val); // this just add
    void updateDecoder(uint64_t key, MediaH264DecoderDefaultImpl* val); // this will overwrite
