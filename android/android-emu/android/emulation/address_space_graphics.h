...
public:
    ...
    static const int kWriteBufferSize;
    static const int kWriteStepSize;
    static const int kBackingSize;

    static const int kToHostRingInfoOffset;
    static const int kFromHostRingInfoOffset;
    static const int kToHostTransferRingInfoOffset;

    static const int kToHostRingBufferOffset;
    static const int kFromHostRingBufferOffset;
    static const int kToHostTransferRingBufferOffset;

    static const int kWriteBufferOffset;
    ...
    using ConsumerCreateCallback2 =
        std::function<void* (struct ring_buffer_with_view,
                             struct ring_buffer_with_view,
                             struct ring_buffer_with_view,
                             OnUnavailableReadCallback,
                             GetPtrAndSizeCallback)>;
    ...
    enum Command {
        ...
        CreateConsumer = 9,
        DestroyConsumer = 10,
        SetAndCreateOpenglConsumer = 11,
        CreateConsumer2 = 12,
        SetAndCreateOpenglConsumer2 = 13,
    };
    ...
    void setConsumer2(
        ConsumerCreateCallback2 createFunc,
        ConsumerDestroyCallback destroyFunc);
...
private:
    ...
    void getPtrAndSize(uint64_t, char**, size_t*);

    char* mBuffer = 0;
    size_t mReadPos = 0;
    std::vector<char> mReadBuffer;

    uint32_t mWriteBufferSize = 4 * 1048576;
    uint32_t mWriteStepSize = 4096;
    ...
    ConsumerCreateCallback2 mConsumerCreateFunc2;
