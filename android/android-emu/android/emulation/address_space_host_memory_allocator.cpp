...
void AddressSpaceHostMemoryAllocatorContext::save(android::qemu::QemuFileStream *stream) const {
...
bool AddressSpaceHostMemoryAllocatorContext::load(android::qemu::QemuFileStream *stream) {
