...
public:
    ...
    public:
        ...
        void recycleSocket(android::base::ScopedSocketWatch&& socket);
        void registerForRecycle(int socket);
        void hostCloseSocket(android::base::ScopedSocketWatch&& socket);
        bool reclaimSocket(int fd);
    private:
        ...
        std::unordered_map<int, android::base::ScopedSocket>
            mRecycledSockets;
    };
...
private:
    ...
    public:
        BufferedSocketReader() = default;
        ~BufferedSocketReader() = default;
        void drainSocket(int socket, bool appendToBuffer);
        bool hasData() const;
