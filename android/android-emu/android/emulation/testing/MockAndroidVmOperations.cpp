...
static const QAndroidVmOperations sQAndroidVmOperations = {
        .snapshotSave = [](const char* name,
            ...
            return android::MockAndroidVmOperations::get().snapshotSave(
                    name, opaque, errConsumer);
        },
        .snapshotLoad = [](const char* name,
                           void* opaque,
                           LineConsumerCallback errConsumer) -> bool {
            return android::MockAndroidVmOperations::get().snapshotLoad(
                    name, opaque, errConsumer);
        },
};
...
MockAndroidVmOperations& MockAndroidVmOperations::get() {
    static base::LazyInstance<MockAndroidVmOperations> sInstance;
