...
public:
    ...
    public:
        ...
        // Connect for a particular pipe instance.
        virtual int connect(void* pipe, const char* name) = 0;

        // Get hw-side pipe for a particular pipe instance.
        virtual void* getHwSidePipe(void* pipe) = 0;
