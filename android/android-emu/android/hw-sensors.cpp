...
static void _hwSensorClient_recv(void* opaque,
                                 ...
                                 int msglen,
                                 QemudClient* client) {
    HwSensorClient* cl = reinterpret_cast<HwSensorClient*>(opaque);
...
static void _hwSensorClient_save(Stream* f, QemudClient* client, void* opaque) {
    HwSensorClient* sc = reinterpret_cast<HwSensorClient*>(opaque);
...
static QemudClient* _hwSensors_connect(void* opaque,
    ...
    HwSensors* sensors = reinterpret_cast<HwSensors*>(opaque);
...
static void _hwSensors_save(Stream* f, QemudService* sv, void* opaque) {
    HwSensors* h = reinterpret_cast<HwSensors*>(opaque);
