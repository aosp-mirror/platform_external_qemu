...
static int android_foldable_get_hinge_posture(int hingeIndex, int degree) {
...
void android_foldable_set_with_1d_parameter(float t) {
    ...
    uint32_t old_device_posture = android_foldable_get_hinge_posture(0,
                                      (int)_foldableState->currentHingeDegrees[0]);
    ...
    uint32_t device_posture = android_foldable_get_hinge_posture(0,
                                  (int)_foldableState->currentHingeDegrees[0]);
    if (device_posture != old_device_posture) {
        printf("send posture %d\n", device_posture);
