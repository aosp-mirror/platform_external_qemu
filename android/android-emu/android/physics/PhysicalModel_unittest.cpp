...
TEST(PhysicalModel, NewMeasurementId) {
    ...
    physicalModel_setTargetPosition(model, targetPosition, false);
...
TEST(PhysicalModel, SetTargetPosition) {
    ...
    targetPosition.y = 3.0f;
    targetPosition.z = 4.0f;
    physicalModel_setTargetPosition(model, targetPosition, true);
...
TEST(PhysicalModel, SetTargetRotation) {
    ...
    physicalModel_setTargetRotation(model, targetRotation, true);
...
TEST(PhysicalModel, GravityAcceleration) {
    ...
    for (const auto& testCase : gravityTestCases) {
        ...
        physicalModel_setTargetRotation(model, targetRotation, false);
...
TEST(PhysicalModel, NonInstantaneousRotation) {
    ...
    startRotation.y = 0.f;
    startRotation.z = 0.f;
    physicalModel_setTargetRotation(model, startRotation, true);
    ...
    newRotation.y = 0.0f;
    newRotation.z = 0.0f;
    physicalModel_setTargetRotation(model, newRotation, false);
...
TEST(PhysicalModel, InstantaneousRotation) {
    ...
    newRotation.y = 0.0f;
    newRotation.z = 0.0f;
    physicalModel_setTargetRotation(model, newRotation, true);
