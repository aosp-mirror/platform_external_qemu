...
public:
     ...
     */
    void setGravity(glm::vec3 gravity, bool instantaneous);

    /*
     * Sets the ambient temperature.
     */
    void setTemperature(float celsius, bool instantaneous);

    /*
     * Sets the target proximity value.
     */
    void setProximity(float centimeters, bool instantaneous);

    /*
     * Sets the target ambient light value.
     */
    void setLight(float lux, bool instantaneous);

    /*
     * Sets the target barometric pressure value.
     */
    void setPressure(float hPa, bool instantaneous);

    /*
     * Sets the target humidity value.
     */
    void setHumidity(float percent, bool instantaneous);
