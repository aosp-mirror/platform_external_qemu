...
struct vec3 physicalModel_getTargetPosition(struct PhysicalModel* model);
struct vec3 physicalModel_getTargetRotation(struct PhysicalModel* model);
struct vec3 physicalModel_getTargetMagneticField(struct PhysicalModel* model);
float physicalModel_getTargetTemperature(struct PhysicalModel* model);
float physicalModel_getTargetProximity(struct PhysicalModel* model);
float physicalModel_getTargetLight(struct PhysicalModel* model);
float physicalModel_getTargetPressure(struct PhysicalModel* model);
float physicalModel_getTargetHumidity(struct PhysicalModel* model);
