...
private:
    ...
    glm::vec3 calculateInertialState(
            ...
            const glm::vec3 accelPhaseQuarticScale = glm::vec3(),
            const glm::vec3 decelPhaseQuarticScale = glm::vec3()) const;
    ...
    glm::mat4x3 mAccelPhasePositionTransform = glm::mat4x3(0.f);
    glm::vec3 mAccelPhasePositionQuarticScale = glm::vec3();
    glm::mat4x3 mAccelPhaseVelocityTransform = glm::mat4x3(0.f);
    glm::mat4x3 mAccelPhaseAccelerationTransform = glm::mat4x3(0.f);
    glm::mat4x3 mDecelPhasePositionTransform = glm::mat4x3(0.f);
    glm::vec3 mDecelPhasePositionQuarticScale = glm::vec3();
    glm::mat4x3 mDecelPhaseVelocityTransform = glm::mat4x3(0.f);
    glm::mat4x3 mDecelPhaseAccelerationTransform = glm::mat4x3(0.f);
