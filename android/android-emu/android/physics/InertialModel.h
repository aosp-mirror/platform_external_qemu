...
// Ambient motion frequency of 5hz.  This is applied directly in the x axis and
// scaled by 1 / sqrt(2) and 1 / sqrt(3) in y and z axis respectively.
const float kAmbientFrequency = 5.f;
