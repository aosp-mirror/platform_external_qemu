...
private:
    ...
    //       target.
    int64_t mPositionChangeStartTime = 0UL;
    ...
    int64_t mPositionChangeEndTime = 0UL;
    ...
    int64_t mRotationChangeStartTime = 0UL;
    ...
    int64_t mRotationChangeEndTime = 0UL;

    /* The time to use as current in this model */
    int64_t mModelTimeNs = 0UL;
};
