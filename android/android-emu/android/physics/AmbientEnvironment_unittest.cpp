...
TEST(AmbientEnvironment, SetMagneticField) {
    ...
    mTestSystem.setUnixTime(1);
    AmbientEnvironment ambientEnvironment;
    ambientEnvironment.setMagneticField(8.f, 11.f, 20.f, true);
...
TEST(AmbientEnvironment, SetGravity) {
    ...
    mTestSystem.setUnixTime(1);
    AmbientEnvironment ambientEnvironment;
    ambientEnvironment.setGravity(glm::vec3(0.f, 1.f, 2.f), true);
...
TEST(AmbientEnvironment, SetTemperature) {
    ...
    mTestSystem.setUnixTime(1);
    AmbientEnvironment ambientEnvironment;
    ambientEnvironment.setTemperature(27.f, true);
...
TEST(AmbientEnvironment, SetProximity) {
    ...
    mTestSystem.setUnixTime(1);
    AmbientEnvironment ambientEnvironment;
    ambientEnvironment.setProximity(8.f, true);
...
TEST(AmbientEnvironment, SetLight) {
    ...
    mTestSystem.setUnixTime(1);
    AmbientEnvironment ambientEnvironment;
    ambientEnvironment.setLight(187.f, true);
...
TEST(AmbientEnvironment, SetPressure) {
    ...
    mTestSystem.setUnixTime(1);
    AmbientEnvironment ambientEnvironment;
    ambientEnvironment.setPressure(823.f, true);
...
TEST(AmbientEnvironment, SetHumidity) {
    ...
    mTestSystem.setUnixTime(1);
    AmbientEnvironment ambientEnvironment;
    ambientEnvironment.setHumidity(0.67f, true);
