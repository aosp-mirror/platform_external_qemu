...
auserConfig_new( AvdInfo* info, SkinRect* monitorRect, int screenWidth, int screenHeight )
{
    ...
    if (ini != NULL) {
        ...
        if (iniFile_hasKey(ini, KEY_EXTENDED_CONTROLS_X)) {
            ...
            uc->extendedControlsX = iniFile_getInteger(ini, KEY_EXTENDED_CONTROLS_X, 0);
            DD("    found %s = %d\n", KEY_EXTENDED_CONTROLS_X, uc->extendedControlsX);
        }

        if (iniFile_hasKey(ini, KEY_EXTENDED_CONTROLS_Y)) {
            uc->hasExtendedControlPos = 1;
            uc->extendedControlsY = iniFile_getInteger(ini, KEY_EXTENDED_CONTROLS_Y, 0);
            DD("    found %s = %d", KEY_EXTENDED_CONTROLS_Y, uc->extendedControlsY);
        }
...
int
auserConfig_getExtendedControlsPos( AUserConfig*  uconfig, int  *pX, int  *pY ) {
...
int
auserConfig_setExtendedControlsPos( AUserConfig*  uconfig, int  x, int  y ) {
...
auserConfig_save( AUserConfig*  uconfig )
{
    ...
    if (uconfig->hasExtendedControlPos) {
        iniFile_setInteger(ini, KEY_EXTENDED_CONTROLS_X, uconfig->extendedControlsX);
        iniFile_setInteger(ini, KEY_EXTENDED_CONTROLS_Y, uconfig->extendedControlsY);
    }
