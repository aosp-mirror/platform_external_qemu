...
TEST(StructuredInfo, testEncode) {
    ...
    // TODO: Set up file-based tests
    // si.reloadFromFile("/Users/lfy/Downloads/structured-info.proto-8cd7a16450000000.proto");
}

TEST(StructuredInfo, testAddUptime) {
    StructuredInfo* siptr = StructuredInfo::get();
    EXPECT_TRUE(siptr);
