        ...
        case GenerateKeypair:
            {
                ...
                D("%s: key generation done, key blob length %u\n",
                        __FUNCTION__, keyBlobLength);
        ...
        case SignData:
            {
                ...
                D("%s: %d signing data\n", __FUNCTION__, __LINE__);
                D("%s: %d keyParamsLen %u\n", __FUNCTION__, __LINE__, keyParamsLen);
                ...
                data += keyParamsLen;
                uint32_t keyBlobLen = unpack<uint32_t>(&data);
                D("%s: %d signing data data blob len %d\n", __FUNCTION__, __LINE__,
                        (int)keyBlobLen);
                const uint8_t* keyBlob = (uint8_t*)data;
                data += keyBlobLen;
                D("%s: %d signing data\n", __FUNCTION__, __LINE__);
                ...
                D("%s: %d signing data raw data len %u\n", __FUNCTION__, __LINE__, rawDataLen);
                data += rawDataLen;
                // output parameters
