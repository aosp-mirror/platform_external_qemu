...
TEST(LayoutResolver, twoIdenticalDisplays) {
    ...
    const std::pair<testDisplayInput, testDisplayOutput> kData[] = {
    	std::make_pair(testDisplayInput{0, 1080, 1960}, testDisplayOutput{0, 0, 0}),
    	std::make_pair(testDisplayInput{1, 1080, 1960}, testDisplayOutput{1, 1080, 0})
    };
...
TEST(LayoutResolver, FourDifferentDisplays) {
    ...
    const std::pair<testDisplayInput, testDisplayOutput> kData[] = {
    	std::make_pair(testDisplayInput{0, 1080, 1960}, testDisplayOutput{0, 0, 0}),
    	std::make_pair(testDisplayInput{1, 1080, 1860}, testDisplayOutput{1, 0, 1960}), 
    	std::make_pair(testDisplayInput{2, 1200, 1300}, testDisplayOutput{2, 1080, 0}),
    	std::make_pair(testDisplayInput{3, 1200, 1400}, testDisplayOutput{3, 1080, 1960})
    };
    const size_t kDataSize = ARRAY_SIZE(kData);
    const double kMonitorAspectRatio = 16.0 / 9.0;
    std::unordered_map<uint32_t, std::pair<uint32_t, uint32_t>> displays;
