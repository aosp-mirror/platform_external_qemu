...
TEST(ComponentManager, IterateAll) {
    ...
    m.forEachComponent(
        [&count](bool live,
                 BasicComponentManger::ComponentHandle componentHandle,
...
TEST(ComponentManager, ReverseMapping) {
    ...
    auto componentHandle1 =
        m.add((BasicComponentManger::EntityHandle)handle1,
              3, 1, true /* tracked */);
    auto componentHandle2 =
        m.add((BasicComponentManger::EntityHandle)handle2,
              4, 1, true /* tracked */);
    auto componentHandle3 =
        m.add((BasicComponentManger::EntityHandle)handle3,
              5, 1, false /* tracked */);
