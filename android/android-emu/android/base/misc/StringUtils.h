...
// Iterates over a string's parts using |splitBy| as a delimiter.  If |splitBy|
// doesn't occur, no-op. |splitBy| must be a nonempty string as well, or also
// no-op. Otherwise, |func| is called on each of the splits, excluding the
