...
int pipeCreate(int* readPipe, int* writePipe);
...
ssize_t pipeRead(int pipe, void* buffer, size_t bufferLen);
...
ssize_t pipeWrite(int pipe, const void* buffer, size_t bufferLen);
