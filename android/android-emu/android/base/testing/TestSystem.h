...
// can be used by UnitTests. Instatiation on of this class will result in:
//
// - The creation of a temporary directory that will be used to interact with the
//   filesystem. This temporary directory is deleted in the destructor.
// - Tempory replacement of the System singleton with this version, the
//   prevous setting will be restored in the destructor of this object
//
...
public:
    TestSystem(StringView launcherDir,
        ...
        : mProgramDir(launcherDir),
          ...
          mUnixTime(),
          mPid() {
            mTempRootPrefix = PathUtils::addTrailingDirSeparator(mTempDir.path());
          }
