...
public:
    ...
    // or the error code. Calling this with the oflag O_CREAT
    // will result in claiming ownership of the shared memory region.
    // When this object goes out of scope, the shared resource will be
    // marked for cleanup
