...
public:
    ...
    size_t find(const StringView& other, size_t off = 0) {
        // Trivial case
    ...
    // getSubstr(); returns a StringView of |other| at the first place
    // it occurs, otherwise, a blank string.
    StringView getSubstr(const StringView& other, size_t off = 0) {
        ...
        return { mString + loc, other.mSize };
    }
