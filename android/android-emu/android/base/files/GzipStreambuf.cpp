...
GzipInputFileStreambuf::GzipInputFileStreambuf(const char* fileName, std::size_t chunk)
        : mCapacity(chunk) {
...
std::streampos GzipInputFileStreambuf::seekoff(std::streamoff off, std::ios_base::seekdir way,
