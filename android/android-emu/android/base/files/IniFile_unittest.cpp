...
TEST_F(IniFileTest, diskSizeFormat) {
    ...
    EXPECT_EQ(99ULL, mIni->getDiskSize("WrongUnit", 99ULL));
    EXPECT_EQ(99ULL, mIni->getDiskSize("FractionalNumber", 99ULL));
    EXPECT_EQ(99ULL, mIni->getDiskSize("FractionalKilo", 99ULL));
    EXPECT_EQ(99ULL, mIni->getDiskSize("smiley_really", 99ULL));
}
