...
TEST_F(IniFileTest, duplicateAndMissingKeys) {
    ...
    EXPECT_EQ(1LL, mIni->getDiskSize("ds", 99ULL));
    ...
    EXPECT_EQ(44LL, mIni->getDiskSize("missing", 44LL));
}
...
TEST_F(IniFileTest, diskSizeFormat) {
    ...
    ASSERT_TRUE(mIni->read());
    EXPECT_EQ(lines.size(), static_cast<size_t>(mIni->size()));
    EXPECT_EQ(30LL, mIni->getDiskSize("ThirtyB", 99));
    EXPECT_EQ(1024LL, mIni->getDiskSize("OneKilo", 99));
    EXPECT_EQ(1024 * 1024LL, mIni->getDiskSize("OneMega", 99));
    EXPECT_EQ(1024 * 1024 * 1024LL, mIni->getDiskSize("OneGiga", 99));
    EXPECT_EQ(5 * 1024LL, mIni->getDiskSize("FiveKilo", 99));
    EXPECT_EQ(5 * 1024 * 1024LL, mIni->getDiskSize("FiveMega", 99));
    EXPECT_EQ(5 * 1024 * 1024 * 1024LL, mIni->getDiskSize("FiveGiga", 99));

    EXPECT_EQ(99LL, mIni->getDiskSize("WrongUnit", 99));
    EXPECT_EQ(99LL, mIni->getDiskSize("FractionalNumber", 99));
    EXPECT_EQ(99LL, mIni->getDiskSize("FractionalKilo", 99));
    EXPECT_EQ(99LL, mIni->getDiskSize("smiley_really", 99));
}
...
TEST_F(IniFileTest, strDefaultValues) {
    ...
    EXPECT_EQ(1024LL, mIni->getDiskSize("missingKey", "1k"));
}
