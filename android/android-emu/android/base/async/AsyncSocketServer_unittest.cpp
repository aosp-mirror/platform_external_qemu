...
#include <functional>                          // for __bind, bind, __base, _1
...
#include "android/base/sockets/SocketUtils.h"  // for socketClose, socketSend
#include "gtest/gtest_pred_impl.h"             // for EXPECT_EQ, Test, Asser...
