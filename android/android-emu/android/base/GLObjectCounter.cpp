...
public:
    ...
    std::vector<size_t> getCounts() {
        return {mCounter.mVertexBuffer.load(),
                mCounter.mTexture.load(),
                mCounter.mRenderBuffer.load(),
                mCounter.mFrameBuffer.load(),
                mCounter.mShaderOrProgram.load(),
                mCounter.mSampler.load(),
                mCounter.mQuery.load(),
                mCounter.mVertexArrayObject.load(),
                mCounter.mTransformFeedback.load()};
    }
