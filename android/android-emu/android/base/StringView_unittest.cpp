...
TEST(StringView, GetSubstr) {
    ...
    EXPECT_EQ(empty, StringView("1").getSubstr(StringView("")));
    EXPECT_EQ(empty, StringView("12").getSubstr(StringView("")));
    EXPECT_EQ(empty, StringView("12").getSubstr(StringView("123")));

    StringView s1234("12341234");
    StringView s12 = s1234.substr(0, 2);
    StringView s23 = s1234.substr(1, 2);
    StringView s34 = s1234.substr(2, 2);
    EXPECT_EQ(s1234, s1234.getSubstr(StringView("12341234")));
    EXPECT_EQ(s12.c_str(), s1234.getSubstr(StringView("12")).c_str());
    EXPECT_EQ(s23.c_str(), s1234.getSubstr(StringView("23")).c_str());
    EXPECT_EQ(s34.c_str(), s1234.getSubstr(StringView("34")).c_str());
