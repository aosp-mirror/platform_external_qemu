...
TEST(StringView, Substr) {
    ...
    EXPECT_EQ(StringView("").substr(0), StringView(""));
    EXPECT_EQ(StringView("").substr(1), StringView(""));
    EXPECT_EQ(StringView("").substr(2), StringView(""));
    EXPECT_EQ(StringView("1").substr(1), StringView(""));
    EXPECT_EQ(StringView("1").substr(0), StringView("1"));

    EXPECT_EQ(StringView("1234").substr(0), StringView("1234"));
    EXPECT_EQ(StringView("1234").substr(4), StringView(""));
    EXPECT_EQ(StringView("1234").substr(3), StringView("4"));
    EXPECT_EQ(StringView("1234").substr(2), StringView("34"));
    EXPECT_EQ(StringView("1234").substr(1), StringView("234"));
}
