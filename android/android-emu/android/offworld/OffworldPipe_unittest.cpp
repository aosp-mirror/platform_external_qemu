...
TEST_F(OffworldPipeTest, Snapshot) {
    ...
    auto replacementHandle = replaceMock(&MockAndroidVmOperations::mock, &mock);
    ...
    EXPECT_CALL(mock, snapshotSave(StrEq("TestSnapshot"), _, _)).Times(1);
                    ...
                    }));
    {
        ...
        request.mutable_snapshot()
                ...
                ->set_snapshot_name("TestSnapshot");
    ...
    EXPECT_CALL(mock, vmStop()).Times(1);
    EXPECT_CALL(mock, snapshotLoad(StrEq("TestSnapshot"), _, _)).Times(1);
    EXPECT_CALL(mock, vmStart()).Times(1);
                    ...
                    }));
    {
        ...
        requestCheckpoint->set_snapshot_name("TestSnapshot");
