...
TEST_F(VideoInjectionControllerTest, sendFollowUpAsyncResponse) {
    ...
    mController->getNextRequest(android::base::Ok());
    // android::base::Result<void, VideoInjectionError> result1(android::base::Err(VideoInjectionError::InvalidRequest));
    mController->sendFollowUpAsyncResponse(1, android::base::Err(VideoInjectionError::InvalidRequest), false);

    testing::Mock::VerifyAndClearExpectations(this);

    // android::base::Result<void, VideoInjectionError> result2(android::base::Err(VideoInjectionError::InvalidRequest));
    EXPECT_CALL(*this, offworldSendResponse).Times(0);
