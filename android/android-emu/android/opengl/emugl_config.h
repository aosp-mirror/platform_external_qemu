...
typedef enum SelectedRenderer {
    ...
    SELECTED_RENDERER_ANGLE = 6, // older, prototype ANGLE
    SELECTED_RENDERER_ANGLE11 = 7, // selected ANGLE D3D11 (with D3D9 fallback)
    SELECTED_RENDERER_ANGLE9 = 8, // selected D3D9 ANGLE
