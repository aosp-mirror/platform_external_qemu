...
static const char kBackupPatternsFilename[] =
    "emu-backup-feature-flags.protobuf";
...
public:
    ...
    bool read(emulator_features::EmulatorFeaturePatterns* patterns) {
        ...
        D("Could not find downloaded feature flags, trying backup %s\n", mBackupFileName.c_str());
        return tryParseFeaturePatternsProtobuf(mBackupFileName, patterns);
    }
