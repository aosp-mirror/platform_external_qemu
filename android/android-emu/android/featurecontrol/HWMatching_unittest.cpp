...
pattern { # 3
  ...
  featureaction { featurename: "HAXM" shoulddisable: true shouldenable: false }
}
...
pattern { # 4
  ...
  featureaction { featurename: "MesaDRI" shoulddisable: true shouldenable: false }
}
...
pattern { # 5
  ...
  featureaction { featurename: "AMDOpenGLDriver" shoulddisable: false shouldenable: true }
}
...
pattern { # 6
  ...
  featureaction { featurename: "MesaDRI" shoulddisable: false shouldenable: true }
}
...
static bool actionsIdentical(
    ...
    for (size_t i = 0; i < a.size(); i++) {
        ...
        if (a[i].shouldDisable != b[i].shouldDisable) return false;
        if (a[i].shouldEnable != b[i].shouldEnable) return false;
    }
