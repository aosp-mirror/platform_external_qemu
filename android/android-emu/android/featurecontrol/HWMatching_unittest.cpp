...
pattern { # 0
  ...
  featureaction { featurename: "GLESDynamicVersion" enable: true }
}
...
pattern { # 1
  ...
  featureaction { featurename: "GLAsyncSwap" enable: false }
}
...
pattern { # 2
  ...
  featureaction { featurename: "GLESDynamicVersion" enable: false }
}
...
pattern { # 3
  ...
  featureaction { featurename: "HAXM" enable: false }
}
...
pattern { # 4
  ...
  featureaction { featurename: "MesaDRI" enable: false }
}
...
pattern { # 5
  ...
  featureaction { featurename: "AMDOpenGLDriver" enable: true }
}
...
pattern { # 6
  ...
  featureaction { featurename: "MesaDRI" enable: true }
}
