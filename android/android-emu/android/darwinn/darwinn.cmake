if(LINUX_X86_64)
  prebuilt(DARWINN)
  android_add_library(TARGET darwinn LICENSE "Apache-2.0" SRC android/darwinn/darwinn-service.cpp)
  ...
  target_include_directories(darwinn PUBLIC ${DARWINN_INCLUDE_DIRS} ${CMAKE_CURRENT_SOURCE_DIR}
