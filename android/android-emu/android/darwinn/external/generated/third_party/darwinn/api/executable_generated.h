...
inline Description (&EnumValuesDescription())[4] {
...
inline const char **EnumNamesDescription() {
...
inline Position (&EnumValuesPosition())[2] {
...
inline const char **EnumNamesPosition() {
  static const char *names[] = {
    "LOWER_32BIT",
    "UPPER_32BIT",
    nullptr
...
inline InterruptType (&EnumValuesInterruptType())[4] {
  static InterruptType values[] = {
...
inline const char **EnumNamesInterruptType() {
  static const char *names[] = {
    "SCALAR_CORE_INT_0",
    "SCALAR_CORE_INT_1",
    "SCALAR_CORE_INT_2",
...
inline Direction (&EnumValuesDirection())[2] {
...
inline AnyHint (&EnumValuesAnyHint())[5] {
  static AnyHint values[] = {
    AnyHint_NONE,
...
inline const char **EnumNamesAnyHint() {
  static const char *names[] = {
    "NONE",
    "DmaDescriptorHint",
    "InstructionHint",
...
inline DataType (&EnumValuesDataType())[6] {
...
inline AnyLayer (&EnumValuesAnyLayer())[3] {
  static AnyLayer values[] = {
    AnyLayer_NONE,
...
inline const char **EnumNamesAnyLayer() {
  static const char *names[] = {
    "NONE",
    "OutputLayer",
    "InputLayer",
...
inline ExecutableType (&EnumValuesExecutableType())[3] {
  static ExecutableType values[] = {
...
inline const char **EnumNamesExecutableType() {
  static const char *names[] = {
    "STAND_ALONE",
    "PARAMETER_CACHING",
    "EXECUTION_ONLY",
...
struct InstructionBitstream FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.Verify(bitstream()) &&
           VerifyOffset(verifier, VT_FIELD_OFFSETS) &&
           verifier.Verify(field_offsets()) &&
...
struct OutputLayout FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.Verify(y_coordinate_to_linear_tile_id_map()) &&
           VerifyOffset(verifier, VT_X_COORDINATE_TO_LINEAR_TILE_ID_MAP) &&
           verifier.Verify(x_coordinate_to_linear_tile_id_map()) &&
           VerifyOffset(verifier, VT_LINEARIZED_TILE_BYTE_OFFSET) &&
           verifier.Verify(linearized_tile_byte_offset()) &&
           VerifyOffset(verifier, VT_X_COORDINATE_TO_LOCAL_BYTE_OFFSET) &&
           verifier.Verify(x_coordinate_to_local_byte_offset()) &&
           VerifyOffset(verifier, VT_Y_COORDINATE_TO_LOCAL_Y_OFFSET) &&
           verifier.Verify(y_coordinate_to_local_y_offset()) &&
           VerifyOffset(verifier, VT_X_COORDINATE_TO_LOCAL_Y_ROW_SIZE) &&
           verifier.Verify(x_coordinate_to_local_y_row_size()) &&
           verifier.EndTable();
  }
...
struct Executable FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.Verify(serialized_model()) &&
           ...
           verifier.Verify(instruction_bitstreams()) &&
...
struct MultiExecutable FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.Verify(serialized_executables()) &&
...
struct Package FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.Verify(serialized_multi_executable()) &&
...
inline AnyHintUnion::AnyHintUnion(const AnyHintUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    case AnyHint_DmaDescriptorHint: {
      assert(false);  // DmaDescriptorHintT not copyable.
      break;
    }
    case AnyHint_InstructionHint: {
...
inline AnyLayerUnion::AnyLayerUnion(const AnyLayerUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    case AnyLayer_OutputLayer: {
      assert(false);  // OutputLayerT not copyable.
      break;
    }
    case AnyLayer_InputLayer: {
