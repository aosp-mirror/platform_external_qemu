...
inline PerformanceExpectation (&EnumValuesPerformanceExpectation())[4] {
  static PerformanceExpectation values[] = {
...
inline const char **EnumNamesPerformanceExpectation() {
