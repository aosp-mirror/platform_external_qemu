...
UsbDfuCommands::FindDfuInterfaces(
  ...
  bool found_dfu_functional_descritpor = false;
  ...
  do {
    ...
    if (type ==
      ...
      // TODO(macwang) consider changing numbers to named constants.
      ...
      found_dfu_functional_descritpor = true;

      // TODO(macwang) consider adding named constants for numbers used in
      // parsing.
  ...
  if ((!dfu_interfaces.empty()) && found_dfu_functional_descritpor) {
...
util::StatusOr<UsbDfuCommands::DfuStatus> UsbDfuCommands::DfuGetStatus() {
  ...
  // TODO(macwang) consider adding named constants for numbers used.
...
util::Status UsbDfuCommands::UpdateFirmware(
  ...
  // TODO(macwang): try DFU abort or clear status to clear the stage, if we're
