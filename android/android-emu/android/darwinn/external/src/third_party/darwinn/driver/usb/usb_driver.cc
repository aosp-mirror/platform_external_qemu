...
constexpr uint16_t kTargetAppProductId = 0x089F;
...
util::Status UsbDriver::PrepareUsbDevice() {
  ...
  switch (device_desc.product_id) {
    case kTargetAppProductId:
      ...
      break;
    case kTargetDfuProductId:
      // Do nothing.
      expect_app_mode_after_reset = false;
      VLOG(7) << "Device is in DFU mode";
      break;
    default:
      return util::FailedPreconditionError("Unrecognized USB Product ID");
  }
