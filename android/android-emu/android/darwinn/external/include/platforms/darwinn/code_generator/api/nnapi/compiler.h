...
// Compiles a model. The input model is passes as a serialized Model proto, and
// the compiled package (and parameter-caching package, if in
// parameter-caching mode) are returned back as a serialized package fbs.
