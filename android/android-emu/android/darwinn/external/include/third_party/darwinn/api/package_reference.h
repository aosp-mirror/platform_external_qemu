#ifndef THIRD_PARTY_DARWINN_API_PACKAGE_REFERENCE_H_
#define THIRD_PARTY_DARWINN_API_PACKAGE_REFERENCE_H_
...
// LINT.IfChange(current_package_identifier)
...
#endif  // THIRD_PARTY_DARWINN_API_PACKAGE_REFERENCE_H_
