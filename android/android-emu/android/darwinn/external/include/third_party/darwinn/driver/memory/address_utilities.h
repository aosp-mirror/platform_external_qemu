...
#ifndef THIRD_PARTY_DARWINN_DRIVER_MEMORY_ADDRESS_UTILITIES_H_
#define THIRD_PARTY_DARWINN_DRIVER_MEMORY_ADDRESS_UTILITIES_H_
...
#endif  // THIRD_PARTY_DARWINN_DRIVER_MEMORY_ADDRESS_UTILITIES_H_
