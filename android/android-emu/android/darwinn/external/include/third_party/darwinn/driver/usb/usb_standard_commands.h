#ifndef THIRD_PARTY_DARWINN_DRIVER_USB_USB_STANDARD_COMMANDS_H_
#define THIRD_PARTY_DARWINN_DRIVER_USB_USB_STANDARD_COMMANDS_H_
...
// TODO(macwang) provide a mechanism like locked/unlocked versions of functions
...
class UsbStandardCommands {
 public:
  ...
  util::Status GetDescriptor(UsbDeviceInterface::DescriptorType desc_type,
                             ...
                             const char* context) {
    // TODO(macwang) add warnings/limitations on what can be queried, according
...
#endif  // THIRD_PARTY_DARWINN_DRIVER_USB_USB_STANDARD_COMMANDS_H_
