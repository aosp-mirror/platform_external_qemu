...
#ifndef THIRD_PARTY_DARWINN_DRIVER_CONFIG_JAGO_JAGO_CSR_OFFSETS_H_
#define THIRD_PARTY_DARWINN_DRIVER_CONFIG_JAGO_JAGO_CSR_OFFSETS_H_
...
const InterruptCsrOffsets kJagoFatalErrIntInterruptCsrOffsets = {
    0x81c0,  // NOLINT: fatal_err_int_control
    0x81c8,  // NOLINT: fatal_err_int_status
};

const InterruptCsrOffsets kJagoScHostIntInterruptCsrOffsets = {
    0x81a0,  // NOLINT: sc_host_int_control
    0x81a8,  // NOLINT: sc_host_int_status
};

const InterruptCsrOffsets kJagoTopLevelIntInterruptCsrOffsets = {
    0x81b0,  // NOLINT: top_level_int_control
    0x81b8,  // NOLINT: top_level_int_status
};

const BreakpointCsrOffsets kJagoAvdatapopBreakpointCsrOffsets = {
    0x4138,  // NOLINT: avDataPopRunControl
    0x4148,  // NOLINT: avDataPopRunStatus
    0x4140,  // NOLINT: avDataPopBreakPoint
};

const BreakpointCsrOffsets kJagoInfeedBreakpointCsrOffsets = {
    0x41b8,  // NOLINT: infeedRunControl
    0x41c0,  // NOLINT: infeedRunStatus
    0x41c8,  // NOLINT: infeedBreakPoint
};

const BreakpointCsrOffsets kJagoOutfeedBreakpointCsrOffsets = {
    0x41f8,  // NOLINT: outfeedRunControl
    0x4200,  // NOLINT: outfeedRunStatus
    0x4208,  // NOLINT: outfeedBreakPoint
};

const BreakpointCsrOffsets kJagoParameterpopBreakpointCsrOffsets = {
    0x4178,  // NOLINT: parameterPopRunControl
    0x4188,  // NOLINT: parameterPopRunStatus
    0x4180,  // NOLINT: parameterPopBreakPoint
};

const BreakpointCsrOffsets kJagoScalarcoreBreakpointCsrOffsets = {
    0x4018,  // NOLINT: scalarCoreRunControl
    0x4238,  // NOLINT: scalarCoreRunStatus
    0x4020,  // NOLINT: scalarCoreBreakPoint
};

const RegisterFileCsrOffsets kJagoPredicateRegisterFileCsrOffsets = {
    0x4500,  // NOLINT: predicateRegisterFile
};

const RegisterFileCsrOffsets kJagoScalarRegisterFileCsrOffsets = {
    0x4400,  // NOLINT: scalarRegisterFile
};

const SyncFlagCsrOffsets kJagoAvdataInfeedSyncFlagCsrOffsets = {
    0x4060,  // NOLINT: SyncCounter_AVDATA_INFEED
};

const SyncFlagCsrOffsets kJagoAvdataPopSyncFlagCsrOffsets = {
    0x4050,  // NOLINT: SyncCounter_AVDATA_POP
};

const SyncFlagCsrOffsets kJagoParameterInfeedSyncFlagCsrOffsets = {
    0x4068,  // NOLINT: SyncCounter_PARAMETER_INFEED
};

const SyncFlagCsrOffsets kJagoParameterPopSyncFlagCsrOffsets = {
    0x4058,  // NOLINT: SyncCounter_PARAMETER_POP
};

const SyncFlagCsrOffsets kJagoProducerASyncFlagCsrOffsets = {
    0x4078,  // NOLINT: SyncCounter_PRODUCER_A
};

const SyncFlagCsrOffsets kJagoProducerBSyncFlagCsrOffsets = {
    0x4080,  // NOLINT: SyncCounter_PRODUCER_B
};

const SyncFlagCsrOffsets kJagoRingOutfeedSyncFlagCsrOffsets = {
    0x4088,  // NOLINT: SyncCounter_RING_OUTFEED
};

const SyncFlagCsrOffsets kJagoScalarInfeedSyncFlagCsrOffsets = {
    0x4070,  // NOLINT: SyncCounter_SCALAR_INFEED
};

const SyncFlagCsrOffsets kJagoScalarPipelineSyncFlagCsrOffsets = {
    0x4090,  // NOLINT: SyncCounter_SCALAR_PIPELINE
};

const TraceCsrOffsets kJagoAvdatapopTraceCsrOffsets = {
    0x4150,  // NOLINT: avDataPopOverwriteMode
    0x4158,  // NOLINT: avDataPopEnableTracing
    0x42a0,  // NOLINT: avDataPopTrace
};

const TraceCsrOffsets kJagoInfeedTraceCsrOffsets = {
    0x41d0,  // NOLINT: infeedOverwriteMode
    0x41d8,  // NOLINT: infeedEnableTracing
    0x4320,  // NOLINT: infeedTrace
};

const TraceCsrOffsets kJagoOutfeedTraceCsrOffsets = {
    0x4210,  // NOLINT: outfeedOverwriteMode
    0x4218,  // NOLINT: outfeedEnableTracing
    0x4360,  // NOLINT: outfeedTrace
};

const TraceCsrOffsets kJagoParameterpopTraceCsrOffsets = {
    0x4190,  // NOLINT: parameterPopOverwriteMode
    0x4198,  // NOLINT: parameterPopEnableTracing
    0x42e0,  // NOLINT: parameterPopTrace
};

const BreakpointCsrOffsets kJagoMeshbus0BreakpointCsrOffsets = {
    0x2250,  // NOLINT: meshBus0RunControl
    0x2258,  // NOLINT: meshBus0RunStatus
    0x2260,  // NOLINT: meshBus0BreakPoint
};

const BreakpointCsrOffsets kJagoMeshbus1BreakpointCsrOffsets = {
    0x2298,  // NOLINT: meshBus1RunControl
    0x22a0,  // NOLINT: meshBus1RunStatus
    0x22a8,  // NOLINT: meshBus1BreakPoint
};

const BreakpointCsrOffsets kJagoMeshbus2BreakpointCsrOffsets = {
    0x22e0,  // NOLINT: meshBus2RunControl
    0x22e8,  // NOLINT: meshBus2RunStatus
    0x22f0,  // NOLINT: meshBus2BreakPoint
};

const BreakpointCsrOffsets kJagoMeshbus3BreakpointCsrOffsets = {
    0x2328,  // NOLINT: meshBus3RunControl
    0x2330,  // NOLINT: meshBus3RunStatus
    0x2338,  // NOLINT: meshBus3BreakPoint
};

const BreakpointCsrOffsets kJagoNarrowtowideBreakpointCsrOffsets = {
    0x2150,  // NOLINT: narrowToWideRunControl
    0x2158,  // NOLINT: narrowToWideRunStatus
    0x2160,  // NOLINT: narrowToWideBreakPoint
};

const BreakpointCsrOffsets kJagoOpBreakpointCsrOffsets = {
    0x20c0,  // NOLINT: opRunControl
    0x20e0,  // NOLINT: opRunStatus
    0x20d0,  // NOLINT: opBreakPoint
};

const BreakpointCsrOffsets kJagoRingbusconsumer0BreakpointCsrOffsets = {
    0x2190,  // NOLINT: ringBusConsumer0RunControl
    0x2198,  // NOLINT: ringBusConsumer0RunStatus
    0x21a0,  // NOLINT: ringBusConsumer0BreakPoint
};

const BreakpointCsrOffsets kJagoRingbusconsumer1BreakpointCsrOffsets = {
    0x21d0,  // NOLINT: ringBusConsumer1RunControl
    0x21d8,  // NOLINT: ringBusConsumer1RunStatus
    0x21e0,  // NOLINT: ringBusConsumer1BreakPoint
};

const BreakpointCsrOffsets kJagoRingbusproducerBreakpointCsrOffsets = {
    0x2210,  // NOLINT: ringBusProducerRunControl
    0x2218,  // NOLINT: ringBusProducerRunStatus
    0x2220,  // NOLINT: ringBusProducerBreakPoint
};

const BreakpointCsrOffsets kJagoWidetonarrowBreakpointCsrOffsets = {
    0x2110,  // NOLINT: wideToNarrowRunControl
    0x2118,  // NOLINT: wideToNarrowRunStatus
    0x2120,  // NOLINT: wideToNarrowBreakPoint
};

const SyncFlagCsrOffsets kJagoAvdataSyncFlagCsrOffsets = {
    0x2028,  // NOLINT: SyncCounter_AVDATA
};

const SyncFlagCsrOffsets kJagoMeshEastInSyncFlagCsrOffsets = {
    0x2048,  // NOLINT: SyncCounter_MESH_EAST_IN
};

const SyncFlagCsrOffsets kJagoMeshEastOutSyncFlagCsrOffsets = {
    0x2068,  // NOLINT: SyncCounter_MESH_EAST_OUT
};

const SyncFlagCsrOffsets kJagoMeshNorthInSyncFlagCsrOffsets = {
    0x2040,  // NOLINT: SyncCounter_MESH_NORTH_IN
};

const SyncFlagCsrOffsets kJagoMeshNorthOutSyncFlagCsrOffsets = {
    0x2060,  // NOLINT: SyncCounter_MESH_NORTH_OUT
};

const SyncFlagCsrOffsets kJagoMeshSouthInSyncFlagCsrOffsets = {
    0x2050,  // NOLINT: SyncCounter_MESH_SOUTH_IN
};

const SyncFlagCsrOffsets kJagoMeshSouthOutSyncFlagCsrOffsets = {
    0x2070,  // NOLINT: SyncCounter_MESH_SOUTH_OUT
};

const SyncFlagCsrOffsets kJagoMeshWestInSyncFlagCsrOffsets = {
    0x2058,  // NOLINT: SyncCounter_MESH_WEST_IN
};

const SyncFlagCsrOffsets kJagoMeshWestOutSyncFlagCsrOffsets = {
    0x2078,  // NOLINT: SyncCounter_MESH_WEST_OUT
};

const SyncFlagCsrOffsets kJagoNarrowToWideSyncFlagCsrOffsets = {
    0x2090,  // NOLINT: SyncCounter_NARROW_TO_WIDE
};

const SyncFlagCsrOffsets kJagoParametersSyncFlagCsrOffsets = {
    0x2030,  // NOLINT: SyncCounter_PARAMETERS
};

const SyncFlagCsrOffsets kJagoPartialSumsSyncFlagCsrOffsets = {
    0x2038,  // NOLINT: SyncCounter_PARTIAL_SUMS
};

const SyncFlagCsrOffsets kJagoRingProducerASyncFlagCsrOffsets = {
    0x20b0,  // NOLINT: SyncCounter_RING_PRODUCER_A
};

const SyncFlagCsrOffsets kJagoRingProducerBSyncFlagCsrOffsets = {
    0x20b8,  // NOLINT: SyncCounter_RING_PRODUCER_B
};

const SyncFlagCsrOffsets kJagoRingReadASyncFlagCsrOffsets = {
    0x2098,  // NOLINT: SyncCounter_RING_READ_A
};

const SyncFlagCsrOffsets kJagoRingReadBSyncFlagCsrOffsets = {
    0x20a0,  // NOLINT: SyncCounter_RING_READ_B
};

const SyncFlagCsrOffsets kJagoRingWriteSyncFlagCsrOffsets = {
    0x20a8,  // NOLINT: SyncCounter_RING_WRITE
};

const SyncFlagCsrOffsets kJagoWideToNarrowSyncFlagCsrOffsets = {
    0x2080,  // NOLINT: SyncCounter_WIDE_TO_NARROW
};

const SyncFlagCsrOffsets kJagoWideToScalingSyncFlagCsrOffsets = {
    0x2088,  // NOLINT: SyncCounter_WIDE_TO_SCALING
};

const TraceCsrOffsets kJagoDmameshbus0TraceCsrOffsets = {
    0x2270,  // NOLINT: dmaMeshBus0OverwriteMode
    0x2278,  // NOLINT: dmaMeshBus0EnableTracing
    0x2740,  // NOLINT: dmaMeshBus0Trace
};

const TraceCsrOffsets kJagoDmameshbus1TraceCsrOffsets = {
    0x22b8,  // NOLINT: dmaMeshBus1OverwriteMode
    0x22c0,  // NOLINT: dmaMeshBus1EnableTracing
    0x27c0,  // NOLINT: dmaMeshBus1Trace
};

const TraceCsrOffsets kJagoDmameshbus2TraceCsrOffsets = {
    0x2300,  // NOLINT: dmaMeshBus2OverwriteMode
    0x2308,  // NOLINT: dmaMeshBus2EnableTracing
    0x2840,  // NOLINT: dmaMeshBus2Trace
};

const TraceCsrOffsets kJagoDmameshbus3TraceCsrOffsets = {
    0x2348,  // NOLINT: dmaMeshBus3OverwriteMode
    0x2350,  // NOLINT: dmaMeshBus3EnableTracing
    0x28c0,  // NOLINT: dmaMeshBus3Trace
};

const TraceCsrOffsets kJagoDmanarrowtowideTraceCsrOffsets = {
    0x2168,  // NOLINT: dmaNarrowToWideOverwriteMode
    0x2170,  // NOLINT: dmaNarrowToWideEnableTracing
    0x2600,  // NOLINT: dmaNarrowToWideTrace
};

const TraceCsrOffsets kJagoDmaringbusconsumer0TraceCsrOffsets = {
...
const TraceCsrOffsets kJagoDmaringbusconsumer1TraceCsrOffsets = {
...
const TraceCsrOffsets kJagoDmaringbusproducerTraceCsrOffsets = {
...
const DebugScalarCoreCsrOffsets kJagoDebugScalarCoreCsrOffsets = {
    ...
    0x4150,  // NOLINT: avDataPopOverwriteMode
    0x4158,  // NOLINT: avDataPopEnableTracing
    0x4160,  // NOLINT: avDataPopStartCycle
    0x4168,  // NOLINT: avDataPopEndCycle
    0x4170,  // NOLINT: avDataPopProgramCounter
    0x4178,  // NOLINT: parameterPopRunControl
    0x4180,  // NOLINT: parameterPopBreakPoint
    0x4188,  // NOLINT: parameterPopRunStatus
    0x4190,  // NOLINT: parameterPopOverwriteMode
    0x4198,  // NOLINT: parameterPopEnableTracing
    0x41a0,  // NOLINT: parameterPopStartCycle
    0x41a8,  // NOLINT: parameterPopEndCycle
    0x41b0,  // NOLINT: parameterPopProgramCounter
    0x41b8,  // NOLINT: infeedRunControl
    0x41c0,  // NOLINT: infeedRunStatus
    0x41c8,  // NOLINT: infeedBreakPoint
    0x41d0,  // NOLINT: infeedOverwriteMode
    0x41d8,  // NOLINT: infeedEnableTracing
    0x41e0,  // NOLINT: infeedStartCycle
    0x41e8,  // NOLINT: infeedEndCycle
    0x41f0,  // NOLINT: infeedProgramCounter
    0x41f8,  // NOLINT: outfeedRunControl
    0x4200,  // NOLINT: outfeedRunStatus
    0x4208,  // NOLINT: outfeedBreakPoint
    0x4210,  // NOLINT: outfeedOverwriteMode
    0x4218,  // NOLINT: outfeedEnableTracing
    0x4220,  // NOLINT: outfeedStartCycle
    0x4228,  // NOLINT: outfeedEndCycle
    0x4230,  // NOLINT: outfeedProgramCounter
    0x4238,  // NOLINT: scalarCoreRunStatus
    0x4240,  // NOLINT: Error_ScalarCore
    0x4248,  // NOLINT: Error_Mask_ScalarCore
    0x4250,  // NOLINT: Error_Force_ScalarCore
    0x4258,  // NOLINT: Error_Timestamp_ScalarCore
    0x4260,  // NOLINT: Error_Info_ScalarCore
    0x4268,  // NOLINT: Timeout
    0x4280,  // NOLINT: avDataPopTtuStateRegFile
    0x42a0,  // NOLINT: avDataPopTrace
    0x42c0,  // NOLINT: parameterPopTtuStateRegFile
    0x42e0,  // NOLINT: parameterPopTrace
    0x4300,  // NOLINT: infeedTtuStateRegFile
    0x4340,  // NOLINT: outfeedTtuStateRegFile
};

const DebugTileCsrOffsets kJagoDebugTileCsrOffsets = {
...
const HibKernelCsrOffsets kJagoHibKernelCsrOffsets = {
...
const HibUserCsrOffsets kJagoHibUserCsrOffsets = {
    0x81b0,  // NOLINT: top_level_int_control
    0x81b8,  // NOLINT: top_level_int_status
    0x81d0,  // NOLINT: sc_host_int_count
    0x81d8,  // NOLINT: dma_pause
...
const QueueCsrOffsets kJagoInstructionQueueCsrOffsets = {
    0x8068,  // NOLINT: instruction_queue_control
    0x8070,  // NOLINT: instruction_queue_status
    0x8078,  // NOLINT: instruction_queue_descriptor_size
    0x8090,  // NOLINT: instruction_queue_base
...
const MemoryCsrOffsets kJagoMemoryMemoryCsrOffsets = {
    0x2010,  // NOLINT: memoryAccess
    0x2018,  // NOLINT: memoryData
};

const ScalarCoreCsrOffsets kJagoScalarCoreCsrOffsets = {
    0x4018,  // NOLINT: scalarCoreRunControl
    0x4138,  // NOLINT: avDataPopRunControl
    0x4178,  // NOLINT: parameterPopRunControl
    0x41b8,  // NOLINT: infeedRunControl
...
const MemoryCsrOffsets kJagoScmemoryMemoryCsrOffsets = {
    0x4040,  // NOLINT: scMemoryAccess
    0x4048,  // NOLINT: scMemoryData
};

const TileConfigCsrOffsets kJagoTileConfigCsrOffsets = {
    0x8260,  // NOLINT: tileconfig0
    0x8268,  // NOLINT: tileconfig1
};

const TileCsrOffsets kJagoTileCsrOffsets = {
...
const WireCsrOffsets kJagoWireCsrOffsets = {
    0x8250,  // NOLINT: wire_int_pending_bit_array
    0x8258,  // NOLINT: wire_int_mask_array
};

const AonResetCsrOffsets kJagoAonResetCsrOffsets = {
...
#endif  // THIRD_PARTY_DARWINN_DRIVER_CONFIG_JAGO_JAGO_CSR_OFFSETS_H_
