...
class PackageReference : public api::ExecutableReference {
 public:
  // This class is neither copyable nor movable.
...
class ExecutableRegistry {
 public:
  ...
  util::StatusOr<const api::ExecutableReference*> RegisterSerialized(
  ...
  util::StatusOr<const api::ExecutableReference*> RegisterFile(
      const std::string& executable_filename);

  // Unregisters an executable. Invokes the callback to unmap the parameter.
  util::Status Unregister(const api::ExecutableReference* executable_reference);
 ...
 private:
  ...
  util::StatusOr<const api::ExecutableReference*> RegisterPackage(
  ...
  // tricky.
  std::unordered_map<const api::ExecutableReference*,
                     std::unique_ptr<api::ExecutableReference>>
      registrations_;
