...
#ifndef THIRD_PARTY_DARWINN_PORT_DEFAULT_THREAD_ANNOTATIONS_H_
#define THIRD_PARTY_DARWINN_PORT_DEFAULT_THREAD_ANNOTATIONS_H_
...
#endif  // THIRD_PARTY_DARWINN_PORT_DEFAULT_THREAD_ANNOTATIONS_H_
