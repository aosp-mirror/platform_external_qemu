#ifndef THIRD_PARTY_DARWINN_DRIVER_JAGO_JAGO_TOP_LEVEL_HANDLER_H_
#define THIRD_PARTY_DARWINN_DRIVER_JAGO_JAGO_TOP_LEVEL_HANDLER_H_
...
// Handles jago resets. Only used in remote driver as this will be handled in
// kernel space in kernel driver.
class JagoTopLevelHandler : public TopLevelHandler {
 public:
  JagoTopLevelHandler(const config::ChipConfig& config, Registers* registers);
  ~JagoTopLevelHandler() override = default;
...
#endif  // THIRD_PARTY_DARWINN_DRIVER_JAGO_JAGO_TOP_LEVEL_HANDLER_H_
