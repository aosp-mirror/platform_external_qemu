...
#ifndef THIRD_PARTY_DARWINN_DRIVER_HARDWARE_STRUCTURES_H_
#define THIRD_PARTY_DARWINN_DRIVER_HARDWARE_STRUCTURES_H_
...
#endif  // THIRD_PARTY_DARWINN_DRIVER_HARDWARE_STRUCTURES_H_
