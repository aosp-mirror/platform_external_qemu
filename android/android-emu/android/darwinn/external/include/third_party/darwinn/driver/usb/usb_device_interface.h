#ifndef THIRD_PARTY_DARWINN_DRIVER_USB_USB_DEVICE_INTERFACE_H_
#define THIRD_PARTY_DARWINN_DRIVER_USB_USB_DEVICE_INTERFACE_H_
...
#endif  // THIRD_PARTY_DARWINN_DRIVER_USB_USB_DEVICE_INTERFACE_H_
