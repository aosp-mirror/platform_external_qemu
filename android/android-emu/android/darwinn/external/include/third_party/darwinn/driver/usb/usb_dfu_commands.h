#ifndef THIRD_PARTY_DARWINN_DRIVER_USB_USB_DFU_COMMANDS_H_
#define THIRD_PARTY_DARWINN_DRIVER_USB_USB_DFU_COMMANDS_H_
...
#endif  // THIRD_PARTY_DARWINN_DRIVER_USB_USB_DFU_COMMANDS_H_
