...
#ifndef THIRD_PARTY_DARWINN_PORT_DEFAULT_PTR_UTIL_H_
#define THIRD_PARTY_DARWINN_PORT_DEFAULT_PTR_UTIL_H_
...
#endif  // THIRD_PARTY_DARWINN_PORT_DEFAULT_PTR_UTIL_H_
