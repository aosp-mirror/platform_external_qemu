#ifndef THIRD_PARTY_DARWINN_DRIVER_SHOAL_SHOAL_TOP_LEVEL_HANDLER_H_
#define THIRD_PARTY_DARWINN_DRIVER_SHOAL_SHOAL_TOP_LEVEL_HANDLER_H_
...
// Handles shoal resets. Only used in remote driver as this will be handled
// in kernel space in kernel driver.
class ShoalTopLevelHandler : public TopLevelHandler {
 public:
  ShoalTopLevelHandler(const config::ChipConfig& config, Registers* registers);
  ~ShoalTopLevelHandler() override = default;
...
#endif  // THIRD_PARTY_DARWINN_DRIVER_SHOAL_SHOAL_TOP_LEVEL_HANDLER_H_
