...
class MmioDriver : public Driver {
 ...
 private:
  ...
  std::unique_ptr<AddressSpaceFactory> address_space_factory_;
  std::unique_ptr<AddressSpace> simple_address_space_;
  // May be nullptr if there is only a simple_address_space.
  std::unique_ptr<AddressSpace> extended_address_space_;
