...
#ifndef THIRD_PARTY_DARWINN_PORT_DEFAULT_ARRAY_SLICE_INTERNAL_H_
#define THIRD_PARTY_DARWINN_PORT_DEFAULT_ARRAY_SLICE_INTERNAL_H_
...
#endif  // THIRD_PARTY_DARWINN_PORT_DEFAULT_ARRAY_SLICE_INTERNAL_H_
