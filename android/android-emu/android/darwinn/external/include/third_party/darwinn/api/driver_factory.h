#ifndef THIRD_PARTY_DARWINN_API_DRIVER_FACTORY_H_
#define THIRD_PARTY_DARWINN_API_DRIVER_FACTORY_H_
...
struct Device {
  ...
  // TODO(ijsung): Replace map of strings with something better.
...
#endif  // THIRD_PARTY_DARWINN_API_DRIVER_FACTORY_H_
