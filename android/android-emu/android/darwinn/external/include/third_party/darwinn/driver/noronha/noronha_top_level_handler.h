#ifndef THIRD_PARTY_DARWINN_DRIVER_NORONHA_NORONHA_TOP_LEVEL_HANDLER_H_
#define THIRD_PARTY_DARWINN_DRIVER_NORONHA_NORONHA_TOP_LEVEL_HANDLER_H_
...
// Handles noronha resets. Only used in remote driver as this will be handled in
// kernel space in kernel driver.
class NoronhaTopLevelHandler : public TopLevelHandler {
 public:
  NoronhaTopLevelHandler(const config::ChipConfig& config,
                         Registers* registers);
  ~NoronhaTopLevelHandler() override = default;
...
#endif  // THIRD_PARTY_DARWINN_DRIVER_NORONHA_NORONHA_TOP_LEVEL_HANDLER_H_
