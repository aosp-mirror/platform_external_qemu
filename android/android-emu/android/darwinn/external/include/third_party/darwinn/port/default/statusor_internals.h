...
#ifndef THIRD_PARTY_DARWINN_PORT_DEFAULT_STATUSOR_INTERNALS_H_
#define THIRD_PARTY_DARWINN_PORT_DEFAULT_STATUSOR_INTERNALS_H_
...
#endif  // THIRD_PARTY_DARWINN_PORT_DEFAULT_STATUSOR_INTERNALS_H_
