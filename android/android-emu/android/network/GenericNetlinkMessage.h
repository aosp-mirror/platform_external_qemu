...
public:
    ...
    android::base::IOVector getAttribute(int attributeId) const;
    bool getAttribute(int attributeId, void* dst, size_t size) const;
    // If attributeId already exists, this method will override the original value
...
private:
    void putHeader(uint32_t pid, uint32_t seq,
			   int type, int flags);
