...
#include "android/emulation/ParameterList.h"    // for ParameterList, Parame...
...
const char* android_cmdLine = nullptr;
...
void process_early_setup(int argc, char** argv) {
    ...
    android_cmdLine = params.toCStringCopy(ParameterList::Format::alwaysQuoteAndEscape);
