...
OPT_FLAG ( ranchu, "*deprecated*. This flag might be removed in future versions." )
OPT_PARAM( engine, "<engine>", "*deprecated*. This parameter is unused and might be removed in future versions." )
