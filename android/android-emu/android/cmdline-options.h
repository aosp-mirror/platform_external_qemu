...
OPT_PARAM( adbkeyfile, "<path-to-adb-key-file>", "use this adb public key file instead of default .android/adbkey.pub"
                       "(option effective in first boot or with -wipe-data)" )
