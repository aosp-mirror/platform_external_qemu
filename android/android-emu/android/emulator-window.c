...
static void emulator_window_window_scroll_wheel_event(int dx, int dy) {
    user_event_agent->sendRotaryEvent(dy);
}
...
emulator_window_setup( EmulatorWindow*  emulator )
{
    ...
    static const SkinWindowFuncs my_window_funcs = {
        ...
        .scroll_wheel_event = &emulator_window_window_scroll_wheel_event,
