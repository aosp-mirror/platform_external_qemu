...
// Reads verified boot parameters from VerifiedBootConfig.textproto.
// and formats them into |params|.
//
// If any of the following issues occurs, the vector is not populated and
...
// when to provide the text proto directly, such as in unit testing.
