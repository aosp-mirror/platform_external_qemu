...
// REF-DO, Reference Data Object, contains an AID reference, DeviceAppID
// reference and an optional package name reference that together uniquely
...
public:
    RefDo(const AidRefDo& aidRefDo,
          ...
          const PkgRefDo& pkgRefDo = PkgRefDo());
};
