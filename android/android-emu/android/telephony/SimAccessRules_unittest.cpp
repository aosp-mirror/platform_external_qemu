...
TEST(SimAccessRulesTest, customAccessRules) {
  ...
  auto config_file_path = testDir.makeSubPath("custom_access_rules.textproto");

  android_emulator::ListRefArDo ref_ar_dos;
  ...
  (*access_rules.mutable_sim_access_rules())[std::string(kAraAid)] = ref_ar_dos;
