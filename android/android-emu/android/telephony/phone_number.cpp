...
public:
    std::string get_phone_number_prefix() {
    ...
    std::string get_phone_number(int port) {
    ...
    std::string get_phone_number_for_sim(int port) {
...
extern "C" const char* get_phone_number(int port) {
    return android::sPhoneNumberContainer->get_phone_number(port).c_str();
}

extern "C" const char* get_phone_number_for_sim(int port) {
