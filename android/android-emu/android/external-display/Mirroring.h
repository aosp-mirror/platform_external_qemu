...
public:
    ...
    // the gui end must call this method first for rendering
    static void registerExternalDisplayWindowProvider(ExternalDisplayWindowProvider* provider) {
        sProvider = provider;
    }
...
private:
    ...
    static ExternalDisplayWindowProvider* sProvider;
    ...
    // video decoding and rendering stuff
