...
help_physics_load(stralloc_t* out)
{
    ...
    "  drive physical parameters such as motion and sensor values.  File path is\n"
    "  specified relative to the current user's home directory.\n\n"
    );
}
...
help_physics_save(stralloc_t* out)
{
    ...
    "  changes from the current emulator session to the specified file path.  File path is\n"
    "  specified relative to the current user's home directory.\n\n"
    );
}
