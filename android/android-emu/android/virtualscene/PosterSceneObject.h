...
public:
    ...
    // Set the poster location in the scene.
    //
    ...
    //             square.
    void setPosterLocation(const glm::vec3& position,
...
private:
    // Make private, setPosterLocation and setScale should be used instead.
