...
#define ANDROID_FOLDABLE_MAX_ROLLS 3
...
#endif
#define ANDROID_FOLDABLE_MAX_HINGES_ROLLS (ANDROID_FOLDABLE_MAX_HINGES > ANDROID_FOLDABLE_MAX_ROLLS) ? ANDROID_FOLDABLE_MAX_HINGES : ANDROID_FOLDABLE_MAX_ROLLS
