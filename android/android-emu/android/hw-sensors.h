 ...
 *       SENSOR_STATUS_NO_SERVICE: "sensors" qemud service is not
 * available/initiated. SENSOR_STATUS_DISABLED: sensor is disabled.
 ...
 */
#define SENSORS_LIST                                                          \
    SENSOR_(ACCELERATION, "acceleration", Accelerometer, vec3,                \
            "acceleration:%g:%g:%g")                                          \
    SENSOR_(GYROSCOPE, "gyroscope", Gyroscope, vec3, "gyroscope:%g:%g:%g")    \
    SENSOR_(MAGNETIC_FIELD, "magnetic-field", Magnetometer, vec3,             \
            "magnetic:%g:%g:%g")                                              \
    SENSOR_(ORIENTATION, "orientation", Orientation, vec3,                    \
            "orientation:%g:%g:%g")                                           \
...
#define PHYSICAL_PARAMETERS_LIST                                               \
    ...
    PHYSICAL_PARAMETER_(ACCELERATION, "acceleration", Acceleration, vec3)      \
    PHYSICAL_PARAMETER_(ANGULAR_VELOCITY, "angular-velocity", AngularVelocity, \
                        vec3)
