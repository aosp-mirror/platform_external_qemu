...
public:
    ...
    StartResult startPlaybackWithCallback(StringView filename, void (*onStopCallback)()) override;
...
private:
    ...
    std::function<void()> mOnStopCallback = nullptr;
...
StartResult AutomationControllerImpl::startPlaybackWithCallback(StringView filename, void (*onStopCallback)()) {
