...
android_add_library(
  TARGET android-emu-crash-service LICENSE Apache-2.0
...
android_add_executable(
  TARGET emulator-crash-service LICENSE Apache-2.0
...
target_compile_definitions(
  ...
  PRIVATE -DCONFIG_QT -DCRASHUPLOAD=${OPTION_CRASHUPLOAD} -DANDROID_SDK_TOOLS_REVISION=${OPTION_SDK_TOOLS_REVISION}
          -DANDROID_SDK_TOOLS_BUILD_NUMBER=${OPTION_SDK_TOOLS_BUILD_NUMBER})
target_link_libraries(emulator-crash-service PRIVATE android-emu-crash-service android-emu emulator-libui
                                                     breakpad_server Qt5::Gui)

# The mingw debug build somehow requires us to link against the vm operations in debug builds, even though we are not
# using them..
...
android_add_executable(TARGET emulator64_test_crasher NODISTRIBUTE SRC android/crashreport/testing/main-test-crasher.cpp)
...
android_add_test(
  ...
  SRC # cmake-format: sortable
      android/crashreport/CrashService_common.cpp android/crashreport/CrashService_unittest.cpp
      android/crashreport/CrashSystem_unittest.cpp android/crashreport/HangDetector_unittest.cpp
      android/crashreport/detectors/CrashDetectors_unittest.cpp
  LINUX android/crashreport/CrashService_linux.cpp
  DARWIN android/crashreport/CrashService_darwin.cpp
  MINGW android/crashreport/CrashService_windows.cpp
