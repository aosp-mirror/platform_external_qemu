...
android_add_library(
  ...
  LINUX android/base/memory/SharedMemory_posix.cpp android/base/threads/Thread_pthread.cpp
  DARWIN android/base/memory/SharedMemory_posix.cpp android/base/threads/Thread_pthread.cpp
...
if(OPTION_TCMALLOC)
  android_target_link_libraries(android-emu-base linux-x86_64 PUBLIC TCMALLOC::TCMALLOC LIBUNWIND::LIBUNWIND -ldl
                                                                     Threads::Threads -lrt)
else()
...
android_target_link_libraries(android-emu-base darwin-x86_64 PUBLIC "-framework Foundation"
                                                                    "-framework ApplicationServices" "-framework IOKit")

android_target_compile_definitions(android-emu-base darwin-x86_64 PRIVATE "-D_DARWIN_C_SOURCE=1" "-Dftello64=ftell"
                                   "-Dfseeko64=fseek")

if(OPTION_TCMALLOC)
  target_compile_definitions(android-emu-base PRIVATE "-DAEMU_TCMALLOC_ENABLED=1")
else()
  target_compile_definitions(android-emu-base PRIVATE "-DAEMU_TCMALLOC_ENABLED=0")
endif()

if(OPTION_GFXSTREAM_BACKEND)
  target_compile_definitions(android-emu-base PRIVATE "-DAEMU_GFXSTREAM_BACKEND=1")
endif()
...
# Add the benchmark
android_add_executable(TARGET android-emu_benchmark NODISTRIBUTE SRC # cmake-format: sortable
