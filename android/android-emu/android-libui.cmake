...
set(ANDROID_SKIN_SOURCES
    # cmake-format: sortable
    android/skin/qt/event-qt.cpp android/skin/qt/init-qt.cpp android/skin/qt/QtLogger.cpp
    android/skin/qt/surface-qt.cpp android/skin/qt/winsys-qt.cpp)
...
if(NOT QTWEBENGINE)
  ...
  set(emulator-libui_windows-x86_64_src
      # cmake-format: sortable
      android/skin/qt/extended-pages/location-page_noMaps.ui android/skin/qt/windows-native-window.cpp)
...
android_target_compile_options(emulator-libui_unittests windows
...
# is set for c++ sources.
if(NOT MSVC)
  android_target_compile_options(emulator-libui-headless windows
                                 PRIVATE "$<$<COMPILE_LANGUAGE:CXX>:-Wno-literal-suffix>")
endif()
