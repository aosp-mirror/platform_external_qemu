...
# Windows 32-bit specific sources
set(android-emu_windows-x86_src
...
set(android-emu_windows-x86_64_src ${android-emu_windows-x86_src})
...
set(android-emu_windows-x86_libs_public -lpsapi -ld3d9
...
set(android-emu_windows-x86_64_libs_public
    ${android-emu_windows-x86_libs_public})

set(android-emu_linux-x86_64_libs_public -lrt -lX11 -lGL)
...
set(android-emu_darwin-x86_64_libs_public
    "-framework AppKit"
...
# Includes
set(android-emu_includes_private
...
set(android-emu_includes_public ${LZ4_INCLUDE_DIRS} ${UUID_INCLUDE_DIRS}
    ...
    # this has to be sorted, as it will prevent the shared library from being
    # used directly.
...
set(android-emu_windows-x86_includes_private
    ${ANDROID_QEMU2_TOP_DIR}/android/third_party/mman-win32/includes/)
set(android-emu_windows-x86_64_includes_private
    ${android-emu_windows-x86_includes_private})

set(android-emu_linux-x86_64_compile_options_private -idirafter
    ${ANDROID_QEMU2_TOP_DIR}/linux-headers)

# Compiler flags for "illegal" things in the headers
set(android-emu_compile_options_private "-Wno-invalid-constexpr")

# Compiler flags
set(android-emu_compile_options_private
    "-Wno-parentheses"
...
set(android-emu_defs_public ${CURL_DEFINITIONS} ${LIBXML2_DEFINITIONS})

set(android-emu_defs_private -DCRASHUPLOAD=${ANDROID_EMULATOR_CRASHUPLOAD})
add_android_library(android-emu)
...
# The dependent target os specific sources, they are pretty much the same as above, excluding
# camera support.
...
set(android-emu-shared_linux-x86_64_src ${android-emu_linux-x86_64_src})
set(android-emu-shared_libs_public ${android-emu_libs_public})
set(android-emu-shared_windows-x86_libs_public
    ${android-emu_windows-x86_libs_public})
set(android-emu-shared_windows-x86_64_libs_public
    ${android-emu_windows-x86_64_libs_public})
set(android-emu-shared_linux-x86_64_libs_public
    ${android-emu_linux-x86_64_libs_public})
set(android-emu-shared_darwin-x86_64_libs_public
    ${android-emu_darwin-x86_64_libs_public})
set(android-emu-shared_includes_private ${android-emu_includes_private})
set(android-emu-shared_includes_public ${android-emu_includes_public})
set(android-emu-shared_windows-x86_includes_private
    ${android-emu_windows-x86_includes_private})
set(android-emu-shared_windows-x86_64_includes_private
    ${android-emu_windows-x86_64_includes_private})
set(android-emu-shared_linux-x86_64_compile_options_private
    ${android-emu_linux-x86_64_compile_options_private})
set(android-emu-shared_compile_options_private ${android-emu_compile_options_private} -fvisibility=default)

set(android-emu-shared_defs_public ${android-emu_defs_public})
set(android-emu-shared_defs_private ${android-emu_defs_private})
add_android_shared_library(android-emu-shared)
...
set(android-emu_unittests_windows_x86_64_src
...
set(android-emu_unittests_windows_x86_src
    ${android-emu_unittests_windows_x86_64_src})

# Darwin & Linux only tests
set(android-emu_unittests_darwin_x86_64_src
    android/emulation/nand_limits_unittest.cpp)
set(android-emu_unittests_linux_x86_64_src
    android/emulation/nand_limits_unittest.cpp)

set(android-emu_unittests_compile_options_private -O0)
set(android-emu_unittests_includes_private
...
# TODO(jansene) We  should link against the shared variant, as this would force
# dependency resolution of the externs. (Which are not exercised in the
# unittests)
set(android-emu_unittests_libs_private android-emu gmock_main)

add_android_executable(android-emu_unittests)
...
set(android-emu-metrics_unittests_compile_options_private -O0)
set(android-emu-metrics_unittests_libs_private  gmock_main android-emu)
add_android_executable(android-emu-metrics_unittests)
