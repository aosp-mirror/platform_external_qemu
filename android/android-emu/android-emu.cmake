...
set(android-emu_windows-x86_libs_public
...
# For the rest we have the same dependencies as the not shared version.
...
set(android-emu-shared_compile_options_private
    ${android-emu_compile_options_private} -fvisibility=default)
...
set(android-emu_unittests_linux-x86_64_prebuilt_properties "LINK_FLAGS>=-Wl,-rpath,'$ORIGIN/lib64'")
...
set(android-emu-metrics_unittests_linux-x86_64_prebuilt_properties "LINK_FLAGS>=-Wl,-rpath,'$ORIGIN/lib64'")
