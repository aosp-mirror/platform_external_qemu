...
android_add_library(
  ...
  SRC # cmake-format: sortable
      ${android-emu_src}
  WINDOWS android/opengl/NativeGpuInfo_windows.cpp android/snapshot/MemoryWatch_windows.cpp
          android/windows_installer.cpp android/camera/camera-capture-windows.cpp
          android/crashreport/CrashReporter_windows.cpp
  LINUX android/opengl/NativeGpuInfo_linux.cpp android/snapshot/MemoryWatch_linux.cpp
...
android_target_compile_options(
  android-emu darwin-x86_64
  PRIVATE -Wno-objc-method-access -Wno-missing-selector-name -Wno-receiver-expr -Wno-incomplete-implementation
          -Wno-incompatible-pointer-types -Wno-deprecated-declarations)

android_target_compile_options(
  android-emu windows_msvc-x86_64 PRIVATE -Wno-unused-private-field -Wno-reorder -Wno-missing-braces
...
android_add_library(
  ...
  DARWIN android/opengl/NativeGpuInfo_darwin.cpp android/snapshot/MemoryWatch_darwin.cpp
         android/opengl/macTouchOpenGL.m android/emulation/MediaH264DecoderVideoToolBox.cpp
         android/snapshot/MacSegvHandler.cpp android/crashreport/CrashReporter_darwin.cpp)
...
android_target_compile_options(android-emu-shared Clang PRIVATE -Wno-extern-c-compat -Wno-invalid-constexpr
                                                                -fvisibility=default)
...
android_target_compile_options(
  android-emu-shared darwin-x86_64
  PRIVATE -Wno-error -Wno-objc-method-access -Wno-receiver-expr -Wno-incomplete-implementation
          -Wno-missing-selector-name -Wno-incompatible-pointer-types)

android_target_compile_options(android-emu-shared windows_msvc-x86_64 PRIVATE -Wno-unused-private-field -Wno-reorder
...
android_target_compile_definitions(android-emu-shared darwin-x86_64 PRIVATE "-D_DARWIN_C_SOURCE=1" "-Dftello64=ftell"
                                   "-Dfseeko64=fseek")

target_compile_definitions(
  android-emu-shared
  PRIVATE "-DCRASHUPLOAD=${OPTION_CRASHUPLOAD}" "-DANDROID_SDK_TOOLS_REVISION=${OPTION_SDK_TOOLS_REVISION}"
          "-DANDROID_SDK_TOOLS_BUILD_NUMBER=${OPTION_SDK_TOOLS_BUILD_NUMBER}")
...
android_add_library(
  TARGET android-mock-vm-operations LICENSE Apache-2.0 SRC # cmake-format: sortable
...
android_add_test(
  ...
  WINDOWS android/base/files/ScopedFileHandle_unittest.cpp android/base/files/ScopedRegKey_unittest.cpp
  ...
  DARWIN android/emulation/nand_limits_unittest.cpp android/emulation/control/adb/AdbShellStream_unittest.cpp
  LINUX android/emulation/nand_limits_unittest.cpp android/emulation/control/adb/AdbShellStream_unittest.cpp)
