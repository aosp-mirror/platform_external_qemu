...
android_target_include_directories(android-emu all PUBLIC ${LZ4_INCLUDE_DIRS} ${UUID_INCLUDE_DIRS}
...
android_target_compile_options(android-emu all PRIVATE -Wno-extern-c-compat -Wno-invalid-constexpr)
...
android_target_compile_definitions(android-emu all PUBLIC ${CURL_DEFINITIONS} ${LIBXML2_DEFINITIONS})

# Specify our name of the renderlib, as cmake will have different naming
android_target_compile_definitions(android-emu all PRIVATE -DRENDERER_LIB_NAME=\"libOpenglRender\")
...
android_target_link_libraries(android-emu-shared linux-x86_64 PUBLIC -lrt -lX11 -lGL -lc++)
...
# Includes
android_target_include_directories(android-emu-shared
                                   all
                                   PRIVATE
                                   ${BREAKPAD_INCLUDE_DIRS}
                                   ${CURL_INCLUDE_DIRS}
...
android_target_include_directories(android-emu-shared all PUBLIC ${LZ4_INCLUDE_DIRS} ${UUID_INCLUDE_DIRS}
                                   # TODO(jansene): The next 2 imply a link dependendency on emugl libs, which
                                   # we have not yet made explicit
                                   ${ANDROID_QEMU2_TOP_DIR}/android/android-emugl/host/include
                                   ${ANDROID_QEMU2_TOP_DIR}/android/android-emugl/shared
...
android_target_compile_options(android-emu-shared all PRIVATE -Wno-extern-c-compat -Wno-invalid-constexpr)
android_target_compile_options(android-emu-shared linux-x86_64 PRIVATE -idirafter ${ANDROID_QEMU2_TOP_DIR}/linux-headers)

# Definitions needed to compile our deps as static
android_target_compile_definitions(android-emu-shared all PUBLIC ${CURL_DEFINITIONS} ${LIBXML2_DEFINITIONS})
...
android_target_compile_options(android-emu-shared all PRIVATE -fvisibility=default)
...
android_add_e2fsprogs_dependency(android-emu_unittests)
