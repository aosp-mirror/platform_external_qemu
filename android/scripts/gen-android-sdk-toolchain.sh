...
#       windows_msvc*)
#           COMPILERS="clang clang++ clang-tidy"
#   esac
...
prepare_build_for_darwin() {
    ...
    OSX_SDK_SUPPORTED="10.10 10.11 10.12 10.13 10.14"
...
prepare_build_for_windows_msvc() {
    ...
    var_append EXTRA_CFLAGS "-isystem $MSVC_DIR/win10sdk/include/10.0.16299.0/ucrt"
    var_append EXTRA_CFLAGS "-isystem $MSVC_DIR/win10sdk/include/10.0.16299.0/um"
    var_append EXTRA_CFLAGS "-isystem $MSVC_DIR/win10sdk/include/10.0.16299.0/winrt"
    var_append EXTRA_CFLAGS "-isystem $MSVC_DIR/win10sdk/include/10.0.16299.0/hypervisor"
    var_append EXTRA_CFLAGS "-isystem $MSVC_DIR/win10sdk/include/10.0.16299.0/shared"
    ...
    var_append EXTRA_CXXFLAGS "-isystem $MSVC_DIR/win10sdk/include/10.0.16299.0/ucrt"
    var_append EXTRA_CXXFLAGS "-isystem $MSVC_DIR/win10sdk/include/10.0.16299.0/um"
    var_append EXTRA_CXXFLAGS "-isystem $MSVC_DIR/win10sdk/include/10.0.16299.0/winrt"
    var_append EXTRA_CXXFLAGS "-isystem $MSVC_DIR/win10sdk/include/10.0.16299.0/hypervisor"
    var_append EXTRA_CXXFLAGS "-isystem $MSVC_DIR/win10sdk/include/10.0.16299.0/shared"
