...
prepare_build_for_windows_msvc() {
    ...
    var_append EXTRA_CFLAGS "-D__STDC_LIMIT_MACROS=1"
    var_append EXTRA_CFLAGS "-D__STDC_FORMAT_MACROS=1"
    ...
    var_append EXTRA_CXXFLAGS "-D__STDC_LIMIT_MACROS=1"
    var_append EXTRA_CXXFLAGS "-D__STDC_FORMAT_MACROS=1"
