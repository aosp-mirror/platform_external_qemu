...
prepare_build_for_windows () {
    ...
    POST_LDFLAGS=
    # Those libs are provided by recent Windows SDK versions and are
    # currently included in the prebuilts MINGW repo.
    var_append POST_LDFLAGS "-lWinHvPlatform"
    var_append POST_LDFLAGS "-lWinHvEmulation"

    POST_CFLAGS=$POST_LDFLAGS
    POST_CXXFLAGS=$POST_LDFLAGS
 }
