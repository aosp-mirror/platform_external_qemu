...
elseif (WIN32)
  # The emulator toolchain is using /MD.
  set(LIBWEBRTC_REQUIRED_C_FLAGS_DEBUG "/MD /Z7")
  set(LIBWEBRTC_REQUIRED_C_FLAGS_RELEASE "/MD /Zi")
  set(LIBWEBRTC_REQUIRED_CXX_FLAGS_DEBUG "/MD /Z7")
  set(LIBWEBRTC_REQUIRED_CXX_FLAGS_RELEASE "/MD /Zi")
