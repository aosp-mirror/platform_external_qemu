...
echo "Ready to go. Type ${GREEN}'${OPTION_GENERATOR} -C ${OPTION_OUT_DIR}'${RESET} to build emulator, and ${GREEN}'${OPTION_GENERATOR} -C ${OUT_DIR} tests'${RESET} to run the unit tests."
