...
option_register_var "--with-qtwebengine" OPTION_WITH_QTWEBENGINE "Build with QtWebEngine support"
...
if [ -z "$OPTION_WITH_QTWEBENGINE" -a "$(get_build_os)" = "linux" -z "$OPTION_MSVC" -a -z "$OPTION_MINGW" ]; then
