...
PROGRAM_DESCRIPTION=\
"Build prebuilt libXau for Linux"

package_builder_register_options

aosp_dir_register_option
prebuilts_dir_register_option
install_dir_register_option "common/libXau"
...
package_builder_process_options libXau
...
dump "$(builder_text) Building libXau"

builder_unpack_package_source libXau

builder_build_autotools_package libXau \
