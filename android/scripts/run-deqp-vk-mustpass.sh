...
GLES3_CTS_MUSTPASS_CASELIST=$AOSP_DIR/external/deqp/android/cts/master/vk-master.txt
DEQP_BUILD_DIR=$AOSP_DIR/external/deqp/build
DEQP_GLES3_EXEC_DIR=$DEQP_BUILD_DIR/external/vulkancts/modules/vulkan/
DEQP_GLES3_EXEC_NAME="./deqp-vk --deqp-caselist-file=$GLES3_CTS_MUSTPASS_CASELIST"
