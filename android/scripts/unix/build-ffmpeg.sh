    ...
    (
        ...
        windows_msvc-x86_64)
          MY_FLAGS="--target-os=win64 \
            ...
            --extra-ldflags=\"-Wl,-libpath:/usr/local/google/home/jansene/src/emu-master-dev/prebuilts/android-emulator-build/common/x264/windows_msvc-x86_64/lib\"  \
            --extra-ldflags=\"-Wl,-libpath:/usr/local/google/home/jansene/src/emu-master-dev/prebuilts/android-emulator-build/common/libvpx/windows_msvc-x86_64/lib\""
            ;;
        darwin-*)
            # Use host compiler.
        ...
        *)
        ...
        #  - gif: animated gids, used by recording
