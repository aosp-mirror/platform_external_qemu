...
please_install_proper_sdk_error() {
    ...
    log "For example:"
    log "tar cvf MacOSX$OSX_REQUIRED.sdk.tar.gz -C /Applications/XCode_old.app/Platforms/MacOSX.platform/Developer/SDKs/ MacOSX$OSX_REQUIRED.sdk"
    log "And making it available in your XCode version:"
    log "tar xzvf ~/Downloads/MacOSX$OSX_REQUIRED.sdk.tar.gz -C $OSX_SDK_ROOT/Platforms/MacOSX.platform/Developer/SDKs/"
