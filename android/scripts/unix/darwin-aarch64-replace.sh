...
# Delete all emulator files. Avoid deleting something potentially important that the user has put in this directory.
...
rm ./lib64/qt/libexec/qtwebengine_locales
