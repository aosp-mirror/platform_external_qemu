...
QEMU2_AUTOGENERATED_DIR=${QEMU2_TOP_DIR}/qemu2-qapi-auto-generated
...
run rm -f $QEMU2_AUTOGENERATED_DIR/asm
run ln -sf $QEMU2_TOP_DIR/linux-headers/asm-x86 $QEMU2_AUTOGENERATED_DIR/asm
