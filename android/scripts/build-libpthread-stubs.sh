...
PROGRAM_DESCRIPTION=\
"Build prebuilt libpthread-stubs for Linux"

package_builder_register_options

aosp_dir_register_option
prebuilts_dir_register_option
install_dir_register_option "common/libpthread-stubs"
...
package_builder_process_options xcb-proto
...
dump "$(builder_text) Building libpthread-stubs"

builder_unpack_package_source libpthread-stubs

builder_build_autotools_package libpthread-stubs \
...
log "Done building libpthread-stubs."
