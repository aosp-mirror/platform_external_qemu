...
PROGRAM_DESCRIPTION=\
"Build prebuilt xproto for Linux"

package_builder_register_options

aosp_dir_register_option
prebuilts_dir_register_option
install_dir_register_option "common/xproto"
...
package_builder_process_options xproto
...
dump "$(builder_text) Building xproto"

builder_unpack_package_source xproto

builder_build_autotools_package xproto \
