...
PROGRAM_DESCRIPTION=\
"Build prebuilt xcb-proto for Linux"

package_builder_register_options

aosp_dir_register_option
prebuilts_dir_register_option
install_dir_register_option "common/xcb-proto"
...
dump "$(builder_text) Building xcb-proto"

builder_unpack_package_source xcb-proto

builder_build_autotools_package xcb-proto \
