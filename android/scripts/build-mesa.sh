...
OPT_OSMESA=
option_register_var "--osmesa" OPT_OSMESA "Build offscreen Mesa instead."
    ...
    (
        ...
        case $SYSTEM in
            windows-*)
                ...
                if [ "$OPT_OSMESA" ]; then
                    MESA_TARGET="libgl-osmesa"
                    MESA_LIBS="osmesa.dll"
                else
