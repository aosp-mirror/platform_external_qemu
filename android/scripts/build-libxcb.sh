...
PROGRAM_DESCRIPTION=\
"Build prebuilt libxcb for Linux. This depends on xorg-macros and xcb-proto libs"

package_builder_register_options

aosp_dir_register_option
prebuilts_dir_register_option
install_dir_register_option "common/libxcb"
...
package_builder_process_options libxcb
...
dump "$(builder_text) Building libxcb"

builder_unpack_package_source libxcb

builder_build_autotools_package libxcb \
