...
public:
    ...
    //
    // NB: don't overuse Uuids! There's a limited set of them, if we aren't
    // careful we might exhaust it. Consider recycling GUIDs you're not using ;)
...
private:
    ...
    using data_t =
        typename std::aligned_storage<
            16, std::alignment_of<std::int64_t>::value
        >::type;
