...
protected:
    ~ConditionVariableImpl() noexcept = default;
};

// Fallback code for pre-Vista OS version - use handcrafted code.
class ConditionVariableImplXp final : public ConditionVariableImpl {
public:
...
class ConditionVariableImplVista final : public ConditionVariableImpl {
public:
    virtual void initCV(ConditionVariable::Data* cvData) const override final {
...
const ConditionVariableImplXp sImplXp;
const ConditionVariableImplVista sImplVista;
const ConditionVariableImpl* sImpl = nullptr;
