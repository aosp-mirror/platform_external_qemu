...
// An alias for the use inside of the Optional class; also it's a more
// STL-like name for those who prefer it
// Note: if you want to refer to the template name inside the template,
//  you need to use some other name than the class name - because the
//  class name inside of the class stands for an instantiated template
template <class T>
