...
Win32UnicodeString win32Path(const StringView& path) {
...
// static
StringVector System::scanDirInternal(const StringView& dirPath) {
    StringVector result;
...
// static
void System::addLibrarySearchDir(const StringView& path) {
...
// static
String System::findBundledExecutable(const StringView& programName) {
