...
public:
    ...
    explicit IpAddress(uint32_t ip) : mKind(kIpv4), mIpv4(ip) {}
    ...
    bool valid() const { return mKind == kIpv4 || mKind == kIpv6; }

    // Returns true iff this instance is IPv4.
    bool isIpv4() const { return mKind == kIpv4; }

    // Returns true iff this instance is IPv6.
    bool isIpv6() const { return mKind == kIpv6; }
