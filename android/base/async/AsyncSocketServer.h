...
public:
    ...
    // kIPv4Optional means that binding to 127.0.0.1 can fail.
    // kIPv6Optional means that binding to ::1 can fail.
    ...
    // may fail to bind to the corresponding ::1 port.
    enum LoopbackMode {
        kNone = 0,
        kIPv4 = (1 << 0),
        kIPv6 = (1 << 1),
    ...
    // Possible values are 0, kIPv4, kIPv6 and kIPv4AndIPv6
