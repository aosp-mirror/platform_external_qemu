...
public:
    ...
    ParallelTaskTest() :
        ...
        mParallelTask(mLooper, &ParallelTaskTest::taskFunction,
                          &ParallelTaskTest::taskDoneFunction, 10) {}
...
protected:
    Looper* mLooper;
    ParallelTask<ParallelTaskTest, Result> mParallelTask;
    Result mResult;
...
TEST_F(ParallelTaskTest, start) {
    unblock();
    EXPECT_TRUE(mParallelTask.start(this));
