...
const QString THEME_PATH_VAR = "PATH";
const QString MAJOR_TAB_COLOR_VAR = "MAJOR_TAB_COLOR";
const QString TAB_BKG_COLOR_VAR = "TAB_BKG_COLOR";
const QString TAB_SELECTED_COLOR_VAR = "TAB_SELECTED_COLOR";

QString darkStylesheet;
QString lightStylesheet;

QString hiDensityFontStylesheet;
QString loDensityFontStylesheet;
...
QHash<QString, QString> lightValues {
    ...
    {"MAJOR_TAB_COLOR",      "#91a4ad"},  // Text of major tabs
    ...
    {"TAB_BKG_COLOR",        "#ffffff"},  // Background of major tabs
    {"TAB_SELECTED_COLOR",   "#f5f5f5"},  // Background of the selected major tab
    ...
    {"PATH",                   "light"},  // Icon directory under images/
};
...
std::atomic_flag stylesheetsInitialized = ATOMIC_FLAG_INIT;

const QString& stylesheetForTheme(SettingsTheme theme) {
    if (!stylesheetsInitialized.test_and_set()) {
