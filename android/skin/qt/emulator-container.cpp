...
void EmulatorContainer::slot_resizeDone()
{
    ...
    // A hacky way of determining if the user is still holding down for a resize.
    // This queries the global event state to see if any mouse buttons are held down.
