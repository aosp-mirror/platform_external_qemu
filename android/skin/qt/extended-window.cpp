...
void ExtendedWindow::adjustTabs(ExtendedWindowPane thisIndex)
{
    ...
    colorStyle += Ui::stylesheetValues(theme)["MAJOR_TAB_COLOR"];
    colorStyle += "; background-color:";
    colorStyle += Ui::stylesheetValues(theme)["TAB_BKG_COLOR"];
    ...
    activeStyle += Ui::stylesheetValues(theme)["MAJOR_TAB_COLOR"];
    activeStyle += "; background-color:";
    activeStyle += Ui::stylesheetValues(theme)["TAB_SELECTED_COLOR"];
