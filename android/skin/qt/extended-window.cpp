...
// ?? JKaye: I think this is too dark. There is not enough contrast
//           between this and the black outlines and shadows.
//#define DARK_FOREGROUND  "#f0f0f0"
//#define DARK_BACKGROUND  "#2c3239"
//#define DARK_ACTIVE      "#3c4249"  // A little lighter than the background
...
ExtendedWindow::ExtendedWindow(EmulatorQtWindow *eW, Tools *tW, const UiEmuAgent *agentPtr) :
    QFrame(eW),
    parentWindow(eW),
    toolWindow(tW),
