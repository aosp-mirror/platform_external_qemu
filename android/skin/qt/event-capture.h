...
// the UI thread.
class EventCapture : public QObject {
Q_OBJECT
public:
...
private:
    struct SubscriberInfo {
        ...
        // holding on to.
        detail::SubscriberTokenImpl* token;
    };

public:
    using SubscriberToken = std::unique_ptr<detail::SubscriberTokenImpl>;

    // Invalidates all tokens dispensed by this instance of EventCapture.
    ~EventCapture();
