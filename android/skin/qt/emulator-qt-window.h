...
private:
    ...
    public:
              ...
              mMode(OverlayMode::Hidden)
        {
            ...
            mCircleRadius = mCenterImage.width() / this->devicePixelRatio();
        }
        ...
        void paintEvent(QPaintEvent *e)
        {
            ...
            if (mMode == OverlayMode::Multitouch) {
                painter.translate(-mCircleRadius / 2, -mCircleRadius / 2);
                ...
                if (lineToPrimary.length() > mCircleRadius) {
                    QPointF delta = (lineToPrimary.unitVector().p2() * (mCircleRadius / 2));
