...
class ScreenCapturer : public QObject,
                       public std::enable_shared_from_this<ScreenCapturer> {
    Q_OBJECT
...
private:
    ...
    void reportResult(ScreenCapturer::Result outResult, QString errString = "");

signals:
    void screenCaptureDone(QString errString = "");

private slots:
    void screenCaptureDone_slot(QString errString);
