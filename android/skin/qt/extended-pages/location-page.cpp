    ...
    mGeoDataLoadingStopRequested(false)
{
    ...
    mGeoDataLoader = GeoDataLoaderThread::newInstance(
            this,
            SLOT(geoDataLoadingStarted()),
            SLOT(startupGeoDataLoadingFinished(QString, bool, QString)));
...
void LocationPage::on_loc_GpxKmlButton_clicked()
{
    ...
    mGeoDataLoader = GeoDataLoaderThread::newInstance(this,
                                                          SLOT(geoDataLoadingStarted()),
                                                          SLOT(geoDataLoadingFinished(QString, bool, QString)));
...
void LocationPage::geoDataLoadingStarted() {
    mUi->loc_pathTable->setRowCount(0);
    SettingsTheme theme = getSelectedTheme();
...
void LocationPage::startupGeoDataLoadingFinished(QString, bool ok, QString) {
...
void LocationPage::geoDataLoadingFinished(QString file_name, bool ok, QString error) {
    mGeoDataLoader = nullptr;
    if (ok) {
        QSettings settings;
