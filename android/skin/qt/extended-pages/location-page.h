...
private slots:
    ...
    void geoDataLoadingStarted();
    void geoDataLoadingFinished(QString file_name, bool ok, QString error);
    void startupGeoDataLoadingFinished(QString file_name, bool ok, QString error);
