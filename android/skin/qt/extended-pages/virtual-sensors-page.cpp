...
void VirtualSensorsPage::onPhoneRotationChanged() {
    QQuaternion device_rotation_quat = mUi->accelWidget->rotation();//getRotationQuat();
    ...
    /*setSensorValue(mSensorsAgent,
                   ...
                   mUi->yawAngleWidget->getValue(),
                   mUi->pitchAngleWidget->getValue(),
                   mUi->rollAngleWidget->getValue());*/
