...
class WorkerThread : public QThread
{
    Q_OBJECT
public:
    WorkerThread(StartFunction f) { start_function = f; }
    void run() Q_DECL_OVERRIDE { if (start_function) start_function(); }
private:
...
public:
    ...
    /*
     ...
     TODO: allow nonblocking calls to these signals by having the signal take ownership of object pointers.
     */
signals:
