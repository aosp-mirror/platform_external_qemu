...
#define QT_STYLE(THEME) \
    ...
    "QTableView::item { padding-left: 16; padding-right: 16; color: " THEME##_TEXT_COLOR"; border: 0; border-bottom: 1 solid " THEME##_DIVIDER_COLOR "}" \
    "QTableView::item:focus{}" \
    "QHeaderView::section { color:" THEME##_TITLE_COLOR "; background:" \
        THEME##_TAB_BKG_COLOR "; border: 0px; padding: 16; border-bottom: 1 solid " THEME##_DIVIDER_COLOR ";" \
        "font-weight: bold}" \
