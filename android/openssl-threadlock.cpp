...
#include "android/openssl-threadlock.h"
...
// We rely on the default implementation of thread_id in openssl. This is safe
// on win32 (GetCurrentThreadId()) and on posix systems where errno is thread
// safe.
