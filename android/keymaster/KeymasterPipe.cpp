        ...
        case GenerateKeypair:
            {
                ...
                int ret = m_keymaster.openssl_generate_keypair(keyType,
        ...
        case ImportKeypair:
            {
                ...
                uint8_t* keyBlob;
                uint32_t keyBlobLength;
                int ret = m_keymaster.openssl_import_keypair(key, keyLen,
        ...
        case GetKeypairPublic:
            {
                ...
                int ret = m_keymaster.openssl_get_keypair_public(keyBlob,
        ...
        case SignData:
            {
                ...
                int ret = m_keymaster.openssl_sign_data(params,
                        keyBlob, keyBlobLen,
                        rawData, rawDataLen,
        ...
        case VerifyData:
            {
                ...
                data += signatureLen;
                // output parameters
                int ret = m_keymaster.openssl_verify_data(params,
                        keyBlob, keyBlobLen,
                        signedData, signedDataLen,
