...
emugl_host_gpu_props* emuglConfig_get_host_gpu_props() {
    ...
    res->makes = new char*[res->num_gpus];
    res->models = new char*[res->num_gpus];
    res->device_ids = new char*[res->num_gpus];
    res->revision_ids = new char*[res->num_gpus];
    res->versions = new char*[res->num_gpus];
    res->renderers = new char*[res->num_gpus];
...
void free_emugl_host_gpu_props(emugl_host_gpu_props* props) {
    ...
    delete [] props->makes;
    delete [] props->models;
    delete [] props->device_ids;
    delete [] props->revision_ids;
    delete [] props->versions;
