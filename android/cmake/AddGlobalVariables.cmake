...
function(add_global_variables)
	...
	set(E2FSPROGS_INCLUDE_DIRS
		${ANDROID_EMULATOR_BUILD}/common/e2fsprogs/${BUILD_HOST_TAG64}/include
		PARENT_SCOPE
		)

	set(E2FSPROGS_LIBRARIES
		${ANDROID_EMULATOR_BUILD}/common/e2fsprogs/${BUILD_HOST_TAG64}/lib/libuuid.a
		PARENT_SCOPE
		)
	...
	set(FFMPEG_INCLUDE_DIRS
		${ANDROID_EMULATOR_BUILD}/common/ffmpeg/${BUILD_HOST_TAG64}/include
		PARENT_SCOPE
		)
	set(FFMPEG_LIBRARIES
		${ANDROID_EMULATOR_BUILD}/common/ffmpeg/${BUILD_HOST_TAG64}/lib/libavcodec.a
		${ANDROID_EMULATOR_BUILD}/common/ffmpeg/${BUILD_HOST_TAG64}/lib/libavfilter.a
		${ANDROID_EMULATOR_BUILD}/common/ffmpeg/${BUILD_HOST_TAG64}/lib/libavformat.a
		${ANDROID_EMULATOR_BUILD}/common/ffmpeg/${BUILD_HOST_TAG64}/lib/libavresample.a
		${ANDROID_EMULATOR_BUILD}/common/ffmpeg/${BUILD_HOST_TAG64}/lib/libavutil.a
		${ANDROID_EMULATOR_BUILD}/common/ffmpeg/${BUILD_HOST_TAG64}/lib/libpostproc.a
		${ANDROID_EMULATOR_BUILD}/common/ffmpeg/${BUILD_HOST_TAG64}/lib/libswresample.a
		${ANDROID_EMULATOR_BUILD}/common/ffmpeg/${BUILD_HOST_TAG64}/lib/libswscale.a
		PARENT_SCOPE
		)
	...
	set(QT5_INCLUDE_DIRS
		...
		${ANDROID_EMULATOR_BUILD}/qt/common/include/QtSvg
...
function(add_qt_support)
	...
	if(UNIX)
		set(QT_UIC_EXECUTABLE ${REPO_ROOT}/external/qemu/android/cmake/uic.sh)
	else()
