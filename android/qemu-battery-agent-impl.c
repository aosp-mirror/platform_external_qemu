...
#include "android/qemu-battery-agent-impl.h"
...
static const QAndroidBatteryAgent globalBatteryAgent = {
...
const QAndroidBatteryAgent* qemu_get_android_battery_agent() {
    return &globalBatteryAgent;
}
