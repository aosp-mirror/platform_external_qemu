...
/*
 * Contains declarations for UI control protocol used by the UI.
 * In essence, here are defined UI control commands sent by the UI to the Core.
 */

#nclude "android/protocol/ui-common.h"
