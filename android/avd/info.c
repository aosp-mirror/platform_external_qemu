 ...
 */
static void
imageLoader_optional_load( ImageLoader *l, AvdImageType img_type,
...
_getImagePaths(AvdInfo*  i, AvdInfoParams*  params )
{
     ...
     */
    if (!noSdCard) {
        imageLoader_optional_load(l, AVD_IMAGE_SDCARD,
     ...
     */
    if (!noSnapshots) {
        imageLoader_optional_load(l, AVD_IMAGE_SNAPSHOTS,
