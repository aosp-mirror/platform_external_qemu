...
static const int kPropertyFileInvalid  = -1; // key was found but value
                                             // contained invalid data
static const int kPropertyFileFound    =  0; // key was found and value
                                             // parsed correctly
static const int kPropertyFileNotFound =  1; // key was not found
                                             // (default used)
 ...
 * |found| if non-null, this is set to kPropertyFileInvalid,
 *         kPropertyFileFound, or kPropertyFileNotFound
