...
static int is_adb_server_alive_get_port(int* port) {
...
int is_adb_server_alive() {
    int adb_server_port;
    return is_adb_server_alive_get_port(&adb_server_port);
}

void check_and_start_adb_server() {
    int adb_server_port;
    if(!is_adb_server_alive_get_port(&adb_server_port)) {
