...
/*
 * Creates a new empty CIniFile not bound to any underlying file, and without any
 ...
 */
int64_t  iniFile_getDiskSize( CIniFile*  f, const char*  key, const char*  defaultValue );
