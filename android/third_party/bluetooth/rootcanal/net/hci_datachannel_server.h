...
// A Datachannel server that will provide the qemu connection.
// (and later on the gRPC connections, when available)
...
private:
    std::vector<std::shared_ptr<AsyncDataChannel>> mChannels;
