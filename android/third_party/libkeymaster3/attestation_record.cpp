...
constexpr unsigned int kCurrentKeymasterVersion = 3;
constexpr unsigned int kCurrentAttestationVersion = 2;
...
static keymaster_error_t build_auth_list(const AuthorizationSet& auth_list, KM_AUTH_LIST* record) {
    ...
    for (auto entry : auth_list) {
        ...
        case KM_TAG_ROOT_OF_TRUST:
            //string_ptr = (ASN1_OCTET_STRING**)(&record->root_of_trust);
            //break;
            continue;
...
keymaster_error_t build_attestation_record(const AuthorizationSet& attestation_params,
    ...
    ASN1_OCTET_STRING_set(key_desc->tee_enforced->root_of_trust->verified_boot_key,
             ...
             , 40);
    ASN1_ENUMERATED_set(key_desc->tee_enforced->root_of_trust->verified_boot_state,
