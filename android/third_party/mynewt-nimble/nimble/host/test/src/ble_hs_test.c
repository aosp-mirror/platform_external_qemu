...
main(int argc, char **argv)
{
    ...
    // ble_att_clt_suite(); // Unexpected packet?
    ble_att_svr_suite();
    ...
    // ble_gap_test_suite_set_cb();  // ble_gap_test_case_set_cb_good fails (unexpected event.type)
    ...
    // ble_gatt_conn_suite(); // timeout test fails (sys clock issue?)
    ...
    // ble_gatt_write_test_suite(); // ble_gatt_write_test_cb_called is not called
    // ble_gatts_notify_suite(); // ble_gatts_notify_test_n fails
    ...
    ble_os_test_suite();
    // ble_sm_gen_test_suite(); // TODO(jansene): These fail, tests expect to override the algs.
    // ble_sm_lgcy_test_suite();  // TODO(jansene): These fail
    // ble_sm_sc_test_suite();   // TODO(jansene): These fail
    ble_store_suite();
    ble_uuid_test_suite();
