...
#for PROBE in e2fsprogs ffmpeg x264 libvpx libxml2 lz4 ANGLE
# do
#   probe_and_set $PROBE common
# done
...
# Probe qemu android deps
# for PROBE in zlib libpng libsdl2; 
# do
#   probe_and_set $PROBE qemu-android-deps
# done
