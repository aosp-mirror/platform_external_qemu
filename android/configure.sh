...
DEFAULT_TARGETS=x86,x86_64,arm,arm64
# Parse options
OPTION_QEMU2_SRCDIR=
OPTION_DEBUG=no
OPTION_SANITIZER=no
...
OPTION_TARGETS=$DEFAULT_TARGETS
OPTION_MIN_BUILD=no
...
EOF
    ...
    echo "  --targets=[...]             List of target emulators [x86, x86_64, arm, arm64, mips, mips64] [$DEFAULT_TARGETS]."
...
echo "QEMU2_TARGETS := $OPTION_TARGETS" | sed 's/,/ /g' >> $config_mk
