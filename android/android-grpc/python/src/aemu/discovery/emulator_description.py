...
class EmulatorDescription(dict):
    ...
    def get_grpc_channel(self):
        ...
        if "grpc.token" in self.description:
    ...
    def name(self):
        ...
        """
        return "emulator-{}".format(self.description["port.serial"])
    ...
    def get(self, prop, default_value=None):
        ...
        return self.description.get(prop, default_value)
