...
class EmulatorDiscovery(object):
    """This class discovers all the running emulators by parsing the available discovery files."""
    ...
    def discover(self):
        """Discovers all running emulators by scanning the discovery dir."""
        ...
        for file in os.listdir(self.discovery_dir):
            ...
            if m:
                ...
                if emu:
                    self.emulators.add(EmulatorDescription(m.group(1), emu))
    ...
    def emulators(self):
        return frozenset(self.emulators)
    ...
    def first(self):
        ...
        return next(iter(self.emulators))
