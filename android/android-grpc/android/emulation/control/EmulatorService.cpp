        ...
        RaiiEventListener<android::MultiDisplay, android::DisplayChangeEvent>
                displayListener(
                        ...
                        [&](auto multiDisplay, auto state) {
                            ...
                            display.set_event(Notification::DISPLAY_EVENT);
                            display.mutable_displayevent()->set_display(
                                    state.displayId);
                            display.mutable_displayevent()->set_eventtype(
                                    (DisplayChangeEvent_DisplayChangeEventType)
                                            state.change);
