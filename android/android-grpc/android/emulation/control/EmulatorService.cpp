...
public:
    WaterfallImpl() : mWaterfall(getDefaultWaterfallServiceForwarder()) {}
    ...
    Status Version(ServerContext* context,
        ...
        auto stub = mWaterfall->getWaterfallStub();
        ::grpc::ClientContext defaultCtx;
        return stub->Version(&defaultCtx, *request, reply);
    }

private:
    std::unique_ptr<WaterfallServiceForwarder> mWaterfall;
};
