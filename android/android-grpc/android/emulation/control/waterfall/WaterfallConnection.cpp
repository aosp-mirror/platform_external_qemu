...
private:
    ...
    int nextSocket() {
        ...
        base::System::Duration blockUntil =
                base::System::get()->getUnixTimeUs() + kTimeout;
    ...
    void onAccept() {
        ...
        socket_read_timeout(fd, kTimeout);
        socket_write_timeout(fd, kTimeout);
    ...
    static constexpr uint64_t kOneMsecInUsec = 1000;
    static constexpr uint64_t kTimeout = 500 * kOneMsecInUsec;
    int mDomainSocket = -1;
    Looper* mLooper;
