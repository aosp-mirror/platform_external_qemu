...
class ASyncWaterfallServiceForwarder;
...
class ASyncWaterfallServiceForwarder : public WaterfallServiceForwarder {
public:
    ASyncWaterfallServiceForwarder() {}

    virtual Stub* open() override;
    virtual void close(Stub*) override;
    virtual void erase(Stub*) override;
