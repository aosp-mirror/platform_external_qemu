...
SkinRotation ScreenshotUtils::translate(Rotation_SkinRotation x) {
    ...
    static_assert(Rotation::PORTRAIT == SKIN_ROTATION_0);
    static_assert(Rotation::LANDSCAPE == SKIN_ROTATION_90);
    static_assert(Rotation::REVERSE_PORTRAIT == SKIN_ROTATION_180);
    static_assert(Rotation::REVERSE_LANDSCAPE == SKIN_ROTATION_270);
    assert(x <= SKIN_ROTATION_270);
