 ...
 * @const
 * @type {!grpc.web.AbstractClientBase.MethodInfo<
 *   !proto.android.emulation.control.KeyEvent,
 *   !proto.google.protobuf.Empty>}
 */
const methodInfo_EmulatorController_sendKey = new grpc.web.AbstractClientBase.MethodInfo(
  google_protobuf_empty_pb.Empty,
  /** @param {!proto.android.emulation.control.KeyEvent} request */
  function(request) {
    return request.serializeBinary();
  },
  google_protobuf_empty_pb.Empty.deserializeBinary
...
/**
 * @param {!proto.android.emulation.control.KeyEvent} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.google.protobuf.Empty)}
