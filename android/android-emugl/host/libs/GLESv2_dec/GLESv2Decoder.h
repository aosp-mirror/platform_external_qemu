...
private:
    ...
    static void gles2_APIENTRY s_glUniform1i(void* self, GLint location, GLint x);
    static void gles2_APIENTRY s_glUniform1f(void* self, GLint location, GLfloat x);
    static void gles2_APIENTRY s_glUniform4f(void* self, GLint location, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
    static void gles2_APIENTRY s_glUniform4fv(void* self, GLint location, GLsizei count, const GLfloat* vals);
    static void gles2_APIENTRY s_glUniformMatrix4fv(void* self, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value);
    ...
    static void gles2_APIENTRY s_glTexParameteri(void* self, GLenum target, GLenum pname, GLint param);

    // FBO========================================================
    static void gles2_APIENTRY s_glBindFramebuffer(void* self, GLenum target, GLuint framebuffer);
    static void gles2_APIENTRY s_glFramebufferTexture2D(void* self, GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level);

    // VAO========================================================
    static void gles2_APIENTRY s_glEnableVertexAttribArray(void* self, GLuint index);
    static void gles2_APIENTRY s_glDisableVertexAttribArray(void* self, GLuint index);
};
#endif
