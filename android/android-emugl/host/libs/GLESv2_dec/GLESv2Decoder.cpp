...
void GLESv2Decoder::s_glUnmapBufferDMA(void* self, GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access, GLboolean* out_res)
{
    GLESv2Decoder *ctx = (GLESv2Decoder *)self;
