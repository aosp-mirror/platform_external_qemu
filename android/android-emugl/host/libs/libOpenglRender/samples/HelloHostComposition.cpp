...
class HelloSurfaceFlinger : public SampleApplication {
public:
    HelloSurfaceFlinger() : SampleApplication(256, 256, 60, GLESApi_3_0, true) { }
protected:
    ...
    void initialize() override {
        ...
        gl->glBufferData(GL_ARRAY_BUFFER, sizeof(vertexAttrs), vertexAttrs, GL_STATIC_DRAW);

        gl->glVertexAttribPointer(
            0, 2, GL_FLOAT, GL_FALSE, sizeof(VertexAttributes), 0);
        gl->glVertexAttribPointer(
            1, 3, GL_FLOAT, GL_FALSE, sizeof(VertexAttributes),
