...
TEST_F(SnapshotGlFramebufferObjectTest, BindDepthRenderbuffer) {
    setStateChanger([this] {
        ...
        // gl->glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH_COMPONENT16, 8,
        // 8);
...
TEST_F(SnapshotGlFramebufferObjectTest, BindColor0Texture2D) {
    setStateChanger([this] {
        ...
        //         0x44,
        // };
        // texData.resize(2 * 2 * glUtilsPixelBitSize(GL_RGBA, GL_UNSIGNED_BYTE)
        // /
        //                8);
        // gl->glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, 2, 2, 0, GL_RGBA,
