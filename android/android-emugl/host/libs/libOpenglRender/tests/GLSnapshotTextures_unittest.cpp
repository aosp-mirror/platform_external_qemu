...
TEST_F(SnapshotGlTextureObjectTest, SetObjectParameters) {
    setStateChanger([this] {
        ...
        fprintf(stderr, "setting state 0x%x: 0x%x\n", GL_TEXTURE_MIN_FILTER, m_state.minFilter);
        fprintf(stderr, "setting state 0x%x: 0x%x\n", GL_TEXTURE_MAG_FILTER, m_state.magFilter);
        fprintf(stderr, "setting state 0x%x: 0x%x\n", GL_TEXTURE_WRAP_S, m_state.wrapS);
        fprintf(stderr, "setting state 0x%x: 0x%x\n", GL_TEXTURE_WRAP_T, m_state.wrapT);
