...
enum class GlVertexAttribMode { Current = 0, Array = 1, Buffer = 2 };
...
static const GlVertexAttrib kGLES2DefaultVertexAttrib = {
        .mode = GlVertexAttribMode::Current,
...
class SnapshotGlVertexAttribCurrentTest
...
TEST_F(SnapshotGlVertexAttribCurrentTest, PreserveCurrentFloatAttrib) {
    selectIndex(31);
...
TEST_F(SnapshotGlVertexAttribArrayTest, PreserveArrayProperties) {
    selectIndex(5);
