...
public:
    ...
    void stateChange() override {
        fprintf(stderr, "Starting state change...\n");
        m_program_name = gl->glCreateProgram();
        m_program_state = getProgramState();
        m_state_changer();
        fprintf(stderr, "Completed state change.\n");
    }
