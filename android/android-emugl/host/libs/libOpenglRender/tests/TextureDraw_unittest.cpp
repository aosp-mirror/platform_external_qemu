...
void TestTextureDrawLayer(const GLESv2Dispatch* gl) {
    ...
    // Test HWC2_COMPOSITION_SOLID_COLOR mode
    ComposeLayer l = {0, HWC2_COMPOSITION_SOLID_COLOR, {0, 0, width, height},
                      {0.0, 0.0, (float)width, (float)height}, HWC2_BLEND_MODE_NONE, 1.0,
                      {255, 0, 0, 255}, (hwc_transform_t)0};
    ...
    // Test HWC2_COMPOSITION_DEVICE mode
    ...
    // Test composing 2 layers, layer1 draws red to the upper half frame;
    // layer2 draws the bottom half of the texture to the bottom half frame
    ComposeLayer l1 = {0, HWC2_COMPOSITION_SOLID_COLOR, {0, 0, width, height/2},
                      {0.0, 0.0, (float)width, (float)height/2},
                      HWC2_BLEND_MODE_NONE, 1.0, {255, 0, 0, 255},
                      (hwc_transform_t)0};
    ComposeLayer l2 = {0, HWC2_COMPOSITION_DEVICE, {0, height/2, width, height},
