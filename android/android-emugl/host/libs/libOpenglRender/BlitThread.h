...
public:
    ...
    void bindSubwinContext(bool canSkip);
    void bindSubwinContextLocked(bool canSkip);
    void unbindContext();
    ...
    void closeColorBufferLocked(uint32_t colorBuffer);
...
private:
    enum BlitThreadOpCode {
        ...
        OpenColorBuffer = 5,
        CloseColorBuffer = 6,
        CloseColorBufferLocked = 7,
        ReadColorBuffer = 8,
        UpdateColorBuffer = 9,
        CreateWindowSurface = 10,
        DestroyWindowSurface = 11,
        CreateSync = 12,
        CleanupProcGLObjects = 13,
        Exit = 14,
    };
