...
// Cache YUV420_888 frame
static constexpr android::base::StringView kYUV420888Cache = "ANDROID_EMU_YUV420_888_Cache";
...
static EGLint rcGetGLString(EGLenum name, void* buffer, EGLint bufferSize) {
    ...
    bool YUV420888CacheEnabled =
        emugl_feature_is_enabled(android::featurecontrol::YUV420888Cache);
    ...
    if (YUV420888CacheEnabled && name == GL_EXTENSIONS) {
        glStr += kYUV420888Cache;
        glStr += " ";
    }
