...
void sAddExtensionIfSupported(GLESDispatchMaxVersion currVersion,
    ...
    if (currVersion > extVersion ||
        emugl::hasExtension(from.c_str(), ext.c_str())) {
        to += ext;
        to += " ";
    }
}
...
#define WHITELIST(extVer, ext) \
    sAddExtensionIfSupported(ver, exts, extVer, #ext, filteredExtensions); \

WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_compressed_ETC1_RGB8_texture)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_depth24)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_depth32)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_depth_texture)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_depth_texture_cube_map)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_EGL_image)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_EGL_image_external)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_EGL_sync)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_element_index_uint)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_framebuffer_object)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_packed_depth_stencil)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_rgb8_rgba8)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_standard_derivatives)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_texture_float)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_texture_float_linear)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_texture_half_float)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_texture_half_float_linear)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_texture_npot)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_OES_texture_3D)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_EXT_blend_minmax)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_EXT_color_buffer_half_float)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_EXT_draw_buffers)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_EXT_instanced_arrays)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_EXT_occlusion_query_boolean)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_EXT_read_format_bgra)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_EXT_texture_filter_anisotropic)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_EXT_texture_format_BGRA8888)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_EXT_texture_rg)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_ANGLE_framebuffer_blit)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_ANGLE_framebuffer_multisample)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_ANGLE_instanced_arrays)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_CHROMIUM_texture_filtering_hint)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_NV_fence)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_NV_framebuffer_blit)
WHITELIST(GLES_DISPATCH_MAX_VERSION_2, GL_NV_read_depth)
