...
template <> void VkVirtualHandleAsHostData<VkMappedMemoryRange>(uint32_t count, const VkMappedMemoryRange* in, VkMappedMemoryRange* out) {
    memcpy(out, in, sizeof(VkMappedMemoryRange));

    out->memory = VkVirtualHandleGetHost<VkDeviceMemory>((uint32_t)(uintptr_t)(in->memory));
}
...
template <> void VkVirtualHandleAsHostData<VkSubmitInfo>(uint32_t count, const VkSubmitInfo* in, VkSubmitInfo* out) {
    memcpy(out, in, sizeof(VkSubmitInfo));

    std::vector<VkSemaphore> tmp_pWaitSemaphores(in->waitSemaphoreCount); for (uint32_t i = 0; i < in->waitSemaphoreCount; i++) { tmp_pWaitSemaphores[i] = VkVirtualHandleGetHost<VkSemaphore>((uint32_t)(uintptr_t)(in->pWaitSemaphores[i])); }; memcpy((VkSemaphore*)out->pWaitSemaphores, &tmp_pWaitSemaphores[0], sizeof(VkSemaphore) * in->waitSemaphoreCount);
    std::vector<VkCommandBuffer> tmp_pCommandBuffers(in->commandBufferCount); for (uint32_t i = 0; i < in->commandBufferCount; i++) { tmp_pCommandBuffers[i] = VkVirtualHandleGetHost<VkCommandBuffer>((uint32_t)(uintptr_t)(in->pCommandBuffers[i])); }; memcpy((VkCommandBuffer*)out->pCommandBuffers, &tmp_pCommandBuffers[0], sizeof(VkCommandBuffer) * in->commandBufferCount);
    std::vector<VkSemaphore> tmp_pSignalSemaphores(in->signalSemaphoreCount); for (uint32_t i = 0; i < in->signalSemaphoreCount; i++) { tmp_pSignalSemaphores[i] = VkVirtualHandleGetHost<VkSemaphore>((uint32_t)(uintptr_t)(in->pSignalSemaphores[i])); }; memcpy((VkSemaphore*)out->pSignalSemaphores, &tmp_pSignalSemaphores[0], sizeof(VkSemaphore) * in->signalSemaphoreCount);
}
...
template <> void VkVirtualHandleAsHostData<VkSparseMemoryBind>(uint32_t count, const VkSparseMemoryBind* in, VkSparseMemoryBind* out) {
    memcpy(out, in, sizeof(VkSparseMemoryBind));
...
template <> void VkVirtualHandleAsHostData<VkSparseBufferMemoryBindInfo>(uint32_t count, const VkSparseBufferMemoryBindInfo* in, VkSparseBufferMemoryBindInfo* out) {
    memcpy(out, in, sizeof(VkSparseBufferMemoryBindInfo));

    out->buffer = VkVirtualHandleGetHost<VkBuffer>((uint32_t)(uintptr_t)(in->buffer));
    VkVirtualHandleAsHostData<VkSparseMemoryBind>(in->bindCount, in->pBinds, (VkSparseMemoryBind*)out->pBinds);
}
...
template <> void VkVirtualHandleAsHostData<VkSparseImageOpaqueMemoryBindInfo>(uint32_t count, const VkSparseImageOpaqueMemoryBindInfo* in, VkSparseImageOpaqueMemoryBindInfo* out) {
    memcpy(out, in, sizeof(VkSparseImageOpaqueMemoryBindInfo));

    out->image = VkVirtualHandleGetHost<VkImage>((uint32_t)(uintptr_t)(in->image));
    VkVirtualHandleAsHostData<VkSparseMemoryBind>(in->bindCount, in->pBinds, (VkSparseMemoryBind*)out->pBinds);
}
...
template <> void VkVirtualHandleAsHostData<VkSparseImageMemoryBindInfo>(uint32_t count, const VkSparseImageMemoryBindInfo* in, VkSparseImageMemoryBindInfo* out) {
    memcpy(out, in, sizeof(VkSparseImageMemoryBindInfo));

    out->image = VkVirtualHandleGetHost<VkImage>((uint32_t)(uintptr_t)(in->image));
}

template <> void VkVirtualHandleAsHostData<VkBindSparseInfo>(uint32_t count, const VkBindSparseInfo* in, VkBindSparseInfo* out) {
    memcpy(out, in, sizeof(VkBindSparseInfo));

    std::vector<VkSemaphore> tmp_pWaitSemaphores(in->waitSemaphoreCount); for (uint32_t i = 0; i < in->waitSemaphoreCount; i++) { tmp_pWaitSemaphores[i] = VkVirtualHandleGetHost<VkSemaphore>((uint32_t)(uintptr_t)(in->pWaitSemaphores[i])); }; memcpy((VkSemaphore*)out->pWaitSemaphores, &tmp_pWaitSemaphores[0], sizeof(VkSemaphore) * in->waitSemaphoreCount);
    VkVirtualHandleAsHostData<VkSparseBufferMemoryBindInfo>(in->bufferBindCount, in->pBufferBinds, (VkSparseBufferMemoryBindInfo*)out->pBufferBinds);
    VkVirtualHandleAsHostData<VkSparseImageOpaqueMemoryBindInfo>(in->imageOpaqueBindCount, in->pImageOpaqueBinds, (VkSparseImageOpaqueMemoryBindInfo*)out->pImageOpaqueBinds);
    VkVirtualHandleAsHostData<VkSparseImageMemoryBindInfo>(in->imageBindCount, in->pImageBinds, (VkSparseImageMemoryBindInfo*)out->pImageBinds);
    std::vector<VkSemaphore> tmp_pSignalSemaphores(in->signalSemaphoreCount); for (uint32_t i = 0; i < in->signalSemaphoreCount; i++) { tmp_pSignalSemaphores[i] = VkVirtualHandleGetHost<VkSemaphore>((uint32_t)(uintptr_t)(in->pSignalSemaphores[i])); }; memcpy((VkSemaphore*)out->pSignalSemaphores, &tmp_pSignalSemaphores[0], sizeof(VkSemaphore) * in->signalSemaphoreCount);
}
...
template <> void VkVirtualHandleAsHostData<VkBufferViewCreateInfo>(uint32_t count, const VkBufferViewCreateInfo* in, VkBufferViewCreateInfo* out) {
    memcpy(out, in, sizeof(VkBufferViewCreateInfo));
...
template <> void VkVirtualHandleAsHostData<VkImageViewCreateInfo>(uint32_t count, const VkImageViewCreateInfo* in, VkImageViewCreateInfo* out) {
    memcpy(out, in, sizeof(VkImageViewCreateInfo));
...
template <> void VkVirtualHandleAsHostData<VkPipelineShaderStageCreateInfo>(uint32_t count, const VkPipelineShaderStageCreateInfo* in, VkPipelineShaderStageCreateInfo* out) {
    memcpy(out, in, sizeof(VkPipelineShaderStageCreateInfo));

    for (uint32_t i = 0; i < count; i++) {
    out[i].module = VkVirtualHandleGetHost<VkShaderModule>((uint32_t)(uintptr_t)(in[i].module));
    fprintf(stderr, "%s: shader module guest %p host %p\n", __func__, in[i].module, out[i].module);
    }
}
...
template <> void VkVirtualHandleAsHostData<VkGraphicsPipelineCreateInfo>(uint32_t count, const VkGraphicsPipelineCreateInfo* in, VkGraphicsPipelineCreateInfo* out) {
    memcpy(out, in, sizeof(VkGraphicsPipelineCreateInfo));

    VkVirtualHandleAsHostData<VkPipelineShaderStageCreateInfo>(in->stageCount, in->pStages, (VkPipelineShaderStageCreateInfo*)out->pStages);
    out->layout = VkVirtualHandleGetHost<VkPipelineLayout>((uint32_t)(uintptr_t)(in->layout));
    out->renderPass = VkVirtualHandleGetHost<VkRenderPass>((uint32_t)(uintptr_t)(in->renderPass));
    out->basePipelineHandle = VkVirtualHandleGetHost<VkPipeline>((uint32_t)(uintptr_t)(in->basePipelineHandle));
}
...
template <> void VkVirtualHandleAsHostData<VkComputePipelineCreateInfo>(uint32_t count, const VkComputePipelineCreateInfo* in, VkComputePipelineCreateInfo* out) {
    memcpy(out, in, sizeof(VkComputePipelineCreateInfo));

    VkVirtualHandleAsHostData<VkPipelineShaderStageCreateInfo>(1, &in->stage, (VkPipelineShaderStageCreateInfo*)&out->stage);
    out->layout = VkVirtualHandleGetHost<VkPipelineLayout>((uint32_t)(uintptr_t)(in->layout));
    out->basePipelineHandle = VkVirtualHandleGetHost<VkPipeline>((uint32_t)(uintptr_t)(in->basePipelineHandle));
}
...
template <> void VkVirtualHandleAsHostData<VkPipelineLayoutCreateInfo>(uint32_t count, const VkPipelineLayoutCreateInfo* in, VkPipelineLayoutCreateInfo* out) {
    memcpy(out, in, sizeof(VkPipelineLayoutCreateInfo));

    std::vector<VkDescriptorSetLayout> tmp_pSetLayouts(in->setLayoutCount); for (uint32_t i = 0; i < in->setLayoutCount; i++) { tmp_pSetLayouts[i] = VkVirtualHandleGetHost<VkDescriptorSetLayout>((uint32_t)(uintptr_t)(in->pSetLayouts[i])); }; memcpy((VkDescriptorSetLayout*)out->pSetLayouts, &tmp_pSetLayouts[0], sizeof(VkDescriptorSetLayout) * in->setLayoutCount);
}
...
template <> void VkVirtualHandleAsHostData<VkDescriptorSetLayoutBinding>(uint32_t count, const VkDescriptorSetLayoutBinding* in, VkDescriptorSetLayoutBinding* out) {
    memcpy(out, in, sizeof(VkDescriptorSetLayoutBinding));

    std::vector<VkSampler> tmp_pImmutableSamplers(in->descriptorCount); for (uint32_t i = 0; i < in->descriptorCount; i++) { tmp_pImmutableSamplers[i] = VkVirtualHandleGetHost<VkSampler>((uint32_t)(uintptr_t)(in->pImmutableSamplers[i])); }; memcpy((VkSampler*)out->pImmutableSamplers, &tmp_pImmutableSamplers[0], sizeof(VkSampler) * in->descriptorCount);
}
...
template <> void VkVirtualHandleAsHostData<VkDescriptorSetLayoutCreateInfo>(uint32_t count, const VkDescriptorSetLayoutCreateInfo* in, VkDescriptorSetLayoutCreateInfo* out) {
    memcpy(out, in, sizeof(VkDescriptorSetLayoutCreateInfo));

    VkVirtualHandleAsHostData<VkDescriptorSetLayoutBinding>(in->bindingCount, in->pBindings, (VkDescriptorSetLayoutBinding*)out->pBindings);
}
...
template <> void VkVirtualHandleAsHostData<VkDescriptorSetAllocateInfo>(uint32_t count, const VkDescriptorSetAllocateInfo* in, VkDescriptorSetAllocateInfo* out) {
    memcpy(out, in, sizeof(VkDescriptorSetAllocateInfo));

    out->descriptorPool = VkVirtualHandleGetHost<VkDescriptorPool>((uint32_t)(uintptr_t)(in->descriptorPool));
    std::vector<VkDescriptorSetLayout> tmp_pSetLayouts(in->descriptorSetCount); for (uint32_t i = 0; i < in->descriptorSetCount; i++) { tmp_pSetLayouts[i] = VkVirtualHandleGetHost<VkDescriptorSetLayout>((uint32_t)(uintptr_t)(in->pSetLayouts[i])); }; memcpy((VkDescriptorSetLayout*)out->pSetLayouts, &tmp_pSetLayouts[0], sizeof(VkDescriptorSetLayout) * in->descriptorSetCount);
}
...
template <> void VkVirtualHandleAsHostData<VkDescriptorImageInfo>(uint32_t count, const VkDescriptorImageInfo* in, VkDescriptorImageInfo* out) {
    memcpy(out, in, sizeof(VkDescriptorImageInfo));

    out->sampler = VkVirtualHandleGetHost<VkSampler>((uint32_t)(uintptr_t)(in->sampler));
    out->imageView = VkVirtualHandleGetHost<VkImageView>((uint32_t)(uintptr_t)(in->imageView));
}
...
template <> void VkVirtualHandleAsHostData<VkDescriptorBufferInfo>(uint32_t count, const VkDescriptorBufferInfo* in, VkDescriptorBufferInfo* out) {
    memcpy(out, in, sizeof(VkDescriptorBufferInfo));
...
template <> void VkVirtualHandleAsHostData<VkWriteDescriptorSet>(uint32_t count, const VkWriteDescriptorSet* in, VkWriteDescriptorSet* out) {
    memcpy(out, in, sizeof(VkWriteDescriptorSet));

    out->dstSet = VkVirtualHandleGetHost<VkDescriptorSet>((uint32_t)(uintptr_t)(in->dstSet));
    VkVirtualHandleAsHostData<VkDescriptorImageInfo>(customCount_VkWriteDescriptorSet_pImageInfo(in), in->pImageInfo, (VkDescriptorImageInfo*)out->pImageInfo);
    VkVirtualHandleAsHostData<VkDescriptorBufferInfo>(customCount_VkWriteDescriptorSet_pBufferInfo(in), in->pBufferInfo, (VkDescriptorBufferInfo*)out->pBufferInfo);
    std::vector<VkBufferView> tmp_pTexelBufferView(customCount_VkWriteDescriptorSet_pTexelBufferView(in)); for (uint32_t i = 0; i < customCount_VkWriteDescriptorSet_pTexelBufferView(in); i++) { tmp_pTexelBufferView[i] = VkVirtualHandleGetHost<VkBufferView>((uint32_t)(uintptr_t)(in->pTexelBufferView[i])); }; memcpy((VkBufferView*)out->pTexelBufferView, &tmp_pTexelBufferView[0], sizeof(VkBufferView) * customCount_VkWriteDescriptorSet_pTexelBufferView(in));
}
...
template <> void VkVirtualHandleAsHostData<VkCopyDescriptorSet>(uint32_t count, const VkCopyDescriptorSet* in, VkCopyDescriptorSet* out) {
    memcpy(out, in, sizeof(VkCopyDescriptorSet));

    out->srcSet = VkVirtualHandleGetHost<VkDescriptorSet>((uint32_t)(uintptr_t)(in->srcSet));
    out->dstSet = VkVirtualHandleGetHost<VkDescriptorSet>((uint32_t)(uintptr_t)(in->dstSet));
}
...
template <> void VkVirtualHandleAsHostData<VkFramebufferCreateInfo>(uint32_t count, const VkFramebufferCreateInfo* in, VkFramebufferCreateInfo* out) {
    memcpy(out, in, sizeof(VkFramebufferCreateInfo));

    out->renderPass = VkVirtualHandleGetHost<VkRenderPass>((uint32_t)(uintptr_t)(in->renderPass));
    std::vector<VkImageView> tmp_pAttachments(in->attachmentCount); for (uint32_t i = 0; i < in->attachmentCount; i++) { tmp_pAttachments[i] = VkVirtualHandleGetHost<VkImageView>((uint32_t)(uintptr_t)(in->pAttachments[i])); }; memcpy((VkImageView*)out->pAttachments, &tmp_pAttachments[0], sizeof(VkImageView) * in->attachmentCount);
}
...
template <> void VkVirtualHandleAsHostData<VkCommandBufferAllocateInfo>(uint32_t count, const VkCommandBufferAllocateInfo* in, VkCommandBufferAllocateInfo* out) {
    memcpy(out, in, sizeof(VkCommandBufferAllocateInfo));

    out->commandPool = VkVirtualHandleGetHost<VkCommandPool>((uint32_t)(uintptr_t)(in->commandPool));
}
...
template <> void VkVirtualHandleAsHostData<VkCommandBufferInheritanceInfo>(uint32_t count, const VkCommandBufferInheritanceInfo* in, VkCommandBufferInheritanceInfo* out) {
    ...
    memcpy(out, in, sizeof(VkCommandBufferInheritanceInfo));

    out->renderPass = VkVirtualHandleGetHost<VkRenderPass>((uint32_t)(uintptr_t)(in->renderPass));
    out->framebuffer = VkVirtualHandleGetHost<VkFramebuffer>((uint32_t)(uintptr_t)(in->framebuffer));
}
...
template <> void VkVirtualHandleAsHostData<VkCommandBufferBeginInfo>(uint32_t count, const VkCommandBufferBeginInfo* in, VkCommandBufferBeginInfo* out) {
    memcpy(out, in, sizeof(VkCommandBufferBeginInfo));

    VkVirtualHandleAsHostData<VkCommandBufferInheritanceInfo>(1, in->pInheritanceInfo, (VkCommandBufferInheritanceInfo*)out->pInheritanceInfo);
}
...
template <> void VkVirtualHandleAsHostData<VkBufferMemoryBarrier>(uint32_t count, const VkBufferMemoryBarrier* in, VkBufferMemoryBarrier* out) {
    memcpy(out, in, sizeof(VkBufferMemoryBarrier));
...
template <> void VkVirtualHandleAsHostData<VkImageMemoryBarrier>(uint32_t count, const VkImageMemoryBarrier* in, VkImageMemoryBarrier* out) {
    memcpy(out, in, sizeof(VkImageMemoryBarrier));
...
template <> void VkVirtualHandleAsHostData<VkRenderPassBeginInfo>(uint32_t count, const VkRenderPassBeginInfo* in, VkRenderPassBeginInfo* out) {
    memcpy(out, in, sizeof(VkRenderPassBeginInfo));
...
static VkResult s_vkCreateShaderModule(VkDevice device, const VkShaderModuleCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkShaderModule* pShaderModule) {
    ...
    // host->guest handle conversions
    fprintf(stderr, "%s: shader module host side %p\n", __func__, *pShaderModule);
    if (pShaderModule) { VkVirtualHandleToGuestArray<VkShaderModule>(1, pShaderModule, pShaderModule); }
    fprintf(stderr, "%s: shader module guest side %p\n", __func__, *pShaderModule);
    if (res == VK_SUCCESS) { fprintf(stderr, "%s: success\n", __func__); } else { fprintf(stderr, "%s: err 0x%x\n", __func__, res); }
    return res;
}
...
static VkResult s_vkCreateFramebuffer(VkDevice device, const VkFramebufferCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkFramebuffer* pFramebuffer) {
    ...
    fprintf(stderr, "%s: host framebuffer %p\n", __func__, *pFramebuffer);

    // host->guest handle conversions
    if (pFramebuffer) { VkVirtualHandleToGuestArray<VkFramebuffer>(1, pFramebuffer, pFramebuffer); }
    fprintf(stderr, "%s: guest framebuffer %p\n", __func__, *pFramebuffer);
    if (res == VK_SUCCESS) { fprintf(stderr, "%s: success\n", __func__); } else { fprintf(stderr, "%s: err 0x%x\n", __func__, res); }
    return res;
}
...
static VkResult s_vkCreateRenderPass(VkDevice device, const VkRenderPassCreateInfo* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkRenderPass* pRenderPass) {
    ...
    fprintf(stderr, "%s: host render pass %p\n", __func__, *pRenderPass);
    // host->guest handle conversions
    if (pRenderPass) { VkVirtualHandleToGuestArray<VkRenderPass>(1, pRenderPass, pRenderPass); }
    fprintf(stderr, "%s: guest render pass %p\n", __func__, *pRenderPass);
    if (res == VK_SUCCESS) { fprintf(stderr, "%s: success\n", __func__); } else { fprintf(stderr, "%s: err 0x%x\n", __func__, res); }
    return res;
}
...
static VkResult s_vkAllocateCommandBuffers(VkDevice device, const VkCommandBufferAllocateInfo* pAllocateInfo, VkCommandBuffer* pCommandBuffers) {
    ...
    fprintf(stderr, "%s: cmdbuf on host: %p\n", __func__, *pCommandBuffers);
    ...
    fprintf(stderr, "%s: cmdbuf on guest: %p\n", __func__, *pCommandBuffers);
    if (res == VK_SUCCESS) { fprintf(stderr, "%s: success\n", __func__); } else { fprintf(stderr, "%s: err 0x%x\n", __func__, res); }
    return res;
}
...
static void s_vkCmdPipelineBarrier(VkCommandBuffer commandBuffer, VkPipelineStageFlags srcStageMask, VkPipelineStageFlags dstStageMask, VkDependencyFlags dependencyFlags, u32 memoryBarrierCount, const VkMemoryBarrier* pMemoryBarriers, u32 bufferMemoryBarrierCount, const VkBufferMemoryBarrier* pBufferMemoryBarriers, u32 imageMemoryBarrierCount, const VkImageMemoryBarrier* pImageMemoryBarriers) {
    ...
    // guest->host handle conversions
    VkCommandBuffer host_commandBuffer = VkVirtualHandleGetHost<VkCommandBuffer>((uint32_t)(uintptr_t)commandBuffer);
    fprintf(stderr, "%s: call cmdbuf guest %p host %p\n", __func__, commandBuffer, host_commandBuffer);
    std::vector<VkBufferMemoryBarrier> tmp_host_pBufferMemoryBarriers(bufferMemoryBarrierCount); if (pBufferMemoryBarriers) { VkVirtualHandleAsHostData<VkBufferMemoryBarrier>(bufferMemoryBarrierCount, pBufferMemoryBarriers, &tmp_host_pBufferMemoryBarriers[0]); } VkBufferMemoryBarrier* host_pBufferMemoryBarriers = &tmp_host_pBufferMemoryBarriers[0];
    std::vector<VkImageMemoryBarrier> tmp_host_pImageMemoryBarriers(imageMemoryBarrierCount); if (pImageMemoryBarriers) { VkVirtualHandleAsHostData<VkImageMemoryBarrier>(imageMemoryBarrierCount, pImageMemoryBarriers, &tmp_host_pImageMemoryBarriers[0]); } VkImageMemoryBarrier* host_pImageMemoryBarriers = &tmp_host_pImageMemoryBarriers[0];
...
static void s_vkCmdBeginRenderPass(VkCommandBuffer commandBuffer, const VkRenderPassBeginInfo* pRenderPassBegin, VkSubpassContents contents) {
    ...
    VkCommandBuffer host_commandBuffer = VkVirtualHandleGetHost<VkCommandBuffer>((uint32_t)(uintptr_t)commandBuffer);
    fprintf(stderr, "%s: call cmdbuf guest %p host %p\n", __func__, commandBuffer, host_commandBuffer);
    fprintf(stderr, "%s: guest render pass %p\n", __func__, pRenderPassBegin->renderPass);
    fprintf(stderr, "%s: guest framebuffer %p\n", __func__, pRenderPassBegin->framebuffer);
    ...
    fprintf(stderr, "%s: host render pass %p\n", __func__, host_pRenderPassBegin->renderPass);
    fprintf(stderr, "%s: host framebuffer %p\n", __func__, host_pRenderPassBegin->framebuffer);

    fprintf(stderr, "%s: clear vals count: %u\n", __func__, pRenderPassBegin->clearValueCount);
    fprintf(stderr, "%s: clear vals: %p\n", __func__, pRenderPassBegin->pClearValues);
    VkClearColorValue cleartest;
    float clear[4] = {0.2, 0.4, 0.6, 1.0};
    memcpy(&cleartest.float32, clear, 4 * sizeof(float));
    VkClearValue myClearValue;
    myClearValue.color = cleartest;
    host_pRenderPassBegin->pClearValues = &myClearValue;
