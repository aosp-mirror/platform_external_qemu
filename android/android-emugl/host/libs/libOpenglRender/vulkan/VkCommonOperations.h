...
#define VK_EXT_SEMAPHORE_HANDLE_INVALID (VK_EXT_MEMORY_HANDLE)(uintptr_t)(-1)
...
#define VK_EXT_SEMAPHORE_HANDLE_INVALID (-1)
...
// State to hold info on synchronization of rendered color buffers with the
// host swapchain.
struct ColorBufferSwapchainSynchronizationInfo {
    bool useNative;
    VulkanDispatch* vk;
    VkDevice device;
    union {
