    ...
    VkDebugUtilsMessengerCallbackDataEXT* to)
{
    ...
    *to = *from;
    ...
    {
        to->pQueueLabels = (VkDebugUtilsLabelEXT*)pool->alloc(from->queueLabelCount * sizeof(const VkDebugUtilsLabelEXT));
    ...
    {
        to->pCmdBufLabels = (VkDebugUtilsLabelEXT*)pool->alloc(from->cmdBufLabelCount * sizeof(const VkDebugUtilsLabelEXT));
    ...
    if (from->pObjects)
    {
        to->pObjects = (VkDebugUtilsObjectNameInfoEXT*)pool->alloc(from->objectCount * sizeof(const VkDebugUtilsObjectNameInfoEXT));
