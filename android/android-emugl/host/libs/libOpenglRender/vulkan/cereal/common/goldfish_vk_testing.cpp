    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkMemoryType(a->memoryTypes + i, b->memoryTypes, onFail);
    }
    ...
    {
        compare_VkMemoryHeap(a->memoryHeaps + i, b->memoryHeaps, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkDeviceQueueCreateInfo(a->pQueueCreateInfos + i, b->pQueueCreateInfos, onFail);
    }
    if (!((*(&a->enabledLayerCount)) == (*(&b->enabledLayerCount)))) onFail("&a->enabledLayerCount (Error: Value not equal)");
    if (!((*(&a->enabledExtensionCount)) == (*(&b->enabledExtensionCount)))) onFail("&a->enabledExtensionCount (Error: Value not equal)");
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkSparseMemoryBind(a->pBinds + i, b->pBinds, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)a->bindCount; ++i)
    {
        compare_VkSparseImageMemoryBind(a->pBinds + i, b->pBinds, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkSparseBufferMemoryBindInfo(a->pBufferBinds + i, b->pBufferBinds, onFail);
    }
    ...
    {
        compare_VkSparseImageOpaqueMemoryBindInfo(a->pImageOpaqueBinds + i, b->pImageOpaqueBinds, onFail);
    }
    ...
    {
        compare_VkSparseImageMemoryBindInfo(a->pImageBinds + i, b->pImageBinds, onFail);
    }
    if (!((*(&a->signalSemaphoreCount)) == (*(&b->signalSemaphoreCount)))) onFail("&a->signalSemaphoreCount (Error: Value not equal)");
    if (!((a->signalSemaphoreCount) == (b->signalSemaphoreCount))) onFail("a->pSignalSemaphores (Error: Lengths not equal)");
    if (!((memcmp(a->pSignalSemaphores, b->pSignalSemaphores, a->signalSemaphoreCount * sizeof(const VkSemaphore*)) == 0))) onFail("a->pSignalSemaphores (Error: Unequal dyn array)");
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkSpecializationMapEntry(a->pMapEntries + i, b->pMapEntries, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkVertexInputBindingDescription(a->pVertexBindingDescriptions + i, b->pVertexBindingDescriptions, onFail);
    }
    ...
    {
        compare_VkVertexInputAttributeDescription(a->pVertexAttributeDescriptions + i, b->pVertexAttributeDescriptions, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pViewports)
    {
        ...
        {
            compare_VkViewport(a->pViewports + i, b->pViewports, onFail);
        }
    }
    ...
    if (a->pScissors)
    {
        ...
        {
            compare_VkRect2D(a->pScissors + i, b->pScissors, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkPipelineColorBlendAttachmentState(a->pAttachments + i, b->pAttachments, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkPipelineShaderStageCreateInfo(a->pStages + i, b->pStages, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkPushConstantRange(a->pPushConstantRanges + i, b->pPushConstantRanges, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkDescriptorSetLayoutBinding(a->pBindings + i, b->pBindings, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkDescriptorPoolSize(a->pPoolSizes + i, b->pPoolSizes, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pImageInfo)
    {
        ...
        {
            compare_VkDescriptorImageInfo(a->pImageInfo + i, b->pImageInfo, onFail);
        }
    }
    ...
    if (a->pBufferInfo)
    {
        ...
        for (uint32_t i = 0; i < (uint32_t)a->descriptorCount; ++i)
        {
            compare_VkDescriptorBufferInfo(a->pBufferInfo + i, b->pBufferInfo, onFail);
        }
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkAttachmentReference(a->pInputAttachments + i, b->pInputAttachments, onFail);
    }
    ...
    {
        compare_VkAttachmentReference(a->pColorAttachments + i, b->pColorAttachments, onFail);
    }
    ...
    if (a->pResolveAttachments)
    {
        ...
        for (uint32_t i = 0; i < (uint32_t)a->colorAttachmentCount; ++i)
        {
            compare_VkAttachmentReference(a->pResolveAttachments + i, b->pResolveAttachments, onFail);
        }
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)a->attachmentCount; ++i)
    {
        compare_VkAttachmentDescription(a->pAttachments + i, b->pAttachments, onFail);
    }
    ...
    {
        compare_VkSubpassDescription(a->pSubpasses + i, b->pSubpasses, onFail);
    }
    ...
    {
        compare_VkSubpassDependency(a->pDependencies + i, b->pDependencies, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkOffset3D(a->srcOffsets + i, b->srcOffsets, onFail);
    }
    compare_VkImageSubresourceLayers(&a->dstSubresource, &b->dstSubresource, onFail);
    if (!((2) == (2))) onFail("a->dstOffsets (Error: Lengths not equal)");
    for (uint32_t i = 0; i < (uint32_t)2; ++i)
    {
        compare_VkOffset3D(a->dstOffsets + i, b->dstOffsets, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pClearValues)
    {
        ...
        {
            compare_VkClearValue(a->pClearValues + i, b->pClearValues, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkRect2D(a->pDeviceRenderAreas + i, b->pDeviceRenderAreas, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkRect2D(a->pSplitInstanceBindRegions + i, b->pSplitInstanceBindRegions, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkInputAttachmentAspectReference(a->pAspectReferences + i, b->pAspectReferences, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkDescriptorUpdateTemplateEntry(a->pDescriptorUpdateEntries + i, b->pDescriptorUpdateEntries, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pRectangles)
    {
        ...
        {
            compare_VkRectLayerKHR(a->pRectangles + i, b->pRectangles, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pRegions)
    {
        ...
        {
            compare_VkPresentRegionKHR(a->pRegions + i, b->pRegions, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)a->inputAttachmentCount; ++i)
    {
        compare_VkAttachmentReference2KHR(a->pInputAttachments + i, b->pInputAttachments, onFail);
    }
    if (!((*(&a->colorAttachmentCount)) == (*(&b->colorAttachmentCount)))) onFail("&a->colorAttachmentCount (Error: Value not equal)");
    if (!((a->colorAttachmentCount) == (b->colorAttachmentCount))) onFail("a->pColorAttachments (Error: Lengths not equal)");
    for (uint32_t i = 0; i < (uint32_t)a->colorAttachmentCount; ++i)
    {
        compare_VkAttachmentReference2KHR(a->pColorAttachments + i, b->pColorAttachments, onFail);
    }
    if (!((!(a->pResolveAttachments) && !(b->pResolveAttachments)) || ((a->pResolveAttachments) && (b->pResolveAttachments)))) onFail("a->pResolveAttachments (Error: Mismatch in optional field)");
    if (a->pResolveAttachments)
    {
        ...
        for (uint32_t i = 0; i < (uint32_t)a->colorAttachmentCount; ++i)
        {
            compare_VkAttachmentReference2KHR(a->pResolveAttachments + i, b->pResolveAttachments, onFail);
        }
    }
    if (!((!(a->pDepthStencilAttachment) && !(b->pDepthStencilAttachment)) || ((a->pDepthStencilAttachment) && (b->pDepthStencilAttachment)))) onFail("a->pDepthStencilAttachment (Error: Mismatch in optional field)");
    if (a->pDepthStencilAttachment)
    ...
    OnFailCompareFunc onFail)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)a->attachmentCount; ++i)
    {
        compare_VkAttachmentDescription2KHR(a->pAttachments + i, b->pAttachments, onFail);
    }
    if (!((*(&a->subpassCount)) == (*(&b->subpassCount)))) onFail("&a->subpassCount (Error: Value not equal)");
    if (!((a->subpassCount) == (b->subpassCount))) onFail("a->pSubpasses (Error: Lengths not equal)");
    for (uint32_t i = 0; i < (uint32_t)a->subpassCount; ++i)
    {
        compare_VkSubpassDescription2KHR(a->pSubpasses + i, b->pSubpasses, onFail);
    }
    if (!((*(&a->dependencyCount)) == (*(&b->dependencyCount)))) onFail("&a->dependencyCount (Error: Value not equal)");
    if (!((a->dependencyCount) == (b->dependencyCount))) onFail("a->pDependencies (Error: Lengths not equal)");
    for (uint32_t i = 0; i < (uint32_t)a->dependencyCount; ++i)
    {
        compare_VkSubpassDependency2KHR(a->pDependencies + i, b->pDependencies, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkIndirectCommandsLayoutTokenNVX(a->pTokens + i, b->pTokens, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkIndirectCommandsTokenNVX(a->pIndirectCommandsTokens + i, b->pIndirectCommandsTokens, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pViewportWScalings)
    {
        ...
        for (uint32_t i = 0; i < (uint32_t)a->viewportCount; ++i)
        {
            compare_VkViewportWScalingNV(a->pViewportWScalings + i, b->pViewportWScalings, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pTimes)
    {
        ...
        for (uint32_t i = 0; i < (uint32_t)a->swapchainCount; ++i)
        {
            compare_VkPresentTimeGOOGLE(a->pTimes + i, b->pTimes, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pViewportSwizzles)
    {
        ...
        for (uint32_t i = 0; i < (uint32_t)a->viewportCount; ++i)
        {
            compare_VkViewportSwizzleNV(a->pViewportSwizzles + i, b->pViewportSwizzles, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pDiscardRectangles)
    {
        ...
        {
            compare_VkRect2D(a->pDiscardRectangles + i, b->pDiscardRectangles, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pQueueLabels)
    {
        ...
        {
            compare_VkDebugUtilsLabelEXT(a->pQueueLabels + i, b->pQueueLabels, onFail);
        }
    }
    ...
    if (a->pCmdBufLabels)
    {
        ...
        {
            compare_VkDebugUtilsLabelEXT(a->pCmdBufLabels + i, b->pCmdBufLabels, onFail);
        }
    }
    if (!((*(&a->objectCount)) == (*(&b->objectCount)))) onFail("&a->objectCount (Error: Value not equal)");
    ...
    if (a->pObjects)
    {
        ...
        {
            compare_VkDebugUtilsObjectNameInfoEXT(a->pObjects + i, b->pObjects, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkSampleLocationEXT(a->pSampleLocations + i, b->pSampleLocations, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkAttachmentSampleLocationsEXT(a->pAttachmentInitialSampleLocations + i, b->pAttachmentInitialSampleLocations, onFail);
    }
    ...
    {
        compare_VkSubpassSampleLocationsEXT(a->pPostSubpassSampleLocations + i, b->pPostSubpassSampleLocations, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkVertexInputBindingDivisorDescriptionEXT(a->pVertexBindingDivisors + i, b->pVertexBindingDivisors, onFail);
    }
}
