// Module: goldfish_vk_testing (impl) Autogenerated by CerealGenerator
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkApplicationInfo(a->pApplicationInfo, b->pApplicationInfo, onFail);
    }
...
void compare_VkImageFormatProperties(
    ...
    OnFailCompareFunc onFail)
{
    compare_VkExtent3D(&a->maxExtent, &b->maxExtent, onFail);
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkPhysicalDeviceLimits(&a->limits, &b->limits, onFail);
    compare_VkPhysicalDeviceSparseProperties(&a->sparseProperties, &b->sparseProperties, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkExtent3D(&a->minImageTransferGranularity, &b->minImageTransferGranularity, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkMemoryType(a->memoryTypes + i, b->memoryTypes + i, onFail);
    }
    ...
    {
        compare_VkMemoryHeap(a->memoryHeaps + i, b->memoryHeaps + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkDeviceQueueCreateInfo(a->pQueueCreateInfos + i, b->pQueueCreateInfos + i, onFail);
    }
    if (!((a->enabledLayerCount) == (b->enabledLayerCount))) onFail("a->enabledLayerCount (Error: Value not equal)");
    if (!((a->enabledExtensionCount) == (b->enabledExtensionCount))) onFail("a->enabledExtensionCount (Error: Value not equal)");
    ...
    {
        compare_VkPhysicalDeviceFeatures(a->pEnabledFeatures, b->pEnabledFeatures, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkExtent3D(&a->imageGranularity, &b->imageGranularity, onFail);
    if (!((a->flags) == (b->flags))) onFail("a->flags (Error: Value not equal)");
}
...
void compare_VkSparseImageMemoryRequirements(
    ...
    OnFailCompareFunc onFail)
{
    compare_VkSparseImageFormatProperties(&a->formatProperties, &b->formatProperties, onFail);
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkSparseMemoryBind(a->pBinds + i, b->pBinds + i, onFail);
    }
}
...
void compare_VkSparseImageMemoryBind(
    ...
    OnFailCompareFunc onFail)
{
    compare_VkImageSubresource(&a->subresource, &b->subresource, onFail);
    compare_VkOffset3D(&a->offset, &b->offset, onFail);
    compare_VkExtent3D(&a->extent, &b->extent, onFail);
    if (!((a->memory) == (b->memory))) onFail("a->memory (Error: Value not equal)");
    if (!((a->memoryOffset) == (b->memoryOffset))) onFail("a->memoryOffset (Error: Value not equal)");
    if (!((a->flags) == (b->flags))) onFail("a->flags (Error: Value not equal)");
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)a->bindCount; ++i)
    {
        compare_VkSparseImageMemoryBind(a->pBinds + i, b->pBinds + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkSparseBufferMemoryBindInfo(a->pBufferBinds + i, b->pBufferBinds + i, onFail);
    }
    ...
    {
        compare_VkSparseImageOpaqueMemoryBindInfo(a->pImageOpaqueBinds + i, b->pImageOpaqueBinds + i, onFail);
    }
    ...
    {
        compare_VkSparseImageMemoryBindInfo(a->pImageBinds + i, b->pImageBinds + i, onFail);
    }
    if (!((a->signalSemaphoreCount) == (b->signalSemaphoreCount))) onFail("a->signalSemaphoreCount (Error: Value not equal)");
    if (!((a->signalSemaphoreCount) == (b->signalSemaphoreCount))) onFail("a->pSignalSemaphores (Error: Lengths not equal)");
    if (!((memcmp(a->pSignalSemaphores, b->pSignalSemaphores, a->signalSemaphoreCount * sizeof(const VkSemaphore)) == 0))) onFail("a->pSignalSemaphores (Error: Unequal dyn array)");
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->format) == (b->format))) onFail("a->format (Error: Value not equal)");
    compare_VkComponentMapping(&a->components, &b->components, onFail);
    compare_VkImageSubresourceRange(&a->subresourceRange, &b->subresourceRange, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkSpecializationMapEntry(a->pMapEntries + i, b->pMapEntries + i, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkSpecializationInfo(a->pSpecializationInfo, b->pSpecializationInfo, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkVertexInputBindingDescription(a->pVertexBindingDescriptions + i, b->pVertexBindingDescriptions + i, onFail);
    }
    ...
    {
        compare_VkVertexInputAttributeDescription(a->pVertexAttributeDescriptions + i, b->pVertexAttributeDescriptions + i, onFail);
    }
}
...
void compare_VkRect2D(
    ...
    OnFailCompareFunc onFail)
{
    compare_VkOffset2D(&a->offset, &b->offset, onFail);
    compare_VkExtent2D(&a->extent, &b->extent, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pViewports)
    {
        ...
        {
            compare_VkViewport(a->pViewports + i, b->pViewports + i, onFail);
        }
    }
    ...
    if (a->pScissors)
    {
        ...
        {
            compare_VkRect2D(a->pScissors + i, b->pScissors + i, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkStencilOpState(&a->front, &b->front, onFail);
    compare_VkStencilOpState(&a->back, &b->back, onFail);
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkPipelineColorBlendAttachmentState(a->pAttachments + i, b->pAttachments + i, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkPipelineShaderStageCreateInfo(a->pStages + i, b->pStages + i, onFail);
    }
    compare_VkPipelineVertexInputStateCreateInfo(a->pVertexInputState, b->pVertexInputState, onFail);
    compare_VkPipelineInputAssemblyStateCreateInfo(a->pInputAssemblyState, b->pInputAssemblyState, onFail);
    ...
    {
        compare_VkPipelineTessellationStateCreateInfo(a->pTessellationState, b->pTessellationState, onFail);
    }
    ...
    if (a->pViewportState)
    {
        compare_VkPipelineViewportStateCreateInfo(a->pViewportState, b->pViewportState, onFail);
    }
    compare_VkPipelineRasterizationStateCreateInfo(a->pRasterizationState, b->pRasterizationState, onFail);
    ...
    {
        compare_VkPipelineMultisampleStateCreateInfo(a->pMultisampleState, b->pMultisampleState, onFail);
    }
    ...
    {
        compare_VkPipelineDepthStencilStateCreateInfo(a->pDepthStencilState, b->pDepthStencilState, onFail);
    }
    ...
    {
        compare_VkPipelineColorBlendStateCreateInfo(a->pColorBlendState, b->pColorBlendState, onFail);
    }
    ...
    if (a->pDynamicState)
    {
        compare_VkPipelineDynamicStateCreateInfo(a->pDynamicState, b->pDynamicState, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    if (!((a->flags) == (b->flags))) onFail("a->flags (Error: Value not equal)");
    compare_VkPipelineShaderStageCreateInfo(&a->stage, &b->stage, onFail);
    if (!((a->layout) == (b->layout))) onFail("a->layout (Error: Value not equal)");
    if (!((a->basePipelineHandle) == (b->basePipelineHandle))) onFail("a->basePipelineHandle (Error: Value not equal)");
    if (!((a->basePipelineIndex) == (b->basePipelineIndex))) onFail("a->basePipelineIndex (Error: Value not equal)");
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkPushConstantRange(a->pPushConstantRanges + i, b->pPushConstantRanges + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkDescriptorSetLayoutBinding(a->pBindings + i, b->pBindings + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkDescriptorPoolSize(a->pPoolSizes + i, b->pPoolSizes + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pImageInfo)
    {
        ...
        {
            compare_VkDescriptorImageInfo(a->pImageInfo + i, b->pImageInfo + i, onFail);
        }
    }
    ...
    if (a->pBufferInfo)
    {
        ...
        for (uint32_t i = 0; i < (uint32_t)a->descriptorCount; ++i)
        {
            compare_VkDescriptorBufferInfo(a->pBufferInfo + i, b->pBufferInfo + i, onFail);
        }
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkAttachmentReference(a->pInputAttachments + i, b->pInputAttachments + i, onFail);
    }
    ...
    {
        compare_VkAttachmentReference(a->pColorAttachments + i, b->pColorAttachments + i, onFail);
    }
    ...
    if (a->pResolveAttachments)
    {
        ...
        for (uint32_t i = 0; i < (uint32_t)a->colorAttachmentCount; ++i)
        {
            compare_VkAttachmentReference(a->pResolveAttachments + i, b->pResolveAttachments + i, onFail);
        }
    }
    ...
    {
        compare_VkAttachmentReference(a->pDepthStencilAttachment, b->pDepthStencilAttachment, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)a->attachmentCount; ++i)
    {
        compare_VkAttachmentDescription(a->pAttachments + i, b->pAttachments + i, onFail);
    }
    ...
    {
        compare_VkSubpassDescription(a->pSubpasses + i, b->pSubpasses + i, onFail);
    }
    ...
    {
        compare_VkSubpassDependency(a->pDependencies + i, b->pDependencies + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkCommandBufferInheritanceInfo(a->pInheritanceInfo, b->pInheritanceInfo, onFail);
    }
}
...
void compare_VkImageCopy(
    ...
    OnFailCompareFunc onFail)
{
    compare_VkImageSubresourceLayers(&a->srcSubresource, &b->srcSubresource, onFail);
    compare_VkOffset3D(&a->srcOffset, &b->srcOffset, onFail);
    compare_VkImageSubresourceLayers(&a->dstSubresource, &b->dstSubresource, onFail);
    compare_VkOffset3D(&a->dstOffset, &b->dstOffset, onFail);
    compare_VkExtent3D(&a->extent, &b->extent, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkOffset3D(a->srcOffsets + i, b->srcOffsets + i, onFail);
    }
    compare_VkImageSubresourceLayers(&a->dstSubresource, &b->dstSubresource, onFail);
    if (!((2) == (2))) onFail("a->dstOffsets (Error: Lengths not equal)");
    for (uint32_t i = 0; i < (uint32_t)2; ++i)
    {
        compare_VkOffset3D(a->dstOffsets + i, b->dstOffsets + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkImageSubresourceLayers(&a->imageSubresource, &b->imageSubresource, onFail);
    compare_VkOffset3D(&a->imageOffset, &b->imageOffset, onFail);
    compare_VkExtent3D(&a->imageExtent, &b->imageExtent, onFail);
}
...
void compare_VkClearValue(
    ...
    OnFailCompareFunc onFail)
{
    compare_VkClearColorValue(&a->color, &b->color, onFail);
    compare_VkClearDepthStencilValue(&a->depthStencil, &b->depthStencil, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkClearValue(&a->clearValue, &b->clearValue, onFail);
}
...
void compare_VkClearRect(
    ...
    OnFailCompareFunc onFail)
{
    compare_VkRect2D(&a->rect, &b->rect, onFail);
    if (!((a->baseArrayLayer) == (b->baseArrayLayer))) onFail("a->baseArrayLayer (Error: Value not equal)");
    if (!((a->layerCount) == (b->layerCount))) onFail("a->layerCount (Error: Value not equal)");
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (!((a->renderPass) == (b->renderPass))) onFail("a->renderPass (Error: Value not equal)");
    if (!((a->framebuffer) == (b->framebuffer))) onFail("a->framebuffer (Error: Value not equal)");
    compare_VkRect2D(&a->renderArea, &b->renderArea, onFail);
    ...
    if (a->pClearValues)
    {
        ...
        {
            compare_VkClearValue(a->pClearValues + i, b->pClearValues + i, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pNext)
    {
        compare_VkBaseOutStructure(a->pNext, b->pNext, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pNext)
    {
        compare_VkBaseInStructure(a->pNext, b->pNext, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkRect2D(a->pDeviceRenderAreas + i, b->pDeviceRenderAreas + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkRect2D(a->pSplitInstanceBindRegions + i, b->pSplitInstanceBindRegions + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkMemoryRequirements(&a->memoryRequirements, &b->memoryRequirements, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkSparseImageMemoryRequirements(&a->memoryRequirements, &b->memoryRequirements, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkPhysicalDeviceFeatures(&a->features, &b->features, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkPhysicalDeviceProperties(&a->properties, &b->properties, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkFormatProperties(&a->formatProperties, &b->formatProperties, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkImageFormatProperties(&a->imageFormatProperties, &b->imageFormatProperties, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkQueueFamilyProperties(&a->queueFamilyProperties, &b->queueFamilyProperties, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkPhysicalDeviceMemoryProperties(&a->memoryProperties, &b->memoryProperties, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkSparseImageFormatProperties(&a->properties, &b->properties, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkInputAttachmentAspectReference(a->pAspectReferences + i, b->pAspectReferences + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkDescriptorUpdateTemplateEntry(a->pDescriptorUpdateEntries + i, b->pDescriptorUpdateEntries + i, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkExternalMemoryProperties(&a->externalMemoryProperties, &b->externalMemoryProperties, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkExtent2D(&a->currentExtent, &b->currentExtent, onFail);
    compare_VkExtent2D(&a->minImageExtent, &b->minImageExtent, onFail);
    compare_VkExtent2D(&a->maxImageExtent, &b->maxImageExtent, onFail);
    if (!((a->maxImageArrayLayers) == (b->maxImageArrayLayers))) onFail("a->maxImageArrayLayers (Error: Value not equal)");
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkExtent2D(&a->imageExtent, &b->imageExtent, onFail);
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkExtent2D(&a->physicalDimensions, &b->physicalDimensions, onFail);
    compare_VkExtent2D(&a->physicalResolution, &b->physicalResolution, onFail);
    if (!((a->supportedTransforms) == (b->supportedTransforms))) onFail("a->supportedTransforms (Error: Value not equal)");
...
void compare_VkDisplayModeParametersKHR(
    ...
    OnFailCompareFunc onFail)
{
    compare_VkExtent2D(&a->visibleRegion, &b->visibleRegion, onFail);
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkDisplayModeParametersKHR(&a->parameters, &b->parameters, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkOffset2D(&a->minSrcPosition, &b->minSrcPosition, onFail);
    compare_VkOffset2D(&a->maxSrcPosition, &b->maxSrcPosition, onFail);
    compare_VkExtent2D(&a->minSrcExtent, &b->minSrcExtent, onFail);
    compare_VkExtent2D(&a->maxSrcExtent, &b->maxSrcExtent, onFail);
    compare_VkOffset2D(&a->minDstPosition, &b->minDstPosition, onFail);
    compare_VkOffset2D(&a->maxDstPosition, &b->maxDstPosition, onFail);
    compare_VkExtent2D(&a->minDstExtent, &b->minDstExtent, onFail);
    compare_VkExtent2D(&a->maxDstExtent, &b->maxDstExtent, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkRect2D(&a->srcRect, &b->srcRect, onFail);
    compare_VkRect2D(&a->dstRect, &b->dstRect, onFail);
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pRectangles)
    {
        ...
        {
            compare_VkRectLayerKHR(a->pRectangles + i, b->pRectangles + i, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pRegions)
    {
        ...
        {
            compare_VkPresentRegionKHR(a->pRegions + i, b->pRegions + i, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)a->inputAttachmentCount; ++i)
    {
        compare_VkAttachmentReference2KHR(a->pInputAttachments + i, b->pInputAttachments + i, onFail);
    }
    if (!((a->colorAttachmentCount) == (b->colorAttachmentCount))) onFail("a->colorAttachmentCount (Error: Value not equal)");
    if (!((a->colorAttachmentCount) == (b->colorAttachmentCount))) onFail("a->pColorAttachments (Error: Lengths not equal)");
    for (uint32_t i = 0; i < (uint32_t)a->colorAttachmentCount; ++i)
    {
        compare_VkAttachmentReference2KHR(a->pColorAttachments + i, b->pColorAttachments + i, onFail);
    }
    if (!((!(a->pResolveAttachments) && !(b->pResolveAttachments)) || ((a->pResolveAttachments) && (b->pResolveAttachments)))) onFail("a->pResolveAttachments (Error: Mismatch in optional field)");
    if (a->pResolveAttachments)
    {
        ...
        for (uint32_t i = 0; i < (uint32_t)a->colorAttachmentCount; ++i)
        {
            compare_VkAttachmentReference2KHR(a->pResolveAttachments + i, b->pResolveAttachments + i, onFail);
        }
    }
    if (!((!(a->pDepthStencilAttachment) && !(b->pDepthStencilAttachment)) || ((a->pDepthStencilAttachment) && (b->pDepthStencilAttachment)))) onFail("a->pDepthStencilAttachment (Error: Mismatch in optional field)");
    if (a->pDepthStencilAttachment)
    {
        compare_VkAttachmentReference2KHR(a->pDepthStencilAttachment, b->pDepthStencilAttachment, onFail);
    }
    if (!((a->preserveAttachmentCount) == (b->preserveAttachmentCount))) onFail("a->preserveAttachmentCount (Error: Value not equal)");
    if (!((a->preserveAttachmentCount) == (b->preserveAttachmentCount))) onFail("a->pPreserveAttachments (Error: Lengths not equal)");
    if (!((memcmp(a->pPreserveAttachments, b->pPreserveAttachments, a->preserveAttachmentCount * sizeof(const uint32_t)) == 0))) onFail("a->pPreserveAttachments (Error: Unequal dyn array)");
    ...
    OnFailCompareFunc onFail)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)a->attachmentCount; ++i)
    {
        compare_VkAttachmentDescription2KHR(a->pAttachments + i, b->pAttachments + i, onFail);
    }
    if (!((a->subpassCount) == (b->subpassCount))) onFail("a->subpassCount (Error: Value not equal)");
    if (!((a->subpassCount) == (b->subpassCount))) onFail("a->pSubpasses (Error: Lengths not equal)");
    for (uint32_t i = 0; i < (uint32_t)a->subpassCount; ++i)
    {
        compare_VkSubpassDescription2KHR(a->pSubpasses + i, b->pSubpasses + i, onFail);
    }
    if (!((a->dependencyCount) == (b->dependencyCount))) onFail("a->dependencyCount (Error: Value not equal)");
    if (!((a->dependencyCount) == (b->dependencyCount))) onFail("a->pDependencies (Error: Lengths not equal)");
    for (uint32_t i = 0; i < (uint32_t)a->dependencyCount; ++i)
    {
        compare_VkSubpassDependency2KHR(a->pDependencies + i, b->pDependencies + i, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkSurfaceCapabilitiesKHR(&a->surfaceCapabilities, &b->surfaceCapabilities, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkSurfaceFormatKHR(&a->surfaceFormat, &b->surfaceFormat, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkDisplayPropertiesKHR(&a->displayProperties, &b->displayProperties, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkDisplayPlanePropertiesKHR(&a->displayPlaneProperties, &b->displayPlaneProperties, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkDisplayModePropertiesKHR(&a->displayModeProperties, &b->displayModeProperties, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkDisplayPlaneCapabilitiesKHR(&a->capabilities, &b->capabilities, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkShaderResourceUsageAMD(&a->resourceUsage, &b->resourceUsage, onFail);
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkIndirectCommandsLayoutTokenNVX(a->pTokens + i, b->pTokens + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkIndirectCommandsTokenNVX(a->pIndirectCommandsTokens + i, b->pIndirectCommandsTokens + i, onFail);
    }
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pViewportWScalings)
    {
        ...
        for (uint32_t i = 0; i < (uint32_t)a->viewportCount; ++i)
        {
            compare_VkViewportWScalingNV(a->pViewportWScalings + i, b->pViewportWScalings + i, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pTimes)
    {
        ...
        for (uint32_t i = 0; i < (uint32_t)a->swapchainCount; ++i)
        {
            compare_VkPresentTimeGOOGLE(a->pTimes + i, b->pTimes + i, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pViewportSwizzles)
    {
        ...
        for (uint32_t i = 0; i < (uint32_t)a->viewportCount; ++i)
        {
            compare_VkViewportSwizzleNV(a->pViewportSwizzles + i, b->pViewportSwizzles + i, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pDiscardRectangles)
    {
        ...
        {
            compare_VkRect2D(a->pDiscardRectangles + i, b->pDiscardRectangles + i, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    if (!((a->sType) == (b->sType))) onFail("a->sType (Error: Value not equal)");
    if (!((!(a->pNext) && !(b->pNext)) || ((a->pNext) && (b->pNext)))) onFail("a->pNext (Error: Mismatch in optional field)");
    compare_VkXYColorEXT(&a->displayPrimaryRed, &b->displayPrimaryRed, onFail);
    compare_VkXYColorEXT(&a->displayPrimaryGreen, &b->displayPrimaryGreen, onFail);
    compare_VkXYColorEXT(&a->displayPrimaryBlue, &b->displayPrimaryBlue, onFail);
    compare_VkXYColorEXT(&a->whitePoint, &b->whitePoint, onFail);
    ...
    OnFailCompareFunc onFail)
{
    ...
    if (a->pQueueLabels)
    {
        ...
        {
            compare_VkDebugUtilsLabelEXT(a->pQueueLabels + i, b->pQueueLabels + i, onFail);
        }
    }
    ...
    if (a->pCmdBufLabels)
    {
        ...
        {
            compare_VkDebugUtilsLabelEXT(a->pCmdBufLabels + i, b->pCmdBufLabels + i, onFail);
        }
    }
    if (!((a->objectCount) == (b->objectCount))) onFail("a->objectCount (Error: Value not equal)");
    ...
    if (a->pObjects)
    {
        ...
        {
            compare_VkDebugUtilsObjectNameInfoEXT(a->pObjects + i, b->pObjects + i, onFail);
        }
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkComponentMapping(&a->samplerYcbcrConversionComponents, &b->samplerYcbcrConversionComponents, onFail);
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkExtent2D(&a->sampleLocationGridSize, &b->sampleLocationGridSize, onFail);
    ...
    {
        compare_VkSampleLocationEXT(a->pSampleLocations + i, b->pSampleLocations + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkSampleLocationsInfoEXT(&a->sampleLocationsInfo, &b->sampleLocationsInfo, onFail);
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkAttachmentSampleLocationsEXT(a->pAttachmentInitialSampleLocations + i, b->pAttachmentInitialSampleLocations + i, onFail);
    }
    ...
    {
        compare_VkSubpassSampleLocationsEXT(a->pPostSubpassSampleLocations + i, b->pPostSubpassSampleLocations + i, onFail);
    }
}
    ...
    OnFailCompareFunc onFail)
{
    ...
    compare_VkExtent2D(&a->maxSampleLocationGridSize, &b->maxSampleLocationGridSize, onFail);
    ...
    OnFailCompareFunc onFail)
{
    ...
    {
        compare_VkVertexInputBindingDivisorDescriptionEXT(a->pVertexBindingDivisors + i, b->pVertexBindingDivisors + i, onFail);
    }
}
