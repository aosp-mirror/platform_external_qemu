...
typedef VkResult (VKAPI_PTR *PFN_vkSetMTLBufferMVK)(VkBuffer buffer, MTLBufferRef mtlBuffer);
typedef void (VKAPI_PTR *PFN_vkGetMTLBufferMVK)(VkBuffer buffer, MTLBufferRef* pMTLBuffer);
