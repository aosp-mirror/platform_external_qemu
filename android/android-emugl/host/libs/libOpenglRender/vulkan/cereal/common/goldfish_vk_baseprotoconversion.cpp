    ...
    const void* structExtension)
{
    ...
    switch(structType)
    {
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_PROPERTIES:
        {
            from_proto_VkPhysicalDeviceSubgroupProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicesubgroupproperties(), reinterpret_cast<const VkPhysicalDeviceSubgroupProperties*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_16BIT_STORAGE_FEATURES:
        {
            from_proto_VkPhysicalDevice16BitStorageFeatures(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevice16bitstoragefeatures(), reinterpret_cast<const VkPhysicalDevice16BitStorageFeatures*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_MEMORY_DEDICATED_REQUIREMENTS:
        {
            from_proto_VkMemoryDedicatedRequirements(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkmemorydedicatedrequirements(), reinterpret_cast<const VkMemoryDedicatedRequirements*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_MEMORY_DEDICATED_ALLOCATE_INFO:
        {
            from_proto_VkMemoryDedicatedAllocateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkmemorydedicatedallocateinfo(), reinterpret_cast<const VkMemoryDedicatedAllocateInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_FLAGS_INFO:
        {
            from_proto_VkMemoryAllocateFlagsInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkmemoryallocateflagsinfo(), reinterpret_cast<const VkMemoryAllocateFlagsInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_RENDER_PASS_BEGIN_INFO:
        {
            from_proto_VkDeviceGroupRenderPassBeginInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdevicegrouprenderpassbegininfo(), reinterpret_cast<const VkDeviceGroupRenderPassBeginInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_COMMAND_BUFFER_BEGIN_INFO:
        {
            from_proto_VkDeviceGroupCommandBufferBeginInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdevicegroupcommandbufferbegininfo(), reinterpret_cast<const VkDeviceGroupCommandBufferBeginInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_SUBMIT_INFO:
        {
            from_proto_VkDeviceGroupSubmitInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdevicegroupsubmitinfo(), reinterpret_cast<const VkDeviceGroupSubmitInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_BIND_SPARSE_INFO:
        {
            from_proto_VkDeviceGroupBindSparseInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdevicegroupbindsparseinfo(), reinterpret_cast<const VkDeviceGroupBindSparseInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_BIND_BUFFER_MEMORY_DEVICE_GROUP_INFO:
        {
            from_proto_VkBindBufferMemoryDeviceGroupInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkbindbuffermemorydevicegroupinfo(), reinterpret_cast<const VkBindBufferMemoryDeviceGroupInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_DEVICE_GROUP_INFO:
        {
            from_proto_VkBindImageMemoryDeviceGroupInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkbindimagememorydevicegroupinfo(), reinterpret_cast<const VkBindImageMemoryDeviceGroupInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_DEVICE_CREATE_INFO:
        {
            from_proto_VkDeviceGroupDeviceCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdevicegroupdevicecreateinfo(), reinterpret_cast<const VkDeviceGroupDeviceCreateInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2:
        {
            from_proto_VkPhysicalDeviceFeatures2(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicefeatures2(), reinterpret_cast<const VkPhysicalDeviceFeatures2*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_POINT_CLIPPING_PROPERTIES:
        {
            from_proto_VkPhysicalDevicePointClippingProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicepointclippingproperties(), reinterpret_cast<const VkPhysicalDevicePointClippingProperties*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_RENDER_PASS_INPUT_ATTACHMENT_ASPECT_CREATE_INFO:
        {
            from_proto_VkRenderPassInputAttachmentAspectCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkrenderpassinputattachmentaspectcreateinfo(), reinterpret_cast<const VkRenderPassInputAttachmentAspectCreateInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_IMAGE_VIEW_USAGE_CREATE_INFO:
        {
            from_proto_VkImageViewUsageCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkimageviewusagecreateinfo(), reinterpret_cast<const VkImageViewUsageCreateInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO:
        {
            from_proto_VkPipelineTessellationDomainOriginStateCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkpipelinetessellationdomainoriginstatecreateinfo(), reinterpret_cast<const VkPipelineTessellationDomainOriginStateCreateInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_RENDER_PASS_MULTIVIEW_CREATE_INFO:
        {
            from_proto_VkRenderPassMultiviewCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkrenderpassmultiviewcreateinfo(), reinterpret_cast<const VkRenderPassMultiviewCreateInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_FEATURES:
        {
            from_proto_VkPhysicalDeviceMultiviewFeatures(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicemultiviewfeatures(), reinterpret_cast<const VkPhysicalDeviceMultiviewFeatures*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PROPERTIES:
        {
            from_proto_VkPhysicalDeviceMultiviewProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicemultiviewproperties(), reinterpret_cast<const VkPhysicalDeviceMultiviewProperties*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTER_FEATURES:
        {
            from_proto_VkPhysicalDeviceVariablePointerFeatures(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicevariablepointerfeatures(), reinterpret_cast<const VkPhysicalDeviceVariablePointerFeatures*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_FEATURES:
        {
            from_proto_VkPhysicalDeviceProtectedMemoryFeatures(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldeviceprotectedmemoryfeatures(), reinterpret_cast<const VkPhysicalDeviceProtectedMemoryFeatures*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_PROPERTIES:
        {
            from_proto_VkPhysicalDeviceProtectedMemoryProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldeviceprotectedmemoryproperties(), reinterpret_cast<const VkPhysicalDeviceProtectedMemoryProperties*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PROTECTED_SUBMIT_INFO:
        {
            from_proto_VkProtectedSubmitInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkprotectedsubmitinfo(), reinterpret_cast<const VkProtectedSubmitInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_INFO:
        {
            from_proto_VkSamplerYcbcrConversionInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vksamplerycbcrconversioninfo(), reinterpret_cast<const VkSamplerYcbcrConversionInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_BIND_IMAGE_PLANE_MEMORY_INFO:
        {
            from_proto_VkBindImagePlaneMemoryInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkbindimageplanememoryinfo(), reinterpret_cast<const VkBindImagePlaneMemoryInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_IMAGE_PLANE_MEMORY_REQUIREMENTS_INFO:
        {
            from_proto_VkImagePlaneMemoryRequirementsInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkimageplanememoryrequirementsinfo(), reinterpret_cast<const VkImagePlaneMemoryRequirementsInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_YCBCR_CONVERSION_FEATURES:
        {
            from_proto_VkPhysicalDeviceSamplerYcbcrConversionFeatures(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicesamplerycbcrconversionfeatures(), reinterpret_cast<const VkPhysicalDeviceSamplerYcbcrConversionFeatures*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_IMAGE_FORMAT_PROPERTIES:
        {
            from_proto_VkSamplerYcbcrConversionImageFormatProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vksamplerycbcrconversionimageformatproperties(), reinterpret_cast<const VkSamplerYcbcrConversionImageFormatProperties*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO:
        {
            from_proto_VkPhysicalDeviceExternalImageFormatInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldeviceexternalimageformatinfo(), reinterpret_cast<const VkPhysicalDeviceExternalImageFormatInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES:
        {
            from_proto_VkExternalImageFormatProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexternalimageformatproperties(), reinterpret_cast<const VkExternalImageFormatProperties*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES:
        {
            from_proto_VkPhysicalDeviceIDProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldeviceidproperties(), reinterpret_cast<const VkPhysicalDeviceIDProperties*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO:
        {
            from_proto_VkExternalMemoryImageCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexternalmemoryimagecreateinfo(), reinterpret_cast<const VkExternalMemoryImageCreateInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO:
        {
            from_proto_VkExternalMemoryBufferCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexternalmemorybuffercreateinfo(), reinterpret_cast<const VkExternalMemoryBufferCreateInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO:
        {
            from_proto_VkExportMemoryAllocateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexportmemoryallocateinfo(), reinterpret_cast<const VkExportMemoryAllocateInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_EXPORT_FENCE_CREATE_INFO:
        {
            from_proto_VkExportFenceCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexportfencecreateinfo(), reinterpret_cast<const VkExportFenceCreateInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO:
        {
            from_proto_VkExportSemaphoreCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexportsemaphorecreateinfo(), reinterpret_cast<const VkExportSemaphoreCreateInfo*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_3_PROPERTIES:
        {
            from_proto_VkPhysicalDeviceMaintenance3Properties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicemaintenance3properties(), reinterpret_cast<const VkPhysicalDeviceMaintenance3Properties*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DRAW_PARAMETER_FEATURES:
        {
            from_proto_VkPhysicalDeviceShaderDrawParameterFeatures(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldeviceshaderdrawparameterfeatures(), reinterpret_cast<const VkPhysicalDeviceShaderDrawParameterFeatures*>(structExtension));
            break;
        }
#endif
#ifdef VK_KHR_swapchain
        case VK_STRUCTURE_TYPE_IMAGE_SWAPCHAIN_CREATE_INFO_KHR:
        {
            from_proto_VkImageSwapchainCreateInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkimageswapchaincreateinfokhr(), reinterpret_cast<const VkImageSwapchainCreateInfoKHR*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_SWAPCHAIN_INFO_KHR:
        {
            from_proto_VkBindImageMemorySwapchainInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkbindimagememoryswapchaininfokhr(), reinterpret_cast<const VkBindImageMemorySwapchainInfoKHR*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_PRESENT_INFO_KHR:
        {
            from_proto_VkDeviceGroupPresentInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdevicegrouppresentinfokhr(), reinterpret_cast<const VkDeviceGroupPresentInfoKHR*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_SWAPCHAIN_CREATE_INFO_KHR:
        {
            from_proto_VkDeviceGroupSwapchainCreateInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdevicegroupswapchaincreateinfokhr(), reinterpret_cast<const VkDeviceGroupSwapchainCreateInfoKHR*>(structExtension));
            break;
        }
#endif
#ifdef VK_KHR_display_swapchain
        case VK_STRUCTURE_TYPE_DISPLAY_PRESENT_INFO_KHR:
        {
            from_proto_VkDisplayPresentInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdisplaypresentinfokhr(), reinterpret_cast<const VkDisplayPresentInfoKHR*>(structExtension));
            break;
        }
#endif
#ifdef VK_KHR_external_memory_win32
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_KHR:
        {
            from_proto_VkImportMemoryWin32HandleInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkimportmemorywin32handleinfokhr(), reinterpret_cast<const VkImportMemoryWin32HandleInfoKHR*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_KHR:
        {
            from_proto_VkExportMemoryWin32HandleInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexportmemorywin32handleinfokhr(), reinterpret_cast<const VkExportMemoryWin32HandleInfoKHR*>(structExtension));
            break;
        }
#endif
#ifdef VK_KHR_external_memory_fd
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHR:
        {
            from_proto_VkImportMemoryFdInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkimportmemoryfdinfokhr(), reinterpret_cast<const VkImportMemoryFdInfoKHR*>(structExtension));
            break;
        }
#endif
#ifdef VK_KHR_win32_keyed_mutex
        case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHR:
        {
            from_proto_VkWin32KeyedMutexAcquireReleaseInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkwin32keyedmutexacquirereleaseinfokhr(), reinterpret_cast<const VkWin32KeyedMutexAcquireReleaseInfoKHR*>(structExtension));
            break;
        }
#endif
#ifdef VK_KHR_external_semaphore_win32
        case VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHR:
        {
            from_proto_VkExportSemaphoreWin32HandleInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexportsemaphorewin32handleinfokhr(), reinterpret_cast<const VkExportSemaphoreWin32HandleInfoKHR*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHR:
        {
            from_proto_VkD3D12FenceSubmitInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkd3d12fencesubmitinfokhr(), reinterpret_cast<const VkD3D12FenceSubmitInfoKHR*>(structExtension));
            break;
        }
#endif
#ifdef VK_KHR_push_descriptor
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES_KHR:
        {
            from_proto_VkPhysicalDevicePushDescriptorPropertiesKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicepushdescriptorpropertieskhr(), reinterpret_cast<const VkPhysicalDevicePushDescriptorPropertiesKHR*>(structExtension));
            break;
        }
#endif
#ifdef VK_KHR_incremental_present
        case VK_STRUCTURE_TYPE_PRESENT_REGIONS_KHR:
        {
            from_proto_VkPresentRegionsKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkpresentregionskhr(), reinterpret_cast<const VkPresentRegionsKHR*>(structExtension));
            break;
        }
#endif
#ifdef VK_KHR_shared_presentable_image
        case VK_STRUCTURE_TYPE_SHARED_PRESENT_SURFACE_CAPABILITIES_KHR:
        {
            from_proto_VkSharedPresentSurfaceCapabilitiesKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vksharedpresentsurfacecapabilitieskhr(), reinterpret_cast<const VkSharedPresentSurfaceCapabilitiesKHR*>(structExtension));
            break;
        }
#endif
#ifdef VK_KHR_external_fence_win32
        case VK_STRUCTURE_TYPE_EXPORT_FENCE_WIN32_HANDLE_INFO_KHR:
        {
            from_proto_VkExportFenceWin32HandleInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexportfencewin32handleinfokhr(), reinterpret_cast<const VkExportFenceWin32HandleInfoKHR*>(structExtension));
            break;
        }
#endif
#ifdef VK_KHR_image_format_list
        case VK_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO_KHR:
        {
            from_proto_VkImageFormatListCreateInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkimageformatlistcreateinfokhr(), reinterpret_cast<const VkImageFormatListCreateInfoKHR*>(structExtension));
            break;
        }
#endif
#ifdef VK_KHR_8bit_storage
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES_KHR:
        {
            from_proto_VkPhysicalDevice8BitStorageFeaturesKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevice8bitstoragefeatureskhr(), reinterpret_cast<const VkPhysicalDevice8BitStorageFeaturesKHR*>(structExtension));
            break;
        }
#endif
#ifdef VK_ANDROID_native_buffer
        case VK_STRUCTURE_TYPE_NATIVE_BUFFER_ANDROID:
        {
            from_proto_VkNativeBufferANDROID(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vknativebufferandroid(), reinterpret_cast<const VkNativeBufferANDROID*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_debug_report
        case VK_STRUCTURE_TYPE_DEBUG_REPORT_CALLBACK_CREATE_INFO_EXT:
        {
            from_proto_VkDebugReportCallbackCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdebugreportcallbackcreateinfoext(), reinterpret_cast<const VkDebugReportCallbackCreateInfoEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_AMD_rasterization_order
        case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_RASTERIZATION_ORDER_AMD:
        {
            from_proto_VkPipelineRasterizationStateRasterizationOrderAMD(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkpipelinerasterizationstaterasterizationorderamd(), reinterpret_cast<const VkPipelineRasterizationStateRasterizationOrderAMD*>(structExtension));
            break;
        }
#endif
#ifdef VK_NV_dedicated_allocation
        case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_IMAGE_CREATE_INFO_NV:
        {
            from_proto_VkDedicatedAllocationImageCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdedicatedallocationimagecreateinfonv(), reinterpret_cast<const VkDedicatedAllocationImageCreateInfoNV*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_BUFFER_CREATE_INFO_NV:
        {
            from_proto_VkDedicatedAllocationBufferCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdedicatedallocationbuffercreateinfonv(), reinterpret_cast<const VkDedicatedAllocationBufferCreateInfoNV*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_MEMORY_ALLOCATE_INFO_NV:
        {
            from_proto_VkDedicatedAllocationMemoryAllocateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdedicatedallocationmemoryallocateinfonv(), reinterpret_cast<const VkDedicatedAllocationMemoryAllocateInfoNV*>(structExtension));
            break;
        }
#endif
#ifdef VK_AMD_texture_gather_bias_lod
        case VK_STRUCTURE_TYPE_TEXTURE_LOD_GATHER_FORMAT_PROPERTIES_AMD:
        {
            from_proto_VkTextureLODGatherFormatPropertiesAMD(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vktexturelodgatherformatpropertiesamd(), reinterpret_cast<const VkTextureLODGatherFormatPropertiesAMD*>(structExtension));
            break;
        }
#endif
#ifdef VK_NV_external_memory
        case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_NV:
        {
            from_proto_VkExternalMemoryImageCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexternalmemoryimagecreateinfonv(), reinterpret_cast<const VkExternalMemoryImageCreateInfoNV*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_NV:
        {
            from_proto_VkExportMemoryAllocateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexportmemoryallocateinfonv(), reinterpret_cast<const VkExportMemoryAllocateInfoNV*>(structExtension));
            break;
        }
#endif
#ifdef VK_NV_external_memory_win32
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_NV:
        {
            from_proto_VkImportMemoryWin32HandleInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkimportmemorywin32handleinfonv(), reinterpret_cast<const VkImportMemoryWin32HandleInfoNV*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_NV:
        {
            from_proto_VkExportMemoryWin32HandleInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexportmemorywin32handleinfonv(), reinterpret_cast<const VkExportMemoryWin32HandleInfoNV*>(structExtension));
            break;
        }
#endif
#ifdef VK_NV_win32_keyed_mutex
        case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV:
        {
            from_proto_VkWin32KeyedMutexAcquireReleaseInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkwin32keyedmutexacquirereleaseinfonv(), reinterpret_cast<const VkWin32KeyedMutexAcquireReleaseInfoNV*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_validation_flags
        case VK_STRUCTURE_TYPE_VALIDATION_FLAGS_EXT:
        {
            from_proto_VkValidationFlagsEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkvalidationflagsext(), reinterpret_cast<const VkValidationFlagsEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_conditional_rendering
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CONDITIONAL_RENDERING_FEATURES_EXT:
        {
            from_proto_VkPhysicalDeviceConditionalRenderingFeaturesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldeviceconditionalrenderingfeaturesext(), reinterpret_cast<const VkPhysicalDeviceConditionalRenderingFeaturesEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_CONDITIONAL_RENDERING_INFO_EXT:
        {
        ...
        case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_W_SCALING_STATE_CREATE_INFO_NV:
        {
            from_proto_VkPipelineViewportWScalingStateCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkpipelineviewportwscalingstatecreateinfonv(), reinterpret_cast<const VkPipelineViewportWScalingStateCreateInfoNV*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_display_control
        case VK_STRUCTURE_TYPE_SWAPCHAIN_COUNTER_CREATE_INFO_EXT:
        {
            from_proto_VkSwapchainCounterCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkswapchaincountercreateinfoext(), reinterpret_cast<const VkSwapchainCounterCreateInfoEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_GOOGLE_display_timing
        case VK_STRUCTURE_TYPE_PRESENT_TIMES_INFO_GOOGLE:
        {
            from_proto_VkPresentTimesInfoGOOGLE(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkpresenttimesinfogoogle(), reinterpret_cast<const VkPresentTimesInfoGOOGLE*>(structExtension));
            break;
        }
#endif
#ifdef VK_NVX_multiview_per_view_attributes
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PER_VIEW_ATTRIBUTES_PROPERTIES_NVX:
        {
            from_proto_VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicemultiviewperviewattributespropertiesnvx(), reinterpret_cast<const VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX*>(structExtension));
            break;
        }
#endif
#ifdef VK_NV_viewport_swizzle
        case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_SWIZZLE_STATE_CREATE_INFO_NV:
        {
            from_proto_VkPipelineViewportSwizzleStateCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkpipelineviewportswizzlestatecreateinfonv(), reinterpret_cast<const VkPipelineViewportSwizzleStateCreateInfoNV*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_discard_rectangles
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DISCARD_RECTANGLE_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceDiscardRectanglePropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicediscardrectanglepropertiesext(), reinterpret_cast<const VkPhysicalDeviceDiscardRectanglePropertiesEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_DISCARD_RECTANGLE_STATE_CREATE_INFO_EXT:
        {
            from_proto_VkPipelineDiscardRectangleStateCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkpipelinediscardrectanglestatecreateinfoext(), reinterpret_cast<const VkPipelineDiscardRectangleStateCreateInfoEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_conservative_rasterization
        ...
        case VK_STRUCTURE_TYPE_DEBUG_UTILS_MESSENGER_CREATE_INFO_EXT:
        {
            from_proto_VkDebugUtilsMessengerCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdebugutilsmessengercreateinfoext(), reinterpret_cast<const VkDebugUtilsMessengerCreateInfoEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_ANDROID_external_memory_android_hardware_buffer
        case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_USAGE_ANDROID:
        {
            from_proto_VkAndroidHardwareBufferUsageANDROID(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkandroidhardwarebufferusageandroid(), reinterpret_cast<const VkAndroidHardwareBufferUsageANDROID*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_PROPERTIES_ANDROID:
        {
            from_proto_VkAndroidHardwareBufferFormatPropertiesANDROID(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkandroidhardwarebufferformatpropertiesandroid(), reinterpret_cast<const VkAndroidHardwareBufferFormatPropertiesANDROID*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_IMPORT_ANDROID_HARDWARE_BUFFER_INFO_ANDROID:
        {
            from_proto_VkImportAndroidHardwareBufferInfoANDROID(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkimportandroidhardwarebufferinfoandroid(), reinterpret_cast<const VkImportAndroidHardwareBufferInfoANDROID*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_EXTERNAL_FORMAT_ANDROID:
        {
            from_proto_VkExternalFormatANDROID(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkexternalformatandroid(), reinterpret_cast<const VkExternalFormatANDROID*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_sampler_filter_minmax
        case VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO_EXT:
        {
            from_proto_VkSamplerReductionModeCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vksamplerreductionmodecreateinfoext(), reinterpret_cast<const VkSamplerReductionModeCreateInfoEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicesamplerfilterminmaxpropertiesext(), reinterpret_cast<const VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_sample_locations
        case VK_STRUCTURE_TYPE_SAMPLE_LOCATIONS_INFO_EXT:
        {
            from_proto_VkSampleLocationsInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vksamplelocationsinfoext(), reinterpret_cast<const VkSampleLocationsInfoEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_RENDER_PASS_SAMPLE_LOCATIONS_BEGIN_INFO_EXT:
        {
            from_proto_VkRenderPassSampleLocationsBeginInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkrenderpasssamplelocationsbegininfoext(), reinterpret_cast<const VkRenderPassSampleLocationsBeginInfoEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_SAMPLE_LOCATIONS_STATE_CREATE_INFO_EXT:
        {
            from_proto_VkPipelineSampleLocationsStateCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkpipelinesamplelocationsstatecreateinfoext(), reinterpret_cast<const VkPipelineSampleLocationsStateCreateInfoEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLE_LOCATIONS_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceSampleLocationsPropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicesamplelocationspropertiesext(), reinterpret_cast<const VkPhysicalDeviceSampleLocationsPropertiesEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_blend_operation_advanced
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_FEATURES_EXT:
        {
            from_proto_VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldeviceblendoperationadvancedfeaturesext(), reinterpret_cast<const VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldeviceblendoperationadvancedpropertiesext(), reinterpret_cast<const VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_ADVANCED_STATE_CREATE_INFO_EXT:
        {
            from_proto_VkPipelineColorBlendAdvancedStateCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkpipelinecolorblendadvancedstatecreateinfoext(), reinterpret_cast<const VkPipelineColorBlendAdvancedStateCreateInfoEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_NV_fragment_coverage_to_color
        case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_TO_COLOR_STATE_CREATE_INFO_NV:
        {
            from_proto_VkPipelineCoverageToColorStateCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkpipelinecoveragetocolorstatecreateinfonv(), reinterpret_cast<const VkPipelineCoverageToColorStateCreateInfoNV*>(structExtension));
            break;
        }
#endif
#ifdef VK_NV_framebuffer_mixed_samples
        case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_MODULATION_STATE_CREATE_INFO_NV:
        {
            from_proto_VkPipelineCoverageModulationStateCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkpipelinecoveragemodulationstatecreateinfonv(), reinterpret_cast<const VkPipelineCoverageModulationStateCreateInfoNV*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_validation_cache
        case VK_STRUCTURE_TYPE_SHADER_MODULE_VALIDATION_CACHE_CREATE_INFO_EXT:
        {
            from_proto_VkShaderModuleValidationCacheCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkshadermodulevalidationcachecreateinfoext(), reinterpret_cast<const VkShaderModuleValidationCacheCreateInfoEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_descriptor_indexing
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO_EXT:
        {
            from_proto_VkDescriptorSetLayoutBindingFlagsCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdescriptorsetlayoutbindingflagscreateinfoext(), reinterpret_cast<const VkDescriptorSetLayoutBindingFlagsCreateInfoEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES_EXT:
        {
            from_proto_VkPhysicalDeviceDescriptorIndexingFeaturesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicedescriptorindexingfeaturesext(), reinterpret_cast<const VkPhysicalDeviceDescriptorIndexingFeaturesEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceDescriptorIndexingPropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicedescriptorindexingpropertiesext(), reinterpret_cast<const VkPhysicalDeviceDescriptorIndexingPropertiesEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO_EXT:
        {
            from_proto_VkDescriptorSetVariableDescriptorCountAllocateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdescriptorsetvariabledescriptorcountallocateinfoext(), reinterpret_cast<const VkDescriptorSetVariableDescriptorCountAllocateInfoEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT_EXT:
        {
            from_proto_VkDescriptorSetVariableDescriptorCountLayoutSupportEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdescriptorsetvariabledescriptorcountlayoutsupportext(), reinterpret_cast<const VkDescriptorSetVariableDescriptorCountLayoutSupportEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_global_priority
        case VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO_EXT:
        {
            from_proto_VkDeviceQueueGlobalPriorityCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkdevicequeueglobalprioritycreateinfoext(), reinterpret_cast<const VkDeviceQueueGlobalPriorityCreateInfoEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_external_memory_host
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_HOST_POINTER_INFO_EXT:
        {
            from_proto_VkImportMemoryHostPointerInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkimportmemoryhostpointerinfoext(), reinterpret_cast<const VkImportMemoryHostPointerInfoEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_HOST_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceExternalMemoryHostPropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldeviceexternalmemoryhostpropertiesext(), reinterpret_cast<const VkPhysicalDeviceExternalMemoryHostPropertiesEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_AMD_shader_core_properties
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_AMD:
        {
            from_proto_VkPhysicalDeviceShaderCorePropertiesAMD(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldeviceshadercorepropertiesamd(), reinterpret_cast<const VkPhysicalDeviceShaderCorePropertiesAMD*>(structExtension));
            break;
        }
#endif
#ifdef VK_EXT_vertex_attribute_divisor
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkphysicaldevicevertexattributedivisorpropertiesext(), reinterpret_cast<const VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_EXT:
        {
            from_proto_VkPipelineVertexInputDivisorStateCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkpipelinevertexinputdivisorstatecreateinfoext(), reinterpret_cast<const VkPipelineVertexInputDivisorStateCreateInfoEXT*>(structExtension));
            break;
        }
#endif
#ifdef VK_NV_device_diagnostic_checkpoints
        case VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_NV:
        {
            from_proto_VkQueueFamilyCheckpointPropertiesNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkqueuefamilycheckpointpropertiesnv(), reinterpret_cast<const VkQueueFamilyCheckpointPropertiesNV*>(structExtension));
            break;
        }
#endif
#ifdef VK_GOOGLE_color_buffer
        case VK_STRUCTURE_TYPE_IMPORT_COLOR_BUFFER_GOOGLE:
        {
            from_proto_VkImportColorBufferGOOGLE(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkimportcolorbuffergoogle(), reinterpret_cast<const VkImportColorBufferGOOGLE*>(structExtension));
            break;
        }
        case VK_STRUCTURE_TYPE_IMPORT_PHYSICAL_ADDRESS_GOOGLE:
        {
            from_proto_VkImportPhysicalAddressGOOGLE(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(output)->mutable_extension_vkimportphysicaladdressgoogle(), reinterpret_cast<const VkImportPhysicalAddressGOOGLE*>(structExtension));
            break;
        }
#endif
        default:
