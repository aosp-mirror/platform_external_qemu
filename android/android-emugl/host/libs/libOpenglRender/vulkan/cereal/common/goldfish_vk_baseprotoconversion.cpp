    ...
    void* structExtension_out)
{
    ...
    switch(structType)
    {
        ...
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_PROPERTIES:
        {
            from_proto_VkPhysicalDeviceSubgroupProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicesubgroupproperties(), reinterpret_cast<VkPhysicalDeviceSubgroupProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_16BIT_STORAGE_FEATURES:
        {
            from_proto_VkPhysicalDevice16BitStorageFeatures(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevice16bitstoragefeatures(), reinterpret_cast<VkPhysicalDevice16BitStorageFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_MEMORY_DEDICATED_REQUIREMENTS:
        {
            from_proto_VkMemoryDedicatedRequirements(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkmemorydedicatedrequirements(), reinterpret_cast<VkMemoryDedicatedRequirements*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_MEMORY_DEDICATED_ALLOCATE_INFO:
        {
            from_proto_VkMemoryDedicatedAllocateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkmemorydedicatedallocateinfo(), reinterpret_cast<VkMemoryDedicatedAllocateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_FLAGS_INFO:
        {
            from_proto_VkMemoryAllocateFlagsInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkmemoryallocateflagsinfo(), reinterpret_cast<VkMemoryAllocateFlagsInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_RENDER_PASS_BEGIN_INFO:
        {
            from_proto_VkDeviceGroupRenderPassBeginInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdevicegrouprenderpassbegininfo(), reinterpret_cast<VkDeviceGroupRenderPassBeginInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_COMMAND_BUFFER_BEGIN_INFO:
        {
            from_proto_VkDeviceGroupCommandBufferBeginInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdevicegroupcommandbufferbegininfo(), reinterpret_cast<VkDeviceGroupCommandBufferBeginInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_SUBMIT_INFO:
        {
            from_proto_VkDeviceGroupSubmitInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdevicegroupsubmitinfo(), reinterpret_cast<VkDeviceGroupSubmitInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_BIND_SPARSE_INFO:
        {
            from_proto_VkDeviceGroupBindSparseInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdevicegroupbindsparseinfo(), reinterpret_cast<VkDeviceGroupBindSparseInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_BIND_BUFFER_MEMORY_DEVICE_GROUP_INFO:
        {
            from_proto_VkBindBufferMemoryDeviceGroupInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkbindbuffermemorydevicegroupinfo(), reinterpret_cast<VkBindBufferMemoryDeviceGroupInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_DEVICE_GROUP_INFO:
        {
            from_proto_VkBindImageMemoryDeviceGroupInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkbindimagememorydevicegroupinfo(), reinterpret_cast<VkBindImageMemoryDeviceGroupInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_DEVICE_CREATE_INFO:
        {
            from_proto_VkDeviceGroupDeviceCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdevicegroupdevicecreateinfo(), reinterpret_cast<VkDeviceGroupDeviceCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2:
        {
            from_proto_VkPhysicalDeviceFeatures2(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicefeatures2(), reinterpret_cast<VkPhysicalDeviceFeatures2*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_POINT_CLIPPING_PROPERTIES:
        {
            from_proto_VkPhysicalDevicePointClippingProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicepointclippingproperties(), reinterpret_cast<VkPhysicalDevicePointClippingProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_RENDER_PASS_INPUT_ATTACHMENT_ASPECT_CREATE_INFO:
        {
            from_proto_VkRenderPassInputAttachmentAspectCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkrenderpassinputattachmentaspectcreateinfo(), reinterpret_cast<VkRenderPassInputAttachmentAspectCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_IMAGE_VIEW_USAGE_CREATE_INFO:
        {
            from_proto_VkImageViewUsageCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkimageviewusagecreateinfo(), reinterpret_cast<VkImageViewUsageCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO:
        {
            from_proto_VkPipelineTessellationDomainOriginStateCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkpipelinetessellationdomainoriginstatecreateinfo(), reinterpret_cast<VkPipelineTessellationDomainOriginStateCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_RENDER_PASS_MULTIVIEW_CREATE_INFO:
        {
            from_proto_VkRenderPassMultiviewCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkrenderpassmultiviewcreateinfo(), reinterpret_cast<VkRenderPassMultiviewCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_FEATURES:
        {
            from_proto_VkPhysicalDeviceMultiviewFeatures(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicemultiviewfeatures(), reinterpret_cast<VkPhysicalDeviceMultiviewFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PROPERTIES:
        {
            from_proto_VkPhysicalDeviceMultiviewProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicemultiviewproperties(), reinterpret_cast<VkPhysicalDeviceMultiviewProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTER_FEATURES:
        {
            from_proto_VkPhysicalDeviceVariablePointerFeatures(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicevariablepointerfeatures(), reinterpret_cast<VkPhysicalDeviceVariablePointerFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_FEATURES:
        {
            from_proto_VkPhysicalDeviceProtectedMemoryFeatures(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldeviceprotectedmemoryfeatures(), reinterpret_cast<VkPhysicalDeviceProtectedMemoryFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_PROPERTIES:
        {
            from_proto_VkPhysicalDeviceProtectedMemoryProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldeviceprotectedmemoryproperties(), reinterpret_cast<VkPhysicalDeviceProtectedMemoryProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PROTECTED_SUBMIT_INFO:
        {
            from_proto_VkProtectedSubmitInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkprotectedsubmitinfo(), reinterpret_cast<VkProtectedSubmitInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_INFO:
        {
            from_proto_VkSamplerYcbcrConversionInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vksamplerycbcrconversioninfo(), reinterpret_cast<VkSamplerYcbcrConversionInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_BIND_IMAGE_PLANE_MEMORY_INFO:
        {
            from_proto_VkBindImagePlaneMemoryInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkbindimageplanememoryinfo(), reinterpret_cast<VkBindImagePlaneMemoryInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_IMAGE_PLANE_MEMORY_REQUIREMENTS_INFO:
        {
            from_proto_VkImagePlaneMemoryRequirementsInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkimageplanememoryrequirementsinfo(), reinterpret_cast<VkImagePlaneMemoryRequirementsInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_YCBCR_CONVERSION_FEATURES:
        {
            from_proto_VkPhysicalDeviceSamplerYcbcrConversionFeatures(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicesamplerycbcrconversionfeatures(), reinterpret_cast<VkPhysicalDeviceSamplerYcbcrConversionFeatures*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_IMAGE_FORMAT_PROPERTIES:
        {
            from_proto_VkSamplerYcbcrConversionImageFormatProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vksamplerycbcrconversionimageformatproperties(), reinterpret_cast<VkSamplerYcbcrConversionImageFormatProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO:
        {
            from_proto_VkPhysicalDeviceExternalImageFormatInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldeviceexternalimageformatinfo(), reinterpret_cast<VkPhysicalDeviceExternalImageFormatInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES:
        {
            from_proto_VkExternalImageFormatProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexternalimageformatproperties(), reinterpret_cast<VkExternalImageFormatProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES:
        {
            from_proto_VkPhysicalDeviceIDProperties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldeviceidproperties(), reinterpret_cast<VkPhysicalDeviceIDProperties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO:
        {
            from_proto_VkExternalMemoryImageCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexternalmemoryimagecreateinfo(), reinterpret_cast<VkExternalMemoryImageCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO:
        {
            from_proto_VkExternalMemoryBufferCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexternalmemorybuffercreateinfo(), reinterpret_cast<VkExternalMemoryBufferCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO:
        {
            from_proto_VkExportMemoryAllocateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexportmemoryallocateinfo(), reinterpret_cast<VkExportMemoryAllocateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_EXPORT_FENCE_CREATE_INFO:
        {
            from_proto_VkExportFenceCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexportfencecreateinfo(), reinterpret_cast<VkExportFenceCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO:
        {
            from_proto_VkExportSemaphoreCreateInfo(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexportsemaphorecreateinfo(), reinterpret_cast<VkExportSemaphoreCreateInfo*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_3_PROPERTIES:
        {
            from_proto_VkPhysicalDeviceMaintenance3Properties(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicemaintenance3properties(), reinterpret_cast<VkPhysicalDeviceMaintenance3Properties*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DRAW_PARAMETER_FEATURES:
        {
            from_proto_VkPhysicalDeviceShaderDrawParameterFeatures(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldeviceshaderdrawparameterfeatures(), reinterpret_cast<VkPhysicalDeviceShaderDrawParameterFeatures*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_swapchain
        case VK_STRUCTURE_TYPE_IMAGE_SWAPCHAIN_CREATE_INFO_KHR:
        {
            from_proto_VkImageSwapchainCreateInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkimageswapchaincreateinfokhr(), reinterpret_cast<VkImageSwapchainCreateInfoKHR*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_SWAPCHAIN_INFO_KHR:
        {
            from_proto_VkBindImageMemorySwapchainInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkbindimagememoryswapchaininfokhr(), reinterpret_cast<VkBindImageMemorySwapchainInfoKHR*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_PRESENT_INFO_KHR:
        {
            from_proto_VkDeviceGroupPresentInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdevicegrouppresentinfokhr(), reinterpret_cast<VkDeviceGroupPresentInfoKHR*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DEVICE_GROUP_SWAPCHAIN_CREATE_INFO_KHR:
        {
            from_proto_VkDeviceGroupSwapchainCreateInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdevicegroupswapchaincreateinfokhr(), reinterpret_cast<VkDeviceGroupSwapchainCreateInfoKHR*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_display_swapchain
        case VK_STRUCTURE_TYPE_DISPLAY_PRESENT_INFO_KHR:
        {
            from_proto_VkDisplayPresentInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdisplaypresentinfokhr(), reinterpret_cast<VkDisplayPresentInfoKHR*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_external_memory_win32
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_KHR:
        {
            from_proto_VkImportMemoryWin32HandleInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkimportmemorywin32handleinfokhr(), reinterpret_cast<VkImportMemoryWin32HandleInfoKHR*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_KHR:
        {
            from_proto_VkExportMemoryWin32HandleInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexportmemorywin32handleinfokhr(), reinterpret_cast<VkExportMemoryWin32HandleInfoKHR*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_external_memory_fd
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHR:
        {
            from_proto_VkImportMemoryFdInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkimportmemoryfdinfokhr(), reinterpret_cast<VkImportMemoryFdInfoKHR*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_win32_keyed_mutex
        case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHR:
        {
            from_proto_VkWin32KeyedMutexAcquireReleaseInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkwin32keyedmutexacquirereleaseinfokhr(), reinterpret_cast<VkWin32KeyedMutexAcquireReleaseInfoKHR*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_external_semaphore_win32
        case VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHR:
        {
            from_proto_VkExportSemaphoreWin32HandleInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexportsemaphorewin32handleinfokhr(), reinterpret_cast<VkExportSemaphoreWin32HandleInfoKHR*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHR:
        {
            from_proto_VkD3D12FenceSubmitInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkd3d12fencesubmitinfokhr(), reinterpret_cast<VkD3D12FenceSubmitInfoKHR*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_push_descriptor
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES_KHR:
        {
            from_proto_VkPhysicalDevicePushDescriptorPropertiesKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicepushdescriptorpropertieskhr(), reinterpret_cast<VkPhysicalDevicePushDescriptorPropertiesKHR*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_incremental_present
        case VK_STRUCTURE_TYPE_PRESENT_REGIONS_KHR:
        {
            from_proto_VkPresentRegionsKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkpresentregionskhr(), reinterpret_cast<VkPresentRegionsKHR*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_shared_presentable_image
        case VK_STRUCTURE_TYPE_SHARED_PRESENT_SURFACE_CAPABILITIES_KHR:
        {
            from_proto_VkSharedPresentSurfaceCapabilitiesKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vksharedpresentsurfacecapabilitieskhr(), reinterpret_cast<VkSharedPresentSurfaceCapabilitiesKHR*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_external_fence_win32
        case VK_STRUCTURE_TYPE_EXPORT_FENCE_WIN32_HANDLE_INFO_KHR:
        {
            from_proto_VkExportFenceWin32HandleInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexportfencewin32handleinfokhr(), reinterpret_cast<VkExportFenceWin32HandleInfoKHR*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_image_format_list
        case VK_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO_KHR:
        {
            from_proto_VkImageFormatListCreateInfoKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkimageformatlistcreateinfokhr(), reinterpret_cast<VkImageFormatListCreateInfoKHR*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_KHR_8bit_storage
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES_KHR:
        {
            from_proto_VkPhysicalDevice8BitStorageFeaturesKHR(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevice8bitstoragefeatureskhr(), reinterpret_cast<VkPhysicalDevice8BitStorageFeaturesKHR*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_ANDROID_native_buffer
        case VK_STRUCTURE_TYPE_NATIVE_BUFFER_ANDROID:
        {
            from_proto_VkNativeBufferANDROID(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vknativebufferandroid(), reinterpret_cast<VkNativeBufferANDROID*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_debug_report
        case VK_STRUCTURE_TYPE_DEBUG_REPORT_CALLBACK_CREATE_INFO_EXT:
        {
            from_proto_VkDebugReportCallbackCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdebugreportcallbackcreateinfoext(), reinterpret_cast<VkDebugReportCallbackCreateInfoEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_AMD_rasterization_order
        case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_RASTERIZATION_ORDER_AMD:
        {
            from_proto_VkPipelineRasterizationStateRasterizationOrderAMD(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkpipelinerasterizationstaterasterizationorderamd(), reinterpret_cast<VkPipelineRasterizationStateRasterizationOrderAMD*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_NV_dedicated_allocation
        case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_IMAGE_CREATE_INFO_NV:
        {
            from_proto_VkDedicatedAllocationImageCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdedicatedallocationimagecreateinfonv(), reinterpret_cast<VkDedicatedAllocationImageCreateInfoNV*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_BUFFER_CREATE_INFO_NV:
        {
            from_proto_VkDedicatedAllocationBufferCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdedicatedallocationbuffercreateinfonv(), reinterpret_cast<VkDedicatedAllocationBufferCreateInfoNV*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_MEMORY_ALLOCATE_INFO_NV:
        {
            from_proto_VkDedicatedAllocationMemoryAllocateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdedicatedallocationmemoryallocateinfonv(), reinterpret_cast<VkDedicatedAllocationMemoryAllocateInfoNV*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_AMD_texture_gather_bias_lod
        case VK_STRUCTURE_TYPE_TEXTURE_LOD_GATHER_FORMAT_PROPERTIES_AMD:
        {
            from_proto_VkTextureLODGatherFormatPropertiesAMD(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vktexturelodgatherformatpropertiesamd(), reinterpret_cast<VkTextureLODGatherFormatPropertiesAMD*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_NV_external_memory
        case VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_NV:
        {
            from_proto_VkExternalMemoryImageCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexternalmemoryimagecreateinfonv(), reinterpret_cast<VkExternalMemoryImageCreateInfoNV*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_NV:
        {
            from_proto_VkExportMemoryAllocateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexportmemoryallocateinfonv(), reinterpret_cast<VkExportMemoryAllocateInfoNV*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_NV_external_memory_win32
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_NV:
        {
            from_proto_VkImportMemoryWin32HandleInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkimportmemorywin32handleinfonv(), reinterpret_cast<VkImportMemoryWin32HandleInfoNV*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_NV:
        {
            from_proto_VkExportMemoryWin32HandleInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexportmemorywin32handleinfonv(), reinterpret_cast<VkExportMemoryWin32HandleInfoNV*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_NV_win32_keyed_mutex
        case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV:
        {
            from_proto_VkWin32KeyedMutexAcquireReleaseInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkwin32keyedmutexacquirereleaseinfonv(), reinterpret_cast<VkWin32KeyedMutexAcquireReleaseInfoNV*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_validation_flags
        case VK_STRUCTURE_TYPE_VALIDATION_FLAGS_EXT:
        {
            from_proto_VkValidationFlagsEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkvalidationflagsext(), reinterpret_cast<VkValidationFlagsEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_conditional_rendering
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CONDITIONAL_RENDERING_FEATURES_EXT:
        {
            from_proto_VkPhysicalDeviceConditionalRenderingFeaturesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldeviceconditionalrenderingfeaturesext(), reinterpret_cast<VkPhysicalDeviceConditionalRenderingFeaturesEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_CONDITIONAL_RENDERING_INFO_EXT:
        {
            from_proto_VkCommandBufferInheritanceConditionalRenderingInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkcommandbufferinheritanceconditionalrenderinginfoext(), reinterpret_cast<VkCommandBufferInheritanceConditionalRenderingInfoEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_NV_clip_space_w_scaling
        case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_W_SCALING_STATE_CREATE_INFO_NV:
        {
            from_proto_VkPipelineViewportWScalingStateCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkpipelineviewportwscalingstatecreateinfonv(), reinterpret_cast<VkPipelineViewportWScalingStateCreateInfoNV*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_display_control
        case VK_STRUCTURE_TYPE_SWAPCHAIN_COUNTER_CREATE_INFO_EXT:
        {
            from_proto_VkSwapchainCounterCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkswapchaincountercreateinfoext(), reinterpret_cast<VkSwapchainCounterCreateInfoEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_GOOGLE_display_timing
        case VK_STRUCTURE_TYPE_PRESENT_TIMES_INFO_GOOGLE:
        {
            from_proto_VkPresentTimesInfoGOOGLE(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkpresenttimesinfogoogle(), reinterpret_cast<VkPresentTimesInfoGOOGLE*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_NVX_multiview_per_view_attributes
        ...
        case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_SWIZZLE_STATE_CREATE_INFO_NV:
        {
            from_proto_VkPipelineViewportSwizzleStateCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkpipelineviewportswizzlestatecreateinfonv(), reinterpret_cast<VkPipelineViewportSwizzleStateCreateInfoNV*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_discard_rectangles
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DISCARD_RECTANGLE_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceDiscardRectanglePropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicediscardrectanglepropertiesext(), reinterpret_cast<VkPhysicalDeviceDiscardRectanglePropertiesEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_DISCARD_RECTANGLE_STATE_CREATE_INFO_EXT:
        {
            from_proto_VkPipelineDiscardRectangleStateCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkpipelinediscardrectanglestatecreateinfoext(), reinterpret_cast<VkPipelineDiscardRectangleStateCreateInfoEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_conservative_rasterization
        ...
        case VK_STRUCTURE_TYPE_DEBUG_UTILS_MESSENGER_CREATE_INFO_EXT:
        {
            from_proto_VkDebugUtilsMessengerCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdebugutilsmessengercreateinfoext(), reinterpret_cast<VkDebugUtilsMessengerCreateInfoEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_ANDROID_external_memory_android_hardware_buffer
        case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_USAGE_ANDROID:
        {
            from_proto_VkAndroidHardwareBufferUsageANDROID(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkandroidhardwarebufferusageandroid(), reinterpret_cast<VkAndroidHardwareBufferUsageANDROID*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_PROPERTIES_ANDROID:
        {
            from_proto_VkAndroidHardwareBufferFormatPropertiesANDROID(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkandroidhardwarebufferformatpropertiesandroid(), reinterpret_cast<VkAndroidHardwareBufferFormatPropertiesANDROID*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_IMPORT_ANDROID_HARDWARE_BUFFER_INFO_ANDROID:
        {
            from_proto_VkImportAndroidHardwareBufferInfoANDROID(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkimportandroidhardwarebufferinfoandroid(), reinterpret_cast<VkImportAndroidHardwareBufferInfoANDROID*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_EXTERNAL_FORMAT_ANDROID:
        {
            from_proto_VkExternalFormatANDROID(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkexternalformatandroid(), reinterpret_cast<VkExternalFormatANDROID*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_sampler_filter_minmax
        case VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO_EXT:
        {
            from_proto_VkSamplerReductionModeCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vksamplerreductionmodecreateinfoext(), reinterpret_cast<VkSamplerReductionModeCreateInfoEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicesamplerfilterminmaxpropertiesext(), reinterpret_cast<VkPhysicalDeviceSamplerFilterMinmaxPropertiesEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_sample_locations
        case VK_STRUCTURE_TYPE_SAMPLE_LOCATIONS_INFO_EXT:
        {
            from_proto_VkSampleLocationsInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vksamplelocationsinfoext(), reinterpret_cast<VkSampleLocationsInfoEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_RENDER_PASS_SAMPLE_LOCATIONS_BEGIN_INFO_EXT:
        {
            from_proto_VkRenderPassSampleLocationsBeginInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkrenderpasssamplelocationsbegininfoext(), reinterpret_cast<VkRenderPassSampleLocationsBeginInfoEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_SAMPLE_LOCATIONS_STATE_CREATE_INFO_EXT:
        {
            from_proto_VkPipelineSampleLocationsStateCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkpipelinesamplelocationsstatecreateinfoext(), reinterpret_cast<VkPipelineSampleLocationsStateCreateInfoEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLE_LOCATIONS_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceSampleLocationsPropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicesamplelocationspropertiesext(), reinterpret_cast<VkPhysicalDeviceSampleLocationsPropertiesEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_blend_operation_advanced
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_FEATURES_EXT:
        {
            from_proto_VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldeviceblendoperationadvancedfeaturesext(), reinterpret_cast<VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldeviceblendoperationadvancedpropertiesext(), reinterpret_cast<VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_ADVANCED_STATE_CREATE_INFO_EXT:
        {
            from_proto_VkPipelineColorBlendAdvancedStateCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkpipelinecolorblendadvancedstatecreateinfoext(), reinterpret_cast<VkPipelineColorBlendAdvancedStateCreateInfoEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_NV_fragment_coverage_to_color
        case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_TO_COLOR_STATE_CREATE_INFO_NV:
        {
            from_proto_VkPipelineCoverageToColorStateCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkpipelinecoveragetocolorstatecreateinfonv(), reinterpret_cast<VkPipelineCoverageToColorStateCreateInfoNV*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_NV_framebuffer_mixed_samples
        case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_MODULATION_STATE_CREATE_INFO_NV:
        {
            from_proto_VkPipelineCoverageModulationStateCreateInfoNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkpipelinecoveragemodulationstatecreateinfonv(), reinterpret_cast<VkPipelineCoverageModulationStateCreateInfoNV*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_validation_cache
        case VK_STRUCTURE_TYPE_SHADER_MODULE_VALIDATION_CACHE_CREATE_INFO_EXT:
        {
            from_proto_VkShaderModuleValidationCacheCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkshadermodulevalidationcachecreateinfoext(), reinterpret_cast<VkShaderModuleValidationCacheCreateInfoEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_descriptor_indexing
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO_EXT:
        {
            from_proto_VkDescriptorSetLayoutBindingFlagsCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdescriptorsetlayoutbindingflagscreateinfoext(), reinterpret_cast<VkDescriptorSetLayoutBindingFlagsCreateInfoEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES_EXT:
        {
            from_proto_VkPhysicalDeviceDescriptorIndexingFeaturesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicedescriptorindexingfeaturesext(), reinterpret_cast<VkPhysicalDeviceDescriptorIndexingFeaturesEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceDescriptorIndexingPropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicedescriptorindexingpropertiesext(), reinterpret_cast<VkPhysicalDeviceDescriptorIndexingPropertiesEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO_EXT:
        {
            from_proto_VkDescriptorSetVariableDescriptorCountAllocateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdescriptorsetvariabledescriptorcountallocateinfoext(), reinterpret_cast<VkDescriptorSetVariableDescriptorCountAllocateInfoEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT_EXT:
        {
            from_proto_VkDescriptorSetVariableDescriptorCountLayoutSupportEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdescriptorsetvariabledescriptorcountlayoutsupportext(), reinterpret_cast<VkDescriptorSetVariableDescriptorCountLayoutSupportEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_global_priority
        case VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO_EXT:
        {
            from_proto_VkDeviceQueueGlobalPriorityCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkdevicequeueglobalprioritycreateinfoext(), reinterpret_cast<VkDeviceQueueGlobalPriorityCreateInfoEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_external_memory_host
        case VK_STRUCTURE_TYPE_IMPORT_MEMORY_HOST_POINTER_INFO_EXT:
        {
            from_proto_VkImportMemoryHostPointerInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkimportmemoryhostpointerinfoext(), reinterpret_cast<VkImportMemoryHostPointerInfoEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_HOST_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceExternalMemoryHostPropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldeviceexternalmemoryhostpropertiesext(), reinterpret_cast<VkPhysicalDeviceExternalMemoryHostPropertiesEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_AMD_shader_core_properties
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_AMD:
        {
            from_proto_VkPhysicalDeviceShaderCorePropertiesAMD(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldeviceshadercorepropertiesamd(), reinterpret_cast<VkPhysicalDeviceShaderCorePropertiesAMD*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_EXT_vertex_attribute_divisor
        case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES_EXT:
        {
            from_proto_VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkphysicaldevicevertexattributedivisorpropertiesext(), reinterpret_cast<VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_EXT:
        {
            from_proto_VkPipelineVertexInputDivisorStateCreateInfoEXT(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkpipelinevertexinputdivisorstatecreateinfoext(), reinterpret_cast<VkPipelineVertexInputDivisorStateCreateInfoEXT*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_NV_device_diagnostic_checkpoints
        case VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_NV:
        {
            from_proto_VkQueueFamilyCheckpointPropertiesNV(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkqueuefamilycheckpointpropertiesnv(), reinterpret_cast<VkQueueFamilyCheckpointPropertiesNV*>(structExtension_out));
            break;
        }
#endif
#ifdef VK_GOOGLE_color_buffer
        case VK_STRUCTURE_TYPE_IMPORT_COLOR_BUFFER_GOOGLE:
        {
            from_proto_VkImportColorBufferGOOGLE(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkimportcolorbuffergoogle(), reinterpret_cast<VkImportColorBufferGOOGLE*>(structExtension_out));
            break;
        }
        case VK_STRUCTURE_TYPE_IMPORT_PHYSICAL_ADDRESS_GOOGLE:
        {
            from_proto_VkImportPhysicalAddressGOOGLE(pool, handleMapping, reinterpret_cast<goldfish_vk_proto::VkExtensionStruct*>(structExtension_out)->mutable_extension_vkimportphysicaladdressgoogle(), reinterpret_cast<VkImportPhysicalAddressGOOGLE*>(structExtension_out));
            break;
        }
#endif
        default:
