    ...
    VkApplicationInfo* output)
{
    ...
    // TODO extension struct
    output->pApplicationName = input->papplicationname().c_str();
    output->applicationVersion = (uint32_t)input->applicationversion();
    output->pEngineName = input->penginename().c_str();
    ...
    VkInstanceCreateInfo* output)
{
    ...
    if (input->has_papplicationinfo())
    {
        *(void**)&output->pApplicationInfo = pool->alloc(sizeof(const VkApplicationInfo));
        from_proto_VkApplicationInfo(pool, handleMapping, input->mutable_papplicationinfo(), output->pApplicationInfo);
    }
    ...
    *(void**)&output->ppEnabledLayerNames = pool->alloc(output->enabledLayerCount * sizeof(char*));
    ...
    {
        output->ppEnabledLayerNames[i] = input->ppenabledlayernames(i).c_str();
    }
    ...
    *(void**)&output->ppEnabledExtensionNames = pool->alloc(output->enabledExtensionCount * sizeof(char*));
    ...
    {
        output->ppEnabledExtensionNames[i] = input->ppenabledextensionnames(i).c_str();
    }
}
...
{
    from_proto_VkExtent3D(pool, handleMapping, input->mutable_maxextent(), &output->maxExtent);
    ...
    VkPhysicalDeviceProperties* output)
{
    ...
    from_proto_VkPhysicalDeviceLimits(pool, handleMapping, input->mutable_limits(), &output->limits);
    from_proto_VkPhysicalDeviceSparseProperties(pool, handleMapping, input->mutable_sparseproperties(), &output->sparseProperties);
}
    ...
    VkQueueFamilyProperties* output)
{
    ...
    from_proto_VkExtent3D(pool, handleMapping, input->mutable_minimagetransfergranularity(), &output->minImageTransferGranularity);
}
    ...
    VkPhysicalDeviceMemoryProperties* output)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)VK_MAX_MEMORY_TYPES; ++i)
    {
        from_proto_VkMemoryType(pool, handleMapping, input->mutable_memorytypes(i), output->memoryTypes + i);
    }
    output->memoryHeapCount = (uint32_t)input->memoryheapcount();
    for (uint32_t i = 0; i < (uint32_t)VK_MAX_MEMORY_HEAPS; ++i)
    {
        from_proto_VkMemoryHeap(pool, handleMapping, input->mutable_memoryheaps(i), output->memoryHeaps + i);
    }
}
    ...
    VkDeviceQueueCreateInfo* output)
{
    ...
    {
        output->pQueuePriorities[i] = inputpqueuepriorities->(i);
    }
}
    ...
    VkDeviceCreateInfo* output)
{
    ...
    *(void**)&output->pQueueCreateInfos = pool->alloc(output->queueCreateInfoCount * sizeof(const VkDeviceQueueCreateInfo));
    ...
    {
        from_proto_VkDeviceQueueCreateInfo(pool, handleMapping, input->mutable_pqueuecreateinfos(i), output->pQueueCreateInfos + i);
    }
    output->enabledLayerCount = (uint32_t)input->enabledlayercount();
    *(void**)&output->ppEnabledLayerNames = pool->alloc(output->enabledLayerCount * sizeof(char*));
    for (uint32_t i = 0; i < (uint32_t)output->enabledLayerCount; ++i)
    ...
    *(void**)&output->ppEnabledExtensionNames = pool->alloc(output->enabledExtensionCount * sizeof(char*));
    ...
    if (input->has_penabledfeatures())
    {
        *(void**)&output->pEnabledFeatures = pool->alloc(sizeof(const VkPhysicalDeviceFeatures));
        from_proto_VkPhysicalDeviceFeatures(pool, handleMapping, input->mutable_penabledfeatures(), output->pEnabledFeatures);
    }
}
    ...
    VkSubmitInfo* output)
{
    ...
    if (output->waitSemaphoreCount)
    {
        for (uint32_t i = 0; i < output->waitSemaphoreCount; ++i)
        {
            ...
            handleMapping->mapHandles_u64_VkSemaphore(&current, &output->pWaitSemaphores[i], 1);
        }
    }
    for (uint32_t i = 0; i < (uint32_t)output->waitSemaphoreCount; ++i)
    {
        output->pWaitDstStageMask[i] = inputpwaitdststagemask->(i);
    }
    ...
    if (output->commandBufferCount)
    {
        for (uint32_t i = 0; i < output->commandBufferCount; ++i)
        {
            ...
            handleMapping->mapHandles_u64_VkCommandBuffer(&current, &output->pCommandBuffers[i], 1);
        }
    }
    ...
    if (output->signalSemaphoreCount)
    {
        for (uint32_t i = 0; i < output->signalSemaphoreCount; ++i)
        {
            ...
            handleMapping->mapHandles_u64_VkSemaphore(&current, &output->pSignalSemaphores[i], 1);
        }
    }
}
    ...
    VkMappedMemoryRange* output)
{
    ...
    {
        uint64_t current = input->memory(i);
        handleMapping->mapHandles_u64_VkDeviceMemory(&current, &&output->memory[i], 1);
    }
    ...
    VkSparseImageFormatProperties* output)
{
    ...
    from_proto_VkExtent3D(pool, handleMapping, input->mutable_imagegranularity(), &output->imageGranularity);
...
{
    from_proto_VkSparseImageFormatProperties(pool, handleMapping, input->mutable_formatproperties(), &output->formatProperties);
    ...
    VkSparseBufferMemoryBindInfo* output)
{
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->buffer(i);
        handleMapping->mapHandles_u64_VkBuffer(&current, &&output->buffer[i], 1);
    }
    ...
    *(void**)&output->pBinds = pool->alloc(output->bindCount * sizeof(const VkSparseMemoryBind));
    ...
    {
        from_proto_VkSparseMemoryBind(pool, handleMapping, input->mutable_pbinds(i), output->pBinds + i);
    }
}
    ...
    VkSparseImageOpaqueMemoryBindInfo* output)
{
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->image(i);
        handleMapping->mapHandles_u64_VkImage(&current, &&output->image[i], 1);
    }
    output->bindCount = (uint32_t)input->bindcount();
    *(void**)&output->pBinds = pool->alloc(output->bindCount * sizeof(const VkSparseMemoryBind));
    for (uint32_t i = 0; i < (uint32_t)output->bindCount; ++i)
...
{
    from_proto_VkImageSubresource(pool, handleMapping, input->mutable_subresource(), &output->subresource);
    from_proto_VkOffset3D(pool, handleMapping, input->mutable_offset(), &output->offset);
    from_proto_VkExtent3D(pool, handleMapping, input->mutable_extent(), &output->extent);
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->memory(i);
        handleMapping->mapHandles_u64_VkDeviceMemory(&current, &&output->memory[i], 1);
    ...
    VkSparseImageMemoryBindInfo* output)
{
    ...
    *(void**)&output->pBinds = pool->alloc(output->bindCount * sizeof(const VkSparseImageMemoryBind));
    for (uint32_t i = 0; i < (uint32_t)output->bindCount; ++i)
    {
        from_proto_VkSparseImageMemoryBind(pool, handleMapping, input->mutable_pbinds(i), output->pBinds + i);
    }
}
    ...
    VkBindSparseInfo* output)
{
    ...
    *(void**)&output->pBufferBinds = pool->alloc(output->bufferBindCount * sizeof(const VkSparseBufferMemoryBindInfo));
    ...
    {
        from_proto_VkSparseBufferMemoryBindInfo(pool, handleMapping, input->mutable_pbufferbinds(i), output->pBufferBinds + i);
    }
    ...
    *(void**)&output->pImageOpaqueBinds = pool->alloc(output->imageOpaqueBindCount * sizeof(const VkSparseImageOpaqueMemoryBindInfo));
    ...
    {
        from_proto_VkSparseImageOpaqueMemoryBindInfo(pool, handleMapping, input->mutable_pimageopaquebinds(i), output->pImageOpaqueBinds + i);
    }
    ...
    *(void**)&output->pImageBinds = pool->alloc(output->imageBindCount * sizeof(const VkSparseImageMemoryBindInfo));
    ...
    {
        from_proto_VkSparseImageMemoryBindInfo(pool, handleMapping, input->mutable_pimagebinds(i), output->pImageBinds + i);
    }
    output->signalSemaphoreCount = (uint32_t)input->signalsemaphorecount();
    if (output->signalSemaphoreCount)
    {
    ...
    VkBufferCreateInfo* output)
{
    ...
    // WARNING PTR CHECK
    if (input->has_pqueuefamilyindices())
    {
        for (uint32_t i = 0; i < (uint32_t)output->queueFamilyIndexCount; ++i)
        {
            output->pQueueFamilyIndices[i] = inputpqueuefamilyindices->(i);
        }
    }
}
    ...
    VkImageViewCreateInfo* output)
{
    ...
    output->format = (VkFormat)input->format();
    from_proto_VkComponentMapping(pool, handleMapping, input->mutable_components(), &output->components);
    from_proto_VkImageSubresourceRange(pool, handleMapping, input->mutable_subresourcerange(), &output->subresourceRange);
}
    ...
    VkPipelineCacheCreateInfo* output)
{
    ...
    {
        output->pInitialData[i] = inputpinitialdata->(void*)(i);
    }
}
    ...
    VkSpecializationInfo* output)
{
    ...
    *(void**)&output->pMapEntries = pool->alloc(output->mapEntryCount * sizeof(const VkSpecializationMapEntry));
    ...
    {
        from_proto_VkSpecializationMapEntry(pool, handleMapping, input->mutable_pmapentries(i), output->pMapEntries + i);
    }
    output->dataSize = (size_t)input->datasize();
    for (uint32_t i = 0; i < (uint32_t)output->dataSize; ++i)
    {
        output->pData[i] = inputpdata->(void*)(i);
    }
}
    ...
    VkPipelineShaderStageCreateInfo* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->module(i);
        handleMapping->mapHandles_u64_VkShaderModule(&current, &&output->module[i], 1);
    }
    output->pName = input->pname().c_str();
    // WARNING PTR CHECK
    if (input->has_pspecializationinfo())
    {
        *(void**)&output->pSpecializationInfo = pool->alloc(sizeof(const VkSpecializationInfo));
        from_proto_VkSpecializationInfo(pool, handleMapping, input->mutable_pspecializationinfo(), output->pSpecializationInfo);
    }
}
    ...
    VkPipelineVertexInputStateCreateInfo* output)
{
    ...
    *(void**)&output->pVertexBindingDescriptions = pool->alloc(output->vertexBindingDescriptionCount * sizeof(const VkVertexInputBindingDescription));
    ...
    {
        from_proto_VkVertexInputBindingDescription(pool, handleMapping, input->mutable_pvertexbindingdescriptions(i), output->pVertexBindingDescriptions + i);
    }
    ...
    *(void**)&output->pVertexAttributeDescriptions = pool->alloc(output->vertexAttributeDescriptionCount * sizeof(const VkVertexInputAttributeDescription));
    ...
    {
        from_proto_VkVertexInputAttributeDescription(pool, handleMapping, input->mutable_pvertexattributedescriptions(i), output->pVertexAttributeDescriptions + i);
    }
}
...
void from_proto_VkRect2D(
    ...
    VkRect2D* output)
{
    from_proto_VkOffset2D(pool, handleMapping, input->mutable_offset(), &output->offset);
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_extent(), &output->extent);
}
    ...
    VkPipelineViewportStateCreateInfo* output)
{
    ...
    if (input->has_pviewports())
    {
        *(void**)&output->pViewports = pool->alloc(output->viewportCount * sizeof(const VkViewport));
        ...
        {
            from_proto_VkViewport(pool, handleMapping, input->mutable_pviewports(i), output->pViewports + i);
        }
    }
    output->scissorCount = (uint32_t)input->scissorcount();
    // WARNING PTR CHECK
    if (input->has_pscissors())
    {
        *(void**)&output->pScissors = pool->alloc(output->scissorCount * sizeof(const VkRect2D));
        ...
        {
            from_proto_VkRect2D(pool, handleMapping, input->mutable_pscissors(i), output->pScissors + i);
        }
    }
}
    ...
    VkPipelineMultisampleStateCreateInfo* output)
{
    ...
    // WARNING PTR CHECK
    if (input->has_psamplemask())
    {
        for (uint32_t i = 0; i < (uint32_t)(((output->rasterizationSamples) + 31) / 32); ++i)
        {
            output->pSampleMask[i] = inputpsamplemask->(i);
        }
    }
    ...
    VkPipelineDepthStencilStateCreateInfo* output)
{
    ...
    from_proto_VkStencilOpState(pool, handleMapping, input->mutable_front(), &output->front);
    from_proto_VkStencilOpState(pool, handleMapping, input->mutable_back(), &output->back);
    ...
    VkPipelineColorBlendStateCreateInfo* output)
{
    ...
    *(void**)&output->pAttachments = pool->alloc(output->attachmentCount * sizeof(const VkPipelineColorBlendAttachmentState));
    ...
    {
        from_proto_VkPipelineColorBlendAttachmentState(pool, handleMapping, input->mutable_pattachments(i), output->pAttachments + i);
    }
    for (uint32_t i = 0; i < (uint32_t)4; ++i)
    {
    ...
    VkPipelineDynamicStateCreateInfo* output)
{
    ...
    {
        output->pDynamicStates[i] = inputpdynamicstates->(i);
    }
}
    ...
    VkGraphicsPipelineCreateInfo* output)
{
    ...
    *(void**)&output->pStages = pool->alloc(output->stageCount * sizeof(const VkPipelineShaderStageCreateInfo));
    ...
    {
        from_proto_VkPipelineShaderStageCreateInfo(pool, handleMapping, input->mutable_pstages(i), output->pStages + i);
    }
    *(void**)&output->pVertexInputState = pool->alloc(sizeof(const VkPipelineVertexInputStateCreateInfo));
    from_proto_VkPipelineVertexInputStateCreateInfo(pool, handleMapping, input->mutable_pvertexinputstate(), output->pVertexInputState);
    *(void**)&output->pInputAssemblyState = pool->alloc(sizeof(const VkPipelineInputAssemblyStateCreateInfo));
    from_proto_VkPipelineInputAssemblyStateCreateInfo(pool, handleMapping, input->mutable_pinputassemblystate(), output->pInputAssemblyState);
    // WARNING PTR CHECK
    if (input->has_ptessellationstate())
    {
        *(void**)&output->pTessellationState = pool->alloc(sizeof(const VkPipelineTessellationStateCreateInfo));
        from_proto_VkPipelineTessellationStateCreateInfo(pool, handleMapping, input->mutable_ptessellationstate(), output->pTessellationState);
    }
    // WARNING PTR CHECK
    if (input->has_pviewportstate())
    {
        *(void**)&output->pViewportState = pool->alloc(sizeof(const VkPipelineViewportStateCreateInfo));
        from_proto_VkPipelineViewportStateCreateInfo(pool, handleMapping, input->mutable_pviewportstate(), output->pViewportState);
    }
    *(void**)&output->pRasterizationState = pool->alloc(sizeof(const VkPipelineRasterizationStateCreateInfo));
    from_proto_VkPipelineRasterizationStateCreateInfo(pool, handleMapping, input->mutable_prasterizationstate(), output->pRasterizationState);
    // WARNING PTR CHECK
    if (input->has_pmultisamplestate())
    {
        *(void**)&output->pMultisampleState = pool->alloc(sizeof(const VkPipelineMultisampleStateCreateInfo));
        from_proto_VkPipelineMultisampleStateCreateInfo(pool, handleMapping, input->mutable_pmultisamplestate(), output->pMultisampleState);
    }
    // WARNING PTR CHECK
    if (input->has_pdepthstencilstate())
    {
        *(void**)&output->pDepthStencilState = pool->alloc(sizeof(const VkPipelineDepthStencilStateCreateInfo));
        from_proto_VkPipelineDepthStencilStateCreateInfo(pool, handleMapping, input->mutable_pdepthstencilstate(), output->pDepthStencilState);
    }
    // WARNING PTR CHECK
    if (input->has_pcolorblendstate())
    {
        *(void**)&output->pColorBlendState = pool->alloc(sizeof(const VkPipelineColorBlendStateCreateInfo));
        from_proto_VkPipelineColorBlendStateCreateInfo(pool, handleMapping, input->mutable_pcolorblendstate(), output->pColorBlendState);
    }
    // WARNING PTR CHECK
    if (input->has_pdynamicstate())
    {
        *(void**)&output->pDynamicState = pool->alloc(sizeof(const VkPipelineDynamicStateCreateInfo));
        from_proto_VkPipelineDynamicStateCreateInfo(pool, handleMapping, input->mutable_pdynamicstate(), output->pDynamicState);
    }
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->layout(i);
        handleMapping->mapHandles_u64_VkPipelineLayout(&current, &&output->layout[i], 1);
    }
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->renderpass(i);
        handleMapping->mapHandles_u64_VkRenderPass(&current, &&output->renderPass[i], 1);
    }
    output->subpass = (uint32_t)input->subpass();
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->basepipelinehandle(i);
        handleMapping->mapHandles_u64_VkPipeline(&current, &&output->basePipelineHandle[i], 1);
    }
    ...
    VkComputePipelineCreateInfo* output)
{
    ...
    // TODO extension struct
    output->flags = (VkPipelineCreateFlags)input->flags();
    from_proto_VkPipelineShaderStageCreateInfo(pool, handleMapping, input->mutable_stage(), &output->stage);
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->layout(i);
        handleMapping->mapHandles_u64_VkPipelineLayout(&current, &&output->layout[i], 1);
    ...
    VkPipelineLayoutCreateInfo* output)
{
    ...
    if (output->setLayoutCount)
    {
        for (uint32_t i = 0; i < output->setLayoutCount; ++i)
        {
            ...
            handleMapping->mapHandles_u64_VkDescriptorSetLayout(&current, &output->pSetLayouts[i], 1);
        }
    }
    ...
    *(void**)&output->pPushConstantRanges = pool->alloc(output->pushConstantRangeCount * sizeof(const VkPushConstantRange));
    ...
    {
        from_proto_VkPushConstantRange(pool, handleMapping, input->mutable_ppushconstantranges(i), output->pPushConstantRanges + i);
    }
}
    ...
    VkDescriptorSetLayoutBinding* output)
{
    ...
    output->stageFlags = (VkShaderStageFlags)input->stageflags();
    // WARNING PTR CHECK
    if (input->has_pimmutablesamplers())
    {
        if (output->descriptorCount)
        {
            for (uint32_t i = 0; i < output->descriptorCount; ++i)
            {
                ...
                handleMapping->mapHandles_u64_VkSampler(&current, &output->pImmutableSamplers[i], 1);
            }
        }
    }
}
    ...
    VkDescriptorSetLayoutCreateInfo* output)
{
    ...
    *(void**)&output->pBindings = pool->alloc(output->bindingCount * sizeof(const VkDescriptorSetLayoutBinding));
    ...
    {
        from_proto_VkDescriptorSetLayoutBinding(pool, handleMapping, input->mutable_pbindings(i), output->pBindings + i);
    }
}
    ...
    VkDescriptorPoolCreateInfo* output)
{
    ...
    *(void**)&output->pPoolSizes = pool->alloc(output->poolSizeCount * sizeof(const VkDescriptorPoolSize));
    ...
    {
        from_proto_VkDescriptorPoolSize(pool, handleMapping, input->mutable_ppoolsizes(i), output->pPoolSizes + i);
    }
}
    ...
    VkDescriptorSetAllocateInfo* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->descriptorpool(i);
        handleMapping->mapHandles_u64_VkDescriptorPool(&current, &&output->descriptorPool[i], 1);
    }
    ...
    VkDescriptorImageInfo* output)
{
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->sampler(i);
        handleMapping->mapHandles_u64_VkSampler(&current, &&output->sampler[i], 1);
    }
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->imageview(i);
        handleMapping->mapHandles_u64_VkImageView(&current, &&output->imageView[i], 1);
    }
    ...
    VkWriteDescriptorSet* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->dstset(i);
        handleMapping->mapHandles_u64_VkDescriptorSet(&current, &&output->dstSet[i], 1);
    }
    ...
    if (input->has_pimageinfo())
    {
        *(void**)&output->pImageInfo = pool->alloc(output->descriptorCount * sizeof(const VkDescriptorImageInfo));
        ...
        {
            from_proto_VkDescriptorImageInfo(pool, handleMapping, input->mutable_pimageinfo(i), output->pImageInfo + i);
        }
    }
    // WARNING PTR CHECK
    if (input->has_pbufferinfo())
    {
        *(void**)&output->pBufferInfo = pool->alloc(output->descriptorCount * sizeof(const VkDescriptorBufferInfo));
        for (uint32_t i = 0; i < (uint32_t)output->descriptorCount; ++i)
        {
            from_proto_VkDescriptorBufferInfo(pool, handleMapping, input->mutable_pbufferinfo(i), output->pBufferInfo + i);
        }
    }
    // WARNING PTR CHECK
    if (input->has_ptexelbufferview())
    {
        if (output->descriptorCount)
        {
            for (uint32_t i = 0; i < output->descriptorCount; ++i)
            {
                ...
                handleMapping->mapHandles_u64_VkBufferView(&current, &output->pTexelBufferView[i], 1);
            }
        }
    }
}
    ...
    VkCopyDescriptorSet* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->srcset(i);
        handleMapping->mapHandles_u64_VkDescriptorSet(&current, &&output->srcSet[i], 1);
    }
    ...
    VkFramebufferCreateInfo* output)
{
    ...
    if (output->attachmentCount)
    {
        for (uint32_t i = 0; i < output->attachmentCount; ++i)
        {
            ...
            handleMapping->mapHandles_u64_VkImageView(&current, &output->pAttachments[i], 1);
        }
    }
    output->width = (uint32_t)input->width();
    output->height = (uint32_t)input->height();
    ...
    VkSubpassDescription* output)
{
    ...
    *(void**)&output->pInputAttachments = pool->alloc(output->inputAttachmentCount * sizeof(const VkAttachmentReference));
    ...
    {
        from_proto_VkAttachmentReference(pool, handleMapping, input->mutable_pinputattachments(i), output->pInputAttachments + i);
    }
    ...
    *(void**)&output->pColorAttachments = pool->alloc(output->colorAttachmentCount * sizeof(const VkAttachmentReference));
    ...
    {
        from_proto_VkAttachmentReference(pool, handleMapping, input->mutable_pcolorattachments(i), output->pColorAttachments + i);
    }
    // WARNING PTR CHECK
    if (input->has_presolveattachments())
    {
        *(void**)&output->pResolveAttachments = pool->alloc(output->colorAttachmentCount * sizeof(const VkAttachmentReference));
        for (uint32_t i = 0; i < (uint32_t)output->colorAttachmentCount; ++i)
        {
            from_proto_VkAttachmentReference(pool, handleMapping, input->mutable_presolveattachments(i), output->pResolveAttachments + i);
        }
    }
    // WARNING PTR CHECK
    if (input->has_pdepthstencilattachment())
    {
        *(void**)&output->pDepthStencilAttachment = pool->alloc(sizeof(const VkAttachmentReference));
        from_proto_VkAttachmentReference(pool, handleMapping, input->mutable_pdepthstencilattachment(), output->pDepthStencilAttachment);
    }
    ...
    {
        output->pPreserveAttachments[i] = inputppreserveattachments->(i);
    }
}
    ...
    VkRenderPassCreateInfo* output)
{
    ...
    *(void**)&output->pAttachments = pool->alloc(output->attachmentCount * sizeof(const VkAttachmentDescription));
    for (uint32_t i = 0; i < (uint32_t)output->attachmentCount; ++i)
    {
        from_proto_VkAttachmentDescription(pool, handleMapping, input->mutable_pattachments(i), output->pAttachments + i);
    }
    ...
    *(void**)&output->pSubpasses = pool->alloc(output->subpassCount * sizeof(const VkSubpassDescription));
    ...
    {
        from_proto_VkSubpassDescription(pool, handleMapping, input->mutable_psubpasses(i), output->pSubpasses + i);
    }
    ...
    *(void**)&output->pDependencies = pool->alloc(output->dependencyCount * sizeof(const VkSubpassDependency));
    ...
    {
        from_proto_VkSubpassDependency(pool, handleMapping, input->mutable_pdependencies(i), output->pDependencies + i);
    }
}
    ...
    VkCommandBufferAllocateInfo* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->commandpool(i);
        handleMapping->mapHandles_u64_VkCommandPool(&current, &&output->commandPool[i], 1);
    }
    ...
    VkCommandBufferInheritanceInfo* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->framebuffer(i);
        handleMapping->mapHandles_u64_VkFramebuffer(&current, &&output->framebuffer[i], 1);
    }
    ...
    VkCommandBufferBeginInfo* output)
{
    ...
    if (input->has_pinheritanceinfo())
    {
        *(void**)&output->pInheritanceInfo = pool->alloc(sizeof(const VkCommandBufferInheritanceInfo));
        from_proto_VkCommandBufferInheritanceInfo(pool, handleMapping, input->mutable_pinheritanceinfo(), output->pInheritanceInfo);
    }
}
...
void from_proto_VkImageCopy(
    ...
    VkImageCopy* output)
{
    from_proto_VkImageSubresourceLayers(pool, handleMapping, input->mutable_srcsubresource(), &output->srcSubresource);
    from_proto_VkOffset3D(pool, handleMapping, input->mutable_srcoffset(), &output->srcOffset);
    from_proto_VkImageSubresourceLayers(pool, handleMapping, input->mutable_dstsubresource(), &output->dstSubresource);
    from_proto_VkOffset3D(pool, handleMapping, input->mutable_dstoffset(), &output->dstOffset);
    from_proto_VkExtent3D(pool, handleMapping, input->mutable_extent(), &output->extent);
}
    ...
    VkImageBlit* output)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)2; ++i)
    {
        from_proto_VkOffset3D(pool, handleMapping, input->mutable_srcoffsets(i), output->srcOffsets + i);
    }
    from_proto_VkImageSubresourceLayers(pool, handleMapping, input->mutable_dstsubresource(), &output->dstSubresource);
    for (uint32_t i = 0; i < (uint32_t)2; ++i)
    {
        from_proto_VkOffset3D(pool, handleMapping, input->mutable_dstoffsets(i), output->dstOffsets + i);
    }
}
    ...
    VkBufferImageCopy* output)
{
    ...
    from_proto_VkImageSubresourceLayers(pool, handleMapping, input->mutable_imagesubresource(), &output->imageSubresource);
    from_proto_VkOffset3D(pool, handleMapping, input->mutable_imageoffset(), &output->imageOffset);
    from_proto_VkExtent3D(pool, handleMapping, input->mutable_imageextent(), &output->imageExtent);
}
...
void from_proto_VkClearValue(
    ...
    VkClearValue* output)
{
    from_proto_VkClearColorValue(pool, handleMapping, input->mutable_color(), &output->color);
}
    ...
    VkClearAttachment* output)
{
    ...
    from_proto_VkClearValue(pool, handleMapping, input->mutable_clearvalue(), &output->clearValue);
}
...
void from_proto_VkClearRect(
    ...
    VkClearRect* output)
{
    from_proto_VkRect2D(pool, handleMapping, input->mutable_rect(), &output->rect);
    output->baseArrayLayer = (uint32_t)input->basearraylayer();
    output->layerCount = (uint32_t)input->layercount();
}
    ...
    VkRenderPassBeginInfo* output)
{
    ...
    from_proto_VkRect2D(pool, handleMapping, input->mutable_renderarea(), &output->renderArea);
    output->clearValueCount = (uint32_t)input->clearvaluecount();
    // WARNING PTR CHECK
    if (input->has_pclearvalues())
    {
        *(void**)&output->pClearValues = pool->alloc(output->clearValueCount * sizeof(const VkClearValue));
        ...
        {
            from_proto_VkClearValue(pool, handleMapping, input->mutable_pclearvalues(i), output->pClearValues + i);
        }
    }
}
    ...
    VkDeviceGroupRenderPassBeginInfo* output)
{
    ...
    *(void**)&output->pDeviceRenderAreas = pool->alloc(output->deviceRenderAreaCount * sizeof(const VkRect2D));
    ...
    {
        from_proto_VkRect2D(pool, handleMapping, input->mutable_pdevicerenderareas(i), output->pDeviceRenderAreas + i);
    }
}
    ...
    VkDeviceGroupSubmitInfo* output)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)output->waitSemaphoreCount; ++i)
    {
        output->pWaitSemaphoreDeviceIndices[i] = inputpwaitsemaphoredeviceindices->(i);
    }
    output->commandBufferCount = (uint32_t)input->commandbuffercount();
    for (uint32_t i = 0; i < (uint32_t)output->commandBufferCount; ++i)
    {
        output->pCommandBufferDeviceMasks[i] = inputpcommandbufferdevicemasks->(i);
    }
    output->signalSemaphoreCount = (uint32_t)input->signalsemaphorecount();
    for (uint32_t i = 0; i < (uint32_t)output->signalSemaphoreCount; ++i)
    {
        output->pSignalSemaphoreDeviceIndices[i] = inputpsignalsemaphoredeviceindices->(i);
    }
}
    ...
    VkBindBufferMemoryDeviceGroupInfo* output)
{
    ...
    {
        output->pDeviceIndices[i] = inputpdeviceindices->(i);
    }
}
    ...
    VkBindImageMemoryDeviceGroupInfo* output)
{
    ...
    *(void**)&output->pSplitInstanceBindRegions = pool->alloc(output->splitInstanceBindRegionCount * sizeof(const VkRect2D));
    ...
    {
        from_proto_VkRect2D(pool, handleMapping, input->mutable_psplitinstancebindregions(i), output->pSplitInstanceBindRegions + i);
    }
}
    ...
    VkPhysicalDeviceGroupProperties* output)
{
    ...
    if (VK_MAX_DEVICE_GROUP_SIZE)
    {
        for (uint32_t i = 0; i < VK_MAX_DEVICE_GROUP_SIZE; ++i)
        {
            ...
            handleMapping->mapHandles_u64_VkPhysicalDevice(&current, &output->physicalDevices[i], 1);
        }
    }
    ...
    VkDeviceGroupDeviceCreateInfo* output)
{
    ...
    if (output->physicalDeviceCount)
    {
        for (uint32_t i = 0; i < output->physicalDeviceCount; ++i)
        {
            ...
            handleMapping->mapHandles_u64_VkPhysicalDevice(&current, &output->pPhysicalDevices[i], 1);
        }
    }
}
    ...
    VkMemoryRequirements2* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkMemoryRequirements(pool, handleMapping, input->mutable_memoryrequirements(), &output->memoryRequirements);
}
    ...
    VkSparseImageMemoryRequirements2* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkSparseImageMemoryRequirements(pool, handleMapping, input->mutable_memoryrequirements(), &output->memoryRequirements);
}
    ...
    VkPhysicalDeviceFeatures2* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkPhysicalDeviceFeatures(pool, handleMapping, input->mutable_features(), &output->features);
}
    ...
    VkPhysicalDeviceProperties2* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkPhysicalDeviceProperties(pool, handleMapping, input->mutable_properties(), &output->properties);
}
    ...
    VkFormatProperties2* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkFormatProperties(pool, handleMapping, input->mutable_formatproperties(), &output->formatProperties);
}
    ...
    VkImageFormatProperties2* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkImageFormatProperties(pool, handleMapping, input->mutable_imageformatproperties(), &output->imageFormatProperties);
}
    ...
    VkQueueFamilyProperties2* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkQueueFamilyProperties(pool, handleMapping, input->mutable_queuefamilyproperties(), &output->queueFamilyProperties);
}
    ...
    VkPhysicalDeviceMemoryProperties2* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkPhysicalDeviceMemoryProperties(pool, handleMapping, input->mutable_memoryproperties(), &output->memoryProperties);
}
    ...
    VkSparseImageFormatProperties2* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkSparseImageFormatProperties(pool, handleMapping, input->mutable_properties(), &output->properties);
}
    ...
    VkRenderPassInputAttachmentAspectCreateInfo* output)
{
    ...
    *(void**)&output->pAspectReferences = pool->alloc(output->aspectReferenceCount * sizeof(const VkInputAttachmentAspectReference));
    ...
    {
        from_proto_VkInputAttachmentAspectReference(pool, handleMapping, input->mutable_paspectreferences(i), output->pAspectReferences + i);
    }
}
    ...
    VkRenderPassMultiviewCreateInfo* output)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)output->subpassCount; ++i)
    {
        output->pViewMasks[i] = inputpviewmasks->(i);
    }
    output->dependencyCount = (uint32_t)input->dependencycount();
    for (uint32_t i = 0; i < (uint32_t)output->dependencyCount; ++i)
    {
        output->pViewOffsets[i] = inputpviewoffsets->(i);
    }
    output->correlationMaskCount = (uint32_t)input->correlationmaskcount();
    for (uint32_t i = 0; i < (uint32_t)output->correlationMaskCount; ++i)
    {
        output->pCorrelationMasks[i] = inputpcorrelationmasks->(i);
    }
}
    ...
    VkSamplerYcbcrConversionInfo* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->conversion(i);
        handleMapping->mapHandles_u64_VkSamplerYcbcrConversion(&current, &&output->conversion[i], 1);
    }
}
    ...
    VkDescriptorUpdateTemplateCreateInfo* output)
{
    ...
    *(void**)&output->pDescriptorUpdateEntries = pool->alloc(output->descriptorUpdateEntryCount * sizeof(const VkDescriptorUpdateTemplateEntry));
    ...
    {
        from_proto_VkDescriptorUpdateTemplateEntry(pool, handleMapping, input->mutable_pdescriptorupdateentries(i), output->pDescriptorUpdateEntries + i);
    }
    output->templateType = (VkDescriptorUpdateTemplateType)input->templatetype();
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->descriptorsetlayout(i);
        handleMapping->mapHandles_u64_VkDescriptorSetLayout(&current, &&output->descriptorSetLayout[i], 1);
    }
    output->pipelineBindPoint = (VkPipelineBindPoint)input->pipelinebindpoint();
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->pipelinelayout(i);
        handleMapping->mapHandles_u64_VkPipelineLayout(&current, &&output->pipelineLayout[i], 1);
    }
    ...
    VkExternalImageFormatProperties* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkExternalMemoryProperties(pool, handleMapping, input->mutable_externalmemoryproperties(), &output->externalMemoryProperties);
}
    ...
    VkSurfaceCapabilitiesKHR* output)
{
    ...
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_currentextent(), &output->currentExtent);
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_minimageextent(), &output->minImageExtent);
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_maximageextent(), &output->maxImageExtent);
    output->maxImageArrayLayers = (uint32_t)input->maximagearraylayers();
    ...
    VkSwapchainCreateInfoKHR* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->surface(i);
        handleMapping->mapHandles_u64_VkSurfaceKHR(&current, &&output->surface[i], 1);
    }
    output->minImageCount = (uint32_t)input->minimagecount();
    output->imageFormat = (VkFormat)input->imageformat();
    output->imageColorSpace = (VkColorSpaceKHR)input->imagecolorspace();
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_imageextent(), &output->imageExtent);
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->oldswapchain(i);
        handleMapping->mapHandles_u64_VkSwapchainKHR(&current, &&output->oldSwapchain[i], 1);
    }
}
    ...
    VkPresentInfoKHR* output)
{
    ...
    if (output->swapchainCount)
    {
        for (uint32_t i = 0; i < output->swapchainCount; ++i)
        {
            ...
            handleMapping->mapHandles_u64_VkSwapchainKHR(&current, &output->pSwapchains[i], 1);
        }
    }
    for (uint32_t i = 0; i < (uint32_t)output->swapchainCount; ++i)
    {
        output->pImageIndices[i] = inputpimageindices->(i);
    }
    // WARNING PTR CHECK
    if (input->has_presults())
    {
        for (uint32_t i = 0; i < (uint32_t)output->swapchainCount; ++i)
        {
            output->pResults[i] = inputpresults->(i);
        }
    }
}
    ...
    VkImageSwapchainCreateInfoKHR* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->swapchain(i);
        handleMapping->mapHandles_u64_VkSwapchainKHR(&current, &&output->swapchain[i], 1);
    }
}
    ...
    VkAcquireNextImageInfoKHR* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->semaphore(i);
        handleMapping->mapHandles_u64_VkSemaphore(&current, &&output->semaphore[i], 1);
    }
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->fence(i);
        handleMapping->mapHandles_u64_VkFence(&current, &&output->fence[i], 1);
    }
    output->deviceMask = (uint32_t)input->devicemask();
}
    ...
    VkDeviceGroupPresentInfoKHR* output)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)output->swapchainCount; ++i)
    {
        output->pDeviceMasks[i] = inputpdevicemasks->(i);
    }
    ...
    VkDisplayPropertiesKHR* output)
{
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->display(i);
        handleMapping->mapHandles_u64_VkDisplayKHR(&current, &&output->display[i], 1);
    }
    output->displayName = input->displayname().c_str();
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_physicaldimensions(), &output->physicalDimensions);
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_physicalresolution(), &output->physicalResolution);
    output->supportedTransforms = (VkSurfaceTransformFlagsKHR)input->supportedtransforms();
...
{
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_visibleregion(), &output->visibleRegion);
    ...
    VkDisplayModePropertiesKHR* output)
{
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->displaymode(i);
        handleMapping->mapHandles_u64_VkDisplayModeKHR(&current, &&output->displayMode[i], 1);
    }
    from_proto_VkDisplayModeParametersKHR(pool, handleMapping, input->mutable_parameters(), &output->parameters);
}
    ...
    VkDisplayPlaneCapabilitiesKHR* output)
{
    ...
    from_proto_VkOffset2D(pool, handleMapping, input->mutable_minsrcposition(), &output->minSrcPosition);
    from_proto_VkOffset2D(pool, handleMapping, input->mutable_maxsrcposition(), &output->maxSrcPosition);
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_minsrcextent(), &output->minSrcExtent);
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_maxsrcextent(), &output->maxSrcExtent);
    from_proto_VkOffset2D(pool, handleMapping, input->mutable_mindstposition(), &output->minDstPosition);
    from_proto_VkOffset2D(pool, handleMapping, input->mutable_maxdstposition(), &output->maxDstPosition);
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_mindstextent(), &output->minDstExtent);
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_maxdstextent(), &output->maxDstExtent);
}
    ...
    VkDisplayPlanePropertiesKHR* output)
{
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->currentdisplay(i);
        handleMapping->mapHandles_u64_VkDisplayKHR(&current, &&output->currentDisplay[i], 1);
    }
    ...
    VkDisplayPresentInfoKHR* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkRect2D(pool, handleMapping, input->mutable_srcrect(), &output->srcRect);
    from_proto_VkRect2D(pool, handleMapping, input->mutable_dstrect(), &output->dstRect);
    ...
    VkWin32KeyedMutexAcquireReleaseInfoKHR* output)
{
    ...
    if (output->acquireCount)
    {
        for (uint32_t i = 0; i < output->acquireCount; ++i)
        {
            ...
            handleMapping->mapHandles_u64_VkDeviceMemory(&current, &output->pAcquireSyncs[i], 1);
        }
    }
    for (uint32_t i = 0; i < (uint32_t)output->acquireCount; ++i)
    {
        output->pAcquireKeys[i] = inputpacquirekeys->(i);
    }
    for (uint32_t i = 0; i < (uint32_t)output->acquireCount; ++i)
    {
        output->pAcquireTimeouts[i] = inputpacquiretimeouts->(i);
    }
    ...
    if (output->releaseCount)
    {
        for (uint32_t i = 0; i < output->releaseCount; ++i)
        {
            ...
            handleMapping->mapHandles_u64_VkDeviceMemory(&current, &output->pReleaseSyncs[i], 1);
        }
    }
    for (uint32_t i = 0; i < (uint32_t)output->releaseCount; ++i)
    {
        output->pReleaseKeys[i] = inputpreleasekeys->(i);
    }
}
    ...
    VkPresentRegionKHR* output)
{
    ...
    if (input->has_prectangles())
    {
        *(void**)&output->pRectangles = pool->alloc(output->rectangleCount * sizeof(const VkRectLayerKHR));
        ...
        {
            from_proto_VkRectLayerKHR(pool, handleMapping, input->mutable_prectangles(i), output->pRectangles + i);
        }
    }
}
    ...
    VkPresentRegionsKHR* output)
{
    ...
    output->swapchainCount = (uint32_t)input->swapchaincount();
    // WARNING PTR CHECK
    if (input->has_pregions())
    {
        *(void**)&output->pRegions = pool->alloc(output->swapchainCount * sizeof(const VkPresentRegionKHR));
        for (uint32_t i = 0; i < (uint32_t)output->swapchainCount; ++i)
        {
            from_proto_VkPresentRegionKHR(pool, handleMapping, input->mutable_pregions(i), output->pRegions + i);
        }
    }
}
    ...
    VkSubpassDescription2KHR* output)
{
    ...
    *(void**)&output->pInputAttachments = pool->alloc(output->inputAttachmentCount * sizeof(const VkAttachmentReference2KHR));
    for (uint32_t i = 0; i < (uint32_t)output->inputAttachmentCount; ++i)
    {
        from_proto_VkAttachmentReference2KHR(pool, handleMapping, input->mutable_pinputattachments(i), output->pInputAttachments + i);
    }
    output->colorAttachmentCount = (uint32_t)input->colorattachmentcount();
    *(void**)&output->pColorAttachments = pool->alloc(output->colorAttachmentCount * sizeof(const VkAttachmentReference2KHR));
    for (uint32_t i = 0; i < (uint32_t)output->colorAttachmentCount; ++i)
    {
        from_proto_VkAttachmentReference2KHR(pool, handleMapping, input->mutable_pcolorattachments(i), output->pColorAttachments + i);
    }
    // WARNING PTR CHECK
    if (input->has_presolveattachments())
    {
        *(void**)&output->pResolveAttachments = pool->alloc(output->colorAttachmentCount * sizeof(const VkAttachmentReference2KHR));
        for (uint32_t i = 0; i < (uint32_t)output->colorAttachmentCount; ++i)
        {
            from_proto_VkAttachmentReference2KHR(pool, handleMapping, input->mutable_presolveattachments(i), output->pResolveAttachments + i);
        }
    }
    // WARNING PTR CHECK
    if (input->has_pdepthstencilattachment())
    {
        *(void**)&output->pDepthStencilAttachment = pool->alloc(sizeof(const VkAttachmentReference2KHR));
        from_proto_VkAttachmentReference2KHR(pool, handleMapping, input->mutable_pdepthstencilattachment(), output->pDepthStencilAttachment);
    }
    output->preserveAttachmentCount = (uint32_t)input->preserveattachmentcount();
    for (uint32_t i = 0; i < (uint32_t)output->preserveAttachmentCount; ++i)
    {
    ...
    VkRenderPassCreateInfo2KHR* output)
{
    ...
    *(void**)&output->pAttachments = pool->alloc(output->attachmentCount * sizeof(const VkAttachmentDescription2KHR));
    for (uint32_t i = 0; i < (uint32_t)output->attachmentCount; ++i)
    {
        from_proto_VkAttachmentDescription2KHR(pool, handleMapping, input->mutable_pattachments(i), output->pAttachments + i);
    }
    output->subpassCount = (uint32_t)input->subpasscount();
    *(void**)&output->pSubpasses = pool->alloc(output->subpassCount * sizeof(const VkSubpassDescription2KHR));
    for (uint32_t i = 0; i < (uint32_t)output->subpassCount; ++i)
    {
        from_proto_VkSubpassDescription2KHR(pool, handleMapping, input->mutable_psubpasses(i), output->pSubpasses + i);
    }
    output->dependencyCount = (uint32_t)input->dependencycount();
    *(void**)&output->pDependencies = pool->alloc(output->dependencyCount * sizeof(const VkSubpassDependency2KHR));
    for (uint32_t i = 0; i < (uint32_t)output->dependencyCount; ++i)
    {
        from_proto_VkSubpassDependency2KHR(pool, handleMapping, input->mutable_pdependencies(i), output->pDependencies + i);
    }
    ...
    {
        output->pCorrelatedViewMasks[i] = inputpcorrelatedviewmasks->(i);
    }
}
    ...
    VkSurfaceCapabilities2KHR* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkSurfaceCapabilitiesKHR(pool, handleMapping, input->mutable_surfacecapabilities(), &output->surfaceCapabilities);
}
    ...
    VkSurfaceFormat2KHR* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkSurfaceFormatKHR(pool, handleMapping, input->mutable_surfaceformat(), &output->surfaceFormat);
}
    ...
    VkDisplayProperties2KHR* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkDisplayPropertiesKHR(pool, handleMapping, input->mutable_displayproperties(), &output->displayProperties);
}
    ...
    VkDisplayPlaneProperties2KHR* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkDisplayPlanePropertiesKHR(pool, handleMapping, input->mutable_displayplaneproperties(), &output->displayPlaneProperties);
}
    ...
    VkDisplayModeProperties2KHR* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkDisplayModePropertiesKHR(pool, handleMapping, input->mutable_displaymodeproperties(), &output->displayModeProperties);
}
    ...
    VkDisplayPlaneInfo2KHR* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->mode(i);
        handleMapping->mapHandles_u64_VkDisplayModeKHR(&current, &&output->mode[i], 1);
    }
    output->planeIndex = (uint32_t)input->planeindex();
}
    ...
    VkDisplayPlaneCapabilities2KHR* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkDisplayPlaneCapabilitiesKHR(pool, handleMapping, input->mutable_capabilities(), &output->capabilities);
}
    ...
    VkImageFormatListCreateInfoKHR* output)
{
    ...
    {
        output->pViewFormats[i] = inputpviewformats->(i);
    }
}
    ...
    VkDebugMarkerObjectNameInfoEXT* output)
{
    ...
    output->pObjectName = input->pobjectname().c_str();
}
    ...
    VkDebugMarkerObjectTagInfoEXT* output)
{
    ...
    {
        output->pTag[i] = inputptag->(void*)(i);
    }
}
    ...
    VkDebugMarkerMarkerInfoEXT* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    output->pMarkerName = input->pmarkername().c_str();
    for (uint32_t i = 0; i < (uint32_t)4; ++i)
    {
    ...
    VkShaderStatisticsInfoAMD* output)
{
    ...
    from_proto_VkShaderResourceUsageAMD(pool, handleMapping, input->mutable_resourceusage(), &output->resourceUsage);
    ...
    VkWin32KeyedMutexAcquireReleaseInfoNV* output)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)output->acquireCount; ++i)
    {
        output->pAcquireTimeoutMilliseconds[i] = inputpacquiretimeoutmilliseconds->(i);
    }
    output->releaseCount = (uint32_t)input->releasecount();
    if (output->releaseCount)
    {
    ...
    VkValidationFlagsEXT* output)
{
    ...
    {
        output->pDisabledValidationChecks[i] = inputpdisabledvalidationchecks->(i);
    }
}
    ...
    VkIndirectCommandsLayoutCreateInfoNVX* output)
{
    ...
    *(void**)&output->pTokens = pool->alloc(output->tokenCount * sizeof(const VkIndirectCommandsLayoutTokenNVX));
    ...
    {
        from_proto_VkIndirectCommandsLayoutTokenNVX(pool, handleMapping, input->mutable_ptokens(i), output->pTokens + i);
    }
}
    ...
    VkCmdProcessCommandsInfoNVX* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->objecttable(i);
        handleMapping->mapHandles_u64_VkObjectTableNVX(&current, &&output->objectTable[i], 1);
    }
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->indirectcommandslayout(i);
        handleMapping->mapHandles_u64_VkIndirectCommandsLayoutNVX(&current, &&output->indirectCommandsLayout[i], 1);
    }
    ...
    *(void**)&output->pIndirectCommandsTokens = pool->alloc(output->indirectCommandsTokenCount * sizeof(const VkIndirectCommandsTokenNVX));
    ...
    {
        from_proto_VkIndirectCommandsTokenNVX(pool, handleMapping, input->mutable_pindirectcommandstokens(i), output->pIndirectCommandsTokens + i);
    }
    output->maxSequencesCount = (uint32_t)input->maxsequencescount();
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->targetcommandbuffer(i);
        handleMapping->mapHandles_u64_VkCommandBuffer(&current, &&output->targetCommandBuffer[i], 1);
    }
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->sequencescountbuffer(i);
        handleMapping->mapHandles_u64_VkBuffer(&current, &&output->sequencesCountBuffer[i], 1);
    }
    output->sequencesCountOffset = (VkDeviceSize)input->sequencescountoffset();
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->sequencesindexbuffer(i);
        handleMapping->mapHandles_u64_VkBuffer(&current, &&output->sequencesIndexBuffer[i], 1);
    }
    ...
    VkObjectTableCreateInfoNVX* output)
{
    ...
    {
        output->pObjectEntryTypes[i] = inputpobjectentrytypes->(i);
    }
    for (uint32_t i = 0; i < (uint32_t)output->objectCount; ++i)
    {
        output->pObjectEntryCounts[i] = inputpobjectentrycounts->(i);
    }
    for (uint32_t i = 0; i < (uint32_t)output->objectCount; ++i)
    {
        output->pObjectEntryUsageFlags[i] = inputpobjectentryusageflags->(i);
    }
    ...
    VkObjectTablePipelineEntryNVX* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->pipeline(i);
        handleMapping->mapHandles_u64_VkPipeline(&current, &&output->pipeline[i], 1);
    }
}
    ...
    VkObjectTableDescriptorSetEntryNVX* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->descriptorset(i);
        handleMapping->mapHandles_u64_VkDescriptorSet(&current, &&output->descriptorSet[i], 1);
    }
}
    ...
    VkPipelineViewportWScalingStateCreateInfoNV* output)
{
    ...
    output->viewportCount = (uint32_t)input->viewportcount();
    // WARNING PTR CHECK
    if (input->has_pviewportwscalings())
    {
        *(void**)&output->pViewportWScalings = pool->alloc(output->viewportCount * sizeof(const VkViewportWScalingNV));
        for (uint32_t i = 0; i < (uint32_t)output->viewportCount; ++i)
        {
            from_proto_VkViewportWScalingNV(pool, handleMapping, input->mutable_pviewportwscalings(i), output->pViewportWScalings + i);
        }
    }
}
    ...
    VkPresentTimesInfoGOOGLE* output)
{
    ...
    if (input->has_ptimes())
    {
        *(void**)&output->pTimes = pool->alloc(output->swapchainCount * sizeof(const VkPresentTimeGOOGLE));
        for (uint32_t i = 0; i < (uint32_t)output->swapchainCount; ++i)
        {
            from_proto_VkPresentTimeGOOGLE(pool, handleMapping, input->mutable_ptimes(i), output->pTimes + i);
        }
    }
}
    ...
    VkPipelineViewportSwizzleStateCreateInfoNV* output)
{
    ...
    output->viewportCount = (uint32_t)input->viewportcount();
    // WARNING PTR CHECK
    if (input->has_pviewportswizzles())
    {
        *(void**)&output->pViewportSwizzles = pool->alloc(output->viewportCount * sizeof(const VkViewportSwizzleNV));
        for (uint32_t i = 0; i < (uint32_t)output->viewportCount; ++i)
        {
            from_proto_VkViewportSwizzleNV(pool, handleMapping, input->mutable_pviewportswizzles(i), output->pViewportSwizzles + i);
        }
    }
}
    ...
    VkPipelineDiscardRectangleStateCreateInfoEXT* output)
{
    ...
    // WARNING PTR CHECK
    if (input->has_pdiscardrectangles())
    {
        *(void**)&output->pDiscardRectangles = pool->alloc(output->discardRectangleCount * sizeof(const VkRect2D));
        ...
        {
            from_proto_VkRect2D(pool, handleMapping, input->mutable_pdiscardrectangles(i), output->pDiscardRectangles + i);
        }
    }
}
    ...
    VkHdrMetadataEXT* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    from_proto_VkXYColorEXT(pool, handleMapping, input->mutable_displayprimaryred(), &output->displayPrimaryRed);
    from_proto_VkXYColorEXT(pool, handleMapping, input->mutable_displayprimarygreen(), &output->displayPrimaryGreen);
    from_proto_VkXYColorEXT(pool, handleMapping, input->mutable_displayprimaryblue(), &output->displayPrimaryBlue);
    from_proto_VkXYColorEXT(pool, handleMapping, input->mutable_whitepoint(), &output->whitePoint);
    ...
    VkDebugUtilsLabelEXT* output)
{
    output->sType = (VkStructureType)input->stype();
    // TODO extension struct
    output->pLabelName = input->plabelname().c_str();
    for (uint32_t i = 0; i < (uint32_t)4; ++i)
    {
        output->color[i] = (float)input->color(i);
    }
    ...
    VkDebugUtilsMessengerCallbackDataEXT* output)
{
    ...
    output->pMessageIdName = input->pmessageidname().c_str();
    output->messageIdNumber = (int32_t)input->messageidnumber();
    output->pMessage = input->pmessage().c_str();
    output->queueLabelCount = (uint32_t)input->queuelabelcount();
    // WARNING PTR CHECK
    if (input->has_pqueuelabels())
    {
        *(void**)&output->pQueueLabels = pool->alloc(output->queueLabelCount * sizeof(VkDebugUtilsLabelEXT));
        ...
        {
            from_proto_VkDebugUtilsLabelEXT(pool, handleMapping, input->mutable_pqueuelabels(i), output->pQueueLabels + i);
        }
    }
    output->cmdBufLabelCount = (uint32_t)input->cmdbuflabelcount();
    // WARNING PTR CHECK
    if (input->has_pcmdbuflabels())
    {
        *(void**)&output->pCmdBufLabels = pool->alloc(output->cmdBufLabelCount * sizeof(VkDebugUtilsLabelEXT));
        ...
        {
            from_proto_VkDebugUtilsLabelEXT(pool, handleMapping, input->mutable_pcmdbuflabels(i), output->pCmdBufLabels + i);
        }
    }
    output->objectCount = (uint32_t)input->objectcount();
    // WARNING PTR CHECK
    if (input->has_pobjects())
    {
        *(void**)&output->pObjects = pool->alloc(output->objectCount * sizeof(VkDebugUtilsObjectNameInfoEXT));
        for (uint32_t i = 0; i < (uint32_t)output->objectCount; ++i)
        {
            from_proto_VkDebugUtilsObjectNameInfoEXT(pool, handleMapping, input->mutable_pobjects(i), output->pObjects + i);
        }
    }
}
    ...
    VkAndroidHardwareBufferFormatPropertiesANDROID* output)
{
    ...
    from_proto_VkComponentMapping(pool, handleMapping, input->mutable_samplerycbcrconversioncomponents(), &output->samplerYcbcrConversionComponents);
    ...
    VkSampleLocationsInfoEXT* output)
{
    ...
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_samplelocationgridsize(), &output->sampleLocationGridSize);
    ...
    *(void**)&output->pSampleLocations = pool->alloc(output->sampleLocationsCount * sizeof(const VkSampleLocationEXT));
    ...
    {
        from_proto_VkSampleLocationEXT(pool, handleMapping, input->mutable_psamplelocations(i), output->pSampleLocations + i);
    }
}
    ...
    VkAttachmentSampleLocationsEXT* output)
{
    ...
    from_proto_VkSampleLocationsInfoEXT(pool, handleMapping, input->mutable_samplelocationsinfo(), &output->sampleLocationsInfo);
}
    ...
    VkRenderPassSampleLocationsBeginInfoEXT* output)
{
    ...
    *(void**)&output->pAttachmentInitialSampleLocations = pool->alloc(output->attachmentInitialSampleLocationsCount * sizeof(const VkAttachmentSampleLocationsEXT));
    ...
    {
        from_proto_VkAttachmentSampleLocationsEXT(pool, handleMapping, input->mutable_pattachmentinitialsamplelocations(i), output->pAttachmentInitialSampleLocations + i);
    }
    ...
    *(void**)&output->pPostSubpassSampleLocations = pool->alloc(output->postSubpassSampleLocationsCount * sizeof(const VkSubpassSampleLocationsEXT));
    ...
    {
        from_proto_VkSubpassSampleLocationsEXT(pool, handleMapping, input->mutable_ppostsubpasssamplelocations(i), output->pPostSubpassSampleLocations + i);
    }
}
    ...
    VkPhysicalDeviceSampleLocationsPropertiesEXT* output)
{
    ...
    from_proto_VkExtent2D(pool, handleMapping, input->mutable_maxsamplelocationgridsize(), &output->maxSampleLocationGridSize);
    for (uint32_t i = 0; i < (uint32_t)2; ++i)
    {
    ...
    VkPipelineCoverageModulationStateCreateInfoNV* output)
{
    ...
    // WARNING PTR CHECK
    if (input->has_pcoveragemodulationtable())
    {
        for (uint32_t i = 0; i < (uint32_t)output->coverageModulationTableCount; ++i)
        {
            output->pCoverageModulationTable[i] = inputpcoveragemodulationtable->(i);
        }
    }
}
    ...
    VkShaderModuleValidationCacheCreateInfoEXT* output)
{
    ...
    for (uint32_t i = 0; i < 1; ++i)
    {
        uint64_t current = input->validationcache(i);
        handleMapping->mapHandles_u64_VkValidationCacheEXT(&current, &&output->validationCache[i], 1);
    }
}
    ...
    VkDescriptorSetLayoutBindingFlagsCreateInfoEXT* output)
{
    ...
    for (uint32_t i = 0; i < (uint32_t)output->bindingCount; ++i)
    {
        output->pBindingFlags[i] = inputpbindingflags->(i);
    }
}
    ...
    VkDescriptorSetVariableDescriptorCountAllocateInfoEXT* output)
{
    ...
    {
        output->pDescriptorCounts[i] = inputpdescriptorcounts->(i);
    }
}
    ...
    VkPipelineVertexInputDivisorStateCreateInfoEXT* output)
{
    ...
    *(void**)&output->pVertexBindingDivisors = pool->alloc(output->vertexBindingDivisorCount * sizeof(const VkVertexInputBindingDivisorDescriptionEXT));
    ...
    {
        from_proto_VkVertexInputBindingDivisorDescriptionEXT(pool, handleMapping, input->mutable_pvertexbindingdivisors(i), output->pVertexBindingDivisors + i);
    }
}
