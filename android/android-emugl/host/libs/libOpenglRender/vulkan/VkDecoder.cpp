    ...
    while (end - ptr >= 8)
    {
        ...
        switch (opcode)
        {
            ...
            case OP_vkCreateFence:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateFence(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateFence_VkResult_return, device, pCreateInfo, pAllocator, (VkFence*)&cgen_var_98);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateEvent:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateEvent(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateEvent_VkResult_return, device, pCreateInfo, pAllocator, (VkEvent*)&cgen_var_118);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateQueryPool:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateQueryPool(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateQueryPool_VkResult_return, device, pCreateInfo, pAllocator, (VkQueryPool*)&cgen_var_131);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateBufferView:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateBufferView(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateBufferView_VkResult_return, device, pCreateInfo, pAllocator, (VkBufferView*)&cgen_var_148);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateShaderModule:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateShaderModule(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateShaderModule_VkResult_return, device, pCreateInfo, pAllocator, (VkShaderModule*)&cgen_var_171);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreatePipelineCache:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreatePipelineCache(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreatePipelineCache_VkResult_return, device, pCreateInfo, pAllocator, (VkPipelineCache*)&cgen_var_178);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateGraphicsPipelines:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateGraphicsPipelines(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateGraphicsPipelines_VkResult_return, device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, (VkPipeline*)cgen_var_197);
                m_pool.freeAll();
                break;
            }
            case OP_vkCreateComputePipelines:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateComputePipelines(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateComputePipelines_VkResult_return, device, pipelineCache, createInfoCount, pCreateInfos, pAllocator, (VkPipeline*)cgen_var_202);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreatePipelineLayout:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreatePipelineLayout(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreatePipelineLayout_VkResult_return, device, pCreateInfo, pAllocator, (VkPipelineLayout*)&cgen_var_209);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateDescriptorSetLayout:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateDescriptorSetLayout(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateDescriptorSetLayout_VkResult_return, device, pCreateInfo, pAllocator, (VkDescriptorSetLayout*)&cgen_var_223);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateDescriptorPool:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateDescriptorPool(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateDescriptorPool_VkResult_return, device, pCreateInfo, pAllocator, (VkDescriptorPool*)&cgen_var_230);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkAllocateDescriptorSets:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkAllocateDescriptorSets(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkAllocateDescriptorSets_VkResult_return, device, pAllocateInfo, (VkDescriptorSet*)cgen_var_238);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateFramebuffer:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateFramebuffer(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateFramebuffer_VkResult_return, device, pCreateInfo, pAllocator, (VkFramebuffer*)&cgen_var_247);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateRenderPass:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateRenderPass(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateRenderPass_VkResult_return, device, pCreateInfo, pAllocator, (VkRenderPass*)&cgen_var_254);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkFreeCommandBuffers:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkFreeCommandBuffers(snapshotTraceBegin, snapshotTraceBytes, &m_pool, device, commandPool, commandBufferCount, pCommandBuffers);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateSamplerYcbcrConversion:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateSamplerYcbcrConversion(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateSamplerYcbcrConversion_VkResult_return, device, pCreateInfo, pAllocator, (VkSamplerYcbcrConversion*)&cgen_var_398);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateSwapchainKHR:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateSwapchainKHR(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateSwapchainKHR_VkResult_return, device, pCreateInfo, pAllocator, (VkSwapchainKHR*)&cgen_var_439);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateDisplayModeKHR:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateDisplayModeKHR(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateDisplayModeKHR_VkResult_return, physicalDevice, display, pCreateInfo, pAllocator, (VkDisplayModeKHR*)&cgen_var_495);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateSamplerYcbcrConversionKHR:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateSamplerYcbcrConversionKHR(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateSamplerYcbcrConversionKHR_VkResult_return, device, pCreateInfo, pAllocator, (VkSamplerYcbcrConversion*)&cgen_var_634);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateDebugReportCallbackEXT:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateDebugReportCallbackEXT(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateDebugReportCallbackEXT_VkResult_return, instance, pCreateInfo, pAllocator, (VkDebugReportCallbackEXT*)&cgen_var_659);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateIndirectCommandsLayoutNVX:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateIndirectCommandsLayoutNVX(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateIndirectCommandsLayoutNVX_VkResult_return, device, pCreateInfo, pAllocator, (VkIndirectCommandsLayoutNVX*)&cgen_var_698);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateObjectTableNVX:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateObjectTableNVX(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateObjectTableNVX_VkResult_return, device, pCreateInfo, pAllocator, (VkObjectTableNVX*)&cgen_var_705);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateDebugUtilsMessengerEXT:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateDebugUtilsMessengerEXT(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateDebugUtilsMessengerEXT_VkResult_return, instance, pCreateInfo, pAllocator, (VkDebugUtilsMessengerEXT*)&cgen_var_767);
                m_pool.freeAll();
                break;
            }
            ...
            case OP_vkCreateValidationCacheEXT:
            {
                ...
                vkStream->commitWrite();
                size_t snapshotTraceBytes = vkReadStream->endTrace();
                m_state->snapshot()->vkCreateValidationCacheEXT(snapshotTraceBegin, snapshotTraceBytes, &m_pool, vkCreateValidationCacheEXT_VkResult_return, device, pCreateInfo, pAllocator, (VkValidationCacheEXT*)&cgen_var_779);
                m_pool.freeAll();
                break;
            }
