...
#define _RETURN_ON_FAILURE(cmd)                                                \
    {                                                                          \
        ...
        if (VK_SUCCESS != result) {                                            \
            ...
            decompImageView = createDefaultImageView(
                    vk, device, decompImg, intermediateFormat, layerCount);
