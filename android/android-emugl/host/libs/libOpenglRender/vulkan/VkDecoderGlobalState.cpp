...
public:
    ...
    VkResult on_vkCreateImage(
        ...
        if (cmpInfo.isCompressed && deviceInfoIt->second.emulateTextureEtc2) {
            ...
            printf("compressed texture created %p %p\n", *pImage, cmpInfo.decompImg);
        }
    ...
    VkResult on_vkCreateImageView(
        ...
        if (deviceInfoIt->second.emulateTextureEtc2) {
            ...
            if (cmpInfo.isCompressed) {
                ...
                pCreateInfo = &createInfo;
                printf("creating compressed texture image view %p\n", imageInfoIt->second.cmpInfo.decompImg);
            }
        }
    ...
    void on_vkCmdCopyBufferToImage(
        ...
        printf("copy buffer to image compressed texture %p %p\n", dstImage, it->second.cmpInfo.decompImg);
