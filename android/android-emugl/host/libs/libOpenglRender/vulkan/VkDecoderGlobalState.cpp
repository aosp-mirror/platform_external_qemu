...
#define _RETURN_ON_FAILURE(cmd)                                                \
    {                                                                          \
        ...
        if (VK_SUCCESS != result) {                                            \
            ...
            std::vector<char> shaderSource = loadShaderSource("/usr/local/google/home/yahan/master/external/qemu/android/android-emugl/host/libs/libOpenglRender/vulkan/Etc2Decomp.spv");
