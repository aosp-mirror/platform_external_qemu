...
//extern VK_EXT_MEMORY_HANDLE dupExternalMemory(VK_EXT_MEMORY_HANDLE h);
...
static constexpr const char* const kEmulatedExtensions[] = {
        "VK_ANDROID_native_buffer", "VK_KHR_external_memory_fuchsia",
        "VK_KHR_external_semaphore_fuchsia",
};

// Leave it here in case we need to use it later
...
public:
    ...
    VkResult on_vkEnumerateInstanceExtensionProperties(
        ...
        result = insertExtensionProperties(pPropertyCount, pProperties,
                                           propertySize, kEmulatedExtensions,
                                           kEmulatedExtensionCount);
        return result;
    }
    ...
    VkResult on_vkEnumerateDeviceExtensionProperties(
        ...
        result = insertExtensionProperties(
                pPropertyCount, pProperties, propertySize,
                kEmulatedDeviceExtensions, kEmulatedDeviceExtensionCount);
        return result;
    }
    ...
    VkResult on_vkImportSemaphoreFdKHR(
        ...
        // TODO: the current implementation leaks fd. Need to figure out how to
        // notify kernel driver and forward dup from the guest
