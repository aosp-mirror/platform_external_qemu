...
#define _RETURN_ON_FAILURE(cmd)                                                \
    ...
    public:
        // We use 16000 as the max number of live handles to track;
        // we don't expect the system to go over 16000 total live handles,
        // outside some dEQP object management tests.
