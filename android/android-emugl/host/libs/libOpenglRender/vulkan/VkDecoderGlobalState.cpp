...
public:
    ...
    void on_vkCmdCopyBufferToImage(
        ...
        if (cmp.sizeCompImg) {
            ...
            for (uint32_t r = 0; r < regionCount; r++) {
                if (pRegions[r].imageSubresource.mipLevel >=
                            cmp.mipLevels - 2 &&
                    pRegions[r].imageSubresource.mipLevel > 0) {
                    continue;
                }
                ...
                dstRegion.imageExtent.width =
                        (pRegions[r].imageExtent.width + 3) / 4;
        ...
        cmdBufferInfoIt->second.preprocessFuncs.push_back(
                [this, cmp, srcBuffer, memory, regions, srcRegions]() {
                    decompressBufferToImage(cmp, srcBuffer, memory,
                                            regions.size(), srcRegions.data(),
                                            regions.data());
                });
    ...
    void on_vkCmdPipelineBarrier(
        ...
        for (uint32_t i = 0; i < imageMemoryBarrierCount; i++) {
            ...
            preDecompBarriers[0].subresourceRange.aspectMask =
            ...
            preDecompBarriers[1].subresourceRange.aspectMask =
                    VK_IMAGE_ASPECT_COLOR_BIT;
            ...
            if (it->second.cmpInfo.compFormat ==
                VK_FORMAT_ETC2_R8G8B8_UNORM_BLOCK) {
                it->second.cmpInfo.cmdDecompress(
                        vk, commandBuffer, dstStageMask,
                        decompBarrier.newLayout, decompBarrier.dstAccessMask);
            ...
            // TODO: fix me
            VkImageMemoryBarrier postDecompBarrier[2] = {sizeCompBarrier,
                                                         sizeCompBarrier};
            ...
            postDecompBarrier[1].subresourceRange.levelCount =
                    postDecompBarrier[1].subresourceRange.levelCount - 1;
            vk->vkCmdPipelineBarrier(
                    commandBuffer,
    ...
    VkResult on_vkResetCommandBuffer(
        ...
        if (VK_SUCCESS == result) {
            ...
            mCmdBufferInfo[commandBuffer].bindPoint =
...
#define _RETURN_ON_FAILURE(cmd)                                                \
    {                                                                          \
        ...
        if (VK_SUCCESS != result) {                                            \
            ...
            switch (compFormat) {
                ...
                case VK_FORMAT_ETC2_R8G8B8A1_SRGB_BLOCK:
                    shaderSrcFileName = "Etc2RGB8.spv";
                    break;
                case VK_FORMAT_ETC2_R8G8B8A8_UNORM_BLOCK:
                case VK_FORMAT_ETC2_R8G8B8A8_SRGB_BLOCK:
                    shaderSrcFileName = "Etc2RGBA8.spv";
                    break;
                case VK_FORMAT_EAC_R11_UNORM_BLOCK:
                    shaderSrcFileName = "EacR11Unorm.spv";
                    break;
                case VK_FORMAT_EAC_R11_SNORM_BLOCK:
                    shaderSrcFileName = "EacR11Snorm.spv";
                    break;
                case VK_FORMAT_EAC_R11G11_UNORM_BLOCK:
                    shaderSrcFileName = "EacRG11Unorm.spv";
                    break;
                case VK_FORMAT_EAC_R11G11_SNORM_BLOCK:
                    shaderSrcFileName = "EacRG11Snorm.spv";
                    break;
                default:
                    shaderSrcFileName = "Etc2RGB8.spv";
                    break;
            ...
            imageView = createDefaultImageView(vk, device, sizeCompImg,
                                               sizeCompFormat);
            ...
            decompImageView = createDefaultImageView(vk, device, decompImg,
                                                     intermediateFormat);
        ...
        void cmdDecompress(goldfish_vk::VulkanDispatch* vk,
            ...
            vk->vkCmdDispatch(commandBuffer, (extent.width + 3) / 4,
                              (extent.height + 3) / 4, extent.depth);
            if (mipLevels > 1) {
                // if (0) {
                ...
                for (uint32_t i = 1; i < mipLevels; i++) {
                    VkPipelineStageFlags currStage =
                            i == 1 ? VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT
                    ...
                    vk->vkCmdPipelineBarrier(commandBuffer, currStage,
                    ...
                    blit.srcOffsets[1] = {(int32_t)mipmapWidth(i - 1),
                                          (int32_t)mipmapHeight(i - 1), 1};
                    blit.srcSubresource.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
                    blit.srcSubresource.mipLevel = i - 1;
                    blit.srcSubresource.baseArrayLayer = 0;
                    blit.srcSubresource.layerCount = 1;
                    blit.dstOffsets[0] = {0, 0, 0};
                    blit.dstOffsets[1] = {(int32_t)mipmapWidth(i),
                                          (int32_t)mipmapHeight(i), 1};
                    blit.dstSubresource.aspectMask = VK_IMAGE_ASPECT_COLOR_BIT;
                    blit.dstSubresource.mipLevel = i;
                    blit.dstSubresource.baseArrayLayer = 0;
                    blit.dstSubresource.layerCount = 1;

                    vk->vkCmdBlitImage(commandBuffer, decompImg,
                    ...
                    for (int w = 0; w < dstRegion.imageExtent.width; w++) {
                        ...
                        switch (cmp.compFormat) {
                            ...
                            case VK_FORMAT_ETC2_R8G8B8_SRGB_BLOCK:
                                ...
                                // printf("(%d, %d, %d)\t", dstPixel[0],
                                // dstPixel[1], dstPixel[2]);
                                break;
                            default:
