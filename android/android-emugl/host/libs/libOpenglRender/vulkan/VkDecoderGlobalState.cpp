...
public:
    ...
    void on_vkCmdPipelineBarrier(
        ...
        for (uint32_t i = 0; i < imageMemoryBarrierCount; i++) {
            ...
            //printf("srcAccessMask %d dstAccessMask %d\n", barrier.srcAccessMask, barrier.dstAccessMask);
            //printf("old layout %d new layout %d\n", barrier.oldLayout, barrier.newLayout);
            ...
            if (sizeCompBarrier.subresourceRange.levelCount > 1) {
...
private:
    ...
    struct CompressedImageInfo {
        ...
        static VkImageView createDefaultImageView(
            ...
            imageViewInfo.viewType = imageType == VK_IMAGE_TYPE_3D ? VK_IMAGE_VIEW_TYPE_3D
    ...
    {                                                                          \
        ...
        if (VK_SUCCESS != result) {                                            \
            ...
            imageView = createDefaultImageView(vk, device, sizeCompImg,
                                               sizeCompFormat, imageType, layerCount);
            ...
            decompImageView = createDefaultImageView(
                    vk, device, decompImg, intermediateFormat, imageType, layerCount);
