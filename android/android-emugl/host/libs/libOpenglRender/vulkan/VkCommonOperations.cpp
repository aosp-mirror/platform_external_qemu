...
VkEmulation* createOrGetGlobalVkEmulation(VulkanDispatch* vk) {
    ...
    if (sVkEmulation->instanceSupportsMoltenVK) {
        ...
        sVkEmulation->setMTLBufferFunc = reinterpret_cast<PFN_vkSetMTLBufferMVK>(
                vk->vkGetInstanceProcAddr(
                        sVkEmulation->instance, "vkSetMTLBufferMVK"));
        if (!sVkEmulation->setMTLBufferFunc) {
            LOG(ERROR) << "Cannot find vkSetMTLBufferMVK";
            return sVkEmulation;
        }
        sVkEmulation->getMTLBufferFunc = reinterpret_cast<PFN_vkGetMTLBufferMVK>(
                vk->vkGetInstanceProcAddr(
                        sVkEmulation->instance, "vkGetMTLBufferMVK"));
        if (!sVkEmulation->getMTLBufferFunc) {
            LOG(ERROR) << "Cannot find vkGetMTLBufferMVK";
            return sVkEmulation;
        }
