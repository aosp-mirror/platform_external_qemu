...
void VkReconstruction::save(android::base::Stream* stream) {
    ...
    fprintf(stderr, "%s: total api trace size: %zu\n", __func__, totalApiTraceSize);
    ...
    fprintf(stderr, "%s: created handle buffer size: %zu trace: %zu\n", __func__, createdHandleBuffer.size(), apiTraceBuffer.size());
...
void VkReconstruction::load(android::base::Stream* stream) {
    ...
    fprintf(stderr, "VkReconstruction::%s: start decoding trace--------------------------------------------------------------------------------\n", __func__);
