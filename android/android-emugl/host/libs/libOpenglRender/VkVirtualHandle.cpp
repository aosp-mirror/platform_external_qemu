...
template<> uint32_t VkVirtualHandleCreate<type>(type instance) { return s_HandleStore_##type.ptr()->add(instance); } \
template<> uint32_t VkVirtualHandleCreateOrGet<type>(type instance) { return s_HandleStore_##type.ptr()->addOrGet(instance); } \
...
template<> type VkVirtualHandleGetHost<type>(uint32_t handle) { return s_HandleStore_##type.ptr()->getHost(handle); } \
