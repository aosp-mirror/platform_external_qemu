...
WindowSurface::FlushColorBufferCmd WindowSurface::flushColorBuffer() {
    ...
    WindowSurface::FlushColorBufferCmd res;
    res.drawContext = EGL_NO_CONTEXT;
    res.drawSurface = EGL_NO_SURFACE;
    res.toFlush = mAttachedColorBuffer.get();
    return res;
}
