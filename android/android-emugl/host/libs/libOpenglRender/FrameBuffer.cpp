...
void FrameBuffer::setColorBufferPendingSemaphoreSignalEmulated(
    uint32_t colorBufferHandle, std::function<void()> waitEmulationFunc) {
    AutoLock mutex(m_lock);
    setColorBufferPendingSemaphoreSignalEmulatedLocked(colorBufferHandle, waitEmulationFunc);
}

void FrameBuffer::setColorBufferPendingSemaphoreSignalEmulatedLocked(
    uint32_t colorBufferHandle, std::function<void()> waitEmulationFunc) {
    ...
    (*c).second.cb->setPendingSemaphoreSignalEmulated(waitEmulationFunc);
}

void FrameBuffer::setColorBufferPendingSemaphoreSignal(
    uint32_t colorBufferHandle) {
    AutoLock mutex(m_lock);
    setColorBufferPendingSemaphoreSignalLocked(colorBufferHandle);
}

void FrameBuffer::setColorBufferPendingSemaphoreSignalLocked(
    uint32_t colorBufferHandle) {
    ...
    (*c).second.cb->setPendingSemaphoreSignal();
}
