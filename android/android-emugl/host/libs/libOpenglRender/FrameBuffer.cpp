...
// <<<<<<< HEAD:android/android-emugl/host/libs/libOpenglRender/FrameBuffer.cpp
//     assert(m_lock.isLocked());
...
// =======
    ...
    return i->second.cb;
// >>>>>>> b52acdc73ff (Native VK Swapchain: Fix the lifetime of DisplayVk::ColorBufferInfo):stream-servers/FrameBuffer.cpp
}
