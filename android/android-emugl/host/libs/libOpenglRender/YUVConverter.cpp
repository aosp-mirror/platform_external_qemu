...
#include "/usr/local/google/home/huans/emu/master/external/qemu/android/android-emugl/host/libs/libOpenglRender/FrameworkFormats.h"
...
static void doYUVConversionDraw(GLuint program,
    ...
    if (format == FRAMEWORK_FORMAT_YV12) {
