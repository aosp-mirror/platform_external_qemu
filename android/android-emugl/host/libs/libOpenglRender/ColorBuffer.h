...
public:
    ...
    const std::shared_ptr<DisplayVk::DisplayBufferInfo>& getDisplayBufferVk() const { return m_displayBufferVk; };
    ...
    bool importMemory(
        ...
        bool linearTiling,
        bool vulkanOnly);
    void setDisplayBufferVk(std::shared_ptr<DisplayVk::DisplayBufferInfo> displayBufferVk);
