...
## Marshaling definitions#######################################################
    ...
    def makeMarshalingProto(self, cmdInfoElem, name):
        ...
        marshalingApi.retType = vt.makeVulkanTypeSimple(False, "void", 0)
        marshalingApi.parameters.insert(0, vt.makeVulkanTypeSimple(False, "void", 1, "vkStream"))
...
## Encoder definitions##########################################################
    ...
    def makeEncodeProto(self, cmdInfoElem, name):
        ...
        encodeApi.parameters.insert(0, vt.makeVulkanTypeSimple(False, "void", 1, "vkStream"))
...
## Validate definitions#########################################################
    ...
    def makeValidateProto(self, cmdInfoElem, name):
        ...
        validateApi.retType = vt.makeVulkanTypeSimple(False, "void", 0)
        validateApi.parameters.insert(0, vt.makeVulkanTypeSimple(False, "VkResult", 1, "validateResult"))
