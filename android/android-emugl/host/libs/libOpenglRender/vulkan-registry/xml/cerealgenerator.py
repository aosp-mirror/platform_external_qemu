...
################################################################################
    ...
    def genCmd(self, cmdinfo, name, alias):
        ...
        frontendProto = self.makeFuncProto(cmdinfo.elem, name, "goldfish_frontend_") + ";\n"

        validateDef = self.makeValidateDef(cmdinfo.elem, name)
        encoderDefWIP = self.makeEncoderDef(cmdinfo.elem, name)
        frontendDef = self.makeFrontendDef(cmdinfo.elem, name)

        self.appendHeader("guest", "goldfish_vk_frontend", frontendProto)
        self.appendImpl("guest", "goldfish_vk_frontend", validateDef)
        self.appendImpl("guest", "goldfish_vk_frontend", encoderDefWIP)
