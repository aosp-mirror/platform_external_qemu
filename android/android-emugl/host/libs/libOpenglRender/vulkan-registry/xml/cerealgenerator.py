...
class CerealGenerator(OutputGenerator):
    ...
    def __init__(self, errFile = sys.stderr,
        ...
        self.host_cmake_generator = lambda cppFiles, protoFiles: """%s
...
android_add_protobuf(OpenglRender_vulkan_cereal_proto %s)
""" % (autogeneratedMkTemplate % banner_command(sys.argv), cppFiles, protoFiles)
...
""" % VULKAN_STREAM_TYPE
        ...
        self.addProto(".", "goldfish_vk_snapshots")
        ...
        self.addProtoWrapper(cereal.VulkanSnapshots, "goldfish_vk_snapshots")
...
""" % namespaceEnd
    ...
    def addProto(self, directory, basename, customAbsDir = None):
        ...
        self.protos[basename].preamble = "// generated proto file"
        self.protos[basename].postamble = "// end generated proto file"
...
## Overrides####################################################################
    ...
    def beginFile(self, genOpts):
        ...
        write(self.host_cmake_generator(self.hostCMakeCppFiles, self.hostCMakeProtoFiles),
              file = self.outFile)
