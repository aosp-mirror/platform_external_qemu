...
"""
        ...
        # Encoder header/impl pre/post##########################################
        self.modules["goldfish_vk_encoder"].headerPreamble = """
#include <vulkan.h>
...
"""
        self.modules["goldfish_vk_encoder"].headerPostamble = """
} // namespace goldfish_vk
"""
...
"""
        self.modules["goldfish_vk_encoder"].implPostamble = """
} // namespace goldfish_vk
"""
