...
## Overrides################3###################################################
    ...
    def genType(self, typeinfo, name, alias):
        ...
        self.forEachModule(lambda m: m.appendHeader("// genType for %s" % name))
    ...
    def genStruct(self, typeinfo, typeName, alias):
        ...
        self.forEachModule(lambda m: m.appendHeader("// genStruct for %s" % typeName))
        if not alias:
    ...
    def genGroup(self, groupinfo, groupName, alias = None):
        ...
        self.forEachModule(lambda m: m.appendHeader("// genGroup for %s" % groupName))

    def genEnum(self, enuminfo, name, alias):
        OutputGenerator.genEnum(self, enuminfo, name, alias)
        self.forEachModule(lambda m: m.appendHeader("// genEnum for %s" % name))
