...
class VulkanAPIWrapper(object):
    ...
    def makeFuncDecl(self, vulkanApi):
        return self.codegen.makeFuncProto(vulkanApi) + ";\n"

    def makeFuncDefFromApi(self, vulkanApi):
        ...
        self.definitionFunc(self, vulkanApi)
    ...
    def makeDecl(self, typeInfo, apiName):
        return self.codegen.makeFuncDecl(self.makeApi(self, typeInfo, apiName))

    def makeDefinition(self, typeInfo, apiName):
        return self.makeFuncDefFromApi(self.makeApi(self, typeInfo, apiName))
