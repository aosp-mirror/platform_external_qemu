...
def is_cmdbuf_statechange(api):
    if api.name in ["vkQueueSubmit", "vkQueueWaitIdle", "vkDeviceWaitIdle", "vkCreateCommandPool", "vkAllocateCommandBuffers", "vkFreeCommandBuffers", "vkResetCommandPool", "vkDestroyCommandPool"]:
        return True
