...
custom_decodes = {
    ...
    "vkGetPhysicalDeviceExternalBufferProperties" : emit_global_state_wrapped_decoding,
    "vkGetPhysicalDeviceExternalBufferPropertiesKHR" : emit_global_state_wrapped_decoding,
