...
def genActualTransforms(resourceTrackerVarName, structOrApiInfo, getExpr, getLen, cgen):
...
class TransformCodegen(VulkanTypeIterator):
    def __init__(self, cgen, inputVar, resourceTrackerVarName, prefix, structOrApiInfo):
        self.cgen = cgen
        ...
        self.checked = False
        self.structOrApiInfo = structOrApiInfo
