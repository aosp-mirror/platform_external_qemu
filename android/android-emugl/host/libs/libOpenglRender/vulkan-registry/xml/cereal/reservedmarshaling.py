...
from .wrapperdefs import PARAMETERS_RESERVEDMARSHALING
from .wrapperdefs import PARAMETERS_RESERVEDMARSHALING_GUEST
...
class VulkanReservedMarshaling(VulkanWrapperGenerator):
    ...
    def __init__(self, module, typeInfo, variant="host"):
        ...
        if self.variant == "guest":
            self.marshalingParams = PARAMETERS_RESERVEDMARSHALING_GUEST
        else:
            self.marshalingParams = PARAMETERS_RESERVEDMARSHALING
