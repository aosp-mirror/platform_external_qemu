...
from .common.codegen import *
from .common.vulkantypes import *

# Contains definitions for various Vulkan API wrappers. This information is shared to
# make it easier for one kind of wrapper to know how to call another one.
...
EQUALITY_ON_FAIL_VAR_TYPE = makeVulkanTypeSimple(False, "OnFailCompareFunc", 0, EQUALITY_ON_FAIL_VAR)
