...
COMPARE_ON_FAIL_VAR = "onFail"
COMPARE_ON_FAIL_VAR_TYPE = makeVulkanTypeSimple(False, "OnFailCompareFunc", 0, COMPARE_ON_FAIL_VAR)
...
class VulkanMarshaling(VulkanWrapperGenerator):
    ...
    def onGenType(self, typeXml, name, alias):
        ...
        if category in ["struct", "union"] and not alias:
            ...
            self.module.appendHeader(self.unmarshalWrapper.codegen.makeFuncDecl(comparePrototype))
            self.module.appendImpl(self.unmarshalWrapper.codegen.makeFuncImpl(comparePrototype, structCompareDef))
