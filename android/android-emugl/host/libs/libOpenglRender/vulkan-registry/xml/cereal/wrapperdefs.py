...
PARAMETERS_MARSHAL = [makeVulkanTypeSimple(False, "VulkanStream", 1, "vkStream")]
PARAMETERS_ENCODE = [makeVulkanTypeSimple(False, "VulkanStream", 1, "vkStream")]
            ...
            for param in api.parameters:
                ...
                if self.typeInfo.isCompoundType(param.typeName):
                    ...
                    if lenExpr:
                        ...
                        cgen.funcCall(None, API_PREFIX_MARSHAL + param.typeName, ["vkStream", paramIndexed])
                        cgen.endFor()
                    else:
                        cgen.funcCall(None, API_PREFIX_MARSHAL + param.typeName, ["vkStream", param.paramName])
...
class VulkanFrontend(VulkanWrapperGenerator):
    def __init__(self, module, typeInfo):
        ...
        def frontendDefFunc(codegen, api):
            ...
            codegen.stmt("VulkanStream* vkStream = 0")
