...
void ColorBuffer::onLoad(android::base::Stream* stream,
                         GLuint& width,
                         GLuint& height,
                         GLenum& internalFormat,
                         FrameworkFormat& frmaeworkFormat) {
    width = static_cast<GLuint>(stream->getBe32());
    height = static_cast<GLuint>(stream->getBe32());
    internalFormat = static_cast<GLenum>(stream->getBe32());
    frmaeworkFormat = static_cast<FrameworkFormat>(stream->getBe32());
}
