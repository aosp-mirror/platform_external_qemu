...
bool ColorBuffer::blitFromCurrentReadBuffer2() {
    ...
    // if (tInfo->currContext->version() > GLESApi_2) {
    ...
    // s_gles2.glBindFramebuffer(GL_FRAMEBUFFER, prev_draw_fbo);
    // if (tInfo->currContext->version() > GLESApi_2) {
    //     s_gles2.glBindFramebuffer(GL_READ_FRAMEBUFFER, prev_read_fbo);
    // }
