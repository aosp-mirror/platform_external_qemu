...
void VsyncThread::threadFunc() {
    ...
    System::WallDuration lastTimeUs = ~0ULL;
    System::WallDuration phasedWaitTimeUs;
    System::WallDuration currentUs;
    auto sys = System::get();

    while (true) {
        System::WallDuration periodUs = mPeriodNs / 1000ULL;
        currentUs = sys->getHighResTimeUs();
        ...
        sys->sleepToUs(phasedWaitTimeUs);
