...
class ContextAutoLock {
 public:
     explicit ContextAutoLock(emugl::ContextGPU* context) : context_(context) {}

     ~ContextAutoLock() = default;
...
void ActiveTextureCall(const GlesContext* c, GLenum texture) {
    auto* context = static_cast<emugl::ContextGPU*>(c->Impl());
    ContextAutoLock lock(context);
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("ActiveTextureCall(%p, %s (0x%x))", c, GetEnumString(texture),
           texture);
...
void BindBufferCall(const GlesContext* c, GLenum target, GLuint buffer) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("BindBufferCall(%p, %s (0x%x), %u)", c, GetEnumString(target),
           target, buffer);
...
void BindFramebufferCall(const GlesContext* c, GLenum target, GLuint framebuffer) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("BindFramebufferCall(%p, %s (0x%x), %u)", c, GetEnumString(target),
           target, framebuffer);
...
void BindRenderbufferCall(const GlesContext* c, GLenum target, GLuint renderbuffer) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("BindRenderbufferCall(%p, %s (0x%x), %u)", c, GetEnumString(target),
           target, renderbuffer);
...
void BindTextureCall(const GlesContext* c, GLenum target, GLuint texture) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("BindTextureCall(%p, %s (0x%x), %u)", c, GetEnumString(target),
           target, texture);
...
void BlendEquationSeparateCall(const GlesContext* c, GLenum modeRGB, GLenum modeAlpha) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("BlendEquationSeparateCall(%p, %s (0x%x), %s (0x%x))", c,
           GetEnumString(modeRGB), modeRGB, GetEnumString(modeAlpha),
           modeAlpha);
...
void BlendFuncCall(const GlesContext* c, GLenum sfactor, GLenum dfactor) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("BlendFuncCall(%p, %s (0x%x), %s (0x%x))", c, GetEnumString(sfactor),
           sfactor, GetEnumString(dfactor), dfactor);
...
void BlendFuncSeparateCall(const GlesContext* c, GLenum srcRGB, GLenum dstRGB, GLenum srcAlpha, GLenum dstAlpha) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("BlendFuncSeparateCall(%p, %s (0x%x), %s (0x%x), %s (0x%x), %s "
           "(0x%x))",
           c, GetEnumString(srcRGB), srcRGB, GetEnumString(dstRGB), dstRGB,
           GetEnumString(srcAlpha), srcAlpha, GetEnumString(dstAlpha),
           dstAlpha);
...
void BufferDataCall(const GlesContext* c, GLenum target, GLsizeiptr size, const void* data, GLenum usage) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("BufferDataCall(%p, %s (0x%x), %ld, %p, %s (0x%x))", c,
           GetEnumString(target), target, size, data, GetEnumString(usage),
           usage);
...
void BufferSubDataCall(const GlesContext* c, GLenum target, GLintptr offset, GLsizeiptr size, const void* data) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("BufferSubDataCall(%p, %s (0x%x), %ld, %ld, %p)", c,
           GetEnumString(target), target, offset, size, data);
...
GLenum CheckFramebufferStatusCall(const GlesContext* c, GLenum target) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("CheckFramebufferStatusCall(%p, %s (0x%x))", c,
           GetEnumString(target), target);
...
void ClearDepthfCall(const GlesContext* c, GLclampf depth) {
    ...
    return _api->glClearDepth(static_cast<GLclampd>(depth));
}
...
void CompressedTexImage2DCall(const GlesContext* c, GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const void* data) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("CompressedTexImage2DCall(%p, %s (0x%x), %d, %s (0x%x), %zd, %zd, "
           "%d, %zd, %p)",
           c, GetEnumString(target), target, level,
           GetEnumString(internalformat), internalformat, width, height, border,
           imageSize, data);
    return _api->glCompressedTexImage2D(target, level, internalformat, width,
...
void CompressedTexSubImage2DCall(const GlesContext* c, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const void* data) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("CompressedTexSubImage2DCall(%p, %s (0x%x), %d, %d, %d, %zd, %zd, "
           "%s (0x%x), %zd, %p)",
           c, GetEnumString(target), target, level, xoffset, yoffset, width,
           height, GetEnumString(format), format, imageSize, data);
    return _api->glCompressedTexSubImage2D(target, level, xoffset, yoffset,
...
void CopyTexImage2DCall(const GlesContext* c, GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("CopyTexImage2DCall(%p, %s (0x%x), %d, %s (0x%x), %d, %d, %zd, %zd, "
           "%d)",
           c, GetEnumString(target), target, level,
           GetEnumString(internalformat), internalformat, x, y, width, height,
           border);
    return _api->glCopyTexImage2D(target, level, internalformat, x, y, width,
                                  height, border);
}
...
void CopyTexSubImage2DCall(const GlesContext* c, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("CopyTexSubImage2DCall(%p, %s (0x%x), %d, %d, %d, %d, %d, %zd, %zd)",
           c, GetEnumString(target), target, level, xoffset, yoffset, x, y,
           width, height);
    return _api->glCopyTexSubImage2D(target, level, xoffset, yoffset, x, y,
                                     width, height);
}
...
void DrawArraysCall(const GlesContext* c, GLenum mode, GLint first, GLsizei count) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("DrawArraysCall(%p, %s (0x%x), %d, %zd)", c, GetEnumString(mode),
           mode, first, count);
...
void DrawElementsCall(const GlesContext* c, GLenum mode, GLsizei count, GLenum type, const void* indices) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("DrawElementsCall(%p, %s (0x%x), %zd, %s (0x%x), %p)", c,
           GetEnumString(mode), mode, count, GetEnumString(type), type,
           indices);
...
void FramebufferRenderbufferCall(const GlesContext* c, GLenum target, GLenum attachment, GLenum renderbuffertarget, GLuint renderbuffer) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("FramebufferRenderbufferCall(%p, %s (0x%x), %s (0x%x), %s (0x%x), "
           "%u)",
           c, GetEnumString(target), target, GetEnumString(attachment),
           attachment, GetEnumString(renderbuffertarget), renderbuffertarget,
           renderbuffer);
    return _api->glFramebufferRenderbuffer(target, attachment,
...
void FramebufferTexture2DCall(const GlesContext* c, GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("FramebufferTexture2DCall(%p, %s (0x%x), %s (0x%x), %s (0x%x), %u, "
           "%d)",
           c, GetEnumString(target), target, GetEnumString(attachment),
           attachment, GetEnumString(textarget), textarget, texture, level);
    return _api->glFramebufferTexture2D(target, attachment, textarget, texture,
                                        level);
}
...
void GenerateMipmapCall(const GlesContext* c, GLenum target) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GenerateMipmapCall(%p, %s (0x%x))", c, GetEnumString(target),
           target);
...
void GetActiveAttribCall(const GlesContext* c, GLuint program, GLuint index, GLsizei bufsize, GLsizei* length, GLint* size, GLenum* type, char* name) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetActiveAttribCall(%p, %u, %u, %zd, %p, %p, %p, %p)", c, program,
           index, bufsize, length, size, type, name);
    return _api->glGetActiveAttrib(program, index, bufsize, length, size, type,
                                   name);
}
...
void GetActiveUniformCall(const GlesContext* c, GLuint program, GLuint index, GLsizei bufsize, GLsizei* length, GLint* size, GLenum* type, char* name) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetActiveUniformCall(%p, %u, %u, %zd, %p, %p, %p, %p)", c, program,
           index, bufsize, length, size, type, name);
    return _api->glGetActiveUniform(program, index, bufsize, length, size, type,
                                    name);
}
...
void GetAttachedShadersCall(const GlesContext* c, GLuint program, GLsizei maxcount, GLsizei* count, GLuint* shaders) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetAttachedShadersCall(%p, %u, %zd, %p, %p)", c, program, maxcount,
           count, shaders);
...
void GetBooleanvCall(const GlesContext* c, GLenum pname, GLboolean* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetBooleanvCall(%p, %s (0x%x), %p)", c, GetEnumString(pname), pname,
           params);
...
void GetBufferParameterivCall(const GlesContext* c, GLenum target, GLenum pname, GLint* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetBufferParameterivCall(%p, %s (0x%x), %s (0x%x), %p)", c,
           GetEnumString(target), target, GetEnumString(pname), pname, params);
...
void GetFloatvCall(const GlesContext* c, GLenum pname, GLfloat* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetFloatvCall(%p, %s (0x%x), %p)", c, GetEnumString(pname), pname,
           params);
...
void GetIntegervCall(const GlesContext* c, GLenum pname, GLint* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetIntegervCall(%p, %s (0x%x), %p)", c, GetEnumString(pname), pname,
           params);
...
void GetProgramivCall(const GlesContext* c, GLuint program, GLenum pname, GLint* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetProgramivCall(%p, %u, %s (0x%x), %p)", c, program,
           GetEnumString(pname), pname, params);
...
void GetProgramInfoLogCall(const GlesContext* c, GLuint program, GLsizei bufsize, GLsizei* length, char* infolog) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetProgramInfoLogCall(%p, %u, %zd, %p, %p)", c, program, bufsize,
           length, infolog);
...
void GetRenderbufferParameterivCall(const GlesContext* c, GLenum target, GLenum pname, GLint* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetRenderbufferParameterivCall(%p, %s (0x%x), %s (0x%x), %p)", c,
           GetEnumString(target), target, GetEnumString(pname), pname, params);
...
void GetShaderivCall(const GlesContext* c, GLuint shader, GLenum pname, GLint* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetShaderivCall(%p, %u, %s (0x%x), %p)", c, shader,
           GetEnumString(pname), pname, params);
...
void GetShaderInfoLogCall(const GlesContext* c, GLuint shader, GLsizei bufsize, GLsizei* length, char* infolog) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetShaderInfoLogCall(%p, %u, %zd, %p, %p)", c, shader, bufsize,
           length, infolog);
...
void GetShaderPrecisionFormatCall(const GlesContext* c, GLenum shadertype, GLenum precisiontype, GLint* range, GLint* precision) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetShaderPrecisionFormatCall(%p, %s (0x%x), %s (0x%x), %p, %p)", c,
           GetEnumString(shadertype), shadertype, GetEnumString(precisiontype),
           precisiontype, range, precision);
    return _api->glGetShaderPrecisionFormat(shadertype, precisiontype, range,
                                            precision);
}
...
void GetShaderSourceCall(const GlesContext* c, GLuint shader, GLsizei bufsize, GLsizei* length, char* source) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetShaderSourceCall(%p, %u, %zd, %p, %p)", c, shader, bufsize,
           length, source);
...
void GetTexParameterfvCall(const GlesContext* c, GLenum target, GLenum pname, GLfloat* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetTexParameterfvCall(%p, %s (0x%x), %s (0x%x), %p)", c,
           GetEnumString(target), target, GetEnumString(pname), pname, params);
...
void GetTexParameterivCall(const GlesContext* c, GLenum target, GLenum pname, GLint* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetTexParameterivCall(%p, %s (0x%x), %s (0x%x), %p)", c,
           GetEnumString(target), target, GetEnumString(pname), pname, params);
...
void GetVertexAttribfvCall(const GlesContext* c, GLuint index, GLenum pname, GLfloat* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetVertexAttribfvCall(%p, %u, %s (0x%x), %p)", c, index,
           GetEnumString(pname), pname, params);
...
void GetVertexAttribivCall(const GlesContext* c, GLuint index, GLenum pname, GLint* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetVertexAttribivCall(%p, %u, %s (0x%x), %p)", c, index,
           GetEnumString(pname), pname, params);
...
void GetVertexAttribPointervCall(const GlesContext* c, GLuint index, GLenum pname, void** pointer) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("GetVertexAttribPointervCall(%p, %u, %s (0x%x), %p)", c, index,
           GetEnumString(pname), pname, pointer);
...
void HintCall(const GlesContext* c, GLenum target, GLenum mode) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("HintCall(%p, %s (0x%x), %s (0x%x))", c, GetEnumString(target),
           target, GetEnumString(mode), mode);
...
void PixelStoreiCall(const GlesContext* c, GLenum pname, GLint param) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("PixelStoreiCall(%p, %s (0x%x), %d)", c, GetEnumString(pname), pname,
           param);
...
void ReadPixelsCall(const GlesContext* c, GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, void* pixels) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("ReadPixelsCall(%p, %d, %d, %zd, %zd, %s (0x%x), %s (0x%x), %p)", c,
           x, y, width, height, GetEnumString(format), format,
           GetEnumString(type), type, pixels);
...
void RenderbufferStorageCall(const GlesContext* c, GLenum target, GLenum internalformat, GLsizei width, GLsizei height) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("RenderbufferStorageCall(%p, %s (0x%x), %s (0x%x), %zd, %zd)", c,
           GetEnumString(target), target, GetEnumString(internalformat),
...
void ShaderBinaryCall(const GlesContext* c, GLsizei n, const GLuint* shaders, GLenum binaryformat, const void* binary, GLsizei length) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("ShaderBinaryCall(%p, %zd, %p, %s (0x%x), %p, %zd)", c, n, shaders,
           GetEnumString(binaryformat), binaryformat, binary, length);
...
void ShaderSourceCall(const GlesContext* c, GLuint shader, GLsizei count, const char** str, const GLint* length) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("ShaderSourceCall(%p, %u, %zd, %p, %p)", c, shader, count, str,
           length);
...
void StencilFuncCall(const GlesContext* c, GLenum func, GLint ref, GLuint mask) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("StencilFuncCall(%p, %s (0x%x), %d, %u)", c, GetEnumString(func),
           func, ref, mask);
...
void StencilFuncSeparateCall(const GlesContext* c, GLenum face, GLenum func, GLint ref, GLuint mask) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("StencilFuncSeparateCall(%p, %s (0x%x), %s (0x%x), %d, %u)", c,
           GetEnumString(face), face, GetEnumString(func), func, ref, mask);
...
void StencilMaskSeparateCall(const GlesContext* c, GLenum face, GLuint mask) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("StencilMaskSeparateCall(%p, %s (0x%x), %u)", c, GetEnumString(face),
           face, mask);
...
void StencilOpCall(const GlesContext* c, GLenum fail, GLenum zfail, GLenum zpass) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("StencilOpCall(%p, %s (0x%x), %s (0x%x), %s (0x%x))", c,
           GetEnumString(fail), fail, GetEnumString(zfail), zfail,
           GetEnumString(zpass), zpass);
...
void StencilOpSeparateCall(const GlesContext* c, GLenum face, GLenum fail, GLenum zfail, GLenum zpass) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("StencilOpSeparateCall(%p, %s (0x%x), %s (0x%x), %s (0x%x), %s "
           "(0x%x))",
           c, GetEnumString(face), face, GetEnumString(fail), fail,
           GetEnumString(zfail), zfail, GetEnumString(zpass), zpass);
...
void TexImage2DCall(const GlesContext* c, GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const void* pixels) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("TexImage2DCall(%p, %s (0x%x), %d, %d, %zd, %zd, %d, %s (0x%x), %s "
           "(0x%x), %p)",
           c, GetEnumString(target), target, level, internalformat, width,
           height, border, GetEnumString(format), format, GetEnumString(type),
           type, pixels);
    return _api->glTexImage2D(target, level, internalformat, width, height,
...
void TexParameterfCall(const GlesContext* c, GLenum target, GLenum pname, GLfloat param) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("TexParameterfCall(%p, %s (0x%x), %s (0x%x), %f)", c,
           GetEnumString(target), target, GetEnumString(pname), pname, param);
...
void TexParameterfvCall(const GlesContext* c, GLenum target, GLenum pname, const GLfloat* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("TexParameterfvCall(%p, %s (0x%x), %s (0x%x), %p)", c,
           GetEnumString(target), target, GetEnumString(pname), pname, params);
...
void TexParameteriCall(const GlesContext* c, GLenum target, GLenum pname, GLint param) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("TexParameteriCall(%p, %s (0x%x), %s (0x%x), %d)", c,
           GetEnumString(target), target, GetEnumString(pname), pname, param);
...
void TexParameterivCall(const GlesContext* c, GLenum target, GLenum pname, const GLint* params) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("TexParameterivCall(%p, %s (0x%x), %s (0x%x), %p)", c,
           GetEnumString(target), target, GetEnumString(pname), pname, params);
...
void TexSubImage2DCall(const GlesContext* c, GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const void* pixels) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("TexSubImage2DCall(%p, %s (0x%x), %d, %d, %d, %zd, %zd, %s (0x%x), "
           "%s (0x%x), %p)",
           c, GetEnumString(target), target, level, xoffset, yoffset, width,
           height, GetEnumString(format), format, GetEnumString(type), type,
           pixels);
    return _api->glTexSubImage2D(target, level, xoffset, yoffset, width, height,
                                 format, type, pixels);
}
...
void UniformMatrix2fvCall(const GlesContext* c, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("UniformMatrix2fvCall(%p, %d, %zd, %d, %p)", c, location, count,
           transpose, value);
...
void UniformMatrix3fvCall(const GlesContext* c, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("UniformMatrix3fvCall(%p, %d, %zd, %d, %p)", c, location, count,
           transpose, value);
...
void UniformMatrix4fvCall(const GlesContext* c, GLint location, GLsizei count, GLboolean transpose, const GLfloat* value) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("UniformMatrix4fvCall(%p, %d, %zd, %d, %p)", c, location, count,
           transpose, value);
...
void VertexAttribPointerCall(const GlesContext* c, GLuint indx, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const void* ptr) {
    ...
    const auto* angle_apis = static_cast<const GraphicsApis*>(c->Apis());
    const auto* _api = static_cast<const ANGLE_GLES2*>(angle_apis->angle);
    DPRINT("VertexAttribPointerCall(%p, %u, %d, %s (0x%x), %d, %zd, %p)", c,
           indx, size, GetEnumString(type), type, normalized, stride, ptr);
    return _api->glVertexAttribPointer(indx, size, type, normalized, stride,
                                       ptr);
}
