...
public:
    ...
    void GetAttachedShaders(GLsizei max_count,
                            GLsizei* count,
                            GLuint* shaders) const;
    void GetProgramiv(GLenum pname, GLint* params) const;
    void GetInfoLog(GLsizei max_length,
                    GLsizei* length,
...
private:
    ...
    private:
        ...
        CachedUniform(const CachedUniform& src) = delete;
        CachedUniform& operator=(const CachedUniform& src) = delete;
    };

    // Contains a reference to an active uniform.
    struct UniformLocation {
        UniformLocation() {}
        UniformLocation(std::string original_name,
    ...
    struct LinkedProgram {
        LinkedProgram() : program_(nullptr) {}
        explicit LinkedProgram(const ProgramVariantPtr& program);
...
using ProgramDataPtr = android::sp<ProgramData>;
