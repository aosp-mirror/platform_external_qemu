...
const char kGeometryDrawVShaderSrc[] = R"(#version 330 core
...
const char kGeometryDrawFShaderSrc[] = R"(#version 330 core
uniform sampler2D tex_sampler;
...
const char kGeometryDrawVShaderSrcFlat[] = R"(#version 330 core
layout(location = 0) in vec4 pos;
layout(location = 1) in vec3 normal;
layout(location = 2) in vec4 color;
layout(location = 3) in float pointsize;
...
const char kGeometryDrawFShaderSrcFlat[] = R"(#version 330 core
uniform sampler2D tex_sampler;
uniform bool enable_textures;
uniform bool enable_lighting;
uniform bool enable_fog;
