...
static GLESiface s_glesIface = {
        ...
        .flush = reinterpret_cast<FUNCPTR_NO_ARGS_RET_VOID>(glFlush),
        .finish = reinterpret_cast<FUNCPTR_NO_ARGS_RET_VOID>(glFinish),
...
static int maxMipmapLevel(GLsizei width, GLsizei height) {
    ...
    return std::log2(std::max(width, height) + 0.5);
}
