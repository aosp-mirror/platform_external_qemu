...
public:
    ...
    GLuint getBuffer(GLenum target) override;
    GLuint getIndexedBuffer(GLenum target, GLuint index) override;
    bool isBindedBuffer(GLenum target) override;
    void bindBuffer(GLenum target,GLuint buffer) override;
    void bindIndexedBuffer(GLenum target, GLuint index, GLuint buffer,
        GLintptr offset, GLsizeiptr size, GLintptr stride = 0, bool isBindBase = false) override;
