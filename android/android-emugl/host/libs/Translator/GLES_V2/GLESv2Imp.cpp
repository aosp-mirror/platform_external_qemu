...
GL_APICALL void  GL_APIENTRY glTestHostDriverPerformance(void);
...
GL_APICALL void  GL_APIENTRY glTestHostDriverPerformance(void) {
    ...
    constexpr char vshaderSrc[] = R"(#version 330 core
    ...
    constexpr char fshaderSrc[] = R"(#version 330 core
    precision highp float;
    ...
    GLuint program = glperf::compileAndLinkShaderProgram(gl, vshaderSrc, fshaderSrc);
