...
struct GLUniformDesc {
    ...
    // The following ctor takes over ownership of val
    GLUniformDesc(GLsizei count, GLboolean transpose, GLenum type,
            GLsizei size, unsigned char* val);
    ...
    GLsizei mSize = 0;
    std::unique_ptr<unsigned char[]> mVal;
