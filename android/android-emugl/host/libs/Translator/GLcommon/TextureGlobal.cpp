...
TextureGlobal::TextureGlobal(const EglImage& eglImage)
...
TextureGlobal::TextureGlobal(const TextureData& texture)
...
TextureGlobal::TextureGlobal(android::base::Stream* stream,
...
void TextureGlobal::onSave(android::base::Stream* stream,
