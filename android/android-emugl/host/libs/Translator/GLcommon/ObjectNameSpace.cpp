...
using android::snapshot::TextureLoaderPtrWeak;
...
void GlobalNameSpace::onLoad(android::base::Stream* stream,
                             const TextureLoaderPtrWeak textureLoaderWeak,
                             SaveableTexture::creator_t creator) {
    const TextureLoaderPtr textureLoader = textureLoaderWeak.lock();
    ...
    loadCollection(
            stream, &m_textureMap,
            [this, creator, textureLoaderWeak](android::base::Stream* stream) {
    ...
    m_backgroundLoader =
        std::make_shared<GLBackgroundLoader>(
            textureLoaderWeak, *m_eglIface, *m_glesIface, m_textureMap);
