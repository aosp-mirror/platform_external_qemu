...
void SaveableTexture::onSave(
    ...
    if (m_target == GL_TEXTURE_2D || m_target == GL_TEXTURE_CUBE_MAP ||
        ...
        bool isLowMem = android::base::System::get()->isUnderMemoryPressure();
        ...
        //
        // TODO: Don't keep those around in disk anyway; append dirty textures
        // to the end
 
        m_isDirty = false || isLowMem; } else if (m_target != 0) {
