...
GLEScontext::GLEScontext(GlobalNameSpace* globalNameSpace,
    ...
    if (stream) {
        ...
        if (m_initialized) {
            ...
            m_polygonOffsetFactor = static_cast<GLfloat>(stream->getBe32());
            m_polygonOffsetUnits = static_cast<GLfloat>(stream->getBe32());
...
void GLEScontext::onSave(android::base::Stream* stream) const {
    ...
    if (m_initialized) {
        ...
        stream->putBe32(m_polygonOffsetFactor);
        stream->putBe32(m_polygonOffsetUnits);
