...
void nsConvertVideoFrameToNV12Textures(void* context,
    ...
    /*
CGLTexImageIOSurface2D(glContext,GL_TEXTURE_RECTANGLE,GL_R8,(GLsizei)textureSize.width,(GLsizei)textureSize.height,GL_RED,GL_UNSIGNED_BYTE,surfaceRef,
0);

// chroma texture, subsampled

CGLTexImageIOSurface2D(glContext,GL_TEXTURE_RECTANGLE, GL_RG8,
(GLsizei)planeSize.width, (GLsizei)planeSize.height, GL_RG, GL_UNSIGNED_BYTE,
surfaceRef, 1);
    */
    ...
    *Ytex = ctx->ytexForDecoder;
    *UVtex = ctx->uvtexForDecoder;
