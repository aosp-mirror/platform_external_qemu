                              ...
                              void* library_out)
{
    ...
    *(emugl::SharedLibrary**)library_out = lib;
    ...
    return gles2_dispatch_init_from_lib(lib, egl_dispatch, dispatch_table);
}

bool gles2_dispatch_init_from_lib(void* _lib, EGLDispatch* egl_dispatch, GLESv2Dispatch* dispatch_table) {
