...
bool gles1_dispatch_init(GLESv1Dispatch* dispatch_table) {
    ...
    return gles1_dispatch_init_from(libName, &s_egl, dispatch_table);
}

bool gles1_dispatch_init_from(const char* libPath, const EGLDispatch* egl_dispatch, GLESv1Dispatch* dispatch_table) {
