...
public:
    ...
    void callCommon_locked(bool changeContext) {
        ...
        // fprintf(stderr, "%s: %p %p query context 0x%llx 0x%llx 0x%llx\n", __func__, this, mPerThreadContextInfo.get(),
        //                 (unsigned long long)c.contextInfo.context,
        //                 (unsigned long long)c.contextInfo.read,
        //                 (unsigned long long)c.contextInfo.draw
        //                 );
        enqueue(c);
    }
