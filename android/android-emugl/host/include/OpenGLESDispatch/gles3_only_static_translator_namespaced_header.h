...
namespace gles2 {
GL_API GLconstubyteptr GL_APIENTRY glGetStringi(GLenum name, GLint index);
...
GL_API void GL_APIENTRY glGetBufferParameteri64v(GLenum target, GLenum value, GLint64 * data);
...
GL_API void GL_APIENTRY glGetUniformIndices(GLuint program, GLsizei uniformCount, const GLchar ** uniformNames, GLuint * uniformIndices);
...
GL_API void GL_APIENTRY glUniform4ui(GLint location, GLint v0, GLuint v1, GLuint v2, GLuint v3);
...
GL_API void GL_APIENTRY glVertexAttribI4i(GLuint index, GLint v0, GLint v1, GLint v2, GLint v3);
GL_API void GL_APIENTRY glVertexAttribI4ui(GLuint index, GLuint v0, GLuint v1, GLuint v2, GLuint v3);
...
GL_API void GL_APIENTRY glDrawArraysInstanced(GLenum mode, GLint first, GLsizei count, GLsizei primcount);
GL_API void GL_APIENTRY glDrawElementsInstanced(GLenum mode, GLsizei count, GLenum type, const void * indices, GLsizei primcount);
...
GL_API GLenum GL_APIENTRY glClientWaitSync(GLsync wait_on, GLbitfield flags, GLuint64 timeout);
GL_API void GL_APIENTRY glWaitSync(GLsync wait_on, GLbitfield flags, GLuint64 timeout);
GL_API void GL_APIENTRY glDeleteSync(GLsync to_delete);
...
GL_API void GL_APIENTRY glEndTransformFeedback();
...
GL_API void GL_APIENTRY glPauseTransformFeedback();
GL_API void GL_APIENTRY glResumeTransformFeedback();
GL_API GLboolean GL_APIENTRY glIsTransformFeedback(GLuint id);
GL_API void GL_APIENTRY glTransformFeedbackVaryings(GLuint program, GLsizei count, const char ** varyings, GLenum bufferMode);
GL_API void GL_APIENTRY glGetTransformFeedbackVarying(GLuint program, GLuint index, GLsizei bufSize, GLsizei * length, GLsizei * size, GLenum * type, char * name);
GL_API void GL_APIENTRY glGenSamplers(GLsizei n, GLuint * samplers);
GL_API void GL_APIENTRY glDeleteSamplers(GLsizei n, const GLuint * samplers);
...
GL_API void GL_APIENTRY glSamplerParameterfv(GLuint sampler, GLenum pname, const GLfloat * params);
GL_API void GL_APIENTRY glSamplerParameteriv(GLuint sampler, GLenum pname, const GLint * params);
...
GL_API void GL_APIENTRY glGenQueries(GLsizei n, GLuint * queries);
GL_API void GL_APIENTRY glDeleteQueries(GLsizei n, const GLuint * queries);
GL_API void GL_APIENTRY glBeginQuery(GLenum target, GLuint query);
...
GL_API void GL_APIENTRY glGetQueryObjectuiv(GLuint query, GLenum pname, GLuint * params);
GL_API GLboolean GL_APIENTRY glIsQuery(GLuint query);
GL_API void GL_APIENTRY glProgramParameteri(GLuint program, GLenum pname, GLint value);
GL_API void GL_APIENTRY glProgramBinary(GLuint program, GLenum binaryFormat, const void * binary, GLsizei length);
GL_API void GL_APIENTRY glGetProgramBinary(GLuint program, GLsizei bufsize, GLsizei * length, GLenum * binaryFormat, void * binary);
GL_API GLint GL_APIENTRY glGetFragDataLocation(GLuint program, const char * name);
GL_API void GL_APIENTRY glGetInteger64v(GLenum pname, GLint64 * data);
...
GL_API void GL_APIENTRY glTexImage3D(GLenum target, GLint level, GLint internalFormat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid * data);
...
GL_API void GL_APIENTRY glTexSubImage3D(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid * data);
