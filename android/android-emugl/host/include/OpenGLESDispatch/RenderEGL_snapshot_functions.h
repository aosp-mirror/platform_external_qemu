...
#define LIST_RENDER_EGL_SNAPSHOT_FUNCTIONS(X) \
  ...
  X(EGLBoolean, eglLoadAllImages, (EGLDisplay display, EGLStream stream, const char* snapshotDir)) \
  ...
  X(EGLBoolean, eglSaveAllImages, (EGLDisplay display, EGLStream stream, const char* snapshotDir)) \
