...
class EGLDispatch;
bool gles2_dispatch_init_from(const char* libName, EGLDispatch* egl_dispatch, GLESv2Dispatch* dispatch_table, void* library_out);
bool gles2_dispatch_init_from_lib(void* library, EGLDispatch* egl_dispatch, GLESv2Dispatch* dispatch_table, bool useEgl);
