...
GL_API void GL_APIENTRY glReleaseShaderCompiler();
...
GL_API void GL_APIENTRY glVertexAttribPointerWithDataSize(GLuint indx, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid* ptr, GLsizei dataSize);
...
GL_API void GL_APIENTRY glTestHostDriverPerformance(GLuint count, uint64_t* duration_us, uint64_t* duration_cpu_us);
} // namespace translator
} // namespace gles2
