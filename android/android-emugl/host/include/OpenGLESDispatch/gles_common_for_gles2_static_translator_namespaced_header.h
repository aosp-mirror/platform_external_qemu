...
GL_API void GL_APIENTRY glGetBufferParameteriv(GLenum buffer, GLenum parameter, GLint * value);
GL_API GLenum GL_APIENTRY glGetError();
GL_API void GL_APIENTRY glGetFloatv(GLenum pname, GLfloat * params);
GL_API void GL_APIENTRY glGetIntegerv(GLenum pname, GLint * params);
GL_API GLconstubyteptr GL_APIENTRY glGetString(GLenum name);
...
GL_API void GL_APIENTRY glPopAttrib();
GL_API void GL_APIENTRY glPopClientAttrib();
} // namespace translator
} // namespace gles2
