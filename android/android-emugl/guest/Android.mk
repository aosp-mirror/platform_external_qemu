...
$(call emugl-begin-static-library,lib$(BUILD_TARGET_SUFFIX)AndroidGraphics)

# use the libOpenglRender Standalone library to be able to use FenceSyncs and so forth
...
LOCAL_SRC_FILES := \
	$(androidSrcDir)/Ashmem.cpp \
	$(androidSrcDir)/GoldfishSync.cpp \
	$(androidSrcDir)/Log.cpp \
	$(androidSrcDir)/Mutex.cpp \
	$(androidSrcDir)/VirtualDisplay.cpp \
	$(root_DIR)/$(EMUGL_PATH)/shared/emugl/common/shared_library.cpp \
...
LOCAL_SRC_FILES := \
    ...
    $(openglSystemCommonSrcDir)/HostPipeStream.cpp \
...
## Gralloc #####################################################################
$(call emugl-begin-shared-library,gralloc_ranchu)
$(call emugl-import,libOpenglSystemCommon)

LOCAL_CFLAGS += $(goldfish_opengl_CFLAGS) -DLOG_TAG=\"gralloc_ranchu\" -Wno-missing-field-initializers
...
LOCAL_SRC_FILES := \
    $(goldfish_opengl_DIR)/system/gralloc/gralloc.cpp \
    $(goldfish_opengl_DIR)/system/gralloc/gralloc_host.cpp \
