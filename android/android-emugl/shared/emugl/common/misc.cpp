...
android::opengl::GLObjectCounter* s_gl_object_counter = nullptr;
...
void emugl::setGLObjectCounter(android::opengl::GLObjectCounter* counter) {
    s_gl_object_counter = counter;
}

android::opengl::GLObjectCounter* emugl::getGLObjectCounter() {
