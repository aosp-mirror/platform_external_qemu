...
static TestTempDir* sTestContentDir = nullptr;

GoldfishOpenglTestEnv::GoldfishOpenglTestEnv() {
    sTestEnv = this;
    sTestContentDir = new TestTempDir("goldfish_opengl_snapshot_test_dir");
    ...
    avdInfo_setCustomContentPath(sTestContentDir->path());
