...
TEST_P(CombinedGoldfishOpenglTest, VertexAttribPointerOffset) {
        constexpr char vshaderSrc[] = R"(#version 300 es
    precision highp float;
    ...
    uint32_t drawCount = 0;
    static constexpr uint32_t kDrawCallLimit = 20000;
    ...
    printf("glVertexAttribPointer %u times in %f ms. Rate: %f Hz\n", kDrawCallLimit, ms,
           drawCallHz);
