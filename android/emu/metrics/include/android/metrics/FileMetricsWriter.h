...
class AEMU_METRICS_API FileMetricsWriter final
...
public:
    ...
    // Creates a new instance of FileMetricsWriter that uses the
    // android studio spool directory with a random uuid for metrics logging.
