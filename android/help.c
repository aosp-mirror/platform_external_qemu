...
static void help_input_record(stralloc_t* out) {
    PRINTF("  use '-event-record <file>' to record input events to the android\n"
...
static void help_input_replay(stralloc_t* out) {
    PRINTF("  use '-event-replay <file>' to replay a saved stream of input \n"
...
static void help_replay_delay(stralloc_t* out) {
    PRINTF("  use '-replay-delay <number>' to add a <number> Sec delay\n"
