...
{
    PRINTF(
    "  the '-dpi-device <dpi>' option is deprecated as of Emulator 2.0 and will be ignored\n\n" );
}
...
{
    PRINTF(
    "  the '-scale <scale>' option is deprecated as of Emulator 2.0 and will be ignored\n\n" );
}
