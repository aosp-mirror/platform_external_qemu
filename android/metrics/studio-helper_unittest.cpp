...
TEST(DotAndroidStudio, androidStudioScanner) {
    ...
    const char *studioPath = NULL;
    char *foundStudioPath = NULL;
    ...
    EXPECT_STREQ(foundStudioPath, studioPath);
    AFREE(foundStudioPath);
    ...
    studioPath  = "/root/home/" ANDROID_STUDIO_DIR;
    ...
    studioPath = "/root/home/" ANDROID_STUDIO_DIR "0.1";
    foundStudioPath = latestAndroidStudioDir("/root/home");
    EXPECT_STREQ(foundStudioPath, studioPath);
    AFREE(foundStudioPath);

    testDir->makeSubDir("root/home/" ANDROID_STUDIO_DIR "1");
    testDir->makeSubDir("root/home/" ANDROID_STUDIO_DIR ANDROID_STUDIO_DIR_PREVIEW "1");

    studioPath = "/root/home/" ANDROID_STUDIO_DIR "1";
    foundStudioPath = latestAndroidStudioDir("/root/home");
    EXPECT_STREQ(foundStudioPath, studioPath);
    AFREE(foundStudioPath);

    testDir->makeSubDir("root/home/" ANDROID_STUDIO_DIR "1.2");
    testDir->makeSubDir("root/home/" ANDROID_STUDIO_DIR ANDROID_STUDIO_DIR_PREVIEW "1.2");
...
TEST(DotAndroidStudio, androidStudioXMLPathBuilder) {
    ...
    testDir->makeSubDir("root/home/" ANDROID_STUDIO_DIR ANDROID_STUDIO_DIR_PREVIEW "1.4");
    testDir->makeSubFile("root/home/" ANDROID_STUDIO_DIR "10.40");

    foundStudioPath = latestAndroidStudioDir("/root/home");
    char *constructedStudioXMLPath = pathToStudioXML(foundStudioPath, "usage.statistics.xml");
    const char *studioXMLPath = "/root/home/" ANDROID_STUDIO_DIR "1.4/" \
        ANDROID_STUDIO_DIR_INFIX "/" ANDROID_STUDIO_DIR_SUFFIX          \
        "/usage.statistics.xml";
    EXPECT_STREQ(constructedStudioXMLPath, studioXMLPath);

    AFREE(constructedStudioXMLPath);
}
