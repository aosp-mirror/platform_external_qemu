...
TEST_F(MetricsReporterToolbarTest, gpuStrings) {
    ...
    static const char kExpected[] =
            ...
            "&gpu0_renderer=OpenGL%20version%20string%3A%203.0%20Mesa%2010.4.2%20%28git-%29"
            ...
            "&gpu1_renderer=OpenGL%20version%20string%3A%203.0%20Mesa%2010.4.2%20%28git-%29"
            ...
            "&gpu2_renderer=OpenGL%20version%20string%3A%203.0%20Mesa%2010.4.2%20%28git-%29"
            ...
            "&gpu3_renderer=OpenGL%20version%20string%3A%203.0%20Mesa%2010.4.2%20%28git-%29";
    static const int kExpectedLen = (int)(sizeof(kExpected) - 1);
    ...
    ANDROID_METRICS_STRASSIGN(metrics.gpu0_make, "Advanced Micro Devices, Inc.");
    ...
    ANDROID_METRICS_STRASSIGN(metrics.gpu0_renderer, "OpenGL version string: 3.0 Mesa 10.4.2 (git-)");
    ANDROID_METRICS_STRASSIGN(metrics.gpu1_make, "Advanced Micro Devices, Inc.");
    ...
    ANDROID_METRICS_STRASSIGN(metrics.gpu1_renderer, "OpenGL version string: 3.0 Mesa 10.4.2 (git-)");
    ANDROID_METRICS_STRASSIGN(metrics.gpu2_make, "Advanced Micro Devices, Inc.");
    ...
    ANDROID_METRICS_STRASSIGN(metrics.gpu2_renderer, "OpenGL version string: 3.0 Mesa 10.4.2 (git-)");
    ANDROID_METRICS_STRASSIGN(metrics.gpu3_make, "Advanced Micro Devices, Inc.");
    ...
    ANDROID_METRICS_STRASSIGN(metrics.gpu3_renderer, "OpenGL version string: 3.0 Mesa 10.4.2 (git-)");
