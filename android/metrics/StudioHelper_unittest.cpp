...
TEST(DotAndroidStudio, androidStudioXMLPathBuilder) {
    ...
    String foundStudioXMLPath = StudioHelper::pathToStudioXML(foundStudioPath, String("usage.statistics.xml"));
    const char *studioXMLPath = "/root/home" FS ANDROID_STUDIO_DIR "1.4" FS \
        ANDROID_STUDIO_DIR_INFIX FS ANDROID_STUDIO_DIR_SUFFIX FS \
...
TEST(DotAndroidStudio, androidStudioUUIDWindows) {
    ...
    testDir->makeSubFile("root/appdata/" ANDROID_STUDIO_UUID_DIR "/" ANDROID_STUDIO_UUID);

    String foundStudioUUIDPath = StudioHelper::pathToStudioUUIDWindows();
    const char *UUIDPath = "/root/appdata" FS ANDROID_STUDIO_UUID_DIR FS ANDROID_STUDIO_UUID;
