...
TEST(DotAndroidStudio, androidStudioXMLPathBuilder) {
    ...
    String constructedStudioXMLPath = StudioHelper::pathToStudioXML(foundStudioPath, String("usage.statistics.xml"));
    const char *studioXMLPath = "/root/home/" ANDROID_STUDIO_DIR "1.4/" \
        ANDROID_STUDIO_DIR_INFIX "/" ANDROID_STUDIO_DIR_SUFFIX          \
        "/usage.statistics.xml";
    EXPECT_STREQ(constructedStudioXMLPath.c_str(), studioXMLPath);
}
