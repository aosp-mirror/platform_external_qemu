...
TEST_F(MetricsReporterGaTest, defaultMetrics) {
    ...
    static const char kExpected[] =
            ...
            "ec=emulator&ea=singleRunCrashInfo&el=crashDetectedOpenglInitFailed&cm2=0&cm3=0";
...
TEST_F(MetricsReporterGaTest, openGLErrorRun) {
    char* post_data;
    AndroidMetrics metrics;
    static const char kExpected[] =
            "v=1&tid=UA-19996407-3&an=Android Studio&av=standalone&"
            "cid=00000000-0000-0000-0000-000000000000&cd6=x86_64&t=event&"
            "ec=emulator&ea=singleRunCrashInfo&el=crashDetectedOpenglInitFailed&cm2=180&"
            "cm3=1080";
    static const int kExpectedLen = (int)(sizeof(kExpected) - 1);
...
TEST_F(MetricsReporterGaTest, openGLErrorInconsistentRun) {
    char* post_data;
    AndroidMetrics metrics;
    static const char kExpected[] =
            "v=1&tid=UA-19996407-3&an=Android Studio&av=standalone&"
            "cid=00000000-0000-0000-0000-000000000000&cd6=x86_64&t=event&"
            "ec=emulator&ea=singleRunCrashInfo&el=cleanExitOpenglInitFailedINCONSISTENT&cm2=180&"
            "cm3=1080";
    static const int kExpectedLen = (int)(sizeof(kExpected) - 1);
