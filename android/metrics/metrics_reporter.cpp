...
ABool androidMetrics_keepAlive(Looper* metrics_looper,
    ...
    const char* const end = emulator_name + sizeof(emulator_name);
    bufprint(emulator_name, emulator_name + sizeof(emulator_name),
