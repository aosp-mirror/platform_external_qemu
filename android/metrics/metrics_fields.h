...
METRICS_STRING(host_gpu_makes, "host_gpu_makes", "unknown")
METRICS_STRING(host_gpu_models, "host_gpu_models", "unknown")
METRICS_STRING(host_gpu_device_ids, "host_gpu_device_ids", "unknown")
METRICS_STRING(host_gpu_revision_ids, "host_gpu_revision_ids", "unknown")
METRICS_STRING(host_gpu_versions, "host_gpu_versions", "unknown")
METRICS_STRING(host_gpu_renderers, "host_gpu_renderers", "unknown")
