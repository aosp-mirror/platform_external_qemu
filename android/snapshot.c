 ...
 */
static void
snapshots_validate_qcow_file( int fd )
{
 ...
 */
static void
snapshots_read_qcow_header( int fd, uint32_t *nb_snapshots, uint64_t *snapshots_offset )
{
    snapshots_validate_qcow_file(fd);
...
snapshot_print_and_exit( const char *snapstorage )
{
    ...
    snapshots_read_qcow_header(fd, &nb_snapshots, &snapshots_offset);
