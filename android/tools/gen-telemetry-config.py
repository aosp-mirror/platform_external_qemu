...
#
# this script is used to generate 'android/telemetry/telemetry-config.h' 
# by parsing 'android/telemetry/telemetry-properties.ini'
#
#
import  sys, os, string, re

# location of source file, relative to current program directory
relativeSourcePath = "../telemetry/telemetry-properties.ini"

# location of target file, relative to current program directory
relativeTargetPath = "../telemetry/telemetry-config-defs.h"
...
#
typesToMacros = {
    'integer': 'TELEMETRYCFG_INT',
    'string':  'TELEMETRYCFG_STRING',
    'boolean': 'TELEMETRYCFG_BOOL',
    }
...
targetHeader = """\
/* this file is automatically generated from 'telemetry-properties.ini'
 * DO NOT EDIT IT. To re-generate it, use android/tools/gen-telemetry-config.py'
 */
"""
