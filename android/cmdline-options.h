...
OPT_PARAM( input_record, "<file>", "record main emulator window input events to file" )
OPT_PARAM( input_replay, "<file>", "replay main emulator window input events from file" )
OPT_PARAM(replay_delay,
          "<number>",
          "delay <number> mSec before starting input event replay")
