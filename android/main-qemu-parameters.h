...
// |argc| and |argv| are the QEMU-specific command-line options, if |argc > 1|,
// note that |argv[0]| will be ignored.
...
// |is_qemu2| should be true iff the engine is QEMU2 (otherwise QEMU1 is
