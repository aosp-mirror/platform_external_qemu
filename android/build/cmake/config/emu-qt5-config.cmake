...
function(add_qt_target target)
  if(NOT TARGET Qt5::${target})
    set(QT_EXECUTABLE ${HOST_PREBUILT_ROOT}/bin/${target}${CMAKE_EXECUTABLE_SUFFIX})
...
function(add_qt_shared_lib target link target_deps)
  if(NOT TARGET Qt5::${target})
    ...
    message("target: Qt5::${target} - ${link}")
...
if(ANDROID_TARGET_TAG STREQUAL "darwin-x86_64")
  ...
  add_qt_shared_lib(Gui "-lQt5Network" "Qt5::Core")
  add_qt_shared_lib(Network "-lQt5Network" "Qt5::Core")
  add_qt_shared_lib(Qml "-lQt5Qml" "Qt5::Network;Qt5::Core")
  add_qt_shared_lib(WebChannel "-lQt5WebChannel" "Qt5::Qml;Qt5::Network;Qt5::Core")
  add_qt_shared_lib(WebSockets "-lQt5WebSockets" "Qt5::Qml;Qt5::Network;Qt5::Core")
  add_qt_shared_lib(WebEngineWidgets "-lQt5WebEngineWidgets" "Qt5::Qml;Qt5::Network;Qt5::Core")
  add_qt_shared_lib(Widgets "-lQt5Widgets" "Qt5::Core;Qt5::Gui")
  add_qt_shared_lib(Svg "-lQt5Svg" "Qt5::Core;Qt5::Gui;Qt5Widgets")
elseif(ANDROID_TARGET_TAG STREQUAL "windows_msvc-x86_64")
  ...
  add_qt_shared_lib(Qml "${PREBUILT_ROOT}/lib/Qt5Qml.lib" "Qt5::Network;Qt5::Core")
  add_qt_shared_lib(WebEngineCore "${PREBUILT_ROOT}/lib/Qt5WebEngineCore.lib" "Qt5::Network")
  add_qt_shared_lib(WebChannel "${PREBUILT_ROOT}/lib/Qt5WebChannel.lib" "Qt5::WebEngineCore;Qt5::Qml;Qt5::Network;Qt5::Core")
  add_qt_shared_lib(WebSockets "${PREBUILT_ROOT}/lib/Qt5WebSockets.lib" "Qt5::WebEngineCore;Qt5::Qml;Qt5::Network;Qt5::Core")
  add_qt_shared_lib(WebEngineWidgets "${PREBUILT_ROOT}/lib/Qt5WebEngineWidgets.lib" "Qt5::WebEngineCore;Qt5::Qml;Qt5::Network;Qt5::Core")
  add_qt_shared_lib(Widgets "${PREBUILT_ROOT}/lib/Qt5Widgets.lib" "Qt5::Core;Qt5::Gui")
  add_qt_shared_lib(Svg "${PREBUILT_ROOT}/lib/Qt5Svg.lib" "Qt5::Core;Qt5::Gui;Qt5::Widgets")
elseif(ANDROID_TARGET_TAG STREQUAL "windows-x86_64")
  ...
  set(QT5_SHARED_DEPENDENCIES
      ...
      ${PREBUILT_ROOT}/plugins/imageformats/qwbmp.dll>lib64/qt/plugins/imageformats/qwbmp.dll;
      ${PREBUILT_ROOT}/plugins/imageformats/qwebp.dll>lib64/qt/plugins/imageformats/qwebp.dll;)
  add_qt_shared_lib(Core "${QT5_LIBRARIES} -lQt5Core" "")
  add_qt_shared_lib(Gui "-lQt5Network" "Qt5::Core")
  add_qt_shared_lib(Network "-lQt5Network" "Qt5::Core")
  add_qt_shared_lib(Qml "-lQt5Qml" "Qt5::Network;Qt5::Core")
  add_qt_shared_lib(WebEngineCore "-lQt5WebEngineCore" "Qt5::Network")
  add_qt_shared_lib(WebChannel "-lQt5WebChannel" "Qt5::WebEngineCore;Qt5::Qml;Qt5::Network;Qt5::Core;")
  add_qt_shared_lib(WebSockets "-lQt5WebSockets" "Qt5::WebEngineCore;Qt5::Qml;Qt5::Network;Qt5::Core")
  add_qt_shared_lib(WebEngineWidgets "-lQt5WebEngineWidgets" "Qt5::WebEngineCore;Qt5::Qml;Qt5::Network;Qt5::Core")
  add_qt_shared_lib(Widgets "-lQt5Widgets" "Qt5::Core;Qt5::Gui")
  add_qt_shared_lib(Svg "-lQt5Svg" "Qt5::Core;Qt5::Gui;Qt5Widgets")
