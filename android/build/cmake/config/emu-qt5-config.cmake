...
if(NOT QTWEBENGINE AND ANDROID_TARGET_TAG MATCHES "linux-x86_64")
  get_filename_component(
    PREBUILT_ROOT
    "${ANDROID_QEMU2_TOP_DIR}/../../prebuilts/android-emulator-build/qt/${ANDROID_TARGET_TAG}-nowebengine" ABSOLUTE)
  ...
  get_filename_component(
    PREBUILT_ROOT "${ANDROID_QEMU2_TOP_DIR}/../../prebuilts/android-emulator-build/qt/${ANDROID_TARGET_TAG}" ABSOLUTE)

  # Use the host compatible moc, rcc and uic
  get_filename_component(
    HOST_PREBUILT_ROOT "${ANDROID_QEMU2_TOP_DIR}/../../prebuilts/android-emulator-build/qt/${ANDROID_HOST_TAG}"
    ABSOLUTE)
endif()
...
function(add_qt_shared_lib target link target_deps)
  if(NOT TARGET Qt5::${target})
    ...
    set_target_properties(
      Qt5::${target}
      PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${QT5_INCLUDE_DIRS}" INTERFACE_LINK_LIBRARIES "${link}"
    ...
    android_license(
      ...
      SPDX "LGPL-3.0-only"
      LICENSE "https://doc.qt.io/qt-5.12/qt${target}-index.html#licenses-and-attributions"
...
if(DARWIN_X86_64)
  ...
  if(QTWEBENGINE)
    ...
    list(
      ...
      # TODO: These 6 are copies of the files immediately above. It would be nice to make these symbolic links rather
      # than copies.
      ...
      # BUG: 143948083 WebEngine expects the locales directory to not be under translations
...
elseif(WINDOWS_MSVC_X86_64)
  ...
  list(
    ...
    ${PREBUILT_ROOT}/resources/qtwebengine_resources_100p.pak>lib64/qt/resources/qtwebengine_resources_100p.pak
    ${PREBUILT_ROOT}/resources/qtwebengine_resources_200p.pak>lib64/qt/resources/qtwebengine_resources_200p.pak
    # TODO: These 6 are copies of the files immediately above. It would be nice to make these symbolic links rather than
    # copies.
...
elseif(LINUX_X86_64)
  ...
  if(QTWEBENGINE)
    ...
    list(
      ...
      ${PREBUILT_ROOT}/resources/qtwebengine_resources_100p.pak>lib64/qt/resources/qtwebengine_resources_100p.pak
      ${PREBUILT_ROOT}/resources/qtwebengine_resources_200p.pak>lib64/qt/resources/qtwebengine_resources_200p.pak
      # TODO: These six are copies of the files immediately above. It would be nice to make these symbolic links rather
      # than copies.
      ${PREBUILT_ROOT}/resources/icudtl.dat>lib64/qt/libexec/icudtl.dat
      ${PREBUILT_ROOT}/resources/qtwebengine_devtools_resources.pak>lib64/qt/libexec/qtwebengine_devtools_resources.pak
      ${PREBUILT_ROOT}/resources/qtwebengine_resources.pak>lib64/qt/libexec/qtwebengine_resources.pak
