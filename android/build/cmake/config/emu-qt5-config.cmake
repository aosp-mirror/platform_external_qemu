...
function(add_qt_target target)
  ...
  if(NOT TARGET Qt5::${target})
    ...
    if(NOT EXISTS ${QT_EXECUTABLE})
      message(
        FATAL_ERROR
          "Unable to add Qt5::${target} due to missing ${QT_EXECUTABLE}")
    endif()
    add_executable(Qt5::${target} IMPORTED GLOBAL)
    set_property(TARGET Qt5::${target} PROPERTY IMPORTED_LOCATION
                                                ${QT_EXECUTABLE})
  endif()
endfunction()
...
if(DARWIN_X86_64 OR DARWIN_AARCH64)
  ...
  set(QT5_LIBRARIES
      ${QT5_LIBRARIES} -lQt5NetworkAndroidEmu -lQt5WebChannelAndroidEmu
      -lQt5WebEngineWidgetsAndroidEmu -lQt5WebSockets)
