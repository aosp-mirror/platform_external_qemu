...
if(ANDROID_TARGET_TAG STREQUAL "linux-x86_64")
  ...
  set(LIBUNWIND_INCLUDE_DIRS "${PREBUILT_ROOT}/include")
  set(LIBUNWIND_LIBRARIES -lunwind -lunwind-x86_64 -L${PREBUILT_ROOT}/lib)
  set(LIBUNWIND_DEPENDENCIES ${PREBUILT_ROOT}/lib/libunwind-x86_64.so.8.0.1>lib64/libunwind-x86_64.so.8.0.1;${PREBUILT_ROOT}/lib/libunwind.so.8.0.1>lib64/libunwind.so.8.0.1)


  add_library(LIBUNWIND::LIBUNWIND INTERFACE IMPORTED GLOBAL)
  set_target_properties(
    LIBUNWIND::LIBUNWIND PROPERTIES
