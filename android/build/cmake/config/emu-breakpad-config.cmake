...
get_filename_component(
  PREBUILT_ROOT
  "${ANDROID_QEMU2_TOP_DIR}/../../prebuilts/android-emulator-build/common/breakpad/${ANDROID_TARGET_TAG}"
  ABSOLUTE)
get_filename_component(
  HOST_PREBUILT_ROOT
  "${ANDROID_QEMU2_TOP_DIR}/../../prebuilts/android-emulator-build/common/breakpad/${ANDROID_HOST_TAG}"
  ABSOLUTE)
...
if(WINDOWS_MSVC_X86_64)
  ...
  if(WINDOWS_X86_64)
    ...
    set(BREAKPAD_MINIDUMP_STACKWALK_EXE
        "${PREBUILT_ROOT}/bin/minidump_stackwalk.exe")
  else()
    set(BREAKPAD_DUMPSYM_EXE "${HOST_PREBUILT_ROOT}/bin/dump_syms")
    set(BREAKPAD_MINIDUMP_STACKWALK_EXE
        "${HOST_PREBUILT_ROOT}/bin/minidump_stackwalk")
  endif()
  set(BREAKPAD_LIBRARIES
...
if(NOT TARGET breakpad_server)
  ...
  set_target_properties(
    breakpad_server
    PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${BREAKPAD_INCLUDE_DIRS}"
  ...
  set_property(TARGET dump_syms PROPERTY IMPORTED_LOCATION
                                         ${BREAKPAD_DUMPSYM_EXE})

  add_executable(minidump_stackwalk IMPORTED GLOBAL)
  set_property(TARGET minidump_stackwalk
               PROPERTY IMPORTED_LOCATION ${BREAKPAD_MINIDUMP_STACKWALK_EXE})

  add_executable(sym_upload IMPORTED GLOBAL)
  set_property(TARGET sym_upload PROPERTY IMPORTED_LOCATION
                                          ${BREAKPAD_UPLOAD_EXE})
endif()
