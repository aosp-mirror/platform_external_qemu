...
if(ANDROID_TARGET_TAG STREQUAL "windows-x86_64")
  set(BREAKPAD_DUMPSYM "${PREBUILT_ROOT}/bin/dump_syms_dwarf")
else()
  set(BREAKPAD_DUMPSYM "${PREBUILT_ROOT}/bin/dump_syms")
endif()

set(PACKAGE_EXPORT
    "BREAKPAD_INCLUDE_DIR;BREAKPAD_INCLUDE_DIRS;BREAKPAD_LIBRARIES;BREAKPAD_CLIENT_LIBRARIES;BREAKPAD_FOUND;BREAKPAD_DUMPSYM")
