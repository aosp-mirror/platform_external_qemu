...
if(WIN32)
  ...
  set(CMAKE_CXX_FLAGS_DEBUG "-Xlinker -ignore:4099")
  set(CMAKE_C_FLAGS_DEBUG "-Xlinker -ignore:4099")
  # Set release flags such that we create pdbs..
  set(CMAKE_C_FLAGS_RELEASE " -Xlinker -ignore:4099")
  set(CMAKE_CXX_FLAGS_RELEASE " -Xlinker -ignore:4099")
