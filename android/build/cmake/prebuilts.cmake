...
#
# RUN_TARGET_DEPENDENCIES List of SRC>DST pairs that contains the dependencies. This SRC will be copied to the
# destination folder. These should be made available through running prebuilt(xxxx). note that you will always want to
    ...
    foreach(DEP ${RUN_TARGET_DEPENDENCIES})
      ...
      if("${DEP}" MATCHES ".*>>.*")
        ...
        if(WIN32)
          ...
          # We want to keep symlinks intact..
          add_custom_command(TARGET ${RUN_TARGET} POST_BUILD
