...
function(android_add_prebuilt_library_list PKG MODULE DEPS)
  if (NOT TARGET ${PKG}::${MODULE})
    add_library(${PKG}::${MODULE} INTERFACE IMPORTED GLOBAL)
    target_link_libraries(${PKG}::${MODULE} INTERFACE ${DEPS})
  endif()
endfunction()
