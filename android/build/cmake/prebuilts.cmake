...
set(PREBUILT_COMMON "BLUEZ;E2FSPROGS;LZ4;VPX;X264")
    ...
    if (DEFINED LOCAL_QEMU2_TOP_DIR AND DEFINED LOCAL_TARGET_TAG)
        if (${PKG} IN ${PREBUILT_COMMON})
            ...
            if (NOT ${PKG}_LIBRARIES MATCHES "${PREBUILT_ROOT}.*")
                message(FATAL_ERROR "Discovered ${pkg} at: ${${PKG}_LIBRARIES}, ${${PKG}_INCLUDE_DIRS} which is outside of tree ${PREBUILT_ROOT}!")
            endif ()
        endif ()
