...
function(_get_host_tag RET_VAL)
  ...
  if(APPLE)
    ...
    execute_process(COMMAND sysctl -n sysctl.proc_translated OUTPUT_VARIABLE IS_ARM_TRANSLATED)
    if(CPU_ARCH MATCHES ".*x86_64.*" AND NOT IS_ARM_TRANSLATED MATCHES "1*")
