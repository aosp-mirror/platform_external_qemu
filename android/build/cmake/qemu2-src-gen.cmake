...
function(generate_traces)
  ...
  generate_trace(GROUP hw_i2c FORMAT h BACKEND ${traces_BACKEND} SRC_DIR hw/i2c DEST ${traces_DEST}/hw/i2c/trace.h GENERATED TRACE_SRC)
  generate_trace(GROUP hw_i2c FORMAT c BACKEND ${traces_BACKEND} SRC_DIR hw/i2c DEST ${traces_DEST}/hw/i2c/trace.c GENERATED TRACE_SRC)
...
execute_process(
    COMMAND python scripts/decodetree.py
            --decode disas_sve -o ${gen_DEST}/decode-sve.inc.c target/arm/sve.decode
    OUTPUT_VARIABLE GEN_TEST_SRC WORKING_DIRECTORY ${ANDROID_QEMU2_TOP_DIR})
endfunction()
...
function(generate_qemu2_sources)
  ...
  generate_decodetree(DEST ${AUTOGEN}/target/arm/)
