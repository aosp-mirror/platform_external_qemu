...
function(generate_traces)
  ...
  set(TRACE_SRC "")
  message(STATUS "Generating tracing backend: ${traces_BACKEND}")
  # ~~~
...
function(generate_qapi_lib)
  ...
  execute_process(
    COMMAND python scripts/qapi-gen.py -b qapi/qapi-schema.json -o ${gen_DEST}/qapi
    OUTPUT_VARIABLE GEN_SRC WORKING_DIRECTORY ${ANDROID_QEMU2_TOP_DIR})
  string(REPLACE "\n" ";" GEN_SRC ${GEN_SRC})
  android_add_library(
    TARGET qemu-qapi
    LICENSE Apache-2.0
  ...
  target_include_directories(
    qemu-qapi PRIVATE ${ANDROID_QEMU2_TOP_DIR}/include ${gen_DEST}/qapi
    PUBLIC ${gen_DEST})
  ...
  string(REPLACE "\n" ";" GEN_TEST_SRC ${GEN_TEST_SRC})
  add_library(qemu-qapi-headers INTERFACE)
  target_include_directories(
      qemu-qapi-headers INTERFACE ${gen_DEST}/tests ${gen_DEST})
  android_license(TARGET "qemu-qapi-headers"
    LICENSE Apache-2.0
    LIBNAME qemu-system
    URL "https://android.googlesource.com/platform/external/qemu/+/refs/heads/emu-master-dev"
    REPO "${ANDROID_QEMU2_TOP_DIR}")
  android_add_library(
    TARGET qemu-qapi-test
    LICENSE Apache-2.0
    LIBNAME
      qemu-system
      URL
    ...
    ${gen_DEST}/qapi/trace.h
        ...
        qobject/qobject.c)
  target_include_directories(
      qemu-qapi-test PRIVATE ${ANDROID_QEMU2_TOP_DIR}/include ${gen_DEST}/tests/qapi ${gen_DEST}/qapi
      PUBLIC ${gen_DEST}/tests ${gen_DEST})
