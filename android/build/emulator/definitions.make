...
# Setting the FIX parameter will cause clang to apply the fixes where it can.
tidy-fix = $(if $(FIX),--fix)
...
$$(_DST): $$(_TST)
	...
	@mkdir -p $$(dir $$(PRIVATE_DST))
	$(hide) $$(PRIVATE_TIDY)  $$(PRIVATE_SRC) $$(PRIVATE_FIX) -analyze-temporary-dtors -header-filter=.* -checks='$$(PRIVATE_CHECKS)' -- $$(PRIVATE_INCLUDES)
	touch $$(PRIVATE_DST)
endef
