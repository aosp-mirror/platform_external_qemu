...
$$(_EXT_DEBUG): PRIVATE_MODULE := $$(_INTERMEDIATE_MODULE)
...
ifeq (darwin,$(BUILD_TARGET_OS))
	$(hide) dsymutil --out=$$(PRIVATE_EXT_DEBUG) $$(PRIVATE_MODULE)
else
	$(hide) $$(PRIVATE_OBJCOPY) --only-keep-debug $$(PRIVATE_MODULE) $$(PRIVATE_EXT_DEBUG)
endif
endef
