...
$$(_DST): $$(_TST)
	...
	@export LD_LIBRARY_PATH=$(BUILD_OBJS_DIR)/testlib64
	...
	$(hide) ASAN_OPTIONS=`cat android/asan_overrides` LLVM_PROFILE_FILE=$(call local-test-result-path)/$$(PRIVATE_TST).profraw LD_LIBRARY_PATH=$(BUILD_OBJS_DIR)/testlib64 VK_ICD_FILENAMES=$(BUILD_OBJS_DIR)/testlib64/VkICD_mock_icd.json VK_LOADER_DEBUG=all $(TEST_SHELL) $$(PRIVATE_TST) --gtest_output=xml:$(call local-test-result-path)/$$(PRIVATE_TST).xml
	@touch $$(PRIVATE_DST)
endef
