...
ifeq (darwin,$(BUILD_TARGET_OS))
	$$(PRIVATE_DUMPSYMS) -g $$(PRIVATE_DSYM) $$(PRIVATE_MODULE) 1> $$(PRIVATE_SYMBOL) 2> $$(PRIVATE_SYMBOL).errors
else
	$(hide) $$(PRIVATE_DUMPSYMS) $$(PRIVATE_MODULE) 1> $$(PRIVATE_SYMBOL)  2> $$(PRIVATE_SYMBOL).errors
endif
endef
