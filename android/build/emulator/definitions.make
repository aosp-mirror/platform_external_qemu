...
$$(_DST): PRIVATE_QT5 := $$(QT_PREBUILTS_DIR)/$$(BUILD_TARGET_OS)-x86_64
$$(_DST): $$(_SRC)
	$(hide) CC=$$(PRIVATE_CC) CXX=$$(PRIVATE_CXX) $$(CMAKE_TOOL) \
       -H$$(PRIVATE_SRC) \
       -B$$(PRIVATE_CMAKE_DST) \
...
$$(_DST): PRIVATE_QT5LIB := $$(QT_PREBUILTS_DIR)/$$(BUILD_TARGET_OS)-x86_64/lib
$$(_DST): $$(_SRC) force
	@$(hide) +LD_LIBRARY_PATH=$$(PRIVATE_QT5LIB) $(MAKE) --no-print-directory $$(PRIVATE_TARGET) -C $$(dir $$(PRIVATE_SRC))
endef
