...
run 'sensor status' to get available sensors.\r\n",
    ...
    { "set", "set sensor values, format: 'set <sensorname> <value-a>[:<value-b>[:<value-c>]]'",
      "'set <sensorname> <value-a>[:<value-b>[:<value-c>]]' allows you to set sensorname values. \
run 'sensor status' to get available sensors.\r\n",
