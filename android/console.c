...
do_gsm_signal_profile( ControlClient  client, char*  args )
{
    ...
    if (val < 0 || val > 4) {
        control_write( client, "KO: invalid signal quality - must be 0..4\r\n");
        return -1;
    }
...
static const CommandDefRec  gsm_commands[] =
{
    ...
    { "signal_profile", "set the signal strength",
    "'gsm signal_profile <quality>' changes the reported strength on next (15s) update.\r\n"
    "quality range is 0..4\r\n",
