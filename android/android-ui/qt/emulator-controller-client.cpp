...
EmulatorControllerClient::EmulatorControllerClient(
    ...
    // gpr_time_from_seconds(5, GPR_TIMESPAN)); bool connect =
    // channel->WaitForConnected(waitUntil); auto state =
...
void EmulatorControllerClient::StreamScreenshotAsync(ImageFormat format,
