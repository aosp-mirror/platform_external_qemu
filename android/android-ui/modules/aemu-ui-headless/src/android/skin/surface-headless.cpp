...
static int skin_surface_height(SkinSurface *s) {
    D("skin_surface_height %d", s->id);
    return s->h;
}

static int skin_surface_is_round(SkinSurface *s) {
    return s->isRound;
}

static void skin_surface_unrefp(SkinSurface* *psurface) {
...
static int skin_surface_width(SkinSurface *s) {
...
static SkinSurface *skin_surface_create(
...
static SkinSurface* skin_surface_create_from_data(
...
static SkinSurface* skin_surface_create_from_file(const char* path) {
...
static SkinSurface* skin_surface_create_derived(SkinSurface* source,
...
static SkinSurface* skin_surface_resize(SkinSurface *surface, int w, int h,
...
static void skin_surface_create_window(SkinSurface* surface,
                                       int x,
                                       int y,
                                       int w,
                                       int h) {
...
static void skin_surface_update(SkinSurface *surface, SkinRect *rect) {
    (void)surface;
    (void)rect;
}

static void skin_surface_blit(SkinSurface *dst, SkinPos *pos, SkinSurface *src, SkinRect *rect, SkinBlitOp op) {
    (void)dst;
    (void)pos;
    (void)src;
    (void)rect;
...
static void skin_surface_upload(
...
static void skin_surface_get_scaled_rect(SkinSurface *surface, const SkinRect *from, SkinRect *to) {
...
static void skin_surface_reverse_map(SkinSurface *surface, int *x, int *y) {
...
static const QAndroidSurfaceAgent sQAndroidSurfaceAgent = {
        .skin_surface_unrefp = &skin_surface_unrefp,
        .skin_surface_width = &skin_surface_width,
        .skin_surface_height = &skin_surface_height,
        .skin_surface_is_round = &skin_surface_is_round,
        .skin_surface_create = &skin_surface_create,
        .skin_surface_create_from_data = &skin_surface_create_from_data,
        .skin_surface_create_from_file = &skin_surface_create_from_file,
        .skin_surface_create_derived = &skin_surface_create_derived,
        .skin_surface_resize = &skin_surface_resize,
        .skin_surface_create_window = &skin_surface_create_window,
        .skin_surface_reverse_map = &skin_surface_reverse_map,
        .skin_surface_get_scaled_rect = &skin_surface_get_scaled_rect,
        .skin_surface_update = &skin_surface_update,
        .skin_surface_upload = &skin_surface_upload,
        .skin_surface_blit = &skin_surface_blit,
        .skin_surface_fill = &skin_surface_fill,
};
