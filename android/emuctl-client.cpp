...
#define PACKET_TYPE_SENSOR_DATA_ACCELEROMETER (0x01)
#define PACKET_TYPE_SENSOR_DATA_MAGNETOMETER (0x02)
#define PACKET_TYPE_SENSOR_DATA_ORIENTATION (0x03) /* deprecated */
#define PACKET_TYPE_SENSOR_DATA_AMBIENT_TEMPERATURE (0x04)
#define PACKET_TYPE_SENSOR_DATA_PROXIMITY (0x05)
#define PACKET_TYPE_SENSOR_DATA_LIGHT (0x06)
#define PACKET_TYPE_SENSOR_DATA_PRESSURE (0x07)
#define PACKET_TYPE_SENSOR_DATA_HUMIDITY (0x08)
#define PACKET_TYPE_MT_ACTION_DOWN (0x09)
#define PACKET_TYPE_MT_ACTION_MOVE (0x0A)
#define PACKET_TYPE_MT_ACTION_UP (0x0B)
#define PACKET_TYPE_MT_ACTION_CANCEL (0x0C)
...
static int scaleForTouchpad(float in, int axis_in) {
  ...
  return in * (axis_out-1) / (touchpad_size-1);
}
