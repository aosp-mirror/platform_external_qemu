...
public:
    ...
    // HACK: Allow tests to speed things up by setting an implementation detail.
    // Set to non-0 to set a non default |checkTimeoutMs| argument to
    // |ParallelTask|.
    void speedUpExecutionForTest(unsigned ms);
