...
public:
    ...
    void expectStringInVector(const String& item,
        ...
        EXPECT_TRUE(std::any_of(vec.begin(), vec.end(),
                ...
                << "Failed to find \"" << item.c_str() << "\" in \""
                << vectorToString(vec).c_str() << "\"";
    }

    String vectorToString(const StringVector& vec) {
        String res;
    ...
    bool obsequiousShellCommandImpl(const StringVector& commandLine,
                                    System::Duration,
                                    System::ProcessExitCode* outExitCode,
                                    System::Pid*,
                                    const String&) {
...
protected:
    ...
    StringVector mShellCommandLine;
