...
class FilePusherTest : public testing::Test {
    ...
    void SetUp() override {
        mTestSystem.reset(new android::base::TestSystem("/progdir",
                    System::kProgramBitness, "/homedir", "/appdir"));
    ...
    static bool fakeShellCommand(void* opaque, const vector<string>& command,
            System::Duration, System::ProcessExitCode* outExitCode,
            System::Pid*, const string&) {
...
TEST_F(FilePusherTest, enqueueWhilePushing) {
    const vector<ProgressPair> kExpectedProgress = {
        ...
        {0.5, false}, {0.75, false}, {1.0, true}};  // Final batch of push.
    const vector<ResultPair> kExpectedResults = {
        {"file1", FilePusher::Result::Success},
        {"file2", FilePusher::Result::Success},
        {"file3", FilePusher::Result::Success},
