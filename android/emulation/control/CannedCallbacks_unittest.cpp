...
#include "android/emulation/control/CannedCallbacks.h"
...
void callCallback(void* opaque, lineConsumerCallback callback, const char* str) {
...
TEST(CannedCallbacks, LineConsumerUseCase) {
    ...
    LineConsumer lineConsumer;
    callCallback(lineConsumer.opaque(),
