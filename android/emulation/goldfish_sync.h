...
#define SYNC_REG_BATCH_COMMAND                         0x4c // batch operation
#define SYNC_REG_BATCH_COMMAND_OUT                     0x50 // batch operation
#define SYNC_REG_BATCH_GUESTCOMMAND                     0x54 // batch operation
#define SYNC_REG_BATCH_COMMAND_ADDR                    0x58 // address where the batch
#define SYNC_REG_BATCH_COMMAND_ADDR_HIGH               0x5c // operation is found
#define SYNC_REG_BATCH_GUESTCOMMAND_ADDR                    0x60 // address where the batch
#define SYNC_REG_BATCH_GUESTCOMMAND_ADDR_HIGH               0x64 // operation is found
