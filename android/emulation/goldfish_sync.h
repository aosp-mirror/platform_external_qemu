...
//   of pairs of timeline-id-values. Over time, neither the set
//   nor the items within may change (they might in implementation,
//   but this level of detail is sufficient for understanding).
//   The first component is often referred to as the fence fd.
