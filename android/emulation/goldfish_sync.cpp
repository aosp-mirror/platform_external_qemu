...
void goldfish_sync_timeline_inc(uint64_t timeline,
                                uint32_t howmuch) {
    GoldfishSyncWakerSignal(CMD_SYNC_TIMELINE_INC, timeline, howmuch, next_unique_id());

//     uint32_t id = next_unique_id();
// 
