...
public:
    GoldfishSyncCommandQueueWithDefaultParams() {
        ...
        // By now, hw/misc/goldfish_sync.c has set
        // receiveCommandResult to a write-back function
        // that we will want to use. We wrap _that_ up in a function
        // that also does additional processing on androidemu side.
