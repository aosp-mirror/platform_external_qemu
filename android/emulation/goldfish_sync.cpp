...
// This keeps track of all the commands in flight
...
//   for a reply.
// - |sendCoommandAndGetResult|, which sends the command and waits
...
// We need to give the virtual device's hw funcs
// a function pointer that it calls upon receiving
// the result of an executed command from the guest.
...
// Goldfish sync host-side interface////////////////////////////////////////////
