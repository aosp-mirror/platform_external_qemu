...
void cellular_setStandard(enum CellularStandard cStandard)
{
    ...
    printf("===== cellular-agents-impl.c: Setting the standard with [%d] string \"%s\"\n", // ??
           (int)cStandard, speedName); // ??
    ...
    if (android_modem) {
        printf("===== cellular-agents-impl.c: Calling amodem_set_data_network_type()\n"); // ??
