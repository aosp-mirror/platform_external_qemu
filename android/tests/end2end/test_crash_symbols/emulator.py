...
class Emulator(object):
    ...
    def launch(self, additional_args=None):
        ...
        self.proc = subprocess.Popen(
            ...
            # Needed on windows, otherwise the environment won't propagate.
            shell=use_shell,
            env=local_env)

        # self._log_std_out(self.proc)

        max_wait = self.max_boot
        logging.info("Waiting for port %d to become available", self.console_port)     
