...
TEST(CrashSystem, getCrashServiceCmdLine) {
    ...
    ::android::base::StringVector tmp1 = CrashSystem::get()->getCrashServiceCmdLine(pipe, proc);
...
//    utils/paths::path_mkdir_if_needed function to create the breakpad directory
//    if not already existing.
//  This function does not use the System/TestSystem infrastructure and does
//    not ignores the testroot, instead trying to mkdir at the system root "/".
