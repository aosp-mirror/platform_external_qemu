...
bool HostCrashReporter::exceptionFilterCallback(void*) {
    ...
    // TODO: temporary replace the mach_ structs with just the task_info,
    // to make our build machines able to process this. Revert the CL once
    // all build machines have 10.9 Mac SDK
