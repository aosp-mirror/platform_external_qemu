...
ConfirmDialog::ConfirmDialog(QWidget* parent,
    ...
    mCommentsText->setPlaceholderText(
            "(Optional) Please describe what you were doing when the crash "
            "occured.");
    ...
    setWindowIcon(icon);
    connect(mSendButton, SIGNAL(clicked()), this, SLOT(sl_accept()));
...
void ConfirmDialog::showProgressBar(std::string msg) {
    mProgressText->setText(tr(msg.c_str()));
    mProgressText->show();
    mProgress->show();
}
