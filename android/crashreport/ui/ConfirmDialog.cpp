...
ConfirmDialog::ConfirmDialog(QWidget* parent,
    ...
    mSavePreference = new QCheckBox(tr("Remember my preference in the future. (This can be changed in the emulator settings page)"));
...
void savePref(bool checked, Ui::Settings::CRASHREPORT_PREFERENCE_VALUE v) {
    QSettings settings;
...
void ConfirmDialog::sendReport() {
    ...
    if (upload_success &&
        ...
        QString msg = tr("ReportId: ") + QString::fromStdString(mCrashService->getReportId());
        msgbox.setInformativeText(msg.toStdString().c_str());
