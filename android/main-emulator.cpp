...
static void delete_files(const char* file_dir, const StringView files_to_delete[], unsigned int num_files) {
    for (unsigned int i = 0; i < num_files; ++ i) {
        std::string file = PathUtils::join(file_dir, files_to_delete[i].c_str());
