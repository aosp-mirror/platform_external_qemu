...
static void clean_up_avd_contents_except_config_ini(const char* avd_folder) {
    std::string files_to_delete[] = {"system.img.qcow2", "userdata-qemu.img", "userdata-qemu.img.qcow2",
        "userdata.img", "userdata.img.qcow2", "cache.img", "cache.img.qcow2", "version_num.cache",
        "encryptionkey.img", "encryptionkey.img.qcow2", "hardware-qemu.ini", "emulator-user.ini"};
...
static void clean_up_android_out(const char* android_out) {
    ...
    std::string files_to_delete[] = {"system.img.qcow2", "userdata-qemu.img", "userdata-qemu.img.qcow2",
        "userdata.img.qcow2", "cache.img.qcow2", "version_num.cache", "hardware-qemu.ini", "emulator-user.ini"};
