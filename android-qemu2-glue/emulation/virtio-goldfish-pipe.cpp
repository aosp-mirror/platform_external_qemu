...
// kVirtioGpuAddressSpaceContextCreateWithSubdeviceAndHostmemId | resp_resid | subdeviceType | hostmemId | >handle | >error
    ...
    void addressSpaceProcessCmd(VirglCtxId ctxId, uint32_t* dwords, int dwordCount) {
        ...
        switch (opcode) {
            ...
            case kVirtioGpuAddressSpaceContextCreateWithSubdeviceAndHostmemId: {
                uint32_t resp_resid = dwords[1];
                uint32_t subdevice_type = dwords[2];
                uint32_t hostmemIdArg = dwords[3];
