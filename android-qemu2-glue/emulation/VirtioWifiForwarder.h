...
public:
    ...
    ~VirtioWifiForwarder();
    bool init();
    int forwardFrame(const android::base::IOVector& iov, bool toRemoteVM = false);
    void stop();
...
private:
    ...
    static ssize_t sendToGuest(VirtioWifiForwarder* forwarder, const uint8_t* buf,
                        size_t size);
    ...
    bool parseHswimFrame(const android::base::IOVector& iov);
    ...
    android::base::IOVector mFrameIOV;
