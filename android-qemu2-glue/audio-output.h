...
public:
    ...
    virtual int open(const char *name, android::emulation::AudioFormat format, int freq, int nchannels, android::emulation::audio_callback_fn callback, void *callback_opaque) override;
