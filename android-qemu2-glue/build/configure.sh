...
rm -f $QEMU2_AUTOGENERATED_DIR/gdbstub-xml.c
bash $QEMU2_TOP_DIR/scripts/feature_to_c.sh \
    $QEMU2_AUTOGENERATED_DIR/gdbstub-xml.c \
    $QEMU2_TOP_DIR/gdb-xml/i386-32bit.xml
    $QEMU2_TOP_DIR/gdb-xml/i386-32bit-core.xml
    $QEMU2_TOP_DIR/gdb-xml/i386-32bit-sse.xml
