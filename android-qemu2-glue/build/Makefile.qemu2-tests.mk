...
start-emulator-qemu-test = \
    ...
    $(eval LOCAL_STATIC_LIBRARIES += $(QEMU2_SYSTEM_STATIC_LIBRARIES) $(QEMU2_GLUE_STATIC_LIBRARIES) $(ANDROID_EMU_STATIC_LIBRARIES) libqemu2-util ) \
    $(eval LOCAL_LDFLAGS += $(QEMU2_SYSTEM_LDFLAGS) $(QEMU2_GLUE_LDFLAGS) $(QEMU2_DEPS_LDFLAGS) ) \
    $(eval LOCAL_LDLIBS += $(QEMU2_SYSTEM_LDLIBS) $(QEMU2_GLUE_LDLIBS) $(QEMU2_GLIB_LDLIBS)) \
