...
BEGIN_CIRCULAR_LD_DEPS :=
END_CIRCULAR_LD_DEPS :=

ifneq ($(BUILD_TARGET_OS),darwin)
BEGIN_CIRCULAR_LD_DEPS := -Wl,--start-group
END_CIRCULAR_LD_DEPS := -Wl,--end-group
endif

QEMU2_GLUE_LDFLAGS := $(EMULATOR_LIBUI_LDFLAGS) $(BEGIN_CIRCULAR_LD_DEPS)
QEMU2_GLUE_LDLIBS := $(EMULATOR_LIBUI_LDLIBS) $(END_CIRCULAR_LD_DEPS)
