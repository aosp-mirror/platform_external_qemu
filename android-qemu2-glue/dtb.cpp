...
/*
node(name='' fullpath='/' basenamelen=0)
  node(name='firmware' fullpath='/firmware' basenamelen=8)
    node(name='android' fullpath='/firmware/android' basenamelen=7)
        property(name='compatible' val=(len=17, val='android,firmware'))
      node(name='fstab' fullpath='/firmware/android/fstab' basenamelen=5)
          property(name='compatible' val=(len=14, val='android,fstab'))
        node(name='vendor' fullpath='/firmware/android/fstab/vendor' basenamelen=6)
