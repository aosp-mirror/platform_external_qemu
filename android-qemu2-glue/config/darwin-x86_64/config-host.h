...
#define CONFIG_QEMU_CONFDIR                                                  \
    "/tmp/qemu-android-build/prebuilts/qemu-android-deps/darwin-x86_64/etc/" \
    "qemu"
#define CONFIG_QEMU_DATADIR                                                    \
    "/tmp/qemu-android-build/prebuilts/qemu-android-deps/darwin-x86_64/share/" \
    "qemu"
#define CONFIG_QEMU_DOCDIR                                                     \
    "/tmp/qemu-android-build/prebuilts/qemu-android-deps/darwin-x86_64/share/" \
    "doc/qemu"
#define CONFIG_QEMU_MODDIR                                                   \
    "/tmp/qemu-android-build/prebuilts/qemu-android-deps/darwin-x86_64/lib/" \
    "qemu"
#define CONFIG_QEMU_LOCALSTATEDIR \
    "/tmp/qemu-android-build/prebuilts/qemu-android-deps/darwin-x86_64/var"
#define CONFIG_QEMU_HELPERDIR                                            \
    "/tmp/qemu-android-build/prebuilts/qemu-android-deps/darwin-x86_64/" \
    "libexec"
...
#define CONFIG_AUDIO_DRIVERS &coreaudio_audio_driver,
