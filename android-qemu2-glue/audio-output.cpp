...
audfmt_e QemuAudioOutputEngine::convert(android::emulation::AudioFormat format)
{
    audfmt_e internal;
    switch (format) {
    case android::emulation::AUDIO_FMT_U8:
        internal = AUD_FMT_U8;
        break;
    case android::emulation::AUDIO_FMT_S8:
        internal = AUD_FMT_S8;
        break;
    case android::emulation::AUDIO_FMT_U16:
        internal = AUD_FMT_U16;
        break;
    case android::emulation::AUDIO_FMT_S16:
        internal = AUD_FMT_S16;
        break;
    case android::emulation::AUDIO_FMT_U32:
        internal = AUD_FMT_U32;
        break;
    case android::emulation::AUDIO_FMT_S32:
