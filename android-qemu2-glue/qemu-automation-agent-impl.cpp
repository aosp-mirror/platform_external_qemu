...
static StartResult start_playback_with_callback(android::base::StringView filename, void (*onStopCallback)()) {
    return AutomationController::get().startPlaybackWithCallback(filename, onStopCallback);
}
