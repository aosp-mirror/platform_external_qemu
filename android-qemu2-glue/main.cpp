...
extern "C" int main(int argc, char** argv) {
    ...
    bool virtualSceneEnabled = !strcmp(hw->hw_camera_back, "virtualscene");
    if (virtualSceneEnabled && !feature_is_enabled(kFeature_VirtualScene)) {
        str_reset(&hw->hw_camera_back, "emulated");
        virtualSceneEnabled = false;
    }

    // Parse virtual scene command line options, if enabled.
    camera_virtualscene_parse_cmdline(virtualSceneEnabled);
