...
extern "C" int main(int argc, char** argv) {
    ...
    printf("Finished feature flag application and host hw query with uptime "
           ...
           get_uptime_ms());
#endif
    // Older version of Android Studio which runs embedded emulator doesn't support
    // virtual scene camera. Therefore, we disable it by default.
    // For newer version of Android Studio with virtual scene camera support, run
