...
//    }
...

    {
        ...
        shouldDisableAsyncSwap = shouldDisableAsyncSwap || (opts->gpu && !strncmp(opts->gpu, "angle", 5));
        shouldDisableAsyncSwap = shouldDisableAsyncSwap || async_query_host_gpu_SyncBlacklisted();
