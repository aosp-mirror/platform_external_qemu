...
#ifdef _WIN32
    if (::android::base::Win32Utils::getServiceStatus("vgk") > 0 &&
        MessageBox(NULL,
                   ...
                   "Vanguard anti-cheat software before running Android "
                   "emulator. Do you wish to continue running emulator?\n"
                   "Click YES to continue emulator\n"
                   "Or click NO to exit emulator now.",
                   "Warning: Imcompatible Software Detected",
