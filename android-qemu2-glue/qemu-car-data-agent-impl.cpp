...
static void send_car_data(const char* msg, int length) {
    return android_send_car_data(msg, length);
}

static void set_car_data_call_back(const std::function<void(const char*, int)>& callback) {
