android_add_library(
  TARGET libqemu-test LICENSE GPL-2.0-only
  SRC tests/libqtest.c ${ANDROID_AUTOGEN}/tests/test-qapi-visit.c ${ANDROID_AUTOGEN}/tests/test-qapi-types.c
...
android_add_library(
  TARGET libqemu-test-crypto LICENSE GPL-2.0-only
  SRC tests/libqtest.c ${ANDROID_AUTOGEN}/tests/test-qapi-visit.c ${ANDROID_AUTOGEN}/tests/test-qapi-types.c
      ${ANDROID_AUTOGEN}/tests/test-qapi-events.c ${ANDROID_AUTOGEN}/tests/test-qapi-introspect.c)
...
function(add_qtest NAME DEPENDENCY)
  android_add_test(TARGET ${NAME} SRC tests/${NAME}.c)
...
android_add_test(TARGET test-util-sockets-qtest SRC tests/test-util-sockets.c tests/socket-helpers.c)
