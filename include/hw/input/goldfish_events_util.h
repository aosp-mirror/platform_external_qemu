...
/*
 * This header file contains code common to goldfish_events and goldfish_roatry.
...
void events_write(void *opaque, hwaddr offset, uint64_t val, unsigned size);
...
void events_clr_bit(GoldfishEvDevState *s, int type, int bit);
