...
typedef void (*qemu_address_space_device_register_deallocation_callback)(void* context, uint64_t gpa, qemu_address_space_device_deallocation_callback_t);
...
struct qemu_address_space_device_control_ops {
    ...
    qemu_address_space_device_register_deallocation_callback register_deallocation_callback;
