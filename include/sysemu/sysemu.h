...
typedef void* (*qemu_address_space_device_control_get_hw_funcs_t)(void);
typedef void (*qemu_address_space_device_ping_with_data_t)(uint32_t handle);
typedef void (*qemu_address_space_device_ping_with_data_at_hva_t)(uint32_t handle, void* hva);
...
struct qemu_address_space_device_control_ops {
    ...
    qemu_address_space_device_ping_with_data_t ping_with_data;
    qemu_address_space_device_ping_with_data_at_hva_t ping_with_data_at_hva;
};
