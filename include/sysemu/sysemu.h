...
typedef void (*QEMURamLoadPageCallback)(void*);
...
// Callback for lazy loading of RAM for snapshots, at page granularity.
void qemu_ram_load_page(void* hostRam);

extern const uint32_t k_snapshot_ram_load_page_size;
