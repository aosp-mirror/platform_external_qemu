...
$(call start-emulator-shared-library, libandroidemu$(BUILD_TARGET_SUFFIX))
...
$(call start-emulator-program, libandroidemu$(BUILD_TARGET_SUFFIX)_unittest)

LOCAL_SRC_FILES := android/libandroidemu_unittest.cpp

LOCAL_SHARED_LIBRARIES := libandroidemu$(BUILD_TARGET_SUFFIX)
