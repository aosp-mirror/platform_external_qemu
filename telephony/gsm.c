...
/* For each gms7 code value, this table gives the equivalent
 * UTF-8 code point.
 */
...
/* For each gms7 extended code value, this table gives the equivalent
 * UTF-8 code point.
 */
...
/*
 * Input:  A UTF-8 code point
 * Output: If the character represented by the input can
 *         be expressed as gsm7, the gsm7 code value is
 *         returned (0 .. 127).
 *         If the input cannot be expressed by a (non-
 *         extended) gsm7 code value, -1 is retuned.
 */
static int
 ...
 * Input:  A UTF-8 code point
 * Output: If the character represented by the input can
 *         be expressed as extended gsm7, the extension
 *         code value is returned (0 .. 127).
 *         If the input cannot be expressed by an
 *         extension gsm7 code value, -1 is retuned.
 */
static int
